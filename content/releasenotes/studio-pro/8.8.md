...
## Upcoming Breaking Changes in Mendix Version 8.9

With Mendix version 8.9, we plan to roll out a more significant upgrade of the underlying technology layer by upgrading React Native to version 0.61 and by upgrading all native libraries to their most recent versions. This will improve the capabilities, quality, and stability of native mobile apps built with Mendix.
...
We advise you to upgrade your project to Mendix version 8.9 as the easiest solution to the upgrades. If you cannot upgrade your project to Mendix version 8.9, we will provide the following options:

* For Android we will provide a special Make It Native app version which you can use with Mendix version 8.8.
