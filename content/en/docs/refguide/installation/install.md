...
url: /refguide/install-studio-pro/
...
1. Open the downloaded Mendix Studio Pro executable. It is named like this: *Mendix-10.X.X-Setup*. Then click **Next**:
    ...
    {{< figure src="/attachments/refguide/installation/install-studio-pro/setup-wizard.png"  >}}

2. Select **I accept the terms in the License Agreement** and click **Next**.

3. Select the folder in which you want to install Studio Pro and click **Next**:

    {{< figure src="/attachments/refguide/installation/install-studio-pro/select-folder.png"   >}}

4. Enter the start menu shortcuts folder you want to use and click **Next**:

    {{< figure src="/attachments/refguide/installation/install-studio-pro/shortcut-folder.png"  >}}
