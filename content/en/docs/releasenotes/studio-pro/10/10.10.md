...
* We made Visual Builder the default editor for XPath unless you have set a preference for the XPath Expression editor.
...
* External Database Connector now supports **Snowflake (Beta)**, execution of Select and DML Queries are supported.
* We have made UI Improvement in External Database Connection document, which enables user have resizeable Query tab.
...
* We fixed an issue where Select Queries were considered as DML Query in External Database Connector.
