...
* We fixed the scenario in which a conditional visible widget was placed inside a conditionally visible container and it was not properly initialized. (Tickets 52885, 52987, 52994, 52976)
...
* Using the `reverse()` method in an XPath constraint now works properly, even for self-references. (Ticket 47140, 52175)
