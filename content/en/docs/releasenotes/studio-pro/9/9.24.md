...
* We updated Git that is installed with Studio Pro to version 2.41.0.3-64-bit.
...
* We fixed an issue where a commit, rollback, or delete action did not always send the associated object along. (Tickets 184397, 152735)
...
* We fixed an issue that occurred after a port fix with a newly created document was committed to a branch and another branch was merged into that branch. If there was a conflict for the document, double-clicking the conflict led to an "oops" pop-up window.
