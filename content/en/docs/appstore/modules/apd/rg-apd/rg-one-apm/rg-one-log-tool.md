---
title: "Log Tool"
url: /appstore/modules/apd/rg-one-log-tool/
---
...
{{< figure src="/attachments/appstore/modules/apd/rg-apd/rg-one-apm/rg-one-log-tool/Overview.png" >}}

You can start and stop the log tool via the "play" button in the header.

Double-clicking a log message shows its details.

{{< figure src="/attachments/appstore/modules/apd/rg-apd/rg-one-apm/rg-one-log-tool/View_Message.png" >}}
...
{{< figure src="/attachments/appstore/modules/apd/rg-apd/rg-one-apm/rg-one-log-tool/Options.png" >}}
...
{{< figure src="/attachments/appstore/modules/apd/rg-apd/rg-one-apm/rg-one-log-tool/Protections.png" >}}
...
{{< figure src="/attachments/appstore/modules/apd/rg-apd/rg-one-apm/rg-one-log-tool/Levels.png" >}}
