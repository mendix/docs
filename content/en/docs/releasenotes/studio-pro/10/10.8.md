...
* We added the ability to navigate through [styling properties](/apidocs-mxsdk/apidocs/design-properties/) by using keyboard shortcuts, such as tab and the arrow keys.
