...
* We extended the MxAssist Best Practice Bot best practice [MXP003](/refguide/performance-best-practices/#mxp003) for a non-indexed attribute used in sorting to the same attribute types as for a non-indexed attribute used in XPath.
* We added a new recommendation MXP016 to Best Practice bot to find the key of an OData source that is missing an index.
* We added a **Category** column to best practices of the Best Practice Bot.
