...
If you want to edit the schedule, click **Edit** ({{% icon name="pencil" %}}) to the right of the schedule. Clicking the "X" icon will delete the schedule. To activate/deactivate a schedule, click the box in front of the schedule.
