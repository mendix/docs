...
* We fixed an issue where for an application run locally and stopping the execution on a breakpoint in a microflow, the items in the **Run** menu > **Debug** as well as shortcut keys like <kbd>Alt</kbd>+<kbd>F6</kbd> would not respond to step through the microflow. (Ticket 78125)
