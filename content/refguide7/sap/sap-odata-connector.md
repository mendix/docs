...
For more information on domain models, see [Domain Model](/refguide7/domain-model) in the Mendix Reference Guide.
...
This domain model is part of the SAP OData Connector module and can be found in **Project ... > App Store module > SAPODataConnector**. Each entity (see [Entities](/refguide7/entities) in the Mendix Reference Guide) contains one or more attributes (see [Attributes](/refguide7/attributes) in the Mendix Reference Guide):
...
You can find more information about OData queries in [OData Query Options](/refguide7/odata-query-options).
