...
* **Catalog** – [search](/mendix-connect/catalog/search/) for registered assets in the search pane and see details of the metadata of selected asset
...
* **Curate** – carry out [curate](/mendix-connect/catalog/curate/) functions on registered assets to enrich the registered metadata and increase discoverability
...
* **Register a new data source** – manually register an OData service from your enterprise business application to the Data Hub (for more details, see [How to Register OData Resources in the Catalog](/mendix-connect/catalog/register-data/))
...
For more details, see [How to Search for Registered Assets](/mendix-connect/catalog/search/).
...
For further information on consuming from the Catalog, see [How to Consume Registered Assets](/mendix-connect/catalog/consume/). For details on using shared entities in Studio Pro, see [Data Hub Pane](/refguide/data-hub-pane/) in the *Studio Pro Guide*.
...
* OData v4 services originating from non-Mendix sources can be registered manually. For further details, see [Register OData Resources in the Catalog](/mendix-connect/catalog/register-data/).
...
You can add tags and descriptions, edit app owners, and toggle discoverability to ensure the right people find your service. For more details, see [How to Curate Registered Assets](/mendix-connect/catalog/curate/).

## 4 Information Available in the Catalog

In the Catalog, all the information for registered assets is displayed in the [Catalog search details](/mendix-connect/catalog/search/#search-details) screen. This information comes from the metadata in the OData service contract, and also from additional metadata that is added when registered assets are curated. Registered assets can be curated by owners, [Data Hub curators](/mendix-connect/catalog/manage-data-sources/user-roles/#curator), and [Mendix Admins](/mendix-connect/catalog/manage-data-sources/user-roles/#admin).
