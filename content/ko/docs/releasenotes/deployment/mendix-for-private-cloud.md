---
title: "Mendix on Kubernetes 릴리스 노트"
linktitle: "Mendix on Kubernetes"
url: /releasenotes/developer-portal/mendix-for-private-cloud/
weight: 20
description: "Mendix on Kubernetes를 사용한 배포에 대한 릴리스 노트"
---

이 릴리스 노트는 [Mendix on Kubernetes](/developerportal/deploy/private-cloud/)(이전 명칭: Mendix for Private Cloud)에 대한 배포 변경 사항을 다룹니다. 다른 배포 대상에 대한 별도의 릴리스 노트가 있습니다. 자세한 내용은 [배포](/releasenotes/developer-portal/deployment/) 릴리스 노트 페이지를 참조하세요.

Mendix on Kubernetes 배포의 현재 상태 및 계획된 릴리스에 대한 정보는 [Mendix Status](https://status.mendix.com/)를 참조하세요.
