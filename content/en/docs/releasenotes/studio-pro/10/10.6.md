...
* We fixed an issue in which clicking **Select...** button inside the **Query External Database** activity caused a crash when the microflow was located within a subfolder.
