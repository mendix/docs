...
Mendix Studio is the place where you can create, view and edit your Mendix applications without going into technical details. For this purpose you can use the [Studio Pro](/refguide/desktop-modeler-overview) and [develop apps together with Studio Pro users](collaborative-development) anytime. 
