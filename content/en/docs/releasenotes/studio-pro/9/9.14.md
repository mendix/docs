...
{{% alert color="warning" %}}We have identified a regression when adding associations to System.User or a specialization. A [Known Issue](#known-issues) with details has been added.{{% /alert %}}
...
* When adding a new association from System.User or a specialization of System.User (i.e. that owner of the association is System.User), through a user-interface, the operation will fail. For instance, managing users through the Administration Module does not work.
