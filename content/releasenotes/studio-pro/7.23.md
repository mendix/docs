...
* We upgraded the JDBC driver for Microsoft SQL Server to version 9.4.1. If you use the Database Connector module with SQL Server and integrated security, you may need to update the JDBC driver in userlib as well.
