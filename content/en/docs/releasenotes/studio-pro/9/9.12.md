...
{{% alert color="info" %}}For an overview of the highlights in this release, see the [Mendix Release 9.12](https://www.mendix.com/blog/mendix-9-12-release-something-for-everybody/) blog post.{{% /alert %}}
...
* We cleaned up generated Java code in order to improve readability and to decrease IDE warnings. Please note that this will cause some changes in your Java code when you push commits to the [Team Server](/developerportal/repository/team-server/). This is to be expected.
