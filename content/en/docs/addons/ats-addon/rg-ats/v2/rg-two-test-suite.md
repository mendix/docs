...
{{< figure src="/attachments/addons/ats-addon/rg-ats/v2/rg-two-test-suite/testsuite-details.png" alt="Edit Test Suite" >}}
...
{{< figure src="/attachments/addons/ats-addon/rg-ats/v2/rg-two-test-suite/search-testcase-testsuite.png" >}}
...
{{< figure src="/attachments/addons/ats-addon/rg-ats/v2/rg-two-test-suite/dialog-testcase-testsuite.png" >}}
