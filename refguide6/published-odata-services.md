...
Please refer to the [OData Query Options](/refguide6/odata-query-options) page to see how to filter the OData response.

### Supported Types

Please refer to the [OData Representation](/refguide6/odata-representation) page to see how Mendix attributes are being represented in OData.
...
With project security enabled, OData resources can still be exposed to anonymous users. Please refer to the section [Anonymous user role](/refguide6/anonymous-users) for detailed information on allowing anonymous users.
