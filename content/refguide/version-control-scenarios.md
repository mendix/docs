...
If you update your app and the changes cannot be merged automatically you will receive a message telling you there are conflicts.
...
## 7 Versioning a Project Deployed to the Cloud
...
### 7.1 Deploying a Specific Version to a Mendix Licensed Cloud Node
...
### 7.2 Creating a Deployment Package from a Specific Version
...
### 8.1 Patching a Deployed Application
