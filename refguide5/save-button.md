...
The save button works in conjunction with a top-level [Data view](/refguide5/data-view). Pressing the button will commit any changes made on the object shown in the data view.
