...
{{% alert color="info" %}}For highlights of this release, see the [Mendix Release 10.4](https://www.mendix.com/blog/mendix-release-10-4-a-low-code-leader-that-keeps-on-giving/) blog post.{{% /alert %}}
