...
url: /catalog/manage-data-sources/curate/
...
{{< figure src="/attachments/catalog/manage-data-sources/curate/curate-list.png" alt="curate list" >}}
...
2. The **Application Metadata** screen is displayed:
    ...
    {{< figure src="/attachments/catalog/manage-data-sources/curate/application-metadata-screen.png" alt="app metadata screen" >}}
...
{{< figure src="/attachments/catalog/manage-data-sources/curate/app-icon-several-services.png" alt="custom contact create" >}}
...
1. In the **Application Metadata** screen of the selected data source, click **Upload a different icon** to display the **Upload Application Icon** pop up:
    ...
    {{< figure src="/attachments/catalog/manage-data-sources/curate/icon-upload-dialog.png" alt="upload icon"   width="300"  >}}
...
4. A preview of the application icon is shown. Click **Save** to upload the selected icon.
    ...
    {{< figure src="/attachments/catalog/manage-data-sources/curate/icon-preview.png" alt="upload icon"   width="300"  >}}

5. The **Application Metadata** screen will now show the selected icon for the application:

    {{< figure src="/attachments/catalog/manage-data-sources/curate/asset-metadata-new-icon.png" alt="upload icon" >}}
...
{{< figure src="/attachments/catalog/manage-data-sources/curate/icon-library.png" alt="upload icon"   width="300"  >}}
...
1. In the **Curation Bar**, click **Edit** > **Edit Metadata** > **Service Details** to display the **Service Metadata** box:
    ...
    {{< figure src="/attachments/catalog/manage-data-sources/curate/service-metadata-box.png" alt="service metadata" >}}
...
2. The description from the OData service metadata is displayed in the **Contract Description**. This cannot be changed, as it is part of the OData service definition. You can provide an alternative description by toggling **Use the catalog description** to display the **Catalog Description** box:
    ...
    {{< figure src="/attachments/catalog/manage-data-sources/curate/service-metadata-description.png" alt="edit description" >}}
...
2. To add tags, click the empty **Tag** input area:
    ...
    {{< figure src="/attachments/catalog/manage-data-sources/curate/service-metadata-tags.png" alt="tags" >}}
...
4. You can enter multiple tags separated by spaces. You can remove tags by clicking the **x**:
    ...
    {{< figure src="/attachments/catalog/manage-data-sources/curate/service-metadata-tags-list.png" alt="tag list" >}}
...
For a description of supported authentication methods, see the [Selecting an Authentication Method](/catalog/register-data-sources/register-data/#authentication) section of *Register OData Resources in the Data Hub Catalog*.
