...
{{% alert color="info" %}}
Kudos to [Marcel Groeneweg for their upvoted idea](https://community.mendix.com/link/ideas/665) about this on the Mendix Community!
{{% /alert %}}
...
For more information, see [Subversion 1.9 in Studio Pro 8 Beta 2](https://community.mendix.com/link/questions/94078) on the Mendix Community.
...
* We fixed an issue where you could not search for changes introduced in nanoflows from convenience methods in the domain model. For more information, see [Search for Nanoflow action](https://community.mendix.com/link/ideas/718) on the Mendix Community. (Ticket 77034)
* We fixed an issue where searching for texts in expressions only showed texts used in microflows, not in pages. For more information, see [Search for Nanoflow action](https://community.mendix.com/link/ideas/966) on the Mendix Community.
