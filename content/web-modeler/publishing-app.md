...
Deployment means getting your app up and running in a cloud environment to make it available for the end-users. The term "publish" is used to describe the same process in Mendix Studio's interface. 
...
By default all apps created in Studio are Free Apps. A Free App is a complete deployment environment in the Mendix Cloud with some limitations. You can upgrade your Free App to a licensed app. The main differences between a Free App and a licensed app are described in the table below: 
...
1. Click **Publish** in the top-bar of Studio (the dialog with your app status will open). 
