...
* <a id="RN771"></a>We fixed the following data retrieval issues when concerning virtual attributes: (Ticket 56016)
...
* We fixed the Oops exception pop-up window that appears when copying or looking for usages of list operation actions. (Tickets 54886, 54610, 54782)
