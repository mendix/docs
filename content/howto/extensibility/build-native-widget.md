...
Note that whenever it's required to reinstall NPM package dependencies inside the scaffolded pluggable widget app project with an NPM version of 7 or higher, make sure to run the installation script with an extra flag: `npm install --legacy-peer-deps`.
