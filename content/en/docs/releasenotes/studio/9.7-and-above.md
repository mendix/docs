...
* We fixed an issue with a horizontal scrollbar that appeared when you selected attributes in the Approval Request workflow wizard. For more information on the wizard, see the [Creating a Workflow Using the Wizard](/studio/workflows/#wizard) section in *Workflows*.
