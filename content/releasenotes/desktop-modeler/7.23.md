...
{{% alert type="info" %}}
When opening a large app project with this version of the Desktop Modeler, the loading of the app can take multiple seconds, and in some cases, the Modeler may become unresponsive. This is due to a performance issue in the **Project Explorer**, and we will be releasing a patch with a fix for that shortly.
{{% /alert %}}
...
### Known Issues {#known-issues-7230}
