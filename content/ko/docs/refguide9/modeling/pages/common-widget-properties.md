...
{{< figure src="/attachments/refguide9/modeling/pages/common-widget-properties/common-section.png" alt="Common Section" class="no-border" >}}
...
{{< figure src="/attachments/refguide9/modeling/pages/common-widget-properties/show-styles.png" class="no-border" >}}
...
{{< figure src="/attachments/refguide9/modeling/pages/common-widget-properties/style-example.png" class="no-border" >}}
...
{{< figure src="/attachments/refguide9/modeling/pages/common-widget-properties/dynamic-classes.png" class="no-border" >}}
...
{{< figure src="/attachments/refguide9/modeling/pages/common-widget-properties/data-source-section.png" alt="Data Source Section" class="no-border" >}}
...
The attribute can be of one of the following [data types](/refguide9/data-types/):
...
{{< figure src="/attachments/refguide9/modeling/pages/common-widget-properties/editability-section.png" alt="Common Section" class="no-border" >}}
...
{{< figure src="/attachments/refguide9/modeling/pages/common-widget-properties/label-section.png" alt="Label Section" class="no-border" >}}
...
{{< figure src="/attachments/refguide9/modeling/pages/common-widget-properties/numeric-formatting-section.png" alt="Numeric Formatting Section" class="no-border" >}}
...
{{< figure src="/attachments/refguide9/modeling/pages/common-widget-properties/validation-section.png" alt="Validation Section" class="no-border" >}}
...
{{< figure src="/attachments/refguide9/modeling/pages/common-widget-properties/visibility-section.png" alt="Visibility Section" class="no-border" >}}
...
{{< figure src="/attachments/refguide9/modeling/pages/common-widget-properties/visibility-example.png" alt="Visibility Example" class="no-border" >}}
