...
* Apply the tone of the Mendix documentation, which is relaxed but straight-forward.
...
For help with spelling and grammar, you can load your article into [Hemingway](https://www.hemingwayapp.com/).

## Guidelines for the Mendix Studio Pro How-tos
...
Write the title of the how-to so that it is clear and attractive to people not familiar with Mendix. In addition, write the title from a problem-solving perspective, so do not just state that you are implementing a solution.
...
Add images that clearly show the specific functionality of the related step. That way, the reader can check that the image matches what they see on their screen. For example, the arrows and flow on this screenshot are too busy and not clear enough for the user:
...
## Guidelines for the Mendix Studio Pro Guide

{{% alert color="info" %}}

This section presents guidelines for writing Studio Pro Guide pages. Read this section while referencing the [Reference Guide Page Template](https://github.com/mendix/docs/blob/development/templates/ref-guide-page-template.md).
...
* Each feature should contain at least one relevant example.
...
* Add images that clearly show the specific functionality being described.
