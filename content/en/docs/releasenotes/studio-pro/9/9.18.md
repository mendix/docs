...
* Starting with version 9.20.0, we will drop support for the following databases, as they are no longer being supported by the vendors. For 9.18 as an MTS version, support for the listed databases will be dropped after version 9.18.2:
  * PostgreSQL 10
  * SQL Server 2017
