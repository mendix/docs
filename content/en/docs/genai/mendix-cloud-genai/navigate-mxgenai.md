...
Below the summary, the page shows **Consumption Over Selected Time Range**. You can switch between weekly (**W**), bundle month (**BM**), month to date (**MTD**), and six months (**6M**) views. Use the **Model** dropdown to filter the charts by a specific model, and the **Key** dropdown to filter by a specific resource key. The charts show:
