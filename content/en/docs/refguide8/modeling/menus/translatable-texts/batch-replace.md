...
{{< figure src="/attachments/refguide8/modeling/menus/translatable-texts/batch-replace/batch-replace-search.png" alt="Batch translate search" class="no-border" >}}
...
{{< figure src="/attachments/refguide8/modeling/menus/translatable-texts/batch-replace/batch-replace-replace.png" class="no-border" >}}
...
{{< figure src="/attachments/refguide8/modeling/menus/translatable-texts/batch-replace/batch-replace-excel.png" alt="Sample Excel file" class="no-border" >}}
