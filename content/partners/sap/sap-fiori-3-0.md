...
The [SAP Fiori 3 Demo app](https://marketplace.mendix.com/link/component/116787) App Store Module contains a number of different skeleton apps which you can review or copy to use as the basis for your own apps.
