...
{{< figure src="/attachments/addons/ats-addon/rg-ats/v1/rg-one-administration/startpage.png" alt="Projects page when logged in as administrator" >}}
...
{{< figure src="/attachments/addons/ats-addon/rg-ats/v1/rg-one-administration/neweditproject.png" alt="New/Edit Project or Action Library" >}}
...
{{< figure src="/attachments/addons/ats-addon/rg-ats/v1/rg-one-administration/selenium.png" alt="Selenium Overview" >}}
...
{{< figure src="/attachments/addons/ats-addon/rg-ats/v1/rg-one-administration/21168202.png" alt="Edit Selenium hub dialog as admin" >}}

## 4 Add Applications

As an admin user, you can add and configure applications to test.

{{< figure src="/attachments/addons/ats-addon/rg-ats/v1/rg-one-administration/applications.png" alt="Add Test Applications" >}}
...
{{< figure src="/attachments/addons/ats-addon/rg-ats/v1/rg-one-administration/accounts.png" alt="Accounts page" >}}

When editing accounts you can set accounts to inactive or block them, which will both deactivate the account.

{{< figure src="/attachments/addons/ats-addon/rg-ats/v1/rg-one-administration/newuser.png" alt="Create new account dialog" >}}
