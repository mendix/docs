...
description: "이 API는 pluggable widget의 이해, 앱 기능 확장 방법, Mx11에서 Mendix API와 상호 작용하도록 구축하는 방법을 설명합니다."
no_list: false
...
### 위젯 속성 정의 {#properties-definition}
...
Mendix는 pluggable widget을 위해 다음 API를 제공합니다:
