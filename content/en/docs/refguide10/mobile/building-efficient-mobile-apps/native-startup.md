...
url: /refguide10/mobile/building-efficient-mobile-apps/native-startup/
weight: 15
...
You can inspect what is actually happening by enabling Trace logs for the various `Client_` log-nodes (most important are `Client_Startup` and `Client_Synchronization`). For more details see [Mobile Logging](/refguide10/mobile/building-efficient-mobile-apps/logging/).
