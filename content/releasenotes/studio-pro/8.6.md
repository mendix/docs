...
* We rebuilt the [Connector](/refguide/view-menu#connector) to give it the same look and feel as the new [Project Explorer](//refguide/project-explorer). Highlighting via the **Filter** now works in the Connector. You can switch to the new version of the Connector via **Edit** > **Preferences** > [New Features](/refguide/preferences-dialog#new-connector).
