...
* [Network Timeout](/refguide/mobile/building-efficient-mobile-apps/network-timeout/): This configuration parameter for mobile applications helps handle slow or unreliable network conditions. Employ it for mobile apps use cases that experience varied network connectivity.
