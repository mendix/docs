...
Studio Pro on Mac is now in [public beta](/releasenotes/beta-features/). **[ADD CROSS-REFERENCE]** This allows you to run Studio Pro natively on Mac without Parallels. With the Mac version of Studio Pro, you can edit your apps on Windows using the functionality you are used to.
...
* The installer is currently not yet notarized, so you need to run it using right-click > **Open** to be able to bypass the dialog box.
