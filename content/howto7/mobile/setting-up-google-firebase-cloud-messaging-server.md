...
To build the hybrid app package, follow [these steps](/howto/mobile/build-hybrid-locally) depending on your platforms until you have the build packages you need. Then, do the following:
