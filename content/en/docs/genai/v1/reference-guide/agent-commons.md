---
title: "Agent Commons"
url: /agents/agents-kit-1/reference-guide/agent-commons/
...
{{% alert color="info" %}}
Looking for Mendix's newest agentic and generative AI features? [This page has been updated for Agents Kit 2](/agents/agents-kit-2/reference-guide/agent-commons/), which is available for Studio Pro 11.12 and above.
{{% /alert %}}
...
Note that [user access approval](/agents/agents-kit-1/reference-guide/commons/#enum-useraccessapproval) can only be set to `HiddenForUser` or `VisibleForUser` for knowledge base retrievals.
...
4. Optional: You can [create a file collection and add files](/agents/agents-kit-1/reference-guide/commons/#initialize-filecollection) to it that can be sent along with the user message to the model. Check the documentation of the underlying LLM connector for support of files and images.
