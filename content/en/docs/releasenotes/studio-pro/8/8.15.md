...
* <a id="2562"></a>We fixed a known performance issue with the [Delete object (or objects)](/refguide8/deleting-objects/) action. This action is no longer slowed down if there are microflow variables containing large lists of entities in scope.
