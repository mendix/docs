---
title: "Part 8: Send Your First Test Push Notification"
linktitle: "8. Test Push Notification"
...
After [configuring the Push Notifications module](/refguide9/mobile/using-mobile-capabilities/push-notifications/notif-config-push/) and [implementing push notifications in your native app](/refguide9/mobile/using-mobile-capabilities/push-notifications/notif-build-native/) or your [progressive web app](/refguide9/mobile/using-mobile-capabilities/push-notifications/notif-implement-pwa/) it is now time to send your first test push notification.
