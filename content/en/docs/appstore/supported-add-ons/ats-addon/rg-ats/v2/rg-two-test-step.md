---
title: "Test Step"
url: /appstore/supported-add-ons/ats/rg-two-test-step/
---

## 1 Introduction

Test steps are the heart and soul of a test case. They describe a sequence of [actions](/appstore/supported-add-ons/ats/rg-two-action/) that ATS performs during the execution of a test case.

When you create a new test case, it is empty by default. You must add test steps to it. For more information on how to add a test step to a test case, see [Test Case](/appstore/supported-add-ons/ats/rg-two-test-case/).

To see the details of a test step, click the name of the test step. The details will open below the test step.

{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-test-step/test-step-details.png" >}}
...
If you record your test steps, ATS enters a description automatically. For more information about recording test steps, see [Recorder](/appstore/supported-add-ons/ats/rg-two-recorder/).
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-test-step/input-value-dialog.png" >}}
