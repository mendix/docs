...
#KI: "The removal of the Dojox library" = UICORE-534
...
* The removal of the Dojox library has caused widgets to break.
	* Workaround: Copy the **dojox** folder from the **runtime\mxclientsystem** folder of a previous Studio Pro 8 installation to the one in 8.4.0 to resolve this issue.
