...
1. After you click **Generate Plan**, the **Define Scope** window appears, and Maia starts populating it with the proposed project scope.     
   The app plan becomes available on the **Projects** page as soon as you click **Generate Plan** at the beginning of the workflow. You can return to the plan at any time after you leave it, and you can add team members to the app.
