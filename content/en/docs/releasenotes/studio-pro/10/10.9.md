...
- External Database Connector: We now support calling of Stored Procedure with no parameters, User can browse through all the Procedures in Browse Database tab. Refresh/Reconnect button is introduced to provide quick access of updated data to the  user.
- External Database Connector is now available on studio-pro beta release for macos.
