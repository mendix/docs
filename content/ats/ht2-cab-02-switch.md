...
<<<<<<< HEAD:content/ats/ht2-cab-02-switch.md
...
>>>>>>> development:content/ats/howtos/ht-version-2/cab-02-switch-2.md
...
<<<<<<< HEAD:content/ats/ht2-cab-02-switch.md
    You use a precondition on the *Click/Doubleclick* action performing the logic: use the [*Assert Not Equals*](rg1-assert-not-equals) action as the precondition.
=======
