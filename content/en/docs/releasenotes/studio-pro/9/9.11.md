...
{{% button color="info" href="https://marketplace.mendix.com/link/studiopro/9.11.1" text="Download in Marketplace" title="Download version 9.11.1 from the Marketplace" %}}
...
{{% button color="info" href="https://marketplace.mendix.com/link/studiopro/9.11.0" text="Download in Marketplace" title="Download version 9.11.0 from the Marketplace" %}}
...
* We added the option to enable [Dark mode preview](/refguide/preferences-dialog/#dark-mode) to the **New features** tab in **Preferences**. Note that not all screens support dark mode yet, and some parts of Studio Pro can be displayed in light mode when dark mode is enabled.
    ...
    {{% alert color="info" %}}This is based on an [upvoted idea from Marcus Groen](https://forum.mendix.com/link/ideas/80) in the [Mendix Idea Forum](https://forum.mendixcloud.com/link/ideas). Thank you for thinking along, Marcus!{{% /alert %}}
