---
title: "JVM Browser"
url: /appstore/modules/apd/rg-one-jvm-browser/
---
...
{{< figure src="/attachments/appstore/modules/apd/rg-apd/rg-one-apm/rg-one-jvm-browser/Overview.png" >}}                

Double-clicking an items drills down shows its details.

{{< figure src="/attachments/appstore/modules/apd/rg-apd/rg-one-apm/rg-one-jvm-browser/Details.png" >}}
