...
* Registration of updatable OData resources in the Data Hub Catalog does not work when the [Updatable (write)](published-odata-resource#capabilities) capability is enabled for a published OData service.
