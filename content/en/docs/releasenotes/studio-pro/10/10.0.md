...
* Mendix no longer supports responding with custom reason phrases, in line with the HTTP/2 protocol which does not support reason phrases. This has the following effects:
