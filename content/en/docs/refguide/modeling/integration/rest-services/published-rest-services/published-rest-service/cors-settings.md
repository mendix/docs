...
When you enable CORS in a [published REST service](/refguide/published-rest-service/), all websites on all servers are allowed to access your service by default. The **CORS Settings** dialog box allows you to configure this type of access on a more detailed level.
