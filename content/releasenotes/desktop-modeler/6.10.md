...
* When you save file documents in S3 or Azure, you can now [configure timeouts](https://docs.mendix.com/refguide6/custom-settings) for connecting to the storage service. (Ticket 68718)
