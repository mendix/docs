...
* Components in the "Solutions" category will not have downloadable content. When you create a new component, you will not be able to upload a source file if it is a "Solutions" type.
