...
Curation is performed from the [asset details screen](/catalog/manage-data-sources/search/#search-details). If you are an owner of an asset or are a curator, you will see the **Curation Bar** for the selected item.
