...
* External database connector now supports UPDATE & DELETE sql statments.
* We improved the performance of populating tables and views metadata from all schemas accesible by the user in External Database Connector. Searching for information within this tab has also been improved.
* External Database Connector has a new SQL Query text box which offers highlighting of SQL grammar, retains indentation and format after pasting into the component. It also now supports standard features such as copy, paste, undo, redo, find and replace.
