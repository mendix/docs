---
title: "네이티브 모바일용 JavaScript Action 빌드"
url: /howto8/extensibility/create-native-javascript-action/
weight: 30
description: "이 튜토리얼에서는 네이티브 모바일 앱용 JavaScript Action을 빌드하는 방법을 알려드립니다."
---
...
1. Add an action button with caption *Scan NFC Tag* on your home page. <br />
    ...
    8. Drag the **HasNFCSupport** JavaScript action onto this nanoflow.<br />
