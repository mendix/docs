...
url: /appstore/modules/apd/ig-three/
weight: 1
---

## 1 Introduction

This is the installation guide for CLEVR APD 3, the successor to [APM 2](/appstore/modules/apd/ig-two/).
...
* Remove APM 1 and/or APM 2 if they are installed (for details, see [Uninstall Steps APM 1](/appstore/modules/apd/ig-one-uninstall-steps/))
