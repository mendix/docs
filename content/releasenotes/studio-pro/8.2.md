...
{{% alert type="warning" %}}
We have decided to retract version 8.2.1 due to an issue related to committing new objects with a one-to-one association in combination with autocommit behavior. This will be fixed in 8.2.2.
{{% /alert %}}
...
{{% alert type="warning" %}}
We have decided to retract version 8.2.0 due to an issue related to committing new objects with a one-to-one association in combination with autocommit behavior. This will be fixed in 8.2.2.
{{% /alert %}}
