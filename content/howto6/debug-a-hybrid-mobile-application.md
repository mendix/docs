...
On the configure screen, fill in the same settings that you used to start weinre, which should be <div style="display: inline">http://1.2.3.4:9090</div> (wherein `1.2.3.4` is your local IP).
