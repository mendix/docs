...
{{% alert color="info" %}}For an overview of the highlights in this release, see the [Mendix Release 10.13](https://www.mendix.com/blog/mendix-release-10-13-maia-generate-a-domain-model-for-me/) blog post.{{% /alert %}}
