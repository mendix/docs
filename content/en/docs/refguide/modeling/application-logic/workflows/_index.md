...
A workflow is composed of elements that you can drag on a path. Below is a categorized overview of all elements. The following categories are used:
...
1. Open the **Toolbox**.
2. Select an element you would like to add and drag this element in the working area.
