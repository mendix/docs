...
* We fixed an issue where sorting by associated attributes led to an error when the default locale was **Turkish**. (Ticket 93299)

### Known Issues

* On MySQL 8.0.19 or higher, when a unique validation rule for an attribute is violated, the generic error message "An error occured, please contact your system administrator" is shown instead of the configured error message for the validation rule. This will be fixed in Mendix Studio Pro 8.6.0.
