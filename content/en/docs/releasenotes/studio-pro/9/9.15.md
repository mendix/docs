...
* We added an icon indicating the type and navigability of associations to the entity properties and **Add Association** dialog box. Also, one-way navigable associations have a special informational banner in the association properties dialog box.
