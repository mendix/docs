...
| Duration   | You can set the deadline for the workflow with the **Due in** option, which indicates the number of hours, days, or weeks the task is due in. Possible values of the property are the following ones:<br /><ul><li>Hour (or Hours)</li><li>Day (or Days)</li><li>Week (or Weeks)</li> </ul> |
...
#### 2.3.2 User Task State Change {#user-task-state-change}
...
### 2.4 Admin Page Section {#admin-page} 
...
### 2.5 Display Information Section {#display-info}
...
##### 2.5.3.2 Performing Other Actions on Parameters
