...
* We added a new log node called IDResolution, which will provide more details about certain actions being executed on the runtime.
...
* We fixed an issue where Chrome extensions could crash the client (Tickets 180229, 180230, 180385, 180405, 180450, 180472 and 183144).
...
* We fixed an issue with widgets packaging during export of solution modules which caused widget conflicts on consuming side. Now solution modules are exported without the widgets. (Ticket 183918)
