...
| :-------------- | :---------------------- | :--------------- | :------------------ |
| Local Selenium Server (Docker) | {{< figure src="/attachments/appstore/partner-solutions/ats/ht/v2/ht-two-upload-file-using-ats/grey.png" >}} Limited<sup>1</sup> | {{< figure src="/attachments/appstore/partner-solutions/ats/ht/v2/ht-two-upload-file-using-ats/green.png" >}} Yes | {{< figure src="/attachments/appstore/partner-solutions/ats/ht/v2/ht-two-upload-file-using-ats/green.png" >}} Yes |
| BrowserStack (SaaS) | {{< figure src="/attachments/appstore/partner-solutions/ats/ht/v2/ht-two-upload-file-using-ats/red.png" >}} No | {{< figure src="/attachments/appstore/partner-solutions/ats/ht/v2/ht-two-upload-file-using-ats/green.png" >}} Yes | {{< figure src="/attachments/appstore/partner-solutions/ats/ht/v2/ht-two-upload-file-using-ats/green.png" >}} Yes |
| SauceLabs (SaaS) | {{< figure src="/attachments/appstore/partner-solutions/ats/ht/v2/ht-two-upload-file-using-ats/red.png" >}} No | {{< figure src="/attachments/appstore/partner-solutions/ats/ht/v2/ht-two-upload-file-using-ats/red.png" >}} No | {{< figure src="/attachments/appstore/partner-solutions/ats/ht/v2/ht-two-upload-file-using-ats/red.png" >}} No |
| Selenium SaaS Agent | {{< figure src="/attachments/appstore/partner-solutions/ats/ht/v2/ht-two-upload-file-using-ats/grey.png" >}} Limited<sup>2</sup> | {{< figure src="/attachments/appstore/partner-solutions/ats/ht/v2/ht-two-upload-file-using-ats/green.png" >}} Yes | {{< figure src="/attachments/appstore/partner-solutions/ats/ht/v2/ht-two-upload-file-using-ats/red.png" >}} No |
...
{{< figure src="/attachments/appstore/partner-solutions/ats/ht/v2/ht-two-upload-file-using-ats/set-file-manager.png" >}}
...
{{< figure src="/attachments/appstore/partner-solutions/ats/ht/v2/ht-two-upload-file-using-ats/file-uploader-widget-app.png" >}}
