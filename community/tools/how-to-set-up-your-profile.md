...
In order to receive Mendix points for your contributions to the Mendix documentation, you must authorize the connection to your GitHub profile. For more details on receiving Mendix points for your documentation work, see [How to Contribute to the Mendix Documentation](../documentation/contribute-to-the-mendix-documentation).
