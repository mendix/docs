...
* We fixed an issue where offline synchronization failed after user's authentication token expired. (Tickets 85208, 85976)
* We fixed a bug where triggering microflow after failed login attempt worked unexpectedly. (Tickets 88971, 89196, 90471)
