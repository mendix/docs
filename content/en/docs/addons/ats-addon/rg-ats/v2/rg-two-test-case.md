...
{{< figure src="/attachments/addons/ats-addon/rg-ats/v2/rg-two-test-case/testcase-details.png" >}}
...
{{< figure src="/attachments/addons/ats-addon/rg-ats/v2/rg-two-test-case/search-button.png" >}}
...
{{< figure src="/attachments/addons/ats-addon/rg-ats/v2/rg-two-test-case/select-function-action.png" >}}.
...
| Icon                                     | Meaning  |
| ---------------------------------------- | -------- |
| {{< figure src="/attachments/addons/ats-addon/rg-ats/v2/rg-two-test-case/setting-gears-2.png" >}} | Setup    |
| {{< figure src="/attachments/addons/ats-addon/rg-ats/v2/rg-two-test-case/hammer-2.png" >}}       | Teardown |
