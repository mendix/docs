...
* <a id="fix-workflow-user-task"></a>We fixed a [known issue](#ki-workflow-user-task) where the workflows user task was not passed correctly as a parameter to the user task's microflow decision method.
