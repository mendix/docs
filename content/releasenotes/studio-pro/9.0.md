...
## 9.0.0 General Availability

**Release date: March 30th, 2021**

{{% modelerdownloadlink "9.0.0" %}}
...
[**UPDATE NOTE BELOW WITH DOC LINK**]
...
[**VERIFY BELOW AND ANY NEW DOC LINK**]

Please note that the **theme** changes are opt-in, which means you can keep using the old structure (for example, if you choose to stick to Atlas UI 2.0 for now). However, Atlas UI 3.0 requires the new structure, and upcoming documentation will explain the steps needed for conversion.
...
* Studio Pro 9.0.0 requires apps to be in at least version [8.12.0](/releasenotes/studio-pro/8.12#8120) to open them. This also applies to importing (Marketplace) modules.
...
## 9.0 Beta Releases (9.0.2–9.0.4)

{{% alert type="warning" %}}
The beta program for 9.0 has ended. This means that the 9.0.2–9.0.4 beta versions of Studio Pro are no longer available for download. In addition, apps created in 9.0.2–9.0.4 beta versions that are converted to 9.0.0 general availability can no longer be opened in the beta versions of Studio Pro.
{{% /alert %}}
