---
title: "REST 및 SOAP에서 SAP Connectivity Service 사용"
linktitle: "REST 및 SOAP에서 SAP Connectivity Service 사용"
url: /developerportal/deploy/sap-cloud-platform/sap-destination-with-rest/
weight: 25
description: "온프레미스 서비스에 도달하기 위해 SAP Destination Service 및 SAP Connectivity Service를 사용하도록 Mendix 네이티브 REST 및 SOAP 호출을 구성하는 방법."
aliases:
