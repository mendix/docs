---
title: "Build an Employee Directory App (Advanced) Step 5: Add Employee Promotion Logic"
...
This is the fifth how-to in this series on creating an employee directory app. In this how-to, you will learn how to add a microflow to the app and edit it in the Desktop Modeler.
...
* Complete the fourth how-to in this series: [How to Build an Employee Directory App (Advanced) Step 4: Add Pages to the User Interface](build-an-employee-directory-app-advanced-3-publish-and-view-your-app)
...
4. Search for "pageheader" in the **Toolbox** and drag the **Pageheader Controls** building block into the **DATA VIEW CONTENT** area:
    ...
    ![](attachments/build-an-employee-directory-app-advanced/pageheader-controls.png)

5. Select the **ROW** of the layout grid that contains this building block:

    ![](attachments/build-an-employee-directory-app-advanced/pageheader-controls-row.png)
...
9.  Change the following properties of the **Edit** button:<br>
    ...
    ![](attachments/build-an-employee-directory-app-advanced/pageheader-controls-finished.png)
...
1. Click the **Domain Models** icon in the left menu:
    ...
    ![](attachments/build-an-employee-directory-app-advanced/domain-models.png)

2. Select **MyFirstModule** and check how your entity looks at this point:

    ![](attachments/build-an-employee-directory-app-advanced/entity.png)
...
3.  Select the **Employee** entity and do the following:<br>
    ...
    ![](attachments/build-an-employee-directory-app-advanced/enumeration.png)
...
2.  Go back to the **Buzz** page of the app in the Mendix Portal:
    ...
    ![](attachments/build-an-employee-directory-app-advanced/back-to-platform.png)

3.  Click the drop-down arrow on **Edit App** and select **Edit in Desktop Modeler** to open your app in the Desktop Modeler:

    ![](attachments/build-an-employee-directory-app-advanced/edit-in-dm.png)
...
4.  Update the local version of your app by clicking **Sync with Web Modeler** in the **Changes** pane of the Desktop Modeler. If the project requires it, commit the project first using the **Commit** button.
    ...
    ![](attachments/build-an-employee-directory-app-advanced/sync-with-wm.png)
...
5.  After synchronizing the project, you can inspect the changes in the **Changes** pane. Click **Finish sync with Web Modeler** to complete the synchronization.
    ...
    ![](attachments/build-an-employee-directory-app-advanced/finish-sync-with-wm.png)
...
1.  Open the **Promote_Employee** microflow:
    ...
    ![](attachments/build-an-employee-directory-app-advanced/open-microflow-dm.png)
...
2.  Right-click the microflow arrow, select **Insert** > **Exclusive Split**, and do the following:<br>
    ...
    ![](attachments/build-an-employee-directory-app-advanced/exclusive-split-level.png)
...
6. Set the remaining condition values on these arrows to **Junior**, **Medior**, and **(empty)**:
    ...
    ![](attachments/build-an-employee-directory-app-advanced/exclusive-split-level1.png)
...
7.  Insert an **Activity** of the **Change object** type to the arrow with the **Junior** conditon and do the following:<br>
    ...
    ![](attachments/build-an-employee-directory-app-advanced/exclusive-split-level5.png)
...
8. Insert an **Activity** of the **Show message** type to the right of the change object activity and do the following:<br>
    ...
    ![](attachments/build-an-employee-directory-app-advanced/show-message.png)
...
9.  Using the scenario above, complete the microflow with the following requirements:
    ...
    * Employees with the **Senior** level should only receive a message that **Senior** is the highest level
    ...
    ![](attachments/build-an-employee-directory-app-advanced/exclusive-split-level15.png)
...
Update and view your app, just like you did in [How to Build an Employee Directory (Advanced) App Step 3: Publish and View Your App](build-an-employee-directory-app-advanced-3-publish-and-view-your-app).
