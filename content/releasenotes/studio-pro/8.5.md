...
#KI: "Layout grid and Atlas UI" = PAG-1254
...
* There is an issue with deploying your app, when you use the new layout grid for web or native pages. This occurs only when using the combination of Mendix Studio Pro 8.5.0 and Atlas UI Resources 2.4.0. This will be fixed in Mendix Studio Pro 8.6.0. If you do not need to use the new layout grid, you could update the Atlas UI Resources module inside of your app to the latest version in the App Store. Doing this means you cannot use the new layout grid anymore.

    {{% alert type="info" %}}To check your Atlas UI version, consult your Atlas UI Resources module in Studio Pro.
    {{% /alert %}}
  
    {{% alert type="info" %}}This cannot be fixed in Studio. You will have to use Studio Pro.
    {{% /alert %}}
