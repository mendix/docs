...
{{% alert type="info" %}}
Studio Pro 8.0.0 Beta app projects that are converted to 8.0.0 General Availability can no longer be opened in 8.0.0 Beta verisons. Support for 8.0.0 Beta versions is dropped with the release of 8.0.0 General Availability.
{{% /alert %}}
