...
4. Click **Quick setup** next to  _Pod annotations_:
...
{{% alert type="warning" %}}
In the near future, Mendix for Private Cloud metrics will be updated to align with the metrics generated by the Mendix 9.6 Runtime.
The dashboard be updated - and if you made any customizations in the dashboard, you will need to apply these customization to the new dashboard template.
{{% /alert %}}
