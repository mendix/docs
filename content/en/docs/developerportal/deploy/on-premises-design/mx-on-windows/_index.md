...
{{< figure src="/attachments/developerportal/deploy/on-premises-design/mx-on-windows/18580733.png" >}}
...
1. Download the latest version of the Mendix Service Console by following the **Related downloads** link from the [Studio Pro Download Page](https://marketplace.mendix.com/link/studiopro/) of the Marketplace.
    ...
    {{< figure src="/attachments/developerportal/deploy/on-premises-design/mx-on-windows/service_console_download.png" >}}
...
3. Start the Mendix Service Console after completing the installation. The first time you launch the application, a popup will be shown (it will always be shown if no valid location is configured for the apps and server files):
    ...
    {{< figure src="/attachments/developerportal/deploy/on-premises-design/mx-on-windows/service_console_first_run.png" >}}

4. Click **Yes**. The **Preferences** dialog box will be shown:

    {{< figure src="/attachments/developerportal/deploy/on-premises-design/mx-on-windows/18580730.png" >}}
...
4. Click **Next >**.
    ...
    {{< figure src="/attachments/developerportal/deploy/on-premises-design/mx-on-windows/18580728.png" >}}

5. On the **Project Files** screen, click **Select app...**.

    {{< figure src="/attachments/developerportal/deploy/on-premises-design/mx-on-windows/18580727.png" >}}
...
8. Click **Next >**.
    ...
    {{< figure src="/attachments/developerportal/deploy/on-premises-design/mx-on-windows/18580726.png" >}}
...
8.  Click **OK**.
    ...
    {{< figure src="/attachments/developerportal/deploy/on-premises-design/mx-on-windows/iis_add_https_binding.png" >}}
...
5. Click **OK**.
    ...
    {{< figure src="/attachments/developerportal/deploy/on-premises-design/mx-on-windows/iis_response_headers.png" >}}
