...
* As of this release, it is possible to start projects on the Git edition of Team Server through Studio Pro. How this can be turned on is detailed in the [preferences](refguide/preferences-dialog#new-features). This feature is current in [Beta](/releasenotes/beta-features/).
