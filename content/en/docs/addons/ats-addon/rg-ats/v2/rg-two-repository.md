...
{{< figure src="/attachments/addons/ats-addon/rg-ats/v2/rg-two-repository/repository.png" >}}
...
* This is a folder:
    ...
    {{< figure src="/attachments/addons/ats-addon/rg-ats/v2/rg-two-repository/folder-icon.png" >}}

* This is a test case:

    {{< figure src="/attachments/addons/ats-addon/rg-ats/v2/rg-two-repository/test-case-icon.png" >}}

* This is test suite:

    {{< figure src="/attachments/addons/ats-addon/rg-ats/v2/rg-two-repository/test-suite-icon.png" >}}
