...
* <a id="fix-cursor-jump"></a>We fixed a [known issue](#ki-cursor-jump) in the new expression editor when the cursor was jumping to the end of the expression upon typing. This cursor issue could also lead to unexpected behavior with IME characters. (Tickets 205514, 216915)
