...
{% alert color="info" %}For the highlights of this release, see the [Mendix Release 8.2](https://www.mendix.com/blog/mendix-8-2-go-with-the-microflow/) blog post.{% /alert %}
