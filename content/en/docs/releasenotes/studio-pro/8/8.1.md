...
We added the [mx command-line tool](/refguide8/mx-command-line-tool/). This is a Windows and Linux command-line tool that can be used to convert the inputted (\1 \1s) to the version of Studio Pro with which the tool is bundled.
