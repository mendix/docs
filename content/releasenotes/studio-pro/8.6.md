...
**Release data: _________, 2020**

{{% modelerdownloadlink "8.6.9" %}}

### Fixes

* An important security patch has been applied and we strongly advise upgrading your Mendix applications to this version (or to 8.12.5 or 8.17.0, where the issue has also been fixed).
