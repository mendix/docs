...
* We added support for [Studio Pro 8.0.0 Beta 3](../studio7-pro/8.0).
...
* We added support for [Studio Pro 8.0.0 Beta 2](../studio7-pro/8.0). 
...
* Mendix Studio now configures the security of any app that you create. That means your data is protected from public access and visible only for users whom you grant access. Moreover, you can configure different roles for different users so that you can optimize the user experience, making sure each user sees exactly what you want them to see.
  ...
  * For professional developers: read the details of model changes that are applied when Mendix Studio auto-configures security settings in [Model Changes When Security Is Enabled in Studio](/refguide/studio7-security-enabled) in the *Studio Pro Guide*
...
* We added support for [Studio Pro 8.0.0 Beta 1](../studio7-pro/8.0). 
...
* We added support for [Studio Pro 7.23.3](../studio7-pro/7.23). 
...
* We added support for [Studio Pro 7.23.2](../studio7-pro/7.23).

### February 22nd, 2019

#### New Features

* We added support for [Studio Pro 7.23.0](../studio7-pro/7.23) and [Studio Pro 7.23.1](../studio7-pro/7.23).
