...
For examples of delete behavior configuring, see section [Delete Behavior](/refguide/create-a-basic-data-layer/#delete-behavior) in *Creating a Bsic Data Layer*.
