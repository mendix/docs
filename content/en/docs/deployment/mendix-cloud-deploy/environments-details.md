...
The root path (`/`) restricts access to the entire application. Settings for a specific paths override the implicitly inherited profile from other non-root paths.
