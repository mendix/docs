...
Deploying your application into Pivotal Web Services is described on this page: [Deploying a Mendix App to Pivotal](/howto/cloud-foundry/deploy-a-mendix-app-to-pivotal).
