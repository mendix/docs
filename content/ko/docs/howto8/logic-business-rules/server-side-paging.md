---
title: "Microflow 데이터 소스를 위한 서버 측 페이징 및 정렬 설정하기"
linktitle: "서버 측 페이징 및 정렬"
url: /howto8/logic-business-rules/server-side-paging/
description: "Microflow 데이터 소스를 사용하여 REST 서비스에서 데이터를 검색하는 데이터 그리드를 생성하고, 서버 측 페이징 및 정렬을 추가하는 방법을 학습합니다."
---
