...
이 사용 방법을 시작하기 전에 [C#을 사용하여 메뉴 확장 프로그램 만들기](/apidocs-mxsdk/apidocs/csharp-extensibility-api-10/create-menu-extension/)를 먼저 수행하는 것이 좋습니다.

## 도킹 가능한 창 확장 클래스 생성

1. [C#을 사용하여 메뉴 확장 프로그램 만들기](/apidocs-mxsdk/apidocs/csharp-extensibility-api-10/create-menu-extension/)를 따라 이전에 생성한 프로젝트를 엽니다.
...
새 도킹 가능한 창을 표시하려면 [C#을 사용하여 메뉴 확장 프로그램 만들기](/apidocs-mxsdk/apidocs/csharp-extensibility-api-10/create-menu-extension/)를 따를 때 생성한 확장 프로그램을 수정하십시오.
...
이러한 변경을 수행한 후 프로젝트를 빌드하십시오. 출력을 대상 폴더에 자동으로 복사하지 않도록 선택한 경우 프로젝트의 bin 출력을 [C#을 사용하여 메뉴 확장 프로그램 만들기](/apidocs-mxsdk/apidocs/csharp-extensibility-api-10/create-menu-extension/) 프로세스를 따를 때 생성한 확장 폴더로 수동으로 복사하십시오.
