...
* <a id="workflow-ki-fix"></a>We fixed a [known issue](/releasenotes/studio-pro/10.3/ki-2202) where the workflows user task was not passed correctly as a parameter to the user task's microflow decision method.
