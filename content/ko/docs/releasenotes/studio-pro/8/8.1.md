...
description: "새로운 기능, 버그 수정 및 알려진 문제에 대한 세부 사항이 포함된 Mendix Studio Pro 8.1 (모든 패치 포함)의 릴리스 노트입니다."
weight: 99
---
...
* We improved support for calling services that require an `Expect: 100-continue` HTTP header.
    ...
    {{% alert color="info" %}}This is based on an upvoted idea from [Edwin van Elk](https://community.mendix.com/link/questions/94038) submitted to the Mendix Community. Thanks Edwin!{{% /alert %}}
