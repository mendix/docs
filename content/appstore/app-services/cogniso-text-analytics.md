...
First, download the *CognisoTextAnalytics.mpk* file for the [Cogniso Text Analytics](https://marketplace.mendix.com/link/component/118593) from the Marketplace. When you want to add the app service to your app in Mendix Studio Pro, follow these steps:

1. Right-click the project in the **Project Explorer**, click **Import module package**, and select the *CognisoTextAnalytics.mpk*. 
...
4. Open the **Project Explorer** to view the CognisoTextAnalytics module. You can see a collection of ready to use items under the CognisoTextAnalytics folder. Besides, if you go to Toolbox window, you will also notice a collection of widgets are added to Toolbox widget list, under the **Cognitive AI widgets** category. 
...
Now you have succesfully added the Cogniso Text Analytics resources to your app.

## 3 CognisoTextAnalytics Content
...
2. In the **Constants** tab of the dialog box, create a new constant with the predefined constant **CognisoTextAnalytics.LicenseToken**.
