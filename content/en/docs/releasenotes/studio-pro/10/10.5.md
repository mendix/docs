...
We have added a new beta visual editor for writing XPath constraints. The XPath builder is an easy-to-use and intuitive tool for quickly developing the most common database constraint use cases without having to learn and write XPaths.
...
Along with the introduction of the new visual XPath Builder, we have also taken the opportunity to unify the **Database** and **XPath** data sources into the **Database** data source.
