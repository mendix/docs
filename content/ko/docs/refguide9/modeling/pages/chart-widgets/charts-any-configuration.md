...
description: "plotly에 올바른 값을 전달하기 위한 Any Chart 위젯 설정 참조입니다. 이를 통해 다양한 차트를 그릴 수 있습니다."
weight: 30
---
...
{{< figure src="/attachments/refguide9/modeling/pages/chart-widgets/charts-any-configuration/any-chart-page-placement.png" class="no-border" >}}
