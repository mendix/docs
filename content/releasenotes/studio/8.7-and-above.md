...
* When configuring an attribute widget, you can now select any surrounding data view as its context entity. 

#### Fixes

* We fixed an issue where Preview did not show proper error messages for Java compilation errors. 
