...
**Release date: February _____, 2021**
...
* We applied an important security patch that fixed a vulnerability for authenticated users. We strongly advise upgrading your Mendix applications to this version (or to [8.17.0](8.17#8170), where the issue has also been fixed).
