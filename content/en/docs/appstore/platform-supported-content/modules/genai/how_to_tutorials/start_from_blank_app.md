...
- Copy the `ConversationalUI_FullScreenChat` page from the **ConversationalUI > USE_ME > Pages** into your module, which in this case we will call it `MyFirstBot` module. Alternatively, if you don’t plan to make any changes to the page, you can use it directly without copying.
...
3. Inside this action, change the page to `ConversationalUI_FullScreenChat` from your `MyFirstBot` module or the `ConversationalUI` module.
