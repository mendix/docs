...
weight: 20
description: "개발자가 앱 스타일링을 변경하고 재사용 가능한 스타일링을 만드는 방법을 설명합니다."
---
...
### 사용자 정의 스타일링 추가 {#add-custom-styling}
...
## 스타일링 변경 미리보기 {#previewing-styling}
...
## Atlas Core 기본 스타일링 비활성화 {#disable-default}
...
## 지원되지 않는 브라우저 맞춤화 (웹) {#customize-unsupported-browsers}
