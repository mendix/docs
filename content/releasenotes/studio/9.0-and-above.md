...
### May 10th, 2021
#### Improvements
* We made sure that you have up-to-date Mendix SSO security and authentication settings in your app. When publishing your app, you will be notified if an auto-upgrade of the security settings of your app is required.
* We enhanced the configuration of the home page property. You now can configure a page or a microflow as home page in the Navigation editor.
* All Help and Learning videos are now using Mendix 9 based examples.

#### Fixes
* We fixed an issue where it was not possible to customize your theme for a Mendix 9.1.0 app.
* We fixed an issue where a customized logo would not be immediately visible in the page editor and theme customizer.
* We fixed an issue where the access rules where incorrectly configured when copy-pasting a of a page, microflow or workflow in Studio.
* We fixed an issue where adding `{` to text areas properties of widgets would crash Studio.
...
* We added support for Studio Pro 9.1.0
