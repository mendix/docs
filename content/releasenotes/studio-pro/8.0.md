...
*  When you upgrade your app from Mendix 6 to 7, and then to Mendix version 8, the user is not properly guided to enable a branch for editing in Mendix Studio. 
    *  Workaround: If you want to edit an app migrated from in Mendix Studio, you should first [enable **New Collaboration Mode**](/refguide7/collaborative-development-migration) in your Developer Portal project settings, and then, in Studio Pro, enable the branch you want to edit by opening the **Branch Line Manager** and clicking **Enable for Mendix Studio**. 
