---
title: "해당 편집기와 함께 새 문서 유형 등록하기"
linktitle: "새 문서 유형 도입"
url: /apidocs-mxsdk/apidocs/web-extensibility-api-11/custom-blob-document-api/
---

## 소개

이 How-to에서는 introduce a new document type and set up a custom editor that allows users to edit documents of that type.
