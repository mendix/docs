...
url: /appstore/services/event-broker/configure-aws-s3-bridge/
linktitle: "Configure a Bridge with AWS S3"
description: "Details on how to configure a bridge with AWS S3 using the Mendix Event Broker."
---
