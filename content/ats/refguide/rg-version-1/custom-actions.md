...
![Add Item button on Repository page](attachments/rg1-test-development/repository.png)

Now click **Add Item**, a popup window will appear.

![Create new Action](attachments/rg1-test-development/sampleaction.png)
...
![Edit Action page](attachments/rg1-test-development/editaction.png)
...
![Select multiple Test Steps in a Test Case](attachments/rg1-custom-actions/21168181.png)

Then extract the actions into one test step that contains your selected actions using the **Extract Action** button:

![Extract action dialog](attachments/rg1-custom-actions/21168182.png)
...
![Open custom action under test step settings](attachments/rg1-custom-actions/21168183.png)
...
![Costum action settings screen](attachments/rg1-custom-actions/21168184.png)
...
![Edit input parameter dialog](attachments/rg1-custom-actions/21168185.png)
...
![Create new enumeration](attachments/rg1-custom-actions/21168186.png)
...
![Edit enumeration dialog](attachments/rg1-custom-actions/21168187.png)
...
![Set output parameter](attachments/rg1-custom-actions/21168188.png)
...
![Set return Value action to return output parameter](attachments/rg1-custom-actions/21168189.png)
