...
State has been moved to the client in Mendix 7 and because of that the following methods are obsolete now.
| Method Name | Alternative |
| --- | --- |
| `retain` | - | 
| `release` | - | 
