...
* There is an issue when user select an existing or adds a new enumeration as return type of a Java action. This can result in an Oops exception in modeler. The user can continue working in the modeler by closing the Oops dialog. (Ticket 76617)
