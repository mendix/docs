...
url: /appstore/supported-add-ons/ats/ht-two-create-datadriven-test-case/
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-create-datadriven-test-case/dataset-fields-company-expenses-app.png" >}}
...
3. Click **New Data Set**
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-create-datadriven-test-case/test-cases-data-sets-new-data-set.png" >}}

    When you click the **New Data Set**, the **New Data Set** dialog box opens.

    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-create-datadriven-test-case/new-data-set-dialog.png" >}}
...
6. Click **Save**.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-create-datadriven-test-case/new-data-set-dialog-new-expense.png" >}}
...
2. Click **New Field**.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-create-datadriven-test-case/add-new-field-data-set.png" >}}
...
5. Click **Save**
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-create-datadriven-test-case/new-data-set-field-amount.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-create-datadriven-test-case/all-fields-new-expense-data-set.png" >}}
...
2. Click **New Record**:
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-create-datadriven-test-case/click-new-record.png" >}}

    The **New Record** dialog box opens:

    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-create-datadriven-test-case/new-record-dialog.png" >}}

3. Enter the desired values for each field and click **Save**:

    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-create-datadriven-test-case/entered-new-record.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-create-datadriven-test-case/all-records-new-expense.png" >}}
...
1. Open Excel and create a new file. ATS implements the values in the first row as dataset fields and all the rows beyond the first row as records. This is an example:
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-create-datadriven-test-case/excel-sheet-example-ats.png" >}}
...
2. Create the dataset fields you need:
    ...
    * Description
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-create-datadriven-test-case/excel-sheet-data-set-fields.png" >}}
...
3. Now you must add records. Create a record for each expense type available, five in total:
    ...
    * Transport
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-create-datadriven-test-case/excel-sheet-add-records-new-expense.png" >}}
...
8. Click **Save**.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-create-datadriven-test-case/new-data-set-dialog-new-expense-excel.png" >}}
...
3. Click **Export to Excel**:
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-create-datadriven-test-case/export-data-set-excel.png" >}}
...
5. Change the description of all records to "ATS excel description 1" etc.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-create-datadriven-test-case/excel-sheet-update-records.png" >}}

6. Click **Import from Excel** inside the **Records** tab:

    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-create-datadriven-test-case/import-from-excel-new-records.png" >}}
...
8. Click **Import**.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-create-datadriven-test-case/import-new-records-excel.png" >}}

ATS updates the changed records:

{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-create-datadriven-test-case/updated-records-new-expense-data-set.png" >}}

Great! You have updated the primary dataset using an Excel file.

## 7 Connecting the Primary Data Set to Your Test Case

The following steps explain how to connect the primary dataset to your test case. An example test case is used in this chapter. For more information, see [How to Create a Test Case](/appstore/supported-add-ons/ats/ht-two-create-a-test-case/).

1. Open your test case and click the **Test Data** tab.
2. Click the arrow icon:

    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-create-datadriven-test-case/test-data-tab-test-case-details-page.png" >}}
...
5. Click **Save**.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-create-datadriven-test-case/select-data-set-dialog-new-expense.png" >}}

    Connect the primary dataset to your test case.

    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-create-datadriven-test-case/connected-primary-data-set-new-expense.png" >}}
...
8. Search for and select the first dataset field:
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-create-datadriven-test-case/first-data-set-field-connected-amount.png" >}}
...
2. Click the result of the data-driven test case.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-create-datadriven-test-case/test-runs-data-driven-test-case.png" >}}

    This opens the **Result Log** page, where ATS displays the result of each run record.

3. Click one of the results:

    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-create-datadriven-test-case/data-driven-test-case-result-log.png" >}}

4. To see the record used by this execution, click the **Data Records** tab:

    This displays all the values in the record:

    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-create-datadriven-test-case/data-driven-test-case-data-records.png" >}}

    You can use the breadcrumbs to return to the overview **Result Log**:

    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-create-datadriven-test-case/result-log-breadcrumb.png" >}}
...
You now learned how to create a dataset and how to use that data in your test case. The next how-to is [How to Use Precondition in Test Cases](/appstore/supported-add-ons/ats/ht-two-use-precondition-in-test-cases/). You find an overview of all the how-tos and the structure on the [ATS 2 How-To's](/appstore/supported-add-ons/ats/ht-two/) page. We advise you to follow the predefined structure.
