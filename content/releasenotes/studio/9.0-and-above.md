...
* You can now use expressions on pages: you can use expressions when configuring [conditional visibility](/studio/page-editor-widgets-visibility-section) and editability for widgets that have these properties. This gives you more flexibility when configuring pages.

#### Fixes

* We fixed an issue in Safari with scrollbars not being displayed correctly in **Select** dialog boxes.
