...
In our continuous effort to enhance makers experience, we're excited to introduce our new web client. This client is built entirely using React.js, a modern JavaScript library known for its efficiency and flexibility. The React client is available as a Public Beta and will be generally available in Mendix 10.12.
...
We are releasing the public beta of Studio Pro on Mac. This allows you to run Studio Pro natively on Mac without having to use Parallels. With the Mac version of Studio Pro you can edit your applications like you can on Windows, using all the same functionality you are used to.
Known limitations:
...
Section is TBD, see metadata for last version's KI tags
