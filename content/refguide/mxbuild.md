...
The version of MxBuild which you need depends on the version of the Mendix model you want to build. You can the following link format to doanload the correct MxBuild  `https://cdn.mendix.com/runtime/mxbuild-{mxversion}.tar.gz`.
...
You can find the build number in your Mendix installation path (for example `C:\Program Files\Mendix\8.1.2.40272`).

{{% /alert %}}

For example, the MxBuild for Mendix version 8.1.2 can be found at [https://cdn.mendix.com/runtime/mxbuild-8.1.2.40272.tar.gz](https://cdn.mendix.com/runtime/mxbuild-8.1.2.40272.tar.gz).
