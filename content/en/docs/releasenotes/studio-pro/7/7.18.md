...
{{% button color="info" href="https://marketplace.mendix.com/link/studiopro/7.18.4" text="Download in Marketplace" title="Download version 7.18.4 from the Marketplace" %}}
...
{{% button color="info" href="https://marketplace.mendix.com/link/studiopro/7.18.3" text="Download in Marketplace" title="Download version 7.18.3 from the Marketplace" %}}
...
{{% button color="info" href="https://marketplace.mendix.com/link/studiopro/7.18.2" text="Download in Marketplace" title="Download version 7.18.2 from the Marketplace" %}}
...
{{% button color="info" href="https://marketplace.mendix.com/link/studiopro/7.18.1" text="Download in Marketplace" title="Download version 7.18.1 from the Marketplace" %}}
...
* You are now able to access and edit associations from an entity details form. (Ticket 65040)
    ...
    {{% alert color="info" %}} This is based on an [upvoted idea from Chek Heng To](https://forum.mendixcloud.com/link/ideas/180) submitted to the [Mendix Idea Forum](https://forum.mendixcloud.com/link/ideas). Thanks, Chek!{{% /alert %}}
