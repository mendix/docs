...
{{% alert type="info" %}}
If you are using **Custom content** in the **Show** option of General tab, please make sure you are using a **Text Widget** without containers around. It might affect the capability of wrapping texts.
{{% /alert %}}
