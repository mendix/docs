...
#ki:  "Creation of a (versioned) deployment package" = UICORE-284 (to be fixed in 8.2.1)
---
...
* We fixed an issue where creation of a deployment package may fail when the project contains a Native navigation profile.
