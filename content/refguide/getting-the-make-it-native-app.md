...
The Make It Native app allows developers to preview, test, and debug native mobile app projects in conjunction with Mendix Studio Pro. It currently comes in two versions: the **Make It Native** app for Studio Pro v8.8 and below, and the **Make It Native 9 app** for Studio Pro v9.0 and above. Both of these apps are available for both Android and iOS devices.
