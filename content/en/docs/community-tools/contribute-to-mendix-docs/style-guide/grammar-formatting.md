...
weight: 20
description: "Provides detailed formatting and grammar guidelines for Mendix documentation including capitalization, lists, cross-referencing, and more."
---

<!-- Source: Confluence page ID 2520678744, last imported: 2026-04-15 -->
...
Use an en dash to set off introductory text in list items. If you use introductory text in a list item, make sure all other items in that list have introductory text too. Bold the introductory text if it appears in the UI. For more guidance about list formatting, see the [Lists](#lists) section.
...
* day is just the cardinal number (16) not the ordinal number (16th)
* year is four digits
...
Capitalize file formats for consistency. This should make file formats consistent with the [Languages](#languages) section (while covering both options if necessary).
...
Capitalize languages. This should make languages consistent with the [File Formats](#file-formats) section (while covering both options if necessary).
