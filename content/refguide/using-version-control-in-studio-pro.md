...
If there is already a Team Server-enabled app, you can be invited to join it (see [App Team](/developerportal/collaborate/team)).
...
When working in different apps with different Studio Pro versions, you may one day find yourself with an app model upgraded and committed to a newer Studio Pro version, while the the rest of your App Team is not yet ready to upgrade. 
...
10. Inform your App Team that they need to do a fresh checkout of the app or run **TortoiseSVN** > **Update** on their app folder before opening the app in the desired Studio Pro version again.
