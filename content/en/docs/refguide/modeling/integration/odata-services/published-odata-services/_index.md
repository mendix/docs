...
To publish an OData resource with full CRUD, select the checkboxes for all [Capabilities](/refguide/published-odata-resource/#capabilities) in the [Published OData Resource](/refguide/published-odata-resource/). You can then [Create](/refguide/create-external-object) and [Delete](/refguide/delete-external-object) these resources using [External Object activities](/refguide/external-object-activities). 
