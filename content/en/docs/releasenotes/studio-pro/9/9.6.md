...
* Ww added a parameter that can be used on the `login.html` to redirect to another page after login.
...
* Starting with version 9.6.15, we will drop support for PostgreSQL 10 due to it no longer being supported by the vendor.
* Starting with version 9.6.15, we will drop support for SQL Server 2017 due to it no longer being supported by the vendor.
