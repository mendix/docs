...
* We fixed a NullPointerException during startup that occurred after renaming a module with a remote entity that was created before Mendix version 9.6.3. (Ticket 142150).
