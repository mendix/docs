...
* On the **Projects** overview page, the **Environments** link is not properly redirecting to the deployment page for apps hosted outside of the Mendix Cloud. A workaround is to navigate to the deployment page through the top-left menu or by navigating directly to the URL.
