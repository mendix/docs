...
* We fixed a bug occurring during transition from anonymous to authenticated user session in a clustered environment. (Ticket 67084)
...
Session management is broken for applications running in a clustered environment using Mendix 7.17.0. Customers running Mendix in clustered mode should therefore not upgrade to this version. The problem is fixed in 7.17.1.
