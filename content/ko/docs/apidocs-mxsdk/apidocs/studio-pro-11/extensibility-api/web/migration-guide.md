---
title: "Web Extensibility API 이전 버전 마이그레이션 가이드"
linktitle: "마이그레이션 가이드"
...
Studio Pro 11.6에서 Web Extensibility API에 호환되지 않는 변경 사항이 도입되어 [menus](/apidocs-mxsdk/apidocs/web-extensibility-api-11/menu/) are created. This guide explains how to update your extension code after upgrading to Studio Pro 11.6 from an earlier version.

## `MenuItemActivated` 이벤트
