...
* We fixed the issue where a reference selector did not attempt to refetch data when the data view object was rolled back. (Ticket 54672)
...
* We fixed the issue with zooming in/out in the microflow editor on 4K screens. (Tickets 50820, 54179)
