...
* An "oops" pop-up window appears when attempting to commit after renaming or deleting a module. (Tickets 69006, 107979)
    * Workaround: Re-adding an empty folder named after the module (for example, **MyFirstModule**) to the **javasource** and **javascriptsource** folders in the app project will allow you to commit to the repository again.
...
* <a name="69006-ki"></a>An "oops" pop-up window appears when attempting to commit after renaming or deleting a module. (Tickets 69006, 107979)
    * Workaround: Re-adding an empty folder named after the module (for example, **MyFirstModule**) to the **javasource** and **javascriptsource** folders in the app project will allow you to commit to the repository again.
