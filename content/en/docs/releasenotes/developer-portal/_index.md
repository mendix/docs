...
* With both Epics and Jira connector as new options to plan your work, we are getting ready to say goodbye to Mendix Stories on October 1. As of today, once you switch to [Epics](/developerportal/collaborate/epics/) or [Jira](/developerportal/collaborate/jira-connector/), we will [archive all your work in Mendix Stories](/developerportal/collaborate/general-settings/#story-archive) and you will not be able to switch back to Mendix Stories anymore. The scrum master of your team can choose the right project management tool for you in a new tab page under General Settings.
