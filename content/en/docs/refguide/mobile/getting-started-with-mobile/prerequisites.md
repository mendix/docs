...
For information on which mobile operating systems and devices are supported by Mendix native mobile apps, see the [Mobile Operating Systems](/refguide/system-requirements/#mobile) section of *System Requirements*.
...
The Make It Native app enables developers to preview, test, and debug native mobile applications in combination with Mendix Studio Pro. It is available for both Android and iOS platforms and can be downloaded from the respective official app stores.

We recommend updating your Mendix native mobile app at least every six months to the latest available [MTS or LTS version](/releasenotes/studio-pro/lts-mts/). This ensures continued compatibility with the latest mobile operating system updates and allows you to keep using the Make It Native app for development and testing without interruption.

### Mendix MTS/LTS Version

The Make It Native app supports only the **latest Mendix MTS or LTS version**. To get started, download the app using the links below:

| [Make It Native for Android](https://play.google.com/store/apps/details?id=com.mendix.developerapp.mx10) | [Make It Native for iOS](https://apps.apple.com/app/make-it-native-10/id6450037464) |
...
{{% alert color="info" %}}
Due to mandatory review processes by Google and Apple, the release of an updated version of Make It Native may occur after a new Mendix version is made available. If you need to test or deploy your app before the updated Make It Native version is released, consider [creating a Custom Developer App](/refguide/mobile/distributing-mobile-apps/building-native-apps/how-to-devapps/).
{{% /alert %}}

### Latest Mendix Version

For your convenience, a preview version of the Make It Native app is available via Google Play Testing and Apple TestFlight. This version supports the **latest Mendix version** and is ideal for early testing and development. Use the following links to download the preview version:

| [Make It Native for Android (Testing)](https://play.google.com/apps/testing/com.mendix.developerapp.mx10) | [Make It Native for iOS (Testflight)](https://testflight.apple.com/join/bQfLf27w)
| {{< figure src="/attachments/refguide/mobile/native-mobile/getting-the-make-it-native-app/android-min-10.png" alt="Android Testing QR Code" class="no-border" >}} | {{< figure src="/attachments/refguide/mobile/native-mobile/getting-the-make-it-native-app/ios-min-10.png" alt="iOS testflight Code" class="no-border" >}} |

To access the preview version of the Make It Native app, you must join our official beta testing programs on the Google Play store and the Apple App Store. To do so, click the relevant links above and follow the instructions.

Note that it is not possible to install both **preview** and **regular** versions on the same device.

{{% alert color="info" %}}
The preview version of the Make It Native app does not include any showcase apps. It is intended solely for testing and debugging your own Mendix applications with the latest platform release.
{{% /alert %}}

### Other Mendix Versions

We do not provide a Make It Native app for running older Mendix versions. However, there are two alternative options for previewing native mobile apps built with earlier Mendix versions:

1. [Create a Custom Developer App](/refguide/mobile/distributing-mobile-apps/building-native-apps/how-to-devapps/)
1. [Build Your Own Make It Native App](https://github.com/mendix/make-it-native)
