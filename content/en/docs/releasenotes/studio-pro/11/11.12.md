...
- **Maia** no longer includes the *Other* option when asking single or multiple-choice questions, as a custom free-text entry is already available for every choice question.
...
- We fixed an issue with `onChange` client actions for [attribute](/apidocs-mxsdk/apidocs/pluggable-widgets-property-types/#attribute) and [association](/apidocs-mxsdk/apidocs/pluggable-widgets-property-types/#association) widget properties. Associated objects passed as arguments to an action would always be empty.
