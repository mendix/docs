...
In Mendix Studio, you work with data in various ways, which can be divided into the following:

* **Working with your own data** – working with local data that you have created. 
...
Visual editor where you work with data is a domain model. The domain model is a data model that describes the information in your application domain in an abstract way. It is central to the architecture of your application. For more information on the domain model and how to work with it, see [Domain Model](domain-model).
