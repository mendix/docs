...
* We fixed a [known issue](known-issues#710) from Mendix 7.1.0 and from now on, offline mobile apps work offline.
...
For an advanced conditional visibility/editability known issue in this release, see [Known Issues](known-issues#710).
...
### Known issues<a name="710KnownIssue"></a>

For known issues in this release, see [Known Issues](known-issues#710).