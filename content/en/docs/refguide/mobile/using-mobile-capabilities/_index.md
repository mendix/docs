...
* [Location and Maps](/refguide/mobile/using-mobile-capabilities/location-&-maps/): native apps can access the user location and display native maps inside the application
