...
* **WorkflowCurrentActivity** - This non-persistent entity represents data generated by the [Generate Jump-to Option microflow action](/refguide/generate-jump-to-options/) and contains information on the current activity of that workflow instance.
