...
| <a id="RequestHandlingAllowLegacyCookies" href="#RequestHandlingAllowLegacyCookies">RequestHandling.<wbr>AllowLegacyCookies</a> | Allows violations of RFC 6265 which is enforced since Mendix 9.6.18, 9.12.15, 9.18.8 and 9.24.0. See [here](https://www.eclipse.org/jetty/javadoc/jetty-10/org/eclipse/jetty/http/CookieCompliance.html#RFC6265_LEGACY) for more information. Be aware of the fact that enabling this custom setting exposes your app to CVE-2023-26049. This setting is available in patch versions of MTS and LTS releases and later (9.6.18, 9.12.15, 9.18.8, 9.24.3). | false |
