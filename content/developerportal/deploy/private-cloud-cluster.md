...
* **type**: – select the Endpoint type, possible options are `ingress`, `openshiftRoute`, and `service`; this parameter can also be configured through the **Configuration Tool**
