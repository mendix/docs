...
* After the app user logs in or out. Note that synchronization after log out does not synchronize data of the logged-out user, but synchronizes data for the anonymous user.
