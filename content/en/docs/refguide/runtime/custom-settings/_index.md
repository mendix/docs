...
| **SessionKeepAliveUpdatesInterval** | Defines after how much time expired sessions can be removed from the database. | one-sixth of the `SessionTimeout` (100000 (100s) by default, if the `SessionTimeout` is not set) |
