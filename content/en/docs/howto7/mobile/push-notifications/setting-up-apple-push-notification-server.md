...
{{< figure src="/attachments/howto7/mobile/push-notifications/setting-up-apple-push-notification-server/20217895.png" class="no-border" >}}
...
Click on the **+** icon on the upper-right side of the screen. This will present you with a new form. Enter a descriptive name for this key, select the **Push Notifications service** checkbox, and then press **Contine**. On the next page, press **Confirm**.
...
{{< figure src="/attachments/howto7/mobile/push-notifications/setting-up-apple-push-notification-server/20217898.png" class="no-border" >}}
