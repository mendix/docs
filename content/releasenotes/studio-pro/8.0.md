...
* Entity access is not applied in the **System.ShowHomePage** microflow. When using this microflow to navigate to the home page and the default home page is a microflow wit **Apply entity access** to **Yes**, entity access will not be applied.
