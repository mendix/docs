...
{{< figure src="/attachments/refguide/runtime/log-levels/log-message-template.png" class="no-border" >}}
...
| Critical | {{< figure src="/attachments/refguide/runtime/mendix-client/log-levels/critical.png" class="no-border" >}} | White (text), red (background) | A serious error has occurred, indicating that the application itself may be unable to continue running. |
...
{{< figure src="/attachments/refguide/runtime/log-levels/set-log-levels.png" class="no-border" >}}
...
{{< figure src="/attachments/refguide/runtime/log-levels/custom-log-messages.png" class="no-border" >}}
