...
Check the documentation on how to [create/maintain test data](/ats/refguide-ats-1/data-management#test-data) and [use it within a test case](/ats/refguide-ats-1/data-driven-tests).
