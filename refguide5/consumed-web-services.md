...
This document describes imported web services. If you're looking for specific information on the imported web services screen, you can check the [Consumed web service](/refguide5/consumed-web-service) documentation.
...
To actually use these imported web services in a microflow, see [Call Web Service](/refguide5/call-web-service).

## Proxies

If you are behind a firewall, you might need to use a proxy to call a webservice. Specific information on how to configure the JVM to use a proxy can be found [here](/refguide5/using-a-proxy-to-call-a-webservice)
