...
2. Click **Add Item** in the **All Objects** tab:
    ...
    {{< figure src="/attachments/addons/ats-addon/ht/v1/create-custom-actions/custom-action-basics/repository-add-item.png" >}}

    This opens the **Create new** dialog box:

    {{< figure src="/attachments/addons/ats-addon/ht/v1/create-custom-actions/custom-action-basics/create-new-action-dialog.png" >}}
...
6. Click **Create**:
    ...
    {{< figure src="/attachments/addons/ats-addon/ht/v1/create-custom-actions/custom-action-basics/create-new-action-dialog-complete.png" >}}
...
4. Click **Extract Action**:
    ...
    {{< figure src="/attachments/addons/ats-addon/ht/v1/create-custom-actions/custom-action-basics/test-case-extract-action.png" >}}
...
7. Click **Close**:
    ...
    {{< figure src="/attachments/addons/ats-addon/ht/v1/create-custom-actions/custom-action-basics/test-case-action-set-details.png" >}}

8. Select the newly created action and click **Open**:

    {{< figure src="/attachments/addons/ats-addon/ht/v1/create-custom-actions/custom-action-basics/test-case-open-new-action.png" >}}
...
{{< figure src="/attachments/addons/ats-addon/ht/v1/create-custom-actions/custom-action-basics/edit-action-page-add-record.png" >}}
...
2. Click the **Settings** tab:
    ...
    {{< figure src="/attachments/addons/ats-addon/ht/v1/create-custom-actions/custom-action-basics/edit-action-page-settings.png" >}}
...
1. Click **New**:
    ...
    {{< figure src="/attachments/addons/ats-addon/ht/v1/create-custom-actions/custom-action-basics/edit-action-page-settings-new.png" >}}
...
8. Click **Save**:
    ...
    {{< figure src="/attachments/addons/ats-addon/ht/v1/create-custom-actions/custom-action-basics/new-action-edit-input-parameter.png" >}}
...
1. Click **Set**:
    ...
    {{< figure src="/attachments/addons/ats-addon/ht/v1/create-custom-actions/custom-action-basics/edit-action-page-settings-set.png" >}}
...
5. Select a **Required/Optional** option. Only use **Optional** if the action still works whebn nothing is returned.
    ...
    {{< figure src="/attachments/addons/ats-addon/ht/v1/create-custom-actions/custom-action-basics/new-action-output-parameter-complete.png" >}}
...
7. Add the [Find/Assert Widget](/addons/ats-addon/rg-one-findassert-widget/) action and the [Set Return Value](/addons/ats-addon/rg-one-set-return-value/) action.
    ...
    {{< figure src="/attachments/addons/ats-addon/ht/v1/create-custom-actions/custom-action-basics/output-parameter-actions.png" >}}
...
8. For ATS to return the outcome of a test step as an **Output Parameter**, it needs to know what it must return. ATS returns the **Value** connected to the **Set Return Value** action. Now connect the outcome of test step 1 to the **Set Return Value** action.
    ...
    {{< figure src="/attachments/addons/ats-addon/ht/v1/create-custom-actions/custom-action-basics/set-return-value-parameter.png" >}}
...
2. Open the **Edit Input Value** dialog box:
    ...
    {{< figure src="/attachments/addons/ats-addon/ht/v1/create-custom-actions/custom-action-basics/edit-value-input-dialog.png" >}}

3. Click **Action Input Parameter** and select the input parameter you want to connect.
4. Click **Save**

    {{< figure src="/attachments/addons/ats-addon/ht/v1/create-custom-actions/custom-action-basics/action-input-parameter-edit.png" >}}
