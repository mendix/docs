...
## 6 Older Versions of Studio Pro {#older}

These details cover older versions of Marketplace in Studio Pro versions under 9.18 and below.
...
#### Downloading Content from the Marketplace Within Studio Pro {#downloading}
...
#### Importing Content from the App Explorer {#import}
...
#### Manually Adding Content into the App Directory {#add}
...
###### Adding a Widget Using the Add Widget Option
...
##### Updating a Widget to a Newer Version
...
##### Updating a Module to a Newer Version{#update-module}
...
#### Using an App or Layout {#project-layout}
