...
### 2.1 <a name="backwards-compatibility-breaking-changes" rel="nofollow"></a>Backwards compatibility breaking changes
...
### 2.3 <a name="new-features" rel="nofollow"></a>New features
...
### 2.4 <a name="improvements" rel="nofollow"></a>Improvements
...
### 2.5 <a name="fixes" rel="nofollow"></a>Fixes
...
### 2.6 <a name="removed-deprecated-methods" rel="nofollow"></a>Removed deprecated methods
