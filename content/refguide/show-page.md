...
| All | After navigating to the **target page**, remove the **source page** and all pages before it from history. Similar to the options 'Single' and 'Multiple', only pages in the current stack will be closed. |
