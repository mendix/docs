...
<<<<<<< HEAD:content/ats/ht1-cab-07-radiobuttons.md
    When you create a custom action for an unsupported widget action, you must use the [Find Widget Child Node](rg1-find-widget-child-node) action. This action is a combination of the [Find/Assert Widget](rg1-findassert-widget) and [Find Element by Sizzle](rg1-find-element-by-sizzle) actions, combining the best of both. It’s an official Mendix action, it has all the internal processes, and it uses a CSS/jQuery selector to find the child, which makes it flexible.
=======
...
>>>>>>> development:content/ats/howtos/ht-version-1/cab-07-radiobuttons.md
