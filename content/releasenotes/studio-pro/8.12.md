...
* An important security patch has been applied and we strongly advise upgrading your Mendix applications to this version (or to 8.17.0, where the issue has also been fixed).
