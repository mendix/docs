...
{{< figure src="/attachments/howto7/monitoring-troubleshooting/log-levels/18580031.png" class="no-border" >}}
...
In the Modeler, log messages that include a stack trace are marked with a paperclip icon ({{% icon name="paperclip" %}}). Double-clicking this icon shows the stack trace.
...
| Warning | {{< figure src="/attachments/howto7/monitoring-troubleshooting/log-levels/18580038.png" class="no-border" >}} | Orange | Indicates that something unexpected happened or that there is some problem in the near future (for example, "disk space low"). The application is still working as expected. |
| Error | {{< figure src="/attachments/howto7/monitoring-troubleshooting/log-levels/18580037.png" class="no-border" >}} | Red | Due to a more serious problem, the application has not been able to perform some function. |
| Critical | {{< figure src="/attachments/howto7/monitoring-troubleshooting/log-levels/18580036.png" class="no-border" >}} | White (text), red (background) | A serious error has occurred, indicating that the application itself may be unable to continue running. |
...
{{< figure src="/attachments/howto7/monitoring-troubleshooting/log-levels/18580030.png" class="no-border" >}}
...
{{< figure src="/attachments/howto7/monitoring-troubleshooting/log-levels/18580029.png" class="no-border" >}}
...
{{< figure src="/attachments/howto7/monitoring-troubleshooting/log-levels/18580028.png" class="no-border" >}}
