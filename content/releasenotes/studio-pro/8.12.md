...
**Release date: _______, 2021**

{{% modelerdownloadlink "8.12.6" %}}

### Fixes

* We decreased the chance of deadlocks in our session administration system actions and we handle them gracefully when they still occur. (Ticket 111360)
...
* We applied an important security patch that fixed a vulnerability for authenticated users. We strongly advise upgrading your Mendix applications to this version (or to 8.17.0, where the issue has also been fixed).
