...
* A Java Developer Kit (JDK) version 11 or 17 - if not yet installed on your machine, Mendix version 10.8.0 and above will install 'Eclipse Temurin JDK 17', and versions below that will install 'Eclipse Temurin JDK 11'.  
