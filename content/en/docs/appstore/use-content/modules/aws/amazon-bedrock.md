...
#### 4.2.4 Operations to persist Amazon Bedrock metadata inside the application
...
##### 4.2.4.1 Sync Models {#sync-models}
...
##### 4.2.4.2 Sync Knowledge Bases {#sync-knowledge-bases}
...
##### 4.2.4.3 Sync Agents {#sync-agents}
