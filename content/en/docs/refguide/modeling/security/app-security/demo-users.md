...
{{< figure src="/attachments/refguide/modeling/security/app-security/demo-users/demo-users-tab.png" >}}
...
{{< figure src="/attachments/refguide/modeling/security/app-security/demo-users/demo-user-properties.png" >}}
...
3. Click a user icon in the right side of the screen. The menu bar **Select user** will be displayed: 
    ...
    {{< figure src="/attachments/refguide/modeling/security/app-security/demo-users/demo-users-example.png" >}}
