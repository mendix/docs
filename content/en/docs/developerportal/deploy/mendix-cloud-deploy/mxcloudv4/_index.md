...
You can also consider running your Mendix app using your own AWS account in a different AWS region. Mendix provides a streamlined way to deploy your apps on in your own AWS account by using [Mendix for Amazon EKS](https://aws.amazon.com/solutions/partners/terraform-modules/mendix-eks/). You can also do this by using Docker, as described in the [Docker](/developerportal/deploy/docker-deploy/) documentation. If you do this, however, you will not receive all the benefits of running in the Mendix Cloud.
