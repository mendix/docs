...
With this action, you can easily configure which nanoflow to call, fill in the parameter values, and capture the return value. Or, you can just drag a nanoflow from **Project Explorer** in the nanoflow editor, and you are good to go!
...
* We now allow you to pass a Boolean expression to a string function in microflow expressions.
    ...
    {{% alert color="info" %}}This is based on an [upvoted idea from Sander Wamelink](https://forum.mendixcloud.com/link/ideas/402) submitted to the [Mendix Idea Forum](https://forum.mendixcloud.com/link/ideas). Thanks, Sander!{{% /alert %}}
