...
description: "Agents Kit 2: This document describes the purpose, configuration, and usage of the MCP Client module from Mendix Marketplace that allows developers to consume tools and prompts from external MCP servers."
weight: 20
aliases:
