...
* The new expression editor does not work well with non-ASCII characters. Users having this issue can switch back
to the old editor using **Preferences** > [New Features](/refguide/preferences-dialog/#new-features).
