...
* We fixed an issue in the [Project Explorer](/refguide/project-explorer) that prevented it from refreshing displayed information. (Tickets 105741, 109182).
...
* We resolved several minor issues in the **Project Explorer** and [Connector](/refguide/view-menu#connector) that caused items in the tree to expand or collapse without good reason.
