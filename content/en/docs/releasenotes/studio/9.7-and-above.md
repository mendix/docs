...
* With workflows being re-enabled and made generally available in Studio for apps in Mendix version 9.12.1 or above, we updated the upgrading     process for existing apps: 
    ...
    * If your app has Mendix version 9.5.1 or above and has workflows (which were in Beta) enabled, your app can only be upgraded manually by a team member using Studio Pro. For information on how to upgrade the app, see [Migrating Workflow Apps](/refguide/workflow-beta-migration/) in *Studio Pro Guide*. 
