...
9. Select the environment in which you want to publish.
	...
	* For apps using [Flexible Environments](/refguide/mendix-cloud-deploy#flexible-environments) you will be able to select the environment from a drop-down list of environments.
