...
#KI: "When microflows" - RUN-2554
#KI: "When deleting a branch" - SPVC-753
...
* When deleting a branch in a Branch Manager form, you will get an error saying that you cannot remove the Main line. (Tickets 108885, 109072)
	* Workaround: You can use [TortoiseSVN](https://tortoisesvn.net/) to delete a branch. Right-click an empty space in your project's folder, choose "TortoiseSVN > Repo-browser" from the context menu. In the Repository Browser window, navigate to the "branches" folder, right-click the folder with your branch's name and choose "Delete". Enter a commit message and press OK.
