...
* We improved the performance of export mappings that export persistable associated objects. It now retrieves batches of associated objects instead of individual associated objects. This reduces the  number of calls to the database. 
