...
* For Studio Pro version 9, a new merge algorithm was introduced that supports fine-grained conflict resolution. We have now deprecated the old merge algorithm, which will be removed in Studio Pro version 10.
