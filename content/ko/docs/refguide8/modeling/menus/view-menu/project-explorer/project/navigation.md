...
weight: 20
description: "앱의 Navigation 개념과 프로필의 속성을 설명합니다."
...
{{< figure src="/attachments/refguide8/modeling/menus/view-menu/project-explorer/project/navigation/navigation-profile-properties.png" class="no-border" >}}
...
{{< figure src="/attachments/refguide8/modeling/menus/view-menu/project-explorer/project/navigation/add-navigation-profile.png" class="no-border" >}}
