...
{{% alert color="info" %}}For an overview of the highlights in this release, see the [Mendix Release 10.17](https://www.mendix.com/blog/mendix-release-10-17-global-reach-sharper-tools/) blog post.{{% /alert %}}
...
* We fixed the issue where in HSQLDB a CASE clause failed to execute if results of all CASE branches were constants.
