...
{{% alert color="info" %}}
You can also use data sources from other applications in your app through the [Data Hub](/refguide9/integration-pane/) pane. These data sources are represented in the domain model as *external entities* which are displayed as purple entity containers in the domain model.
