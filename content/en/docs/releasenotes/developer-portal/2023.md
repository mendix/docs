...
* Have you lost track of where your apps live? We now display the cloud plan on the app tile in [My Apps](/developerportal/#my-projects).
...
* We moved the **Pending Invites** to a tab on the [My Apps](/developerportal/#my-projects) page. You will find both the pending invitations to apps that you have received (which you can **Accept** or **Decline**) in addition to the invitations you have sent.
