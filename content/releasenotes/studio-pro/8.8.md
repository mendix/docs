...
* We now block users after three failed logins in a [Mendix Cloud](/developerportal/deploy/mendix-cloud-deploy) node environment if the app project [security](/refguide8/project-security) is set to **Production**. (Ticket 95292)
