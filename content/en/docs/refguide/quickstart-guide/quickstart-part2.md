...
1. Drag a **Create object** action from the **Toolbox** onto the nanoflow. 
1. Double-click the create object action and select the entity type as **Picture**, then click **OK**. 
1. Drag a **Take Picture** action from the **Toolbox** onto the nanoflow after the create object activity:
