---
title: "플러그형 네이티브 위젯 빌드"
url: /howto/extensibility/build-native-widget/
description: "Mendix 앱에서 네이티브 위젯을 빌드하고 구성하며 스타일링하는 방법을 설명합니다."
weight: 10
---
...
이 하우투에서는 React Native를 사용하여 네이티브 모바일 애플리케이션용 그룹 박스 플러그형 위젯을 만드는 방법을 배웁니다.
...
* 위젯 구조 생성
* Mendix 앱에 플러그형 위젯 배치
* 여러 플랫폼에 맞게 위젯의 속성과 스타일링 구성
