...
**Release date: October __rd, 2022**

{{% modelerdownloadlink "9.12.7" %}}

### Fixes

**If deprecation note for SQL Server 2017, update System Requirements with version where will be removed**

* We fixed an issue for workflows with many decision activities that caused Mark-as-Resolved to hang
...
* Starting with version 9.12.9, we will drop support for SQL Server 2017 due to it no longer being supported by the vendor.
