...
## 7.6
Switching demo users does not work properly, logout happens but the sign-in is broken. As a workaround, you can manually sign in using the generated password which you can copy from the Modeler.
