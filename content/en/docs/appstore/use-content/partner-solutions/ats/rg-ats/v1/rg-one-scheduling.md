...
{{< figure src="/attachments/appstore/use-contents/partner-solutions/ats/rg-ats/v1/rg-one-scheduling/21168214.png" alt="Scheduler page" class="no-border" >}}
...
{{< figure src="/attachments/appstore/use-contents/partner-solutions/ats/rg-ats/v1/rg-one-scheduling/newSchedule.png" alt="New schedule dialog" class="no-border" >}}
