...
For serving content to the web view and communicating both ways with it, see the document with a sample [todo app](/apidocs-mxsdk/apidocs/extensibility-api/extensibility-api-howtos/build-todo-example-extension/).
