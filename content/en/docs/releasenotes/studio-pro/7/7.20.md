...
* We fixed an issue in [XML schemas](/refguide7/xml-schemas/) where namespace prefixes could not be resolved inside WSDLs.
    ...
    {{% alert color="info" %}}This is based on a [question from Jan de Lange](https://community.mendix.com/link/questions/91462) asked in the Mendix Community. Thanks for bringing this to our attention, Jan!{{% /alert %}}
