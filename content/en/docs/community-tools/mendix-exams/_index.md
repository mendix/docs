...
{{% alert color="info" %}}
Exam admins need to [sign up for a Mendix account](https://signup.mendix.com/link/signup) if they do not already have a Mendix account.
{{% /alert %}}

Refer to the following pages to learn how to manage the exam seats on your orders.
