...
* the similarity in the structures of the sample documents – the training results are satisfying when all the sample documents have the same or similar document structure
...
7. To mark an image, use the marker tool properly:
