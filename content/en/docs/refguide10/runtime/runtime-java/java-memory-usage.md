...
{{< figure src="/attachments/refguide10/runtime/runtime-java/java-memory-usage/16844065.png" class="no-border" >}}
...
{{< figure src="/attachments/refguide10/runtime/runtime-java/java-memory-usage/16844066.png" class="no-border" >}}
...
{{< figure src="/attachments/refguide10/runtime/runtime-java/java-memory-usage/16844068.png" class="no-border" >}}

A healthy Mendix application that consumes a small amount of memory will show a graph similar to the graph above.

{{< figure src="/attachments/refguide10/runtime/runtime-java/java-memory-usage/16844067.png" class="no-border" >}}
