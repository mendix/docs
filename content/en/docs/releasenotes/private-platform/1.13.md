...
{{% alert color="info" %}}
This is the [MTS](/releasenotes/studio-pro/lts-mts/#mts) version release. Since the release of LTS version [1.24](/releasenotes/private-platform/1-24/), this MTS version is no longer supported. 
{{% /alert %}}
