...
* We have implemented a UX Refresh to provide a fresh new look and feel for the [Marketplace home](/appstore/home-page/), [catalog](/catalog/), [component details](/appstore/component-details/), and Studio Pro download pages.
...
* As of Studio Pro 8.10.0, you are able to download private content in the App Store again. This is not possible for Studio Pro 8.7 to 8.9.
...
* As of Studio Pro 8.6.4, you are able to download private content in the App Store again. This is possible for Studio Pro 8.6.4 and all further 8.6.x versions. It is not possible for Studio Pro versions below 8.6.4.
...
* Downloading private content from the App Store available in Studio Pro/Desktop Modeler has been temporarily disabled due to a security vulnerability.
    * You will be able to download private content from the App Store available in Studio Pro/Desktop Modeler again once a fix is released in a future 8.x, 8.6.x, and 7.23.x release. This functionality will then only be available in those specific versions with the fix and subsequent versions. This functionality will not be available again for the App Store in Desktop Modeler version 6.
