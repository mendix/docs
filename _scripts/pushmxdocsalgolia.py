...
1. Checks that this is a push to production, otherwise ends
...
pushIfBranch = "production" # push to Algolia only if deploying this branch
targetBranch = os.environ['TARGET_BRANCH'] # set by CI workflow

if targetBranch != pushIfBranch:
