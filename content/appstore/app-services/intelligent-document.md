...
The [Intelligent Document Service](https://marketplace.mendix.com/link/component/118388) app service uses AI and OCR technologies to extract text and key value pairs from images of documents.

To use the app service, you need to train a document model using the [Document Model Training app](#document-model-training) and include the intelligent document service activity in your microflow that accepts your trained document model,
...
7.  Click **Create Keys** to generate the **Access_Key**, **Secret_Key** and **Encryption_Key**.
