---
title: "Build an Employee Directory App (Easy) Step 2: Build a Dashboard Page"
...
* Complete the first how-to in this series: [Build an Employee Directory App Step 1: Create the App](build-an-employee-directory-app-easy-1-create-the-app)
...
1. Select the **COLUMN**:
    ...
    ![](attachments/build-an-employee-directory-app-easy/select-column.png)

2. Change the **Row Layout** to a four-column layout:

    ![](attachments/build-an-employee-directory-app-easy/change-row-layout.png)
...
3. See how this influences the behavior on a phone, tablet, and desktop devices by changing the device icons on top of view of your page:
    ...
    ![](attachments/build-an-employee-directory-app-easy/change-devices.png) 
...
4. For the phone device, the columns now have a full widget. Change the **Phone** **Row Layout** to the 2x2 layout and view how this changes the layout for the different devices:
    ...
    ![](attachments/build-an-employee-directory-app-easy/change-phone-layout.png)
...
1. Open the **Toolbox** tab and make sure **Building Blocks** is selected:
    ...
    ![](attachments/build-an-employee-directory-app-easy/select-toolbox.png) 

2. Scroll down and open the **Cards** section to find the **Card Action** building block:

    ![](attachments/build-an-employee-directory-app-easy/card-action.png)
...
4. Now that you've gotten the hang of it using building blocks, you will replace the current header with **HeroHeader1**. Locate this in the **Header** building blocks section:
    ...
    ![](attachments/build-an-employee-directory-app-easy/header-section.png)

5. Drag the **HeroHeader1** building block and drop it just below the top header:
    
    ![](attachments/build-an-employee-directory-app-easy/heroheader1.png)
...
8. Select the **LAYOUT GRID** of the default header and click **Delete** in the bottom-right of the page to remove it:
    ...
    ![](attachments/build-an-employee-directory-app-easy/remove-current-header.png)
...
1. Open the **Theme Customizer** by clicking the paintbrush icon at the bottom of the left menu bar.
    ...
    ![](attachments/build-an-employee-directory-app-easy/theme-customizer.png)
...
4. At the bottom-right of the screen, click **Apply Style** to confirm the changes:
    ...
    ![](attachments/build-an-employee-directory-app-easy/apply-style.png)

    This will take you back to the main window of the Web Modeler, where you can see your new styling:
 
    ![](attachments/build-an-employee-directory-app-easy/theme-customizer-orange.png)
 
    Clicking **Reset Style** in **Theme Customizer** will undo the changes.
     
Well done! Continue with [How to Build an Employee Directory App (Easy) Step 3: Publish and View Your App](build-an-employee-directory-app-easy-3-publish-and-view-your-app).
