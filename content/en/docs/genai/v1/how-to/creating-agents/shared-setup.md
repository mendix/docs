...
url: /agents/agents-kit-1/how-to/creating-agents/shared-setup/
weight: 60
...
* [Create an Agent with Agent Editor](/agents/agents-kit-1/how-to/create-agent-with-agent-editor/)
* [Create an Agent with Agent Commons](/agents/agents-kit-1/how-to/create-agent-with-agent-commons/)
* [Create an Agent Programmatically](/agents/agents-kit-1/how-to/create-agent-programmatically/)
...
* Studio Pro 10.24 or above (or Studio Pro 11.9.1 or above if you plan to use [Agent Editor](/agents/agents-kit-1/how-to/create-agent-with-agent-editor/))
...
For help choosing an approach, see [Creating Your First Agent](/agents/agents-kit-1/how-to/creating-agents/#implementation-approach).
