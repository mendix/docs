...
For details on seting up, see [How to Set Up Your Two-Factor Authentication with Google](../support/how-to-set-up-two-factor-authentication-with-google-authenticator).
