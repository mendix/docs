...
| Intermediate Catch | {{< icon name="controls-stop-filled" color="green" >}} Platform Native | [Notification Activity](/refguide/notification/)                                                                                                                                                                                                                                                                                                                                  |
| Intermediate Boundary (Interrupting) | {{< icon name="controls-stop-filled" color="green" >}} Platform Native | [Interrupting Notification Event](/refguide/notification/)                                                                                                                                                                                                                                                                                                                                                                                                     |
| Intermediate Boundary (Non-Interrupting) | {{< icon name="controls-stop-filled" color="green" >}} Platform Native | [Non-Interrupting Notification Event](/refguide/notification/)                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| Intermediate Boundary (Interrupting) | {{< icon name="controls-stop-filled" color="green" >}} Platform Native | Use an [Interrupting Notification Event](/refguide/notification/) to catch the event, and use a microflow with multiple [Notify Workflow](/refguide/notify-workflow/) activities to deliver the signal to all waiting instances.                                                      |
...
| Event Subprocess (Non-Interrupting) | {{< icon name="controls-stop-filled" color="green" >}} Platform Native | Use a [Non-Interrupting Notification Event Subprocess Start](/refguide/workflow-event-sub-processes/#start-event-types) to catch the event, and use a microflow to evaluate the escalation condition and send a notification using a [Notify Workflow](/refguide/notify-workflow/) activity when the escalation needs to happen. |
| Intermediate Boundary (Interrupting) | {{< icon name="controls-stop-filled" color="green" >}} Platform Native | Use an [Interrupting Notification Event](/refguide/notification/) to catch the event, and use a microflow to evaluate the escalation condition and send a notification using a [Notify Workflow](/refguide/notify-workflow/) activity when the escalation needs to happen.                                                                       |
| Intermediate Boundary (Non-Interrupting) | {{< icon name="controls-stop-filled" color="green" >}} Platform Native | Use a [Non-Interrupting Notification Event](/refguide/notification/) to catch the event, and use a microflow to evaluate the escalation condition and send a notification using a [Notify Workflow](/refguide/notify-workflow/) activity when the escalation needs to happen.                                                                    |
...
| Variant | Support Level | How                                                                                                                                                                                                                          |
|---|---|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Intermediate Boundary (Interrupting) | {{< icon name="controls-stop-filled" color="green" >}} Platform Native | Use an [Interrupting Notification Event](/refguide/notification/) to catch the event, and use a microflow to send a notification using a [Notify Workflow](/refguide/notify-workflow/) activity when the cancellation occurs.                |
