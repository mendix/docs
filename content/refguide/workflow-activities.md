...
* [Change workflow state](change-workflow-state) – allows you to add **Abort**, **Restart**,  **Continue**, **Pause**, and **Resume** operations to a workflow and control workflow instances.
