...
weight: 5
description: "Maia Chat의 기능을 설명합니다."
aliases:
...
{{% alert color="info" %}}
Maia Chat was released for GA in Studio Pro 10.12.0. From Studio Pro 10.6 to 10.11, it was available as a beta feature and called MendixChat. Maia Chat is also available in the Mendix Portal. For more information, refer to the [Maia Chat](/portal/maia/#maia-chat) section in *Maia in Mendix Portal*.
{{% /alert %}}
