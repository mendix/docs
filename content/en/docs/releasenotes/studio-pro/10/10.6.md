...
* We fixed an issue where non-English characters were removed from an Expression or XPath editor (the text editor control). (Tickets 205072, 205761, 206502, 206632, 207386, 208264)
