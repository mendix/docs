...
#### Custom metrics
The [Core.Metrics API](https://docs.mendix.com/refguide/metrics) and corresponding [microflow activities](https://docs.mendix.com/refguide/metrics-activities) in Studio Pro are now available.
