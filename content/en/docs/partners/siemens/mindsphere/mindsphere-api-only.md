...
{{% alert color="warning" %}}
This information is for standalone Mendix application which are not fully integrated into Insights Hub - just want to incorporate IIoT Data coming from Insights Hub.
{{% /alert %}}
