...
7.  Add the [Find/Assert Widget](/ats/refguide/refguide-ats-1/findassert-widget) action and the [Set Return Value](/ats/refguide/refguide-ats-1/set-return-value) action.
