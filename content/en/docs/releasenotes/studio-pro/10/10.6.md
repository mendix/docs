...
* The first time you open MendixChat, you need to click **Sign in** so that it is available for use. This only needs to be done once after installing this version of Studio Pro.
    * Fixed in [10.7.0](/releasenotes/studio-pro/10.7/#fix-first-time)
...
* <a id="ki-first-time"></a>The first time you open MendixChat, you need to click **Sign in** so that it is available for use. This only needs to be done once after installing this version of Studio Pro.
    * Fixed in [10.7.0](/releasenotes/studio-pro/10.7/#fix-first-time)
