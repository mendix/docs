...
* We fixed a bug that occurred when the list of an entity was sorted on an attribute of its generalization in a nanoflow and deploying the app threw an error. (Ticket 138310) 
