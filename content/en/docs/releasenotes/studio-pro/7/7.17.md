...
* We added `createXPathQuery` in the Core Java API. This offers a fluent way of creating and executing an XPath-based query. This new API supercedes the `retrieveXPathQueryEscaped` methods, which is deprecated pending removal in Mendix 8.
