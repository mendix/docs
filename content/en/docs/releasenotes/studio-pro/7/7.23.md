...
* Starting with version 7.23.35, we will drop support for following databases due to them no longer being supported by vendors:
  * PostgreSQL 10
  * SQL Server 2017
* We dropped support for Oracle 12.2 due to it no longer being supported by the vendor.
