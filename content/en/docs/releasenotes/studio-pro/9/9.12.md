...
* Starting with version 9.12.9, we will drop support for SQL Server 2017, because it is no longer supported by the vendor.
...
* Starting with version 9.12.8, we will drop support for PostgreSQL 10, because it is no longer supported by the vendor.
