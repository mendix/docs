...
The Mendix Platform offers online services such as [version control](/refguide9/version-control/) and [cloud deployment](/deployment/). When enabled, this will create an app in [Projects](https://projects.home.mendix.com/) and a corresponding version control repository.
