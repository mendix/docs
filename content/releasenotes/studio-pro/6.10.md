...
* When running a hybrid app or web app in a mobile browser on iOS 12.2, the keyboard did not appear when clicking an input field, and you had to click multiple times to use the keyboard. This is now fixed. (Tickets 82022, 82079, 82462, 85575, 86079, 86186)
