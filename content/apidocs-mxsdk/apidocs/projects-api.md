...
| TemplateUUID (can be `empty`) | String | [UUID](developerportal/app-store/app-store-overview#3-3-additionalinfosection) which identifies the template with which the project will be created. If left empty, a default blank template will be used instead. |
