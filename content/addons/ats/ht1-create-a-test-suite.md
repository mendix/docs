...
This how-to uses the Company Expenses app as an example. You will create a test suite and add the test cases you created in [How to Create a Test Case](ht1-create-a-test-case). If you don't have them anymore, create two new test cases without any test steps to walk through this how-to. 
...
2.  Click **Add Test** inside the **Tests** tab:
    ...
    ![](attachments/ht1-create-a-test-suite/repository-add-test.png)

    You can also click **Add Item** inside the **All Objects** tab:
    
    ![](attachments/ht1-create-a-test-suite/repository-add-item.png)

    Clicking either button opens the **Create new** dialog box:
    
    ![](attachments/ht1-create-a-test-suite/repository-create-new.png)
...
6.  Click **Create**.
    ...
    ![](attachments/ht1-create-a-test-suite/repository-create-new-test-suite.png)
...
![](attachments/ht1-create-a-test-suite/repository-test-suite-page.png)
...
1.  Click **Add** on the **Test Suite** page.
    ...
    ![](attachments/ht1-create-a-test-suite/repository-test-suite-page-add.png)

2.  The **Select Test** pop-up dialog opens:
    
    ![](attachments/ht1-create-a-test-suite/repository-select-test.png)
...
4.  Click **Save**:
    ...
    ![](attachments/ht1-create-a-test-suite/test-suite-page-select-test.png)

Repeat this process for the Recorder test case to complete your test suite.

![](attachments/ht1-create-a-test-suite/test-suite-page-complete.png)
...
To create a new test case, click **Create a new Test Case**, and complete [How to Create a Test Case](ht1-create-a-test-case).
    
![](attachments/ht1-create-a-test-suite/test-suite-page-select-test-new.png)
...
You have now learned how to create a test suite, so the next how-to is [How to Create Custom Actions](ht1-create-custom-actions), which will cover creating your own actions. You can also proceed with [How to Upload a File in Your App Using ATS](ht1-upload-file-using-ats).
