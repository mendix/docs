...
* The [date picker](/refguide/date-picker)'s placeholders now respect the date formats that has been passed to it. This means some of the languages' date format will show the exact date format which might result in different placeholder values from previous releases. (Ticket 89996)
