...
| 9.0-9.6      | Latest available version, but no lower than 9.5.1. Due to breaking changes, minimum Studio-supported version in this bundle is 9.5.1.  Apps below 9.5.1 will not open in Studio and will be suggested to upgrade. Due to breaking changes, minimum Studio-supported version in this bundle is 9.5.1. {{% todo %}}[Do we need to explain what breaking changes are and name them?]{{% /todo %}} |
