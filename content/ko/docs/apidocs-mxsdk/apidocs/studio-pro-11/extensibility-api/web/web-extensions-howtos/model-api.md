---
title: "Web API를 사용하여 Mendix 모델 접근하기"
linktitle: "Mendix 모델"
...
이 How-to에서는 use the Model Access API, which allows access to the Mendix model.

## Model Access API 사용하기 {#using-api}
...
## 유닛 정보 읽기 및 유닛 로드하기 {#units-info-load}
