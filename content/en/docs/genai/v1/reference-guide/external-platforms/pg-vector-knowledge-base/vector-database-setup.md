...
url: /agents/agents-kit-1/reference-guide/external-connectors/pgvector-setup/
...
1. Add the PgVector Knowledge Base module and its dependencies to your Mendix app and set it up. For detailed instructions, see [PgVector Knowledge Base](/agents/agents-kit-1/reference-guide/external-connectors/pgvector/).
