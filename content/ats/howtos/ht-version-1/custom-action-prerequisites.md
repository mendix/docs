...
[Guidelines for Building a Custom Action](/ats/howtos/ht-version-1/guidelines-custom-action-1) is a best practice document that describes the guidelines  you must follow when building custom actions. These guidelines deliver the best results.
...
The how-to's don't explain everything in detail. Simple things like adding an input parameter are not explained. Make sure you have completed the [Custom Action Basics](custom-action-basics) how-to.
