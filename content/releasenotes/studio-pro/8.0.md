...
Native apps support the translation of pages.

Snippets can be used on native pages and layouts. To enable this, set the new `Type` property to `Native`.
