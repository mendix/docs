...
* We updated the information on building blocks as it may differ depending on Atlas version used in the app. Now when clicking an information icon on a building block, a new tab opens with information corresponding to the Atlas version 3 or 4. 
