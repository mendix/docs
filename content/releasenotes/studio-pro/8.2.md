...
* We fixed an issue introduced in Studio Pro [8.2.0](#820) where objects are not committed when executing the commit action in special cases related to one-to-one associations. This reverts a [change made in 8.2.0](#69877). (Ticket 89612) 
