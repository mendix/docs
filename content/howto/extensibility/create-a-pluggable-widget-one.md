...
7.  Add a test widget to the proappject home page:<br />
	a. To find your widget for the first time you need to refresh from the files system. Use <kbd>F4</kbd> or select **Project** > **Synchronize Project Directory** from the Studio Pro menu.<br />
