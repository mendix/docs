---
title: "커맨드 라인을 사용하여 Kubernetes 기반 Mendix 클러스터에 Mendix 앱 배포"
linktitle: "CLI를 사용한 배포"
url: /developerportal/deploy/private-cloud-operator/
description: "Kubernetes 기반 Mendix에서 Mendix Operator를 직접 사용하여 Mendix 앱을 배포하는 프로세스를 설명합니다."
weight: 30
---
