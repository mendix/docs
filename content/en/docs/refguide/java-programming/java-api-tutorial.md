...
This tutorial contains some examples of how to use the [Mendix Runtime Java API](https://docs.mendix.com/apidocs-mxsdk/apidocs/runtime-api/). The tutorial assumes that you have some basic Java and Mendix modeling knowledge.
