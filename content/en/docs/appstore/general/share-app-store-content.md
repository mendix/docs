...
* For example pages and microflows to be copied to another module, select the **Exclude from app** option for the document in order to encourage duplication and reduce dependency errors 
