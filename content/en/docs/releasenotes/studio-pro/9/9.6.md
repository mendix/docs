...
* We now show which services are validated in the [Data Hub pane](/refguide9/data-hub-pane/). This corresponds to the services that are marked as validated in the [Data Hub Catalog](/data-hub/data-hub-catalog/).
