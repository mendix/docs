---
title: "비영구 객체와 가비지 컬렉션"
url: /refguide/transient-objects-garbage-collecting/
weight: 1
description: "영구 및 비영구 객체의 라이프사이클과 플랫폼 메모리를 통해 흐르는 방식을 설명합니다."
---
...
#### Objects Associated with Current User or Session
...
#### Objects Which Are Parameters of Web Pages
