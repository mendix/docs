...
- We fixed an issue that made it impossible to start Studio Pro for the first time when there is no internet connection available.
- We fixed an issue in the App Selector when the loading spinner stayed visible forever even when app loading had finished.
