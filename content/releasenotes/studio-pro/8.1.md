...
#ki: "When you use the Extract sub-nanofow" = OFF-137
#ki: "Delete action causes error on page" = WTF-187 (done already, to be released for 8.3)
---
...
* When you have a conditionally visible widget and the object used for the conditional expression is deleted this will result in an error. (Tickets 88646, 88783, 89114, 89756, 90495, 90680)
