...
url: /appstore/industry/3d-viewer/3d-viewer-api/
description: "Describes how to use the 3D Viewer API"
aliases:
    - /partners/siemens/3d-viewer-api/
---
...
1. Retrieve selected object information as a string through the [On Selection Change](/appstore/industry/3d-viewer/usage/#on-selection-change) event attribute of the 3D Viewer.
