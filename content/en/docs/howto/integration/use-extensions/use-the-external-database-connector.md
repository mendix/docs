...
2. Enter the query to call a stored procedure. Make sure to add a schema name with the stored procedure name. Use the syntax: `Call latest_schema.InsertDataIntoTable1({1},{2})`
