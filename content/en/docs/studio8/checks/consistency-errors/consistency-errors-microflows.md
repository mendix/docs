...
An example of a consistency error is when you set a drag a **Create Object** activity onto the microflow, but do not specify what entity should be used as a data source to create the object. 
