...
* Studio Pro has many options for data sources used in widgets to filter the data that it shows during runtime. We are getting rid of the **Database** data source. [**TW: LOCATION? IMMEDIATELY?**]
