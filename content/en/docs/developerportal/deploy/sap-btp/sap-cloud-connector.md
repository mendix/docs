...
{{< figure src="/attachments/appstore/use-contents/modules/sap-cloud-connector/connectivity-service.png" class="no-border" >}}
...
{{< figure src="/attachments/appstore/use-contents/modules/sap-cloud-connector/cloud-connector.png" class="no-border" >}}
