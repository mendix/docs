---
title: "Mistral"
url: /appstore/modules/genai/v1/reference-guide/external-connectors/mistral/
linktitle: "Mistral"
description: "Agents Kit 1: Describes the configuration and usage of the Mistral Connector, which allows you to integrate generative AI into your Mendix app."
weight: 20
...
Mistral also provides vector embedding generation capabilities which can be invoked using this connector module. The `MistralDeployedModel` entity is compatible with the [knowledge base operations](/appstore/modules/genai/v1/genai-for-mx/commons/#genai-knowledgebase-content) from the GenAI Commons.
...
Mistral supports the following [tool choice types](/appstore/modules/genai/v1/genai-for-mx/commons/#enum-toolchoice) of GenAI Commons for the [Tools: Set Tool Choice](/appstore/modules/genai/v1/genai-for-mx/commons/#set-toolchoice) action are supported. For API mapping reference, see the table below:
