...
We are releasing the beta version of our redesigned access rule editor. In this new UI you can easily view and edit the access rules of an entity in one single overview. Enable the new UI in the [Preferences Dialog](/refguide/preferences-dialog/#new-features) inside Studio Pro.
