...
* [Import](#import) the component from the **App Explorer** – this only works for [connectors](/appstore/connectors/) and [modules](/appstore/modules/), including [add-on modules]()
* [Manually add](#add) the component into the app directory – this only works for [widgets](/appstore/widgets/) and add-on modules
...
{{% alert type="info" %}}This procedure only works for [connectors](/appstore/connectors/) and [modules](/appstore/modules/), including add-on modules.{{% /alert %}}
...
{{% alert type="info" %}}This procedure only works for [widgets](/appstore/widgets/) and [add-on modules]().{{% /alert %}}
