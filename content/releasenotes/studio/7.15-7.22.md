...
title: "7.15–7.22"
category: "Studio"
description: "New features, bug fixes, and known issues in Mendix Studio correlated to Mendix Studio Pro version 7.15-7.22."
---

These are Mendix Studio release notes for app projects built with Studio Pro version 7.15–7.22. The release notes include all minor versions, patches, and known issues.

For more information on Mendix Studio version and Mendix Studio Pro version correlation, see [Studio Version & Mendix Version Correlation](/studio/general-versions).

{{% alert type="info" %}}

Previously Mendix Studio was called the Web Modeler and Mendix Studio Pro was called the Desktop Modeler.

For Mendix Studio release notes correlated with Studio Pro versions 7.23 and above, see [7.23 & Above](7.23-and-above). 

For Mendix Studio release notes correlated with Studio Pro versions 7.11–7.14, see [7.11–7.14](7.11-7.14). 
{{% /alert %}}

{{% alert type="info" %}}
For updates on the operational status of Mendix Studio as well as deployment features and other Mendix services, see [Mendix Status](https://status.mendix.com/).
{{% /alert %}}
...
* To make your work in the [page editor](/studio/page-editor) easier, we improved data container highlights in the following ways:

  * If the widget is inside a data container (a data view or a list view), it will be indicated with a data container icon

    {{% image_container width="350" %}}![](../../studio/attachments/page-editor/input-widget-example.png)
    {{% /image_container %}}
...
* We added support for [Studio Pro 7.22.1](../studio-pro/7.22).
...
* We added support for [Studio Pro 7.22](../studio-pro/7.22).
...
* We added support for [Studio Pro 7.21](../studio-pro/7.21).
...
* We added support for [Studio Pro 7.20.1](../studio-pro/7.20).
...
* To prevent you from getting consistency errors that cannot be fixed in Studio, you now cannot delete a page in Studio if it is used in one of navigation profiles in Studio Pro. For more information on navigation profiles, see [Navigation Profiles](/refguide7/navigation-profile).
...
* To help you fix consistency errors in microflows quickly and efficiently, we added documentation on [consistency errors in the microflow editor](/studio/consistency-errors-microflows). For more information on consistency errors in microflows and ways to fix them, see [Microflow Editor Consistency Errors](/studio/consistency-errors-microflows).
* We added support for [Studio Pro 7.20](../studio-pro/7.20).
...
* Default access rules are now assigned for newly created entities. This improves collaboration between Studio Pro and Studio and has impact on projects for which project security is enabled in Studio Pro. For more information on security, see [Security](/refguide7/security).
...
* To help you fix consistency errors quickly and efficiently, we added documentation on the most common [consistency errors in the page editor](/studio/consistency-errors-pages) and [navigation](/studio/consistency-errors-navigation), and described the ways to fix them. For more information on consistency errors and ways to fix them, see [Consistency Errors](/studio/consistency-errors), [Page Editor Consistency Errors](/studio/consistency-errors-pages), and [Navigation Consistency Errors](/studio/consistency-errors-navigation).
...
* We added support for [Studio Pro 7.19](../studio-pro/7.19).
...
* We fixed an issue where the page editor showed nothing in the data source for **List View** widgets with a **Nanoflow** source. Note that nanoflows can be configured in Studio Pro only.
 ...
 * We re-added support for [Studio Pro 7.18](../studio-pro/7.18). The known issue with consistency error checking in Mendix version 7.18.0 has been resolved in version [7.18.1](../studio-pro/7.18#68234). Stduio users with apps in Mendix version 7.18.0 can now upgrade their apps when opening Studio in order to continue building and publishing.
...
* We fixed a broken URL for the how-to that describes syncing Studio with Studio Pro. This link is located in the pop-up window that appears after selecting **Edit in Studio Pro** via the information menu at the top-right of the screen.
...
* You can switch between list view templates in Studio, if you have configured them in Studio Pro and then synchronized your project with Studio. This will improve collaboration between Studio and Studio Pro. 

#### Fixes

* We fixed an issue where if you had a project built with Studio Pro versions 7.11-7.14 and you tried to upgrade the project in Studio, the upgrade would fail. Now if you click the **Upgrade** button in Studio, your project will be updated to the latest current version. 
...
* We added support for [Studio Pro 7.18](../studio-pro/7.18).
...
* We fixed an issue where you deleted a layout in Studio Pro, synced a project with Studio, and Studio crashed because of the missing layout. You will see an informative error message now. 
...
* We fixed an issue where the page editor in Studio did not take the alignment property of scroll container widgets (configured in Studio Pro) into account, and the scroll container was always aligned to the right.

### August 17th, 2018

#### New Features

* We added support for [Studio Pro 7.17.2](../studio-pro/7.17).
...
* We added support for [Studio Pro 7.17](../studio-pro/7.17).
...
* Documentation for the [Studio](/studio) is now available. We added the *Studio Guide* to improve your understanding of Studio. You can now read about the main features, concepts, and definitions, as well as learn how to perform different actions.
...
* When you add several tabs on a page in Studio Pro, you can now switch between them in Studio and view their contents. This improves collaboration between developers in Studio and Studio Pro. 
...
* We added support for [Studio Pro 7.16](../studio-pro/7.16). Studio supports ranges for Mendix Studio Pro. This gives you choice in whether to update Studio right away, or postpone the update. For more information on the topic, see [Studio Versions & Mendix Versions Correlation](/studio/general-versions).
...
*  We fixed an issue where it was impossible to deploy an app or open a project in Studio Pro after **Auto Arrange** in the domain model editor was used. 
