...
* <a name="2047"></a>We fixed a [known issue](#ki-2047) that prevented selecting a line in multi-column trees when double-clicking a column that was not the first.
