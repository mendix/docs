...
![](attachments/ht2-configure-a-selenium-hub/new-selenium-hub-dialog-saucelabs.png)
...
For more information on local selenium set-up go to [Customer Hosted Selenium](ov-deployment#customer-hosted-selenium).
