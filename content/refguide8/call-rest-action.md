...
* When you deploy the app to the Mendix cloud, the identifier is set when [pinning a client certificate](../developerportal/deploy/certificates#client-certificates)
