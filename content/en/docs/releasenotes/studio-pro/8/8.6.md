...
{% alert color="info" %}For the highlights of this release, see the [Mendix Release 8.6](https://www.mendix.com/blog/mendix-8-6-youre-going-to-love-this/) blog post.{% /alert %}
