...
If **Enable MxAssist Logic Bot** is checked, then [Mx Assist Logic Bot](mendix-assist-logic-bot) is activated and can offer suggestions for activities in your microflows.
