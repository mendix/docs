...
An enumeration has one or more [enumeration values](/refguide5/enumeration-values). Each value represents one option. An attribute of type enumeration can also be empty to represent an uninitialized state.
...
See [Enumeration Values](/refguide5/enumeration-values).
