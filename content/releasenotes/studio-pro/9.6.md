...
* In [9.6.8](#968), we fixed an issue where an exception is thrown when decoding Base64 binary data with special characters. We now introduce a new runtime setting com.mendix.core.UseMimeDecoderForBase64 to be able to decode MIME type of Base64. (Ticket #136429)
