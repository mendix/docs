...
* We fixed the snap-to-object behavior in the new beta microflow, nanoflow and rules editors that occurs when the dragged object started inside of a loop. [**TW**]
* We fixed an issue where items in the top bar of the new beta microflow, nanoflow, and rules editors were selectable.  [**TW**]
...
* Studio Pro has many options for data sources used in widgets to filter the data that it shows during runtime. We are getting rid of the **Database** data source. [**TW: NOW, OR IN FUTURE?**]
