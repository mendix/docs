...
In Mendix, tracing is supported by the [GenAI Commons](/agents/agents-kit-2/genai-for-mx/commons/#traceability) module to help debug and monitor agent behavior.
