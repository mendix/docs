...
* <a name="private-content"></a>Downloading private content in the App Store available in Studio Pro has been enabled again for this version and all further 8.6.x versions. It is not possible for Studio Pro versions below 8.6.4. This has also been fixed for [Studio Pro 8.10.0](8.10#211) and above.
