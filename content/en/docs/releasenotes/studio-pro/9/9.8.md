...
* When a dataset or data source is validated in the Data Hub Catalog, it is now also shown in the [Integration pane](/refguide9/integration-pane/) in Studio Pro.
* We changed how the names of external entities are displayed in the Integration pane so that they are now consistent with the dataset names in the Data Hub Catalog.
