...
* **New merge algorithm with fine-grained conflict resolution** is now default and only option for conflict resolution in Studio Pro and, therefore, was removed from the **New Features** tab of the **Preferences** dialog.
