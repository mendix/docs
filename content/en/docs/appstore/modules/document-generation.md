...
* If you configured [ApplicationRootURL](/refguide/custom-settings/#ApplicationRootUrl) to a custom domain then the document generation service will return a [timeout error](#module-usage-runtime-issues) and the pdf will not be generated.
...
* [ApplicationRootURL](/refguide/custom-settings/#ApplicationRootUrl) is configured to a custom domain which is a known issue.
