...
description: "Mendix Marketplace의 PgVector Knowledge Base 모듈의 구성 및 사용법을 설명합니다. 이 모듈을 통해 개발자는 pgvector가 설치된 PostgreSQL 데이터베이스를 Knowledge Base로 Mendix 앱에 통합할 수 있습니다."
weight: 70
aliases:
