...
* <a name="639"></a>We fixed a [known issue](/releasenotes/studio-pro/9.13/#ki-639) where scheduled events did not execute in a horizontally-scaled environment and in some cases in a single-node environment. (Ticket 146867)
