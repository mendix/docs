...
* We improved Studio performance and it is now loading 20% – 35% faster.

#### Fixes

* We fixed an issue where inline editing a caption of a button crashed in Microsoft Edge.
...
*  We fixed an error message CE1569 that had an unpopulated parameter. 
