...
url: /appstore/connectors/aws/amazon-location-service/
...
The [Amazon Location Service](!!link to be added) connector enables you to add location data to your Mendix app by connecting it to [Amazon Location Service](https://aws.amazon.com/location/).
...
The Amazon Location Service connector requires Mendix Studio Pro version {STUDIO PRO VERSION} or above.

To authenticate with Amazon Web Service (AWS), you must also install and configure the [AWS Authentication connector version {MINIMUM REQUIRED VERSION} or higher](https://marketplace.mendix.com/link/component/120333). It is crucial for the Amazon Location Service connector to function correctly. For more information about installing and configuring the AWS Authentication connector, see [AWS Authentication](/appstore/modules/aws/aws-authentication/).

#### VARIANT 2 - IF THE CONNECTOR ALSO HAS OTHER DEPENDENCIES

The Amazon Location Service connector requires Mendix Studio Pro version {STUDIO PRO VERSION} or above.

To use the Amazon Location Service connector, you must also install and configure the following modules:

* [AWS Authentication connector version {MINIMUM REQUIRED VERSION} or higher](https://marketplace.mendix.com/link/component/120333) - This connector is required to authenticate with Amazon Web Services (AWS). It is crucial for the Amazon Location Service connector to function correctly. For more information about installing and configuring the AWS Authentication connector, see [AWS Authentication](/appstore/modules/aws/aws-authentication/).
...
Activities define the actions that are executed in a microflow or a nanoflow. For the Amazon Location Service connector, they {PURPOSE OF THE ACTIVITIES}.
