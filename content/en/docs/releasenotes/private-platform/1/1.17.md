...
When installing Private Cloud License Manager, you can now select aws-irsa as authentication method. For more information, see [Private Mendix Platform Quickstart Guide](/private-mendix-platform/quickstart/).
