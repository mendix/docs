...
* Resolved an issue in Free Apps where technical contacts were unable to access sandbox backups. (Tickets #279092, #279580)
* Fixed an issue that prevented access to the Environment page for Free Apps that had not yet been deployed. (Tickets #278349, #279299)
  
#### New Features
Activity logs generated in the Cloud Portal are now automatically published to the Central Audit Logging System, providing improved visibility and auditability across environments.(https://ccauditlogs.home.mendix.com/)
