...
{{< figure src="/attachments/howto9/mobile/native-mobile/distribution/build-native-apps/native-build-locally-manually/nt-sp-9-example.png" alt="iOS output"   width="200"  class="no-border" >}}

So like in the example picture shown above, in the case of Mendix Studio Pro 9.24.x, you could choose any Native Template version from 7.0.0 to the latest 7 version. Ideally you should choose the most recent supported version.
