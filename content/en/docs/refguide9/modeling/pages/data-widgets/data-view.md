...
{{< figure src="/attachments/refguide9/modeling/pages/data-widgets/data-view/data-view-example-structure-mode.png" class="no-border" >}}
...
{{< figure src="/attachments/refguide9/modeling/pages/data-widgets/data-view/data-view-complex-example.png" class="no-border" >}}
...
{{< figure src="/attachments/refguide9/modeling/pages/data-widgets/data-view/data-view-properties.png"   width="250"  class="no-border" >}}
