...
Collaborative development is the process that allows team members work together on one project in Mendix Studio Pro and Mendix Studio and easily synchronize changes made by others using [version control](/refguide8/version-control). 
