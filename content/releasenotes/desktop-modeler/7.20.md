...
* Startup is significantly slower than usual due to a password strength check that checks user accounts too aggressively. Apps with more than 1000 Users are strongly recommended not to upgrade until a fix is released. (Ticket 76176)
