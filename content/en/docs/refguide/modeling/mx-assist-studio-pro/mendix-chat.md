...
{{% alert color="warning" %}}
From Studio Pro 10.6.0 to 10.6.2, sometimes even if you are already logged in to Studio Pro, you might still need to click **Sign in** under the **MendixChat** tab to make MendixChat available for use.
{{% /alert %}}
...
3. Press <kbd>Enter</kbd> (or <kbd>Ctrl</kbd> + <kbd>Enter</kbd>), or the **Ask** button, to send the question.
    ...
    {{% alert color="info" %}}In Studio Pro 10.7.0 and below, you can only use <kbd>Enter</kbd> to add a new line, not to send the question.{{% /alert %}}
