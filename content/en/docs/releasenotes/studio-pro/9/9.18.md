...
* We fixed an issue where editing a **Call microflow**, **Call nanoflow** or **Show page** activity in a microflow or nanoflow resulted in an error dialog if the selected document had multiple parameters with the same name after merging branches.
## 9.18.0 {#9180}
