...
| App Store widgets<a name="app-store-widgets"></a> | Widgets that are you can download to your project directly from Studio. Some App Store widgets are already in your project as a part of the app. Such widgets have the information icon in the top-right corner of widgets in the **Toolbox**. <br />For more information on the App Store, see [Marketplace Overview](/appstore/general/app-store-overview). | [App Store](/appstore/index)                     |
