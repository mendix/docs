...
*   User is familiar with the logging guidelines defined in:
    *   [Review log files – MS IIS Server](Review+log+files+-+MS+IIS+Server "Review log files - MS IIS Server")
    *   [Review log files – MS SQL Server](Review+log+files+-+MS+SQL+Server "Review log files - MS SQL Server")
    *   [Monitoring - Mendix Runtime](Monitoring+-+Mendix+Runtime "Monitoring - Mendix Runtime")
