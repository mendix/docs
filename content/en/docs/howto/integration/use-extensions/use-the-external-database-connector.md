...
2. Enter the query to call a stored procedure(make sure to add schema name with stored procedure name). Use the syntax: `Call latest_schema.InsertDataIntoTable1({1},{2})`
