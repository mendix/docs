...
The input variable can be the name of a string variable, a file document, an [HttpRequest](/refguide/http-request-and-response-entities/request-and-response-entities#http-request), or an [HttpRequest](/refguide/http-request-and-response-entities/request-and-response-entities#http-response). The content of the file document, HttpRequest, or HttpResponse should be XML or JSON.
