---
title: "Build an Employee Directory App (Intermediate) Step 3: Publish and View Your App"
...
* Complete the second how-to in this series: [How to Build an Employee Directory App (Intermediate) Step 2: Build a Dashboard Page](build-an-employee-directory-app-intermediate-2-build-a-dashboard-page)
...
1. Click **Publish** on the top-right of the Web Modeler:
    ...
    ![](attachments/build-an-employee-directory-app-intermediate/publish.png)
...
1. Click **View app** to view it in the phone preview mode in a new browser window:
     ...
     ![](attachments/build-an-employee-directory-app-intermediate/phone-preview.png)
...
2. Return to the Web Modeler and select the drop-down arrow on the **View app** button to select the **Tablet preview** or **Desktop preview** mode, which will open that preview in a new browser window:
     ...
     ![](attachments/build-an-employee-directory-app-intermediate/view-app.png)
...
1. Click **View on mobile device**:
     ...
     ![](attachments/build-an-employee-directory-app-intermediate/view-app-mobile.png)
...
Nice. Now you're ready to continue with the last how-to of this tutorial: [How to Build an Employee Directory App (Intermediate) Step 4: Add Pages to the User Interface](build-an-employee-directory-app-intermediate-4-add-pages-to-the-user-interface).
