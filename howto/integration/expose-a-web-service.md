...
3. You should now see the **Published Web Service** properties window. Take note of the following tab details:
    ...
    * On the **Settings** tab, you can configure the other settings (for now leave the settings as they are; for details on these settings, see [Published Web Services](/refguide/published-web-services) in the Mendix Reference Guide):
