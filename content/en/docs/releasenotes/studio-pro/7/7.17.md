...
{{% alert color="info" %}}
This is based on an [upvoted idea from Stephan Bruijnis](https://community.mendix.com/link/ideas/688) submitted to the Mendix Community. Cheers, Stephan!
{{% /alert %}}
...
{{% alert color="info" %}}
This is based on an [upvoted idea from Jelle Dekker](https://community.mendix.com/link/space/microflows/ideas/697) submitted to the Mendix Community. Thanks, Jelle!
{{% /alert %}}
