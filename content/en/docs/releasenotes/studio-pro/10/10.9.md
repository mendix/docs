...
* <a id="fix-output-variable-not-set"></a> We fixed a [known issue](/releasenotes/studio-pro/10.6/#ki-output-variable-not-set) in the logic editors where sometimes the type of an output variable of an activity was showed as **Not set**. (Tickets 205751, 207251)
