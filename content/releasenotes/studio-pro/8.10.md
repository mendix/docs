...
#ki: "When you click an action" = WTF-448
---
...
* When you are using an action inside a list view which is inside another list view in a native profile, an exception would occur when you execute the action. This has been fixed. (Ticket 101465)
