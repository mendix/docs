...
* We fixed an issue where the action for closing a pop-up window did not work correctly if it targeted an [action button](/refguide/button-widgets/) and there were multiple instances of that button in an app. (Ticket 192989)
