...
* An overview page displaying a table of data for a specific entity, like this:
    {{< figure src="/attachments/refguide10/runtime/communication-patterns/19399028.png" class="no-border" >}}
* A details page where a specific object of an entity can be edited, like this:
    {{< figure src="/attachments/refguide10/runtime/communication-patterns/19399029.png" class="no-border" >}}
...
{{< figure src="/attachments/refguide10/runtime/communication-patterns/19399030.png" class="no-border" >}}
...
{{< figure src="/attachments/refguide10/runtime/communication-patterns/19399031.png" class="no-border" >}}
...
{{< figure src="/attachments/refguide10/runtime/communication-patterns/19399032.png" class="no-border" >}}
...
{{< figure src="/attachments/refguide10/runtime/communication-patterns/19399033.png" class="no-border" >}}
...
{{< figure src="/attachments/refguide10/runtime/communication-patterns/attribute-security.png" class="no-border" >}}
...
{{< figure src="/attachments/refguide10/runtime/communication-patterns/19399034.png" class="no-border" >}} 
...
{{< figure src="/attachments/refguide10/runtime/communication-patterns/19399035.png" class="no-border" >}}
...
{{< figure src="/attachments/refguide10/runtime/communication-patterns/19399036.png" class="no-border" >}}
