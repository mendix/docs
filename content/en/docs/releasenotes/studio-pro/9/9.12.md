...
* <a name="168024"></a>We fixed a [known issue](/releasenotes/studio-pro/9.5/#ki-168024) where . . . [**ADD VIA BELOW**]
...
* Starting with version 9.12.11, we will drop support for MariaDB 10.2 because it is no longer supported by the vendor. [**ADD DEPRECATION REMINDER**]
