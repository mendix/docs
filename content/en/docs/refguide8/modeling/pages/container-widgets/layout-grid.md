...
{{% alert color="info" %}}
Row and column properties described below are available if your project has [Mendix 8.5.1](/releasenotes/studio-pro/8.5/) or above and [Atlas UI Resources](https://marketplace.mendix.com/link/component/104730) version 2.4.0 or above. 
...
{{< figure src="/attachments/refguide8/modeling/pages/container-widgets/layout-grid/layout-example-phone.png" alt="Layout Example, Phone"   width="300"  class="no-border" >}}
