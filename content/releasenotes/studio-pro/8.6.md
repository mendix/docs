...
* <a name="1510"></a>We resolved a possible crash that could occur when switching between [languages](/howto/collaboration-requirements-management/translate-your-app-content) in your app.
...
* We fixed a regression introduced in Mendix 8.5.0 with respect to the 'changedDate' system attribute. Now the changed date attribute doesn't get updated anymore when a microflow changes an entity to the values it already has. (Ticket 96446)
