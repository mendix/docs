...
For more details, see [Schedules](/addons/ats/rg2-schedule) in the *ATS 2 Reference Guide*.
...
* Test case executions in Browserstack now show the result from ATS.
  ...
  ![Browserstack-ATS integration](/addons/ats/attachments/rg2-results/browserstack.png)
