...
{{< figure src="/attachments/refguide9/modeling/pages/input-widgets/radio-buttons/radio-buttons-displayed.png" >}}
...
{{< figure src="/attachments/refguide9/modeling/pages/input-widgets/radio-buttons/radio-buttons.png" >}}

## 2 Properties

An example of radio button properties is represented in the image below:

{{< figure src="/attachments/refguide9/modeling/pages/input-widgets/radio-buttons/radio-buttons-properties.png"   width="250"  >}}
