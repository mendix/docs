...
* We changed the properties order of [tab container](/refguide8/tab-container/) so that the focus is set to the caption.
    ...
    {{% alert color="info" %}}This is based on an [upvoted idea from Jan van der Lubbe](https://forum.mendixcloud.com/link/ideas/1486) submitted to the Mendix Idea Forum. Thanks, Jan!{{% /alert %}}
