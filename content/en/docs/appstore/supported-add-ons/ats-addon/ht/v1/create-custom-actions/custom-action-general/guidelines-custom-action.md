...
url: /appstore/supported-add-ons/ats/ht-one-guidelines-custom-action/
---

## 1 Introduction

For a details on custom actions, please see [Custom Actions](/appstore/supported-add-ons/ats/rg-one-custom-actions/) in the ATS Reference Guide 1.

These are the definitions of Mendix actions and Core actions:

* Mendix actions are a combination [Mendix actions](/appstore/supported-add-ons/ats/rg-one-mendix-actions/) and [Mendix Marketplace widget actions](/appstore/supported-add-ons/ats/rg-one-appstore-widg-acts/)
* Core actions are a combination of [ATS Core actions](/appstore/supported-add-ons/ats/rg-one-ats-core-actions/) and [Selenium actions](/appstore/supported-add-ons/ats/rg-one-selenium-actions/)
...
| Waiting for background processes | A Mendix action waits untill the Mendix app is finished rendering. This aspect is also covered by the [Mendix Wait](/appstore/supported-add-ons/ats/rg-one-mendix-wait/) action.<br> |
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v1/create-custom-actions/custom-action-general/guidelines-custom-action/mendix-action-input-parameters.png" >}}

But when you use a Core action, you have four input parameters: 

{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v1/create-custom-actions/custom-action-general/guidelines-custom-action/core-action-input-parameters.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v1/create-custom-actions/custom-action-general/guidelines-custom-action/visual-component-widget.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v1/create-custom-actions/custom-action-general/guidelines-custom-action/mx-name-in-debugger.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v1/create-custom-actions/custom-action-general/guidelines-custom-action/mendix-wait-action.png" >}}

For more information, please see [Mendix wait](/appstore/supported-add-ons/ats/rg-one-mendix-wait/).
...
When defining action parameters, always use the ATS [naming conventions](/appstore/supported-add-ons/ats/rg-one-best-practices/).
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v1/create-custom-actions/custom-action-general/guidelines-custom-action/standard-input-parameters.png" >}}

{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v1/create-custom-actions/custom-action-general/guidelines-custom-action/standard-input-parameters-2.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v1/create-custom-actions/custom-action-general/guidelines-custom-action/describe-teststeps-define-output.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v1/create-custom-actions/custom-action-general/guidelines-custom-action/datatype-web-element.png" >}}

The JavaScript actions have three different versions, based on the data types:

* [Execute Javascript Integer](/appstore/supported-add-ons/ats/rg-one-execute-javascript-integer/)
* [Execute Javascript String](/appstore/supported-add-ons/ats/rg-one-execute-javascript-string/)
* [Execute Javascript WebElement](/appstore/supported-add-ons/ats/rg-one-execute-javascript-webelement/)
