...
For details on custom actions, please see [Custom Actions](../../refguide/rg1/custom-actions) in the ATS 1 Reference Guide.
 
These are the definitions of Mendix actions and core actions:

* Mendix actions include [Mendix actions](../../refguide/rg1/mendix-actions) and [Mendix App Store widget actions](../../refguide/rg1/mendix-appstore-widgets-actions)
* Core actions include [ATS Core actions](../../refguide/rg1/ats-core-actions) and [Selenium actions](../../refguide/rg1/selenium-actions)
...
| Waiting for background processes | A Mendix action waits untill the Mendix app is finished rendering. This aspect is also covered by the [Mendix Wait](../../refguide/rg1/mendix-wait) action.<br> |
...
For more information, please see [Mendix Wait](../../refguide/rg1/mendix-wait).
...
When defining action parameter names, always use the ATS [naming conventions](../../refguide/rg1/best-practices).
...
* [Execute Javascript Integer](../../refguide/rg1/execute-javascript-integer)
* [Execute Javascript String](../../refguide/rg1/execute-javascript-string)
* [Execute Javascript WebElement](../../refguide/rg1/execute-javascript-webelement)
