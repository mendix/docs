...
The following steps present an example of you how you can interact with MendixChat.

1. Start by clicking one of the demo questions or asking your own question in the chatbox.
...
3. Press the **Ask** button (or <kbd>CTRL</kbd> + <kbd>Enter</kbd>) to send the question. You will then see the following:
    ...
    * References links and page titles
    * Feedback icons
