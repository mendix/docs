...
In React Client, Strict Mode mode will make your app more secure when the access rules are not set up correctly. For more information, see the [Strict Mode](/refguide/strict-mode/) page.
