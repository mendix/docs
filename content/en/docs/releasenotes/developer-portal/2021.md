...
* We increased the performance of opening the [My Apps page](/developerportal/#my-projects)
...
* We changed the [My Apps](/developerportal/#my-projects) page and moved your favorite apps to the **Pinned** tab. This will become the default tab on this page, making it easy to quickly access the apps you care about the most.
...
* We added a link to your app's [environments](/developerportal/deploy/environments/) in the app tile on [My Apps](/developerportal/#my-projects).
...
* We fixed several minor issues with the [My Apps](/developerportal/#my-projects) page.

### January 15, 2021

#### Improvements

* We redesigned the [My Apps](/developerportal/#my-projects) page.
