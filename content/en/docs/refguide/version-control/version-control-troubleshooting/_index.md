...
When merging 2 branches, changes sometimes don't come trough.
...
### 2.4 Getting an "The project contains changes that have not been committed yet. Please commit first before attempting to merge again. While you have not changes any files." error  - when you feel there are no uncommitted changes.  
