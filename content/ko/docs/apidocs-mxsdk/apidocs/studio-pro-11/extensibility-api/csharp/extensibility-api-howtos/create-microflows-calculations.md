---
title: "C#를 사용하여 계산용 Microflow 만들기"
linktitle: "계산용 Microflow"
...
이 How-to에서는 create microflows that perform calculations and return the result.

이 How-to의 예제는 [이 GitHub 저장소](https://github.com/mendix/ExtensionAPI-Samples)에서 다운로드할 수 있습니다.

## Microflow를 생성하는 확장 클래스 만들기
...
전체 구현을 보려면 [전체 코드](https://github.com/mendix/ExtensionAPI-Samples)를 다운로드하세요. 
