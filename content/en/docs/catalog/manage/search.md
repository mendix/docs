...
{{< figure src="/attachments/catalog/data-hub-catalog/search/search-pane.png" alt="search pane"   width="300"  >}}
...
{{< figure src="/attachments/catalog/data-hub-catalog/search/attributes-associations.png" alt="associations info" >}}
...
{{< figure src="/attachments/catalog/data-hub-catalog/search/metadata.png" alt="metadata pane"   width="300"  >}}
...
{{< figure src="/attachments/catalog/data-hub-catalog/search/download_example.png" alt="download example" >}}
