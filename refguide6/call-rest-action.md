...
Using this option, a single [Export Mapping](/refguide6/export-mappings) can be used to generate the body for the request. You can choose the export mapping to use for the request part and, if applicable, the object that you want to use as parameter for the mapping.
...
*   Import mapping for the entire response. If the response is JSON or XML it can be mapped to entities using an [Import Mapping](/refguide6/import-mappings). 
...
Here you can choose the [Import Mapping](/refguide6/import-mappings) that will be used to transform the JSON or XML into objects.
