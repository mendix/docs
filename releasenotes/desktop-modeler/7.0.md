...
Note that we also removed the deprecated parts of the API. All of the changes are documented in [Runtime API Changes](https://docs.mendix.com/apidocs/runtime-api-changes).
