...
description: "Mendix Marketplace의 Amazon Rekognition 커넥터의 구성 및 사용법을 설명합니다. Amazon Rekognition은 이미지와 동영상에서 정보와 인사이트를 추출할 수 있는 사전 학습 및 맞춤형 컴퓨터 비전(CV) 기능을 제공합니다."
weight: 20
aliases:
