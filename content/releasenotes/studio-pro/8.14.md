...
* When deleting a branch in a Branch Manager form, you will get an error saying that you cannot remove the Main line. (Tickets 108885, 109072)
	* Workaround: You can use TortoiseSVN to delete a branch. Open the Repo Browser from the context menu, navigate to "branches > (name of your branch)" folder, right-click it and choose "Delete". Enter a commit message and press OK.
