...
url: /appstore/supported-add-ons/ats/ht-two-custom-action-howto-structure/
...
The introduction also tells you what type of action the how-to explains. The how-to's are written based on the [guidelines for building a custom action](/appstore/supported-add-ons/ats/ht-two-guidelines-custom-action/).

## 3 How-to Prerequisites

All of the how-to's have the prerequisite that you must read and if necessary complete the [General](/appstore/supported-add-ons/ats/ht-two-custom-action-general/) section.
...
After creating the action structure, you must create and connect the necessary parameters to the actions. There is a naming convention that you must follow in most situations. There is a how-to for the [basics of creating a custom action](/appstore/supported-add-ons/ats/ht-two-custom-action-basics/).
