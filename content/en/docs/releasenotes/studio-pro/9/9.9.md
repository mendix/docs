...
* We added the option to perform automatic retries for tasks that are executed in a [task queue](/refguide9/task-queue/#retry). Methods were added to the Java API to perform a fixed or exponential retry.
