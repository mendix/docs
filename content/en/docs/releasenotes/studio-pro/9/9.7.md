...
We have added support for deleting objects in native mobile apps and offline-first progressive web apps. This can be done via the [Delete (\1 \1s)](/refguide9/deleting-objects/#delete-in-nano) activity in nanoflows and the [Delete (\1 \1s)](/refguide9/deleting-objects/#action) action on pages.
