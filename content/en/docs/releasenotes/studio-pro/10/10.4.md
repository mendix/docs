...
We are releasing the Beta version of our redesigned logic editors. We have enhanced the usability of the MxAssist Logic Bot, added more support for keyboard navigation, and also invested in more developer experience details to make sure the interaction with the canvas is even more fluent. For more information, see [Logic Editors Beta](/refguide/logic-editors-beta/).
