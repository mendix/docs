...
In the project explorer, an app service can be selected in the 'Add' context menu on a module. See [Select app service](/refguide5/select-app-service) for more information.

See the [Settings](/refguide5/settings) page for more information on document options.
