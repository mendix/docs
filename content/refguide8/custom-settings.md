...
| **EnableApacheCommonsLogging** | Some libraries used by the Mendix runtime use apache commons for logging. Set this value to `true` to receive the log messages from these libraries in the Mendix logs. The default, `false`, suppresses these log messages. This setting is available in Mendix 8.18.6 and later. | false |
