...
* In External Database Connector, Editor size has been increased to simplify writing larger queries, and database view is now organized by schema, helps you focus on the relevant schema, and finally autocomplete in the editor lets you select tables & views.
