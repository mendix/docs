...
* Best Practice Recommender Check – Evaluate results of the Maia Best Practice Recommender within your pipeline. You can configure this step to fail the pipeline if errors, warnings, deprecations, and/or recommendations are detected.
