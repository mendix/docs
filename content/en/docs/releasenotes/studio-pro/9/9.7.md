...
We have added support for deleting objects in native mobile apps and offline-first progressive web apps. This can be done via the [Delete object (or objects)](/refguide9/deleting-objects/#delete-in-nano) activity in nanoflows and the [Delete object (or objects)](/refguide9/deleting-objects/#action) action on pages.
