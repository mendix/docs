...
* <a id="ki-empty-caption"></a>Generating task pages for [user tasks](/refguide/workflow-elements/#user-tasks) that have outcomes with captions defined on them result in outcome buttons with empty captions on the generated page.
