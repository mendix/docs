...
### Known Issues
* Oops dialogue appears when dragging external entities which have an enum attribute into domain model. This happens only when it is consumed directly from datahub. 
