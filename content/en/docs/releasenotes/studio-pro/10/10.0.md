...
* We added an option to the `mx check` command in the [mx command-line tool](/refguide/mx-command-line-tool/#check) to output results to a JSON file.
...
* We added **Majority** and **Threshold** decision methods to workflow multi-user tasks. 
