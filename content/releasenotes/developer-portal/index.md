...
* Mendix Admins can now configure their own [single sign-on](/developerportal/deploy/mendix-sso) configuration from the [Security](/developerportal/control-center/#security) tab of Control Center. 
