...
ATS has its own [API for CICD](/appstore/supported-add-ons/ats/rg-two-cicd-api/#api). To use this, follow the steps in the **ATS and CI/CD** section of [How to Use ATS in Combination with CI/CD](/appstore/supported-add-ons/ats/ht-two-ats-and-ci-cd/#ats-and-ci-cd).
