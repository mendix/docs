...
| :-------------- | :---------------------- | :--------------- | :------------------ |
| Local Selenium Server (Docker) | ![](attachments/ht1-upload-file-using-ats/grey.png) Limited<sup>1</sup> | ![](attachments/ht1-upload-file-using-ats/green.png) Yes | ![](attachments/ht1-upload-file-using-ats/green.png) Yes |
| BrowserStack (SaaS) | ![](attachments/ht1-upload-file-using-ats/red.png) No | ![](attachments/ht1-upload-file-using-ats/green.png) Yes | ![](attachments/ht1-upload-file-using-ats/green.png) Yes |
| SauceLabs (SaaS) | ![](attachments/ht1-upload-file-using-ats/red.png) No | ![](attachments/ht1-upload-file-using-ats/red.png) No | ![](attachments/ht1-upload-file-using-ats/red.png) No |
| Selenium SaaS Agent | ![](attachments/ht1-upload-file-using-ats/grey.png) Limited<sup>2</sup> | ![](attachments/ht1-upload-file-using-ats/green.png) Yes | ![](attachments/ht1-upload-file-using-ats/red.png) No |
...
<<<<<<< HEAD:content/ats/ht1-upload-file-using-ats-1.md
...
=======
ATS has a standard action for uploading files into your Mendix app. The  [Set File Manager](/ats/refguide/rg-version-1/set-file-manager) action uploads a file from the local computer into the app using a file path. As explained earlier the file must be on the local machine for this to work.
>>>>>>> development:content/ats/howtos/ht-version-1/upload-file-using-ats-1.md

_The Set File Manager action_

![](attachments/ht1-upload-file-using-ats/set-file-manager-action.png)
...
![](attachments/ht1-upload-file-using-ats/file-uploader-widget-app.png)
