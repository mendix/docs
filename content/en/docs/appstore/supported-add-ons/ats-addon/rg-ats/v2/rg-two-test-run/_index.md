---
title: "Test Run"
url: /appstore/supported-add-ons/ats/rg-two-test-run/
---
...
Before a test is run, the **Job Configuration** page opens. For every test run, a new job is created. For details on the different options you can set for running a test, see [Job Configuration](/appstore/supported-add-ons/ats/rg-two-test-run-configuration/).
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-test-run/job-cancel.png" >}}
