...
weight: 82
#DEPRECATION NOTE IN v25: MariaDB 10.3 support to be dropped, update System Requirements directly with RN
---
...
* We will drop support for MariaDB 10.3 after July 1, 2023, as it is no longer supported by the vendor.
