...
* When you drag a parameter to the microflow editor working area, it gets a default name. This improvement speeds up the process of configuring a microflow. 
