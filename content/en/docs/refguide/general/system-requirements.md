...
* [Microsoft SQL Server](/developerportal/deploy/mendix-on-windows-microsoft-sql-server/): 2017, 2019 (please note that support for 2017 is deprecated and [will be removed in Studio Pro versions 9.20.0, 9.18.2, and 9.6.15)
...
* [IBM DB2](/refguide/db2/): 11.5 for Linux, Unix, and Windows (please note that support for DB2 is deprecated and [will be removed in Studio Pro version 10](/releasenotes/studio-pro/9.12/#deprecations))
