...
3. Choose the **Mendix Operator Version** that you would like to install. If you already have installed the Mendix Operator, your currently installed version will be highlighted.
...
4. Press the Download icon to download the installation and configuration tool. Make sure that it is stored somewhere on your path.
