...
5. Enter a name in the dialog and click **OK**. This opens the **Constant** dialog. where you can add the following properties:
    ...
    * Default value: True
    ...
    {{< figure src="/attachments/appstore/partner-solutions/ats/ht/v2/ht-two-increase-recorder-helper-coverage/add-constant.png" >}}
...
{{< figure src="/attachments/appstore/partner-solutions/ats/ht/v2/ht-two-increase-recorder-helper-coverage/changed-mx-name.png" >}}
...
{{< figure src="/attachments/appstore/partner-solutions/ats/ht/v2/ht-two-increase-recorder-helper-coverage/not-recordable-image.png" >}}
...
{{< figure src="/attachments/appstore/partner-solutions/ats/ht/v2/ht-two-increase-recorder-helper-coverage/2-mx-names.png" >}}
...
{{< figure src="/attachments/appstore/partner-solutions/ats/ht/v2/ht-two-increase-recorder-helper-coverage/no-mx-name-listview.png" >}}
...
{{< figure src="/attachments/appstore/partner-solutions/ats/ht/v2/ht-two-increase-recorder-helper-coverage/no-mx-name-listview-app-e.png" >}}

You can manually enter a class in the **Class** of Mendix Studio Pro with an mx-name to solve this:

{{< figure src="/attachments/appstore/partner-solutions/ats/ht/v2/ht-two-increase-recorder-helper-coverage/mx-name-listview.png" >}}

{{< figure src="/attachments/appstore/partner-solutions/ats/ht/v2/ht-two-increase-recorder-helper-coverage/mx-name-listview-app-e.png" >}}
...
{{< figure src="/attachments/appstore/partner-solutions/ats/ht/v2/ht-two-increase-recorder-helper-coverage/extra-class-name.png" >}}
...
{{< figure src="/attachments/appstore/partner-solutions/ats/ht/v2/ht-two-increase-recorder-helper-coverage/mx-name-in-name.png" >}}
