...
![](attachments/bp2-test-case-dependencies/amount-and-description-field.png)

This is the **TC.01 - Create New Expense** screen:

![](attachments/bp2-test-case-dependencies/random-number-and-random-string.png)
...
![](attachments/bp2-test-case-dependencies/delete-expense-by-datagrid-row.png)
...
![](attachments/bp2-test-case-dependencies/delete-expense-create-new-expense-setup-step.png)
...
![](attachments/bp2-test-case-dependencies/multiple-scenarios-create-new-expense-and-delete-expense.png)
...
![](attachments/bp2-test-case-dependencies/tc.01-create-new-expense.png)

This is TC.02 - Delete Expense:

![](attachments/bp2-test-case-dependencies/tc.02-delete-expense.png)

This is TS.01 - Create New Expense and Delete Expense:

![](attachments/bp2-test-case-dependencies/ts.01-create-new-expense-and-Delete-expense.png)
...
![](attachments/bp2-test-case-dependencies/ts.01-create-new-expense-and-Delete-expense-type-sequential.png)
