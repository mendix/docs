...
The number of possible constraints on a single query is unlimited. For more information on how to add and manipulate these constraints see [this page](/refguide5/xpath-constraints).
...
Element A of a query is optional and specifies an aggregation. Element A can be one of the following functions: [avg](/refguide5/xpath-avg), [count](/refguide5/xpath-count), [max](/refguide5/xpath-max), [min](/refguide5/xpath-min) and [sum](/refguide5/xpath-sum). With the exception of 'count', each of these functions require that a particular attribute is specified in element D.

The exception to these basic guidelines is the ID query. See [this page](/refguide5/xpath-id) for more information.

## [Tokens](/refguide5/xpath-tokens)

## [Operators](/refguide5/xpath-operators)

## Functions

The following XPath functions are available:

[XPath functions](/refguide5/xpath-query-functions):
...
[Constraint functions](/refguide5/xpath-constraint-functions):
