...
* <a id="fix-macos-context-actions"></a> We fixed an issue on macOS where context actions in the **App Explorer** and the **Edit** menu were not properly registered for the currently selected element.
