...
* Recommitting a previously failed commit (in a microflow and in the client) will work again and no longer give an error like Object of type 'MyFirstModule.MyEntity' with guid '1234' cannot be updated, as it does not exist anymore (fixes #47277)
* When setting the First day of the week setting to Default (based on locale) results now in the correct week numbers (based on the locale) (fixes #44259)
