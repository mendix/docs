...
* You can now download [Windows Service](https://marketplace.mendix.com/link/component/223425) and **Server Distribution** for the latest Studio Pro version using the **Related Downloads** button on the **Get Studio Pro** page.  
