...
You add users to ATS by inviting them to your Mendix app project. For more information on the user roles, see [Different User Roles](../general/introduction#4-different-user-roles).
{{% /alert %}}
