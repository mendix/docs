...
* [**KI**] We fixed an issue with the exporting of user [metrics](/developerportal/operate/metrics) where the user graph was empty for apps deployed to the public Mendix Cloud. 
