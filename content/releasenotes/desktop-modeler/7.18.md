...
* There is a known issue where users in an application are deleted under specific circumstances. Anonymous users have to be enabled for this to occur, and we are investigating the root cause of this issue. If you have further questions, please contact [Mendix Support](https://support.mendix.com). 
