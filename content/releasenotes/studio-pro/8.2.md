...
#ki:  = UICORE-284 (to be fixed in 8.2.1)
---
...
* Creation of a (versioned) deployment package using Studio Pro may fail when the project contains a Native navigation profile. Creation of deployment packages from th Mendix Developer Portal is not affected.
