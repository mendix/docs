...
description: "Documents the installation of Private Mendix Platform."
weight: 10
tags: ["private mendix platform",  "private platform", "mendix operator", "installation", "pclm", "svix"]
---

## 1 Introduction

This document provides a guide for installing the Private Mendix Platform. The process involves installing the Mendix Operator, the Private Cloud License Manager, and the Private Mendix Platform itself. If you plan to use webhooks, you can also install an optional Svix component.
...
## 5 Optional: Installing the Svix Component {#install-svix}
