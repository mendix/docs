...
The module comes with a default IMAPPOP3Admin module role. Access rights for this role have been set with wider use-cases in mind. Please review the access rights if they fit to your use case and security requirements before linking the module role to User Roles in App Security.
