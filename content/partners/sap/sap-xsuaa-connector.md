...
{{% alert type="info" %}}
Version 2.0.0 of the XSUAA Connector for SAP Business Technology Platform uses a new user administration module, `SapAuthentication`. If you are upgrading from a version below 2.0.0, you will need to migrate your existing users from `Administration.Account` to `SapAuthentication.SapUser` using the [user Migration](/modules/user-migration-module) module.
{{% /alert %}}
