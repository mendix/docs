...
{{< figure src="/attachments/refguide9/modeling/menus/run-menu/run-menu.png" alt="Run Menu" >}}
...
| **Edit Cloud Foundry Settings** | Opens the **Edit Cloud Foundry Settings** dialog box so you can edit your Cloud Foundry settings. For more information on this dialog box, see [Edit Cloud Foundry Settings](/refguide9/edit-cloud-foundry-settings-dialog/). | |
| **Debug** | Allows you to connect the [Debugger](/refguide9/view-menu/#debugger). | |
