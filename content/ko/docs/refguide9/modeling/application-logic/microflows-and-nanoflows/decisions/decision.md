...
자세한 내용은 the [Caption](/refguide9/microflow-element-common-properties/#caption) section in *Common Properties*.
...
자세한 내용은 the [Error Handling Type](/refguide9/microflow-element-common-properties/#error-handling) section in *Common Properties*.
