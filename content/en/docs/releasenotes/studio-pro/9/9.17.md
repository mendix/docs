...
* You now can define Java action parameters as optional instead of required. Optional parameters can be left empty when using your Java action in a microflow. For Example, this could come in handy when you'd like to build a Java action to send messages where the 'To' field is required, but the 'Cc' field can be left empty.
...
* Microflow parameters are now automatically named when you drag them onto the working area.
