...
Firstly, you may be working as a team to create the app. You will want to control who is on the team and what each member can do. This is managed in [Projects](https://projects.home.mendix.com/). For more information, see [Building an App as a Team](#team) section below. 
...
If you want to invite your colleagues to build your app, you can manage the **Team** in [Projects](https://projects.home.mendix.com/). Only team members who are invited to your app can access it (as a project to collaborate on). You can assign app roles to them. These team member roles define what they can access and change in the app in the backend while developing the app and are different from end-user roles which define what users can access in a running app. For more information, see [Team](/developerportal/general/team/) in the **Projects** documentation.

## The Security Overview

The [Security Overview](/refguide10/security-overview/) provides you with an overview of your app's security. To access the overview, open the **App** menu, and then click **Show Security Overview**. 
