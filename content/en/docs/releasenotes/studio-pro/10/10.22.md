...
* We optimized the History dialog to load significantly faster for full and partial clones, and increased the batch size in the History panel from 25 to 250. The batch size remains 25 when viewing the history for a single document.
