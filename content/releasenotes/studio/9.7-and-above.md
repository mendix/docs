...
* We improved error messages that might appear on the [Buzz](collaboration-buzz) tab by making them clearer.
* We added a descriptive name for the **Send External Object** activity that can be added in Studio Pro. It takes the variable name of the updatable [external entity](/studio/data-hub-in-studio) that should be sent.  

### Fixes

* We fixed an issue where the top menu bar was not shown in **Roles & Permissions** and **Widget Overview** screens.
