...
* **Summarize**: Click this button to get a key-points summary of the discussion, generated by the AI-powered summarize assist. This feature makes it easier for you to find solutions to your questions without having to read through every answer in the thread.
...
5. To use the AI-powered rewrite assist to help you with your writing, click **Rewrite**. The rewrite assist is an assisted writing aid integrated within the Mendix Community posting interface, which helps you to ask properly-formatted questions that are more likely to be answered!
