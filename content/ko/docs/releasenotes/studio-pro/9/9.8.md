...
description: "새로운 기능, 버그 수정 및 알려진 문제에 대한 세부 사항이 포함된 Mendix Studio Pro 9.8 (모든 패치 포함)의 릴리스 노트입니다."
weight: 92
---
...
* We fixed an issue where the [Atlas UI Resources](https://marketplace.mendix.com/link/component/104730) module could not be imported from the Marketplace.
