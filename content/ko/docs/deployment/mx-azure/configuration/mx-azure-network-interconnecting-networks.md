---
title: "Mendix on Azure와 다른 프라이빗 네트워크 간 연결 활성화"
url: /developerportal/deploy/mendix-on-azure/configuration/interconnecting-networks
description: "Mendix on Azure를 프라이빗 네트워크와 상호 연결하는 방법을 설명합니다."
weight: 10
---
## 소개
...
### 해결 방법 1: Azure Virtual Network Peering {#network-peering}
...
### 해결 방법 2: PrivateLink with Private Endpoints
