...
{{% alert color="info" %}}For more information on this release, see the [Mendix Release 9.24 – What a Ride It Has Been](mendix-release-9-24-what-a-ride-it-has-been/) blog post.{{% /alert %}}
