...
To publish your app in an app store, we recommend building native iOS apps instead. For more information, see [Building Native Apps](/refguide/mobile/distributing-mobile-apps/building-native-apps/).
{{% /alert %}}
