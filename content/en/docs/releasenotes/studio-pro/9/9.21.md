...
* Collaborating with Mendix Studio is no longer possible for Mendix 9.21 and above. To upgrade an older app where collaboration is still enabled you have to first disable collaboration.
