...
| InviterEmailAddress | String | Yes | Email address of the inviter of the new user. Based on this address, the Mendix platform will include the name of this user in the invitation mail the invitee will receive. |
