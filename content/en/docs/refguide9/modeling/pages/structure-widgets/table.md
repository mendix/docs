...
{{< figure src="/attachments/refguide9/modeling/pages/structure-widgets/table/table.png" class="no-border" >}}
...
{{< figure src="/attachments/refguide9/modeling/pages/structure-widgets/table/merge-icons.png" alt="Merge Icons" class="no-border" >}}

## Properties

An example of table properties is represented in the image below:

{{< figure src="/attachments/refguide9/modeling/pages/structure-widgets/table/table-properties.png" alt="Table Properties"   width="250"  class="no-border" >}}
...
{{< figure src="/attachments/refguide9/modeling/pages/structure-widgets/table/width-unit-and-column-widths.png" alt="Width Unit and Column Widths" class="no-border" >}}
