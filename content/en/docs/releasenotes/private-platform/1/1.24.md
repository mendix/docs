...
* Studio Pro 10.24 LTS latest patch version updated to [10.24.24](/releasenotes/studio-pro/10.24/#102424)

##### Other Platform Components

* Mendix on Kubernetes Operator version [v.2.26.1](/releasenotes/developer-portal/mendix-for-private-cloud/#2.26.1)
* Private Cloud License Manager (PCLM) version [0.11.1](/releasenotes/developer-portal/mendix-for-private-cloud/#0.11.1)

#### Fixes

We have provided the following fixes:

* (General) We have fixed an issue that occurred when using Azure DevOps as the version control system, where trying to create a new app with a name identical to an existing one would fail without showing an error message to the user.
...
* Studio Pro 10.24 LTS latest patch version updated to [10.24.20](/releasenotes/studio-pro/10.24/#102420)
...
* (General) We have resolved an issue where notifications could not be opened from the **Notifications** bar.
* (General) We have fixed an issue where the **Azure DevOps** tile would disappear from the **Service Credentials** tab of the user profile.
* (Installation) We have removed the **Maia** option from the installer, since [Maia](/private-mendix-platform/maia/) is not supported for Private Mendix Platform 1.24.
...
The upgrade process now checks the number of replicas before proceeding. For more information, see [Upgrading the Private Mendix Platform](/private-mendix-platform/upgrade/).
...
This issue is currently being addressed and will be resolved in a future release. In urgent cases, please reach out to your Technical Account Manager, Specialized Account Executive, Partner Contact or Mendix Support to request a temporary license.
