...
weight: 20
description: "Mendix Cloud 내에서 애플리케이션을 제공할 때 고려해야 할 일반적인 측면을 설명합니다."
aliases:
...
## 서비스에 인증 적용{#service-authentication}
...
## 업로드된 파일의 악성 콘텐츠 검사 {#scanning-for-malicious-content}
