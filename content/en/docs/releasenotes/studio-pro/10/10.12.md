...
- We fixed an issue when an error dialog was displayed after opening an app in the Developer Portal when the user was signed in and there was no Internet connection.
