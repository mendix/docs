...
Some modules are part of your app by default, while others you can download in the [Mendix Marketplace](https://marketplace.mendix.com/) to add functionality to app. If a module from the Marketplace has an IP-protection enabled, it is an [add-on module](add-on-module). For more information on downloading and installing a module from the Marketplace, see [Use Marketplace Content in Studio Pro](/appstore/general/app-store-content) in the *Marketplace Guide*. 
