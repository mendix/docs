...
#KI: 1515 fixed in 9.13.0 and due to be fixed in 9.12.2, add link to 9.12.2 fix note to 9.12.0 and 9.12.1 KIs
---
...
* Scheduled events are not triggered on horizontally-scaled environments.
	* Fixed: Redeploy your app with the [buildpack](/refguide/runtime-deployment/) release of [4.27.4](https://github.com/mendix/cf-mendix-buildpack/releases/tag/v4.27.4), which fixes this issue.
>>>>>>> development
* An error occurs when you import translations from an Excel file for batch translate or batch replace operations.
	* Fixed in [9.13.0](/releasenotes/studio-pro/9.13/#1515).
