...
* An app can now publish a REST service on URL prefix `ws/` or `odata/`, provided that it has no published web services
  or published OData services, respectively.
...
* We have fixed an issue with sync to device microflow action (Ticket #196961)
