...
Native Mobile iOS Apps built against Studio Pro 8.6.3 should not trigger the following Apple error message when released to the Apple App Store: "ITMS-90809: Deprecated API Usage - Apple will stop accepting submissions of new apps that use UIWebView APIs starting from April 2020".
