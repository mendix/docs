...
The Make It Native app allows developers to preview, test, and debug native mobile apps in conjunction with Mendix Studio Pro. Use the **Make It Native 9** app for Studio Pro [9.24](/releasenotes/studio-pro/9.24/#improvements).
