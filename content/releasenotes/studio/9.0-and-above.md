...
* The microflow editor has a new expression editor now (the same as the workflow editor). The new expression editor is enhanced with more functions, mathematical and logical operations, which allow you to write more complex conditions for your microflows. 
