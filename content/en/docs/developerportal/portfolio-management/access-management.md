...
* **Approve** – Clicking this approves the request and gives the user access to the portfolio. You can assign the user an access role different from the one they requested.
