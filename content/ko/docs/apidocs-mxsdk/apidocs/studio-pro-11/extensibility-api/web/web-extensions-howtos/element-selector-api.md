---
title: "Element Selector API 사용하기"
...
이 How-to에서는 use the Element Selector API to allow users to select documents or entities from their Mendix application. The extension displays selection dialogs that filter results based on query parameters such as module name, document name, and SDK name.
