---
title: "UX 디자인 모범 사례 구현"
linktitle: "UX 디자인 모범 사례"
url: /howto/front-end/ux-best-practices/
weight: 10
description: "앱 개발 프로세스에 기여하기 위해 UX 디자이너가 작성한 모범 사례를 설명합니다."
aliases:
...
{{< figure src="/attachments/howto/front-end/ux-best-practices/single-screen.png" class="no-border" >}}
...
{{< figure src="/attachments/howto/front-end/ux-best-practices/drop-down.png" class="no-border" >}}
...
{{< figure src="/attachments/howto/front-end/ux-best-practices/where-am-i.png" class="no-border" >}}

### 집중하지 못하는 사용자를 위한 디자인
...
{{< figure src="/attachments/howto/front-end/ux-best-practices/long-lines.png" class="no-border" >}}
...
{{< figure src="/attachments/howto/front-end/ux-best-practices/pop-up.png" class="no-border" >}}

### 팝업 창이 너무 많아지지 않도록 하세요
...
{{< figure src="/attachments/howto/front-end/ux-best-practices/cards.png" class="no-border" >}}
...
{{< figure src="/attachments/howto/front-end/ux-best-practices/forms.png" class="no-border" >}}
...
{{< figure src="/attachments/howto/front-end/ux-best-practices/buttons.png" class="no-border" >}}
