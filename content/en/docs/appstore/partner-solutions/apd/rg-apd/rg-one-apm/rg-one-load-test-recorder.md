...
url: /appstore/modules/apd/rg-one-load-test-recorder/
---
...
{{< figure src="/attachments/appstore/modules/apd/rg-apd/rg-one-apm/rg-one-load-test-recorder/Control.png" >}}
...
{{< figure src="/attachments/appstore/modules/apd/rg-apd/rg-one-apm/rg-one-load-test-recorder/Options.png" >}}
...
{{< figure src="/attachments/appstore/modules/apd/rg-apd/rg-one-apm/rg-one-load-test-recorder/Overview.png" >}}
