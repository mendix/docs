...
This document explains how to integrate the prompt engineering capabilities of the [Agent Commons](/agents/agents-kit-2/reference-guide/agent-commons/) module into your app.
...
For more technical details, refer to [Agent Commons](/agents/agents-kit-2/reference-guide/agent-commons/).
