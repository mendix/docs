...
1. Go to the [Developer Portal](https://home.mendix.com). Sign in if necessary.
...
1. Make sure **Full Snapshot** is selected and click **Start** to prepare the download.
1. Click **Download** when the snapshot is ready.
...
The final step is to restore your data. This must be done after you've deployed your app because this ensures that a database has been provisioned ready to accept your data.
