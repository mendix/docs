...
* The old process of syncing Studio and Studio Pro called **Sync with Studio** is no longer available and has been entirely replaced by the collaborative development that allows you to easily synchronize changes. 
...
* For **App from a spreadsheet**, if importing your file fails, you can retry importing the file or another one without having to create another app. 
