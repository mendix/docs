...
For step-by-step instructions and an example API call, see the [Search Using the API](/catalog/manage/search/#search-api) section of *How to Search in the Catalog*. 
