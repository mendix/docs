...
For serving content to the web view and communicating both ways with it, see the comprehensive tutorial with a sample [todo app](/extensions-api/todo-extension/).
