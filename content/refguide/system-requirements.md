...
Mendix [Studio Pro](modeling) version 9 is supported on 64-bit versions of Windows 10 release 1803 and above. Studio Pro does not run on Windows emulators on M1 Macs or on any other ARM-based machines.
