...
* We added a new action to click an x-y coordinate within the browser window or a certain UI element. For more details, see [Click Coordinates](/addons/ats/rg1-click-coordinates) in the ATS Reference Guide 1.
...
The [Action Reference Guide](/addons/ats/rg1-standard-actions-reference) lists the new actions.
...
We've also documented all our actions in a [Reference Guide](/addons/ats/rg1-standard-actions-reference). It describes all the actions that you can use in your test cases. In addition to that, it also references the internal actions that are very helpful if you want to create your own actions.
