...
| Input | Output | 
| --- | --- | 
| `UserPrompt`, `SystemPrompt`, `Configuration`, `Model`, `ENUM_ResponseFormat_Chat` | `AssistantResponseText` | 
...
| Input | Output | 
| --- | --- | 
| `ChatCompletionsSession`, `Configuration`, `Model`, `ENUM_ResponseFormat_Chat` | `AssistantResponseText` | 
...
| Input | Output | 
| --- | --- | 
| `OutputImage`, `Prompt`, `Configuration`, `Model`, `ENUM_Size`, `UserString`, `ENUM_Quality`, `ENUM_Style`, `ENUM_ResponseFormat_Image` | `IsSuccess` | 
