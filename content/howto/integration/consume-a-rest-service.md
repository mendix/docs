...
{{% alert type="info" %}}
For Studio Pro v 8.15 and above, the **Call REST** dialog box has changed to what is shown in the video. You have to ensure that for  **Output** you select **Yes** for **Store in variable** and then specify the **Variable name**.
{{% /alert %}}
