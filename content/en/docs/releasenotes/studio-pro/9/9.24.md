...
* We fixed an issue in the grid control where selecting multiple cells using <kbd>Shift</kbd> was inconsistent (when clicking on the interactable control itself in the cell, i.e. CheckBox).
