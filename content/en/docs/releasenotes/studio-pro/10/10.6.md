...
We are releasing the beta of version of the Consumed REST service. This new feature allows developers to integrate with REST services faster. You can now build your REST requests, test them directly, and convert their response to entities without building any of the mappings manually. For more information, see [Consumed REST Service (Beta)](/refguide/consumed-rest-services-beta/).
...
* Follow these 2 links to find out more about [extending design properties](/howto/front-end/extend-design-properties/) and [the design properties API](/apidocs-mxsdk/apidocs/design-properties/).
