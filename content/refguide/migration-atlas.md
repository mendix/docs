...
2. Import this module into your app and replace the old resource module. This will overwrite the layouts, page templates, and building blocks inside of the resource module. The **theme** folder related to your old resource module will be moved to **theme_old**. You will get a new **theme** folder with the latest changes. <br />
	a. If you didn’t change anything in the old **theme** folder, you can safely remove **theme_old** and leave everything else as it is. Your styling will work and you can stop with this how to. <br />
	b. If you did change anything in the old **theme** folder, you’ll have to do some manual work. Consult the information below to decide what to do based on your needs.
...
If you have altered the CSS in your HTML files, consult the bullets below. If you have not, you may ignore this subsection.
...
If you changed Design Properties for Web in **settings.json**, you must manually integrate your old **settings.json** into the new folder [todo: check this wording]
...
**todo: make sure file pathways are clear, esp appreviated ones**

If you changed anything in the **styles/sass/lib** folder, take the following actions based on your specific change:
...
* If you removed a file, no action is requred
