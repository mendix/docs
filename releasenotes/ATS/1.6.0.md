...
Check the documentation on how to [create/maintain test data](/addons/ATS/data-management#test-data) and [use it within a test case](/addons/ATS/data-driven-tests).
