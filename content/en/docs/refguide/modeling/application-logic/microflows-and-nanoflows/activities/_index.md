...
| {{< figure src="/attachments/refguide/modeling/application-logic/microflows-and-nanoflows/activities/send-rest-request.png" alt="send rest request" link="/refguide/consumed-rest-services-beta/" max-width=100% >}} | [Send REST Request (beta)](/refguide/send-rest-request/) | Can be used to send a REST request, which is configured in a [Consumed REST Service (beta)](/refguide/consumed-rest-services-beta/) document.|
