...
* We changed the home page of the Developer Portal to [My Apps](/developerportal/#my-projects).
...
* We removed the list appearance of the [My Company's Apps](/developerportal/#my-company-projects) page.
...
* We fixed a bug where the star icon ({{% icon name="star" %}}) on your [favorite apps](/developerportal/#my-projects) was not displayed properly.
...
* We fixed an issue where [favorited apps](/developerportal/#my-projects) still showed up in the favorites view on the [My Apps](/developerportal/#my-projects) page after being deleted.
