...
* Understand [How to Create a Custom Action](ht2-custom-action-general)
...
3.  Click the **Actions** drop-down menu and then click **New Action**:
    ...
    ![](attachments/ht2-mask-your-password/create_new_action.png)
...
6.  Click **Create**:
    ...
    ![](attachments/ht2-mask-your-password/create-new-action-dialog-c.png)

    This opens the **Action Details** page. ATS displays the **Name** and **Description** on this page.

    ![](attachments/ht2-mask-your-password/action_details-page.png)
...
10. Enter a description of the test step:
    ...
    ![](attachments/ht2-mask-your-password/description_added.png)

11. Click the **Settings** tab.
12. Add a new input parameter by clicking **New** below **Input Parameters**:

    ![](attachments/ht2-mask-your-password/add_input_parameter.png)

    Clicking **New** opens the **Edit Input Parameter** dialog box:

    ![](attachments/ht2-mask-your-password/edit_input_paremeter.png)
...
15. Click **Save**:
    ...
    ![](attachments/ht2-mask-your-password/Username_input_parameter_edit.png)
...
3.  Click the drop-down menu next to the **Password** input parameter. Clicking the drop-down opens the input field:
    ...
    ![](attachments/ht2-mask-your-password/input_field_password.png)

4. Enter the password in the **Password** field.
5.  Select the **Constant value**:

    ![](attachments/ht2-mask-your-password/password_entered.png)
...
![](attachments/ht2-mask-your-password/unmasked_password.png)

You can now unmask your password using ATS. You can use these steps as well to mask data in ATS.

## 4 Next Up

You have now learned how to unmask your password in a login action. The next how-to to complete is [How to Upload a File in Your App Using ATS](ht2-upload-file-using-ats). You can find an overview of all the how-tos and the structure on [ATS 2 How-to's](ht2). We advise you to follow the predefined structure.
