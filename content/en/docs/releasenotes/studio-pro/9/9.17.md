...
* <a name="ki-2661"></a>When you navigate between dockable panes using <kbd>Ctrl</kbd> + <kbd>Tab</kbd> and  you are in the microflow editor, the page editor, or the **Properties** pane, releasing the <kbd>Ctrl</kbd> key does not close the pane selection dialog.
  The workaround is to use <kbd>Enter</kbd> or a mouse click. (Ticket 163193)
