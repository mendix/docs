---
title: "Configuration"
url: /appstore/supported-add-ons/ats/rg-one-configuration/
---
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v1/rg-one-configuration/21168209.png" alt="Configuration Page Project" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v1/rg-one-configuration/21168210.png" alt="Configuration Selenium Tab" >}}

To add a new Selenium hub, click the **New** in the top bar:

{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v1/rg-one-configuration/21168211.png" alt="Edit Selenium hub dialog" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v1/rg-one-configuration/21168212.png" alt="Configuration Applications tab" >}}

You can edit, create, and delete applications by pressing the buttons in the top bar:

{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v1/rg-one-configuration/21168213.png" alt="New Application Dialog" >}}
