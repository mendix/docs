...
* You can now trigger nanoflows from custom widgets as well. For more information, see [How to Use XML in Widget Development](/howto/widget-development/use-xml-widget) and [Namespace: data](https://apidocs.mendix.com/7/client/mx.data.html#.callNanoflow) in the Client API.
