...
|         | Set task outcome | Sets which outcome the [user task](user-task) should follow. This activity can be used to add custom validations and complete the user task upon them. |
