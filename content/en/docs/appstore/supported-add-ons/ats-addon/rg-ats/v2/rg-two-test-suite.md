---
title: "Test Suite"
url: /appstore/supported-add-ons/ats/rg-two-test-suite/
---
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-test-suite/testsuite-details.png" alt="Edit Test Suite" >}}
...
| Run                    | The [run configuration page](/appstore/supported-add-ons/ats/rg-two-test-run/) opens, where you edit the run configuration. If the test suite was run before, the prior configuration is copied. |
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-test-suite/search-testcase-testsuite.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-test-suite/dialog-testcase-testsuite.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-test-suite/delete-2.png" >}}
