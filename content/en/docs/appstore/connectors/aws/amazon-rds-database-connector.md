...
2. Optional: If you want to limit access to the database to specific apps, do the following steps:
    ...
    6. Select the IP address of your Mendix app as the source. If your app is hosted on Mendix Cloud, see [Mendix IP Addresses: Outgoing IP](/developerportal/deploy/mendix-ip-addresses/#22-outgoing-ip/) for a list of addresses to whitelist.
