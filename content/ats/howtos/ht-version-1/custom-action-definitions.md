...
The focus is on finding an element that you can use to find the widget. The [find/assert widget](/ats/ats/refguide-ats-1/findassert-widget) action is a great example for a search context action.
