...
* Trying to change a member in the Change Object activity properties results in an error: "Please select an object first".
  * Workaround: A workaround is available to change the members of an object. After selecting an object, press the OK button **before** trying to change any members. Reopen the properties dialog and now you will be able to edit the members of the obect.
