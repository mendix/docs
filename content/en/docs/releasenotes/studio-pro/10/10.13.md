...
{{% alert color="info" %}}For the highlights of this release, see the [Mendix Release 10.13](https://www.mendix.com/blog/mendix-release-10-13-maia-generate-a-domain-model-for-me/) blog post.{{% /alert %}}
