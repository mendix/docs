...
{{< figure src="/attachments/howto9/security/best-practices-security/mendix-runtime-architecture.png" alt="Mendix Runtime Architecture"   width="500"  >}}
...
{{< figure src="/attachments/howto9/security/best-practices-security/default-access-restrictions.png" alt="Mendix Cloud Access Restrictions Overview" >}}
...
* Check available modules in the [Mendix Marketplace](https://marketplace.mendix.com/). For more information on how to use the Mendix Marketplace content, see [How to Use Marketplace Content in Studio Pro](/appstore/overview/app-store-content/).
