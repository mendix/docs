...
Set the `EncryptionPrefix` constant located in the **Private - String en/de-cryption** folder. If you are using version 1.4.1 or above of this module, the value of this constant should be set to `{AES2}`. If you are using version 2.2.0 or above set the constant to `{AES3}`.
