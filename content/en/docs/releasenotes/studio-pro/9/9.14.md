...
{{% alert color="warning" %}}We have identified a regression that occurs when adding associations to a specialization of **System.User**. We have added a [known issue](#ki) below.{{% /alert %}}
