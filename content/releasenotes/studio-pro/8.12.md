...
* The [built-in database viewer](/howto/collaboration-requirements-management/sharing-the-development-database#db-viewer) now uses a free TCP port instead of a fixed one to avoid conflicts.
