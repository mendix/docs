...
* Sometimes when a data view was used as a direct child of a list view, template grid or tab page it got a fixed height set in the client. (Ticket 106282, 109153)
* When opening a layout which is not a popup and the first child in a placeholder is a data view, this dataview was sometimes not properly resized. (Ticket 107633)
