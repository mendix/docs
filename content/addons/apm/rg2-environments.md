...
After selecting an app from the [Apps overview](rg2-apps), an overview of available environments for that app is displayed. It is possible to select an existing environment or add a new environment.

![](attachments/rg2/environments.png)

When selecting an existing environment, the [Dashboard](rg2-dashboard) of that environment will be shown.
...
![](attachments/rg2/new_environment.png)
