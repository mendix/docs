...
In keeping with our commitment to delivering the best maker experience possible, we are excited to introduce our new web client. This client is built entirely using React.js, a modern JavaScript library known for its efficiency and flexibility. The React client is available as a public beta and will be generally available in Mendix 10.12. For more information on what a beta release is, see [Beta and Preview releases](/releasenotes/beta-features/).
