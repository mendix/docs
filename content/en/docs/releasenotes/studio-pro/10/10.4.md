...
* We made the [Data Grid 2](/appstore/modules/data-grid-2/) configuration easier by adding the ability to automatically fill the contents, create columns with filters, and create buttons for the selected entity.
