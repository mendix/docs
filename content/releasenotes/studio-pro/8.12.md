...
* The builtin database viewer now uses a free TCP port instead of a fixed one to avoid conflicts.

### Fixes

* We fixed the initial center position of dialogs (Tickets #105797 and #109459)
