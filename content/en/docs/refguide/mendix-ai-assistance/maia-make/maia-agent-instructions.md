...
aliases:
  - /refguide/maia-instructions/
weight: 95
description: "Describes how to create and manage agent instructions (AGENTS.md) to steer agent behavior at the project or module level."
...
To use Agent Instructions, an internet connection and signing in to Studio Pro are required.
{{% /alert %}}
...
## Creating a New Agent Instruction {#creating-instructions}

To create a new agent instruction, follow these steps:
...
Agent Instructions are arbitrary Markdown files that follow the AGENTS.md standard. You can structure them any way you like.
