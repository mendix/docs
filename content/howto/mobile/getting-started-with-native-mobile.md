...
To view your app on a iOS device, you must download and install the Make It Native app (select correct version 8 or 9) from the [Apple App Store](https://apps.apple.com/us/app/make-it-native/id1334081181):
