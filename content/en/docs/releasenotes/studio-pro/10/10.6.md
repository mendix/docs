...
* We have implemented a new text editor that is enabled by default (with the option in **Preferences** > [New Features](/refguide/preferences-dialog/#new-features) to go back to the legacy text editor). This new text editor will also work on MacOS. [**TW**]
