...
{{< figure src="/attachments/howto7/front-end/ux-best-practices/single-screen.png" class="no-border" >}}
...
{{< figure src="/attachments/howto7/front-end/ux-best-practices/drop-down.png" class="no-border" >}}
...
{{< figure src="/attachments/howto7/front-end/ux-best-practices/where-am-i.png" class="no-border" >}}
...
{{< figure src="/attachments/howto7/front-end/ux-best-practices/long-lines.png" class="no-border" >}}
...
{{< figure src="/attachments/howto7/front-end/ux-best-practices/pop-up.png" class="no-border" >}}
...
{{< figure src="/attachments/howto7/front-end/ux-best-practices/cards.png" class="no-border" >}}
...
{{< figure src="/attachments/howto7/front-end/ux-best-practices/forms.png" class="no-border" >}}
...
{{< figure src="/attachments/howto7/front-end/ux-best-practices/buttons.png" class="no-border" >}}
