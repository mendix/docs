...
url: /howto10/front-end/ux-best-practices/
weight: 10
description: "앱 개발 프로세스에 기여하기 위한 UX 디자이너의 모범 사례를 설명합니다."
aliases:
...
{{< figure src="/attachments/howto10/front-end/ux-best-practices/single-screen.png" class="no-border" >}}
...
{{< figure src="/attachments/howto10/front-end/ux-best-practices/drop-down.png" class="no-border" >}}
...
{{< figure src="/attachments/howto10/front-end/ux-best-practices/where-am-i.png" class="no-border" >}}
...
{{< figure src="/attachments/howto10/front-end/ux-best-practices/long-lines.png" class="no-border" >}}
...
{{< figure src="/attachments/howto10/front-end/ux-best-practices/pop-up.png" class="no-border" >}}
...
{{< figure src="/attachments/howto10/front-end/ux-best-practices/cards.png" class="no-border" >}}
...
{{< figure src="/attachments/howto10/front-end/ux-best-practices/forms.png" class="no-border" >}}
...
{{< figure src="/attachments/howto10/front-end/ux-best-practices/buttons.png" class="no-border" >}}
