...
We also made the **Delete** action configurable. You can now specify which objects you want to delete, which can be an available selection, any surrounding data view, or a page or snippet parameter. For more information, see the [Delete (\1 \1s)](/refguide/on-click-event/#delete-objects) section in *On Click Event and Events Section*.
