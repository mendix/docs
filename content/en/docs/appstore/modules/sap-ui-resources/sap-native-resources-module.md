...
Follow the instructions in [How to Use Marketplace Content](/appstore/overview/use-content/) to import the SAP Horizon Native UI Resources module into your app.
