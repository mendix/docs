...
For examples of delete behavior configuring, see section [6 Delete Behavior](../../howto/data-models/create-a-basic-data-layer#6-delete-behavior) in *How to Create a Basic Data Layer* in *Data Models* category.
