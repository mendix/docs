...
{{% alert color="info" %}}For the highlights of this release, see the [Mendix Release 10.9](https://www.mendix.com/blog/mendix-release-10-9-see-whats-inside/) blog post.{{% /alert %}}
