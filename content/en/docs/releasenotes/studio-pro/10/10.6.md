...
# KI: "When calling mxbuild": RUN-3843
---
...
* When calling mxbuild with the "--generate-sbom" flag together with an app that has managed dependencies you may get the "Unsupported specification version: 1.5" error.
