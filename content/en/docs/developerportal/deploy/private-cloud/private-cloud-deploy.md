...
Please make sure that the password set in the portal is in accordance to the password requirements set in Studio Pro. Also for the security purpose, portal expects a minimum of 8 characters, minimal 1 symbol, minimal 1 capital and minimal 1 number.
