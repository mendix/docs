...
{{% alert color="warning" %}}
If you are using Studio Pro on a Mac device with Parallels, see [this update](https://kb.parallels.com/112091#section7) for improving the loading time of Marketplace in Studio Pro.{{% /alert %}}
