---
title: "Get Started"
url: /appstore/supported-add-ons/ats/ht-two-getting-started/
...
You add users to ATS by inviting them to your Mendix app. For more information on the user roles, see [Different User Roles](/appstore/supported-add-ons/ats/ov-introduction/#roles).
{{% /alert %}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-getting-started/my-apps-page.png" >}}

1. Open your app inside ATS. This opens the **Dashboard** page.

    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-getting-started/dashboard-page.png" >}}

2. Open the profile menu and click **Show Test Settings**.

    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-getting-started/show-test-settings.png" >}}

You are now on the **Settings** page. Here you add environments and selenium hubs.

{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-getting-started/settings-page.png" >}}
...
1. Click **New** under **Environments**, which opens the **Environment** dialog box.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-getting-started/new-environment.png" >}}
...
3. Click **Save** to save the settings.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-getting-started/add-environment.png" >}}
...
1. Click **New Selenium Hub** under **Selenium hubs**.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-getting-started/new-selenium-hub.png" >}}
...
4. Click **Save** to save the settings.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-getting-started/browserstack-selenium-hub-wizard.png" >}}

For further documentation on how-to install the ATS Helper and the Recorder see [How-to configure a Selenium hub](/appstore/supported-add-ons/ats/ht-two-configure-a-selenium-hub/).

## 4 Test Cases

The **Test Cases** menu is where you access the repositoy, test data and user stories.

{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-getting-started/test-cases-menu.png" >}}
...
1. On the **Repository** tab, click **Actions** and click **New Test Case** in the drop-down. This opens the **Create new** dialog box.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-getting-started/actions-new-test-case.png" >}}
...
4. Click **Create**.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-getting-started/create-new-test-case.png" >}}
...
5. When the **Test Case Details** page opens, you are now in the actual test case. In the top left corner of the page, you see the name and description of your test case. The **Test Case Details** page also displays the following buttons:
    ...
    * **Export** – exports the test case as a XML file (this file can be uploaded into another ATS environment) or exports a PDF report or your test case
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-getting-started/test-case-details-page.png" >}}
...
4. Install the ATS Recorder extension in your Chrome browser.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-getting-started/information-dialog.png" >}}

For further documentation on how-to install the ATS Helper and the Recorder see [How-to install the ATS Helper and Recorder](/appstore/supported-add-ons/ats/ht-two-install-ats-helper-recorder/).
...
1. Click **Record step** while inside a test case in ATS, which opens the **Recording Session** page. On this page you can manage your recording session.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-getting-started/click-record.png" >}}
...
3. Click **Save** to save your test steps.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-getting-started/recording-session.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-getting-started/test-data-tab.png" >}}
...
For further documentation on how-to create a datadriven test case see [How-to create a datadriven test case](/appstore/supported-add-ons/ats/ht-two-create-datadriven-test-case/).
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-getting-started/show-usages-tab.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-getting-started/stories-tab.png" >}}

For further documentation on how-to link stories to test cases see [How-to link Test Cases/Test Suites to User Stories](/appstore/supported-add-ons/ats/ht-two-connect-stories-to-testcases/).
...
1. On the **Repository** tab, click **Actions** and click **New Test Suite** in the drop-down. This opens the **Create new** dialog box.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-getting-started/actions-new-test-suite.png" >}}
...
4. Click **Create**.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-getting-started/create-new-test-suite.png" >}}
...
5. The **Test Suite** page looks similar to the **Test Case** page, but with fewer options. The **Test Suite** page also displays the following buttons:
    ...
    * **Export** – exports the test suite as a XML file (this file can be uploaded into another ATS environment).
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-getting-started/test-suite-details-page.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-getting-started/add-test-case.png" >}}

For further documentation on how-to create a test suite see [How-to create a test suite](/appstore/supported-add-ons/ats/ht-two-create-a-test-suite/).
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-getting-started/show-usages-tab-test-suite.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-getting-started/stories-tab-test-suite.png" >}}

For further documentation on how-to link stories to test suites see [How-to link Test Cases/Test Suites to User Stories](/appstore/supported-add-ons/ats/ht-two-connect-stories-to-testcases/).

## 5 Run Configuration

When you click **Run** in the upper-right corner of your test case/suite, the **Job Configuration** page will open.

{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-getting-started/job-configuration.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-getting-started/test-runs-page.png" >}}

Once your test case/suite is run, the result is shown here.

You have now finished the getting started guide for ATS. We advice to read next [How-to Install the ATS Helper and Recorder](/appstore/supported-add-ons/ats/ht-two-install-ats-helper-recorder/).

Good luck testing your Mendix app with ATS!

## 7 Next Up

You now learned a few basics of working with ATS. The next how-to is [How to Install the ATS Helper and ATS Recorder](/appstore/supported-add-ons/ats/ht-two-install-ats-helper-recorder/). You find an overview of all the how-tos and the structure on the [ATS 2 How-tos](/appstore/supported-add-ons/ats/ht-two/) page. We advise you to follow the predefined structure.
