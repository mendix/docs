...
* We improved the process of publishing your app and made it more smooth and reliable. To share your live app with others, you only need to click the **Publish** button in a new **Publish your app** dialog box:

    ![Publish App](attachments/8.7/publish-app.jpg)
    
    When your app is being published, all changes of your app are committed in the [Team Server](/refguide/version-control#team-server) and a new version of your app is created. Afterwards you can view and share your app. You can view it in the browser clicking the link or view it on mobile by simply scanning the QR code:
    ...
    The new Studio publish process was brought in line with the Mendix Studio Pro publishing process. Now every Studio publish is based on a specific commit in the Team Server. This provides the development team full insight in what changes have been published to the live app and by whom.
#### Fixes
