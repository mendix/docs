...
When you are deploying your application to a server or the Mendix cloud you will have to configure settings below there. See the [Deployment](/developerportal/deploy/mendix-cloud-deploy) guide for more information.
...
<table><thead><tr><th class="confluenceTh">Value</th><th class="confluenceTh">Description</th></tr></thead><tbody><tr><td class="confluenceTd">Default</td><td class="confluenceTd">Use the default heap memory size of the installed Java virtual machine.</td></tr><tr><td class="confluenceTd">Custom</td><td class="confluenceTd">Use the value of the 'Maximum size (in MB)' setting.</td></tr></tbody></table>
