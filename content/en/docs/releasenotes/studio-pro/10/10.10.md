...
- We fixed an issue in MendixChat where the screen went blank when you logged out while on the qualitative feedback page.
We have fixed the tab functionality in the new expression editor. (Ticket 205514) {TW}
