...
* The jar is coming from a platform supported module. For more information about support categories see [Marketplace Content Support](/appstore/overview/use-content-support/).
