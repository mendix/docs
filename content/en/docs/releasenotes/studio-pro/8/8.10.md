...
{% alert color="info" %}For the highlights of this release, see the [Mendix Release 8.10](https://www.mendix.com/blog/mendix-8-10-making-life-better/) blog post.{% /alert %}
