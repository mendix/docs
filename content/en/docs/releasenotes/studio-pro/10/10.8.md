...
* <a id="fix-rename-attribute"></a>We fixed a known issue where renaming an attribute or its data-type was not possible if you have any columns unselected in data preview.
