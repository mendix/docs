...
{{% alert type="info" %}}
This limitation has been removed in Studio Pro versions [9.8.0](/releasenotes/studio-pro/9.8) and above, and also from MTS version 9.6 patch version 3 ([9.6.3](/releasenotes/studio-pro/9.6#963)) and above.
{{% /alert %}}
