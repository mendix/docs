...
* In the page editor, we enhanced capabilities of the [layout grid](/studio/page-editor-widgets-structure#layout-grid), [rows](/studio/page-editor-widgets-structure#row), and [columns](/studio/page-editor-widgets-structure#column) by adding new settings to them. Changes can be outlined as following:
  ...
  * You can align all columns in a row or align an individual column
