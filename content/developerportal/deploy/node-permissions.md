...
With the Access to Monitoring permission, you can view the application metrics, logs, and alerts under the **Deploy** category in the [Developer Portal](http://sprintr.home.mendix.com). This allows you to successfully operate your Mendix Cloud environments.
