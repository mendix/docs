...
* Fixed a bug with image picker generating duplicated images on the device.
* Fixed a bug with soft keyboard getting hidden when selecting textfields in list views.
