...
url: /appstore/modules/genai/v1/reference-guide/external-connectors/pgvector-setup/
...
1. Add the [PgVector Knowledge Base](https://marketplace.mendix.com/link/component/225063) module and its dependencies to your Mendix app and set it up correctly, see [PgVector Knowledge Base](/appstore/modules/genai/v1/reference-guide/external-connectors/pgvector/).
