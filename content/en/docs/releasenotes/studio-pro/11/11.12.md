...
* We fixed an issue where native pages with popover layouts were flickering. (Ticket 282642)
...
* We fixed an issue where Strict mode did not work correctly with certain Client APIs and nanoflow actions in offline applications. (Tickets 287100, 282233)
...
* We fixed an issue in the modernized App Explorer where navigating to a document not visible in the tree (for example, a hidden styling node) caused Studio Pro to become unresponsive.
