...
* We are excited to announce a new feature that allows you to transfer drafts between people within the same company. With this feature, you can now easily collaborate on [Your Mendix Drafts](/appstore/general/app-store-overview/#my-drafts) with your colleagues, even if a colleague is not available to work on a draft that they originally created. You can easily transfer ownership of a draft to yourself as long as you are part of the same company. This allows team members to continue working on the same draft even if someone is out of the office.
