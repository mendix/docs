...
description: "Mendix의 서버, 로그 파일, 데이터베이스, Amazon S3 스토리지 서비스, IBM Cloud Object Storage, Microsoft Azure, IBM Bluemix 객체 스토리지, 웹 클라이언트 및 프록시 서버에 대한 사용자 정의 설정을 설명합니다."
