...
##### Automated Installation through Helm

You can now use Helm charts in order to install Private Mendix Platform components and run the configurations through the Helm chart UI. For more information, refer to the [Private Mendix Platform Quickstart Guide](/private-mendix-platform/quickstart/).

##### Support for Maia Make

Mendix AI Assistance (Maia) in Private Mendix Platform now supports Maia Make, a unified conversational interface in Studio Pro that groups all AI-assisted development capabilities into a single chat experience. For more information, see [Maia in Private Mendix Platform](/private-mendix-platform/maia/).
