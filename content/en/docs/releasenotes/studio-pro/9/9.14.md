...
{{% alert color="info" %}}For highlights of this release, see the [Mendix Release 9.14](https://www.mendix.com/blog/mendix-release-9-14-servicing-different-needs/) blog post.{{% /alert %}}
