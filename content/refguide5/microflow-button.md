...
Pressing this button will execute a microflow. It is possible to pass the object of the data view that the microflow button is contained in, as well as the object of the enclosing data view.
