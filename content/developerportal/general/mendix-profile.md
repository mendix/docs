...
You can also see a list of people you may know so that you can add further connections to your profile. To connect with someone, click the plus icon.
...
For five successful invites, you will get a Mendix t-shirt in the mail. So, after you have invited someone to Mendix, click **View Status** to see their name and status listed at the bottom of the card. Their status is determined via these steps:
...
Once five of your referred users reach the **Successful** status, you will see the **Claim your t-shirt** link on your dashboard. Click this to fill in some details and receive your awesome Mendix t-shirt!
...
You can easily edit the information on your Mendix Profile by clicking the **Settings** cog icon. The editing page has a sidebar menu that allows you to edit the sections described below.

### 10.1 Profile

**[ALL INFO IN THESE PARTS COPIED FROM CURRENT Mendix Profile DOC - VERIFY NAMING]**

In this menu item, you can view and edit the following information:
...
#### 10.1.1 Changing Your Password

**[VERIFY, ADD INFO]**

You can change your password here as well. By default, you are requested to change your password every 90 days. Only a Company Admin is allowed to change the expiration period.
...
### 10.2 Latest Messages

In this menu item, you will get an overview of all the notifications from the [Buzz](../collaborate/appbuzz). For example, when your colleague does any of the following, you will get a notification:

* Creates an app, sprint, or story
* Adds a file or comment
* Joins a new app project team

### 10.3 Documents

In this menu item, you will get an overview of all the documents that you have shared within different apps in the Developer Portal.

### 10.4 Feedback

In this menu item, you can view your the feedback you provided on the following:
...
* External Mendix apps (this is also feedback you will not have permission to manage)
...
Changes made through the Desktop Modeler are stored in the Mendix Team Server. This menu item provides an overview of the revisions you have committed.

### 10.6 API Keys

In this menu item, you can view and create API keys that can be used by external applications to connect to the APIs of the Developer Portal on behalf of your user account. These keys allow you to execute operations (or have them executed on your behalf) that require authentication but for which you do not want to pass your actual password. An example of this is to use an API key to perform scripted operations on your application model with the Platform SDK.

For more information, see Mendix Platform SDK.

### 10.7 Pending Invites

In this menu item, you can view your sent and received invitations.
...
**[ANYTHING ELSE FROM ABOVE GOES HERE?]**
...
#### 10.8.2 Merging Your Accounts

**[CORRECT LOCATION IS UNDER ADVANCED TAB?]**
...
**[SUFFICIENT TO WRITE "Follow the directions on the screen"? SEE SCREENSHOT; OR IS BELOW ACCURATE?]**
