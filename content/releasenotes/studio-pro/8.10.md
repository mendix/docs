...
<a name="101587"></a>We fixed an issue where the output of an Import with mapping activity was incorrectly set to **Nothing**. (Tickets 101587, 101786, 102227, 102287, 102621, 102641)
