...
{{< figure src="/attachments/addons/ats-addon/rg-ats/v2/rg-two-app/dashboard.png" >}}
...
| Icon                                     | Meaning    |
| ---------------------------------------- | ---------- |
|{{< figure src="/attachments/addons/ats-addon/rg-ats/v2/rg-two-app/test-case-icon.png" >}} | Test case  |
|{{< figure src="/attachments/addons/ats-addon/rg-ats/v2/rg-two-app/test-suite-icon.png" >}} | Test suite |
|{{< figure src="/attachments/addons/ats-addon/rg-ats/v2/rg-two-app/ddt-icon.png" >}}| Data-driven test case |
...
{{< figure src="/attachments/addons/ats-addon/rg-ats/v2/rg-two-app/settings.png" >}}
...
{{< figure src="/attachments/addons/ats-addon/rg-ats/v2/rg-two-app/deployments.png" >}}
...
{{< figure src="/attachments/addons/ats-addon/rg-ats/v2/rg-two-app/selenium-hub.png" >}}
