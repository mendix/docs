...
* Two known issues occur due to the `t is not a function. Please Close and reopen this UI component. If the issue persists, contact Mendix Support.` error introduced by Microsoft Edge WebView 2 version 150:
