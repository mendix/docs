...
5. Click **Continue**.
    ...
    {{< figure src="/attachments/appstore/modules/sap-odata-connector/login-catalog.png" >}}
...
9. Click **Generate .mpk**.
    ...
    {{< figure src="/attachments/appstore/modules/sap-odata-connector/generate-mpk.png" >}}
...
14. Right-click the app in the **App Explorer** and select **Import module package…**.
    ...
    {{< figure src="/attachments/appstore/modules/sap-odata-connector/import-module.png" >}}
...
15. Find the file that you stored in the /resources folder and import it.
    ...
    {{< figure src="/attachments/appstore/modules/sap-odata-connector/data-model.png" >}}
...
{{< figure src="/attachments/appstore/modules/sap-odata-connector/get-list.png" >}}
...
4. Select the **Name**, **Category**, and **Price** attributes to display in the data grid.
    ...
    {{< figure src="/attachments/appstore/modules/sap-odata-connector/show-get-list-result.png" >}}
...
1. Set the following environment properties.
    ...
    1. In SAP BTP, the options can be set as shown below:
        ...
        {{< figure src="/attachments/appstore/modules/sap-odata-connector/sap-btp-options.png" >}}

    2. In the manifest file, you need to set the options as shown below:

        {{< figure src="/attachments/appstore/modules/sap-odata-connector/manifest-options.png" >}}
...
2. Restart the application to apply the changes.
    ...
    {{< figure src="/attachments/appstore/modules/sap-odata-connector/debug-mode-indication.png" >}}
...
6. Set up remote Debugging in the Eclipse IDE as shown in the image below:
    ...
    {{< figure src="/attachments/appstore/modules/sap-odata-connector/debug-in-ide.png" alt="Debug configuration screen in Eclipse" >}}
...
{{< figure src="/attachments/appstore/modules/sap-odata-connector/actions-sapodataconnector.png" >}}
...
{{< figure src="/attachments/appstore/modules/sap-odata-connector/get-list-params.png" >}}
...
{{< figure src="/attachments/appstore/modules/sap-odata-connector/get-entry-params.png" >}}
...
{{< figure src="/attachments/appstore/modules/sap-odata-connector/create-params.png" >}}
...
{{< figure src="/attachments/appstore/modules/sap-odata-connector/deep-create-parent-child.png" >}}
...
{{< figure src="/attachments/appstore/modules/sap-odata-connector/delete-params.png" >}}
...
{{< figure src="/attachments/appstore/modules/sap-odata-connector/functionnames-sapodataconnector.png" >}}
...
{{< figure src="/attachments/appstore/modules/sap-odata-connector/execute-entry-params.png" >}}
...
{{< figure src="/attachments/appstore/modules/sap-odata-connector/execute-list-params.png" >}}
...
{{< figure src="/attachments/appstore/modules/sap-odata-connector/refresh-params.png" >}}
...
{{< figure src="/attachments/appstore/modules/sap-odata-connector/update-params.png" >}}
...
{{< figure src="/attachments/appstore/modules/sap-odata-connector/errorhandling-sapodataconnector.png" >}}
...
{{< figure src="/attachments/appstore/modules/sap-odata-connector/actionparameters-sapodataconnector.png" >}}
...
{{< figure src="/attachments/appstore/modules/sap-odata-connector/editbox-sapodataconnector.png" >}}
...
{{< figure src="/attachments/appstore/modules/sap-odata-connector/functionsandfunctionparameters-sapodataconnector.png" >}}
...
{{< figure src="/attachments/appstore/modules/sap-odata-connector/requestparams-sapodataconnector.png" >}}
...
{{< figure src="/attachments/appstore/modules/sap-odata-connector/tolineitems-sapodataconnector.png" >}}
...
{{< figure src="/attachments/appstore/modules/sap-odata-connector/serviceroot.png" >}}
...
{{< figure src="/attachments/appstore/modules/sap-odata-connector/domainmodelgwsample_basic-sapodataconnector.png" >}}
...
{{< figure src="/attachments/appstore/modules/sap-odata-connector/domainmodel-sapodataconnector.png" >}}
...
* [SAP Cloud Connector](/appstore/modules/sap/sap-cloud-connector/)
