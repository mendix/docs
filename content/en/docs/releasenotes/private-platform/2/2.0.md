...
We have updated the templates that provision pipelines into Jenkins and Azure DevOps Pipelines CI/CD tools to include SBOM generation and storing the file in the same folder as the MDA, for analysis by [Software Composition](/private-mendix-platform/reference-guide/admin/company/#software-composition).
