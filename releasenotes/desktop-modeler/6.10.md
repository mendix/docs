...
* We changed the default transaction isolation level for microflows on MySQL and MariaDB to **Read Committed**. For this level, row-based logging is required in your database. For details on how to configure this, see [MySQL](https://docs.mendix.com/refguide6/mysql) in the Mendix Reference Guide. (Ticket 51330)
