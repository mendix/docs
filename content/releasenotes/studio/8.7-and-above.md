...
* To speed up the process of creating an app, we added an opportunity to clear the selected attribute. Simply click the **Clear** button:

  <img src="attachments/8.7/clear-attribute.png" style="zoom:70%;" />
...
* We fixed an issue where you could not manage users if you app had the AppCloudServices module instead of the MendixSSO module.
