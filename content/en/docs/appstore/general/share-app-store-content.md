...
[**TO DO: GNU General Public License (GPL), version 3  to be removed from UI - verified? Remove from list below**]
[**TO DO: verify if 4 other licenses in second table will be added to UI**]
