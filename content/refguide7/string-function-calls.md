...
If this third parameter is too big, the function will throw an error saying it is out of range, so make sure tto limit it. This is an example with use of the length function:
