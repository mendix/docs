...
* <a id="ki-skills-button"></a>The **Skills** button in Maia Chat is not visible after adding skills via Maia. It becomes visible only after restarting the app, closing the project, or starting a new chat.
    * Fixed in [11.15.0](/releasenotes/studio-pro/11.15/#ki-fix-skills-button).
