...
linktitle: "첫 번째 Agent 만들기"
weight: 60
description: "Knowledge Base, Function Calling, Prompt 관리를 통합하여 Mendix 애플리케이션에서 강력한 GenAI 사용 사례를 구축하는 두 가지 접근 방식을 안내합니다. 두 접근 방식 모두 Mendix Agents Kit의 기능을 활용합니다. 하나는 Agent Builder UI를 사용하여 Agent Commons 원칙에 따라 런타임에 Agent를 정의하고, 다른 하나는 GenAI Commons의 빌딩 블록을 사용하여 프로그래밍 방식으로 Agent를 정의합니다."
---
