...
Session management is broken for applications running in a clustered environment using Mendix 7.17.0. Customers running Mendix in clustered mode should therefore not upgrade to this version. 
