...
| RequestHandling.AllowLegacyCookies | Allows violations of RFC 6265 which is enforced since Studio Pro 7.23.36. See [here](https://www.eclipse.org/jetty/javadoc/jetty-10/org/eclipse/jetty/http/CookieCompliance.html#RFC6265_LEGACY) for more information. Be aware of the fact that enabling this custom setting exposes your app to CVE-2023-26049. This setting is available in Studio Pro 7.23.36 and above. | false |
