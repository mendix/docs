...
* You can use the **Page break** widget that is included in this module to structure your documents. The **Page break** widget enables you to force a page break at a specific position in your document. In addition, you can use the **Add page break** design property that is available for Container widgets. This design property enables you to force a page break *before* or *after* a specific container.
