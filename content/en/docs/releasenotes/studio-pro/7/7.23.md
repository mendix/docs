...
* We dropped support for the following database versions that are no longer supported by vendors:
    * Oracle 18
    * SQL Server 2016
* Starting with version 7.23.25, we will drop support for Oracle 12.2, because it is no longer supported by the vendor.
...
* Starting with version 7.23.23, we will drop support for Microsoft SQL Server 2016, because it is no longer supported by the vendor.
