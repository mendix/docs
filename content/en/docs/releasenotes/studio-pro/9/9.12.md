...
We added modularity capability to the platform. Members of the [Mendix Vendor Program](/appstore/creating-content/vendor-program/) are able to create new types of modules which have IP protection options and offer different distribution mechanisms that enable using easier upgrade management on consumer side.
