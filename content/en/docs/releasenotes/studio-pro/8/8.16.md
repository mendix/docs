...
* We now show the attributes of external entities in the [Integration pane](/refguide8/integration-pane/). It is possible to navigate to an attribute of a consumed entity using the context menu of the given attribute.
