...
* The order of the options of a drop-down menu search field were sometimes not the same ad the order configured in the Desktop Modeler. We fixed this for you. (Ticket 53268)
