...
{{< figure src="/attachments/refguide9/modeling/pages/button-widgets/button-properties/button-properties.png" alt="Button Properties"   width="250"  class="no-border" >}}
...
* Double-click the button on the page and click **Edit** in the **General** section > **Caption**:
    ...
    {{< figure src="/attachments/refguide9/modeling/pages/button-widgets/button-properties/opening-parameters.png" alt="Opening Parameters" class="no-border" >}} 
...
2. In the **Edit Items** dialog box, click **New**:
    ...
    {{< figure src="/attachments/refguide9/modeling/pages/button-widgets/button-properties/adding-new-item.png" alt="Adding New Item" class="no-border" >}}
