...
* We now show the attributes of external entities in the [Data Hub pane](refguide/data-hub-pane). It is possible to navigate to an attribute of a consumed entity using the context menu of the given attribute.
...
* When a data view was a direct child of a [list view](/refguide/list-view), [template grid](/refguide/template-grid), or [tab page](/refguide/tab-container#tab-page), it got a fixed height set in the client. This should no longer be the case. (Tickets 106282, 109153)
