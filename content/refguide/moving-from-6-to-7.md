...
##### From com.mendix.systemwideinterfaces.connectionbus.data.IDataRow

| Method Name | Alternative |
| --- | --- |
| `getPrimaryKeyValue()` | `getValue(context, 0)` |   

##### 6.4.1.1 Example Usage 
...
IDataRow dataRow = dataRows.get(0);
IMendixIdentifier mendixIdentifier = dataRow.getPrimaryKeyValue();
