...
For more information on the correlation between Mendix Studio and Desktop Modeler/Mendix Studio Pro versions, see [Studio Version & Mendix Version Correlation](/studio7/general-versions).
...
* We added support for [Studio Pro 7.22.1](../studio7-pro/7.22).
...
* We added support for [Studio Pro 7.22](../studio7-pro/7.22).
...
* We added support for [Studio Pro 7.21](../studio7-pro/7.21).
...
* We added support for [Studio Pro 7.20.1](../studio7-pro/7.20).
...
* We added support for [Studio Pro 7.20](../studio7-pro/7.20).
...
* We added support for [Studio Pro 7.19](../studio7-pro/7.19).
 ...
 * We re-added support for [Studio Pro 7.18](../studio7-pro/7.18). The known issue with consistency error checking in Mendix version 7.18.0 has been resolved in version [7.18.1](../studio7-pro/7.18#68234). Stduio users with apps in Mendix version 7.18.0 can now upgrade their apps when opening Studio in order to continue building and publishing.
...
* We added support for [Studio Pro 7.18](../studio7-pro/7.18).
...
* We added support for [Studio Pro 7.17.2](../studio7-pro/7.17).
...
* We added support for [Studio Pro 7.17](../studio7-pro/7.17).
...
* We added support for [Studio Pro 7.16](../studio7-pro/7.16). Studio supports ranges for Mendix Studio Pro. This gives you choice in whether to update Studio right away, or postpone the update. For more information on the topic, see [Studio Versions & Mendix Versions Correlation](/studio7/general-versions).
