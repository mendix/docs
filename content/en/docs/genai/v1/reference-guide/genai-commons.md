---
title: "GenAI Commons"
url: /appstore/modules/genai/v1/genai-for-mx/commons/
linktitle: "GenAI Commons"
description: "Agents Kit 1: Describes the purpose, configuration and usage of the GenAI Commons module from the Mendix Marketplace that allows developers to integrate GenAI common principles and patterns into their Mendix app."
weight: 10
aliases:
...
Lastly, the [Conversational UI module](/appstore/modules/genai/v1/genai-for-mx/conversational-ui/) provides pages, snippets, and logic to display and export token usage information. For this to work, the module roles `UsageMonitoring` from both Conversational UI as well as GenAI Commons need to be assigned to the applicable project roles.
