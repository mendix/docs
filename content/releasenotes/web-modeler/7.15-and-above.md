...
* To make your work in the page editor easier, we improved data container highlights in the following ways:

  * If the widget is inside a data container (a data view or a list view), it will be indicated with a data container icon

    {{% image_container width="350" %}}![](../Documents/Sourcetree clone/content/refguide/web-modeler/attachments/page-editor-wm/wm-input-widget-example.png)
    {{% /image_container %}}
