...
* To utilize the `Source` attribute of the references, include `MetaData` with the key `sourceUrl`. In [ConversationalUI](/agents/agents-kit-1/reference-guide/genai-for-mx/conversational-ui/), this appears as a clickable link for the end-user.
