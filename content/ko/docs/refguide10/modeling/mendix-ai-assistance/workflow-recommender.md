...
weight: 30
description: "Mendix Studio Pro의 Workflow Recommender를 설명합니다."
---
...
{{< figure src="/attachments/refguide10/modeling/mendix-ai-assistance/workflow-recommender/blue-plus.png" max-width=20% >}}
...
{{< figure src="/attachments/refguide10/modeling/mendix-ai-assistance/workflow-recommender/initial-recommendations.png" max-width=50% >}}
...
{{< figure src="/attachments/refguide10/modeling/mendix-ai-assistance/workflow-recommender/search-toolbox.png" max-width=80% >}}
