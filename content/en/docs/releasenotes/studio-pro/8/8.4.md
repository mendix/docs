...
{% alert color="info" %}For the highlights of this release, see the [Mendix Release 8.4](https://www.mendix.com/blog/mendix-8-4-we-deliver-good-news-you-deliver-great-experience/) blog post.{% /alert %}
