...
* We fixed the issue where validation errors in a radio button group were shown twice in a pop-up window instead of once next to the widget. (Ticket 51743, 51960, 53677, 53837)
...
* The `$currentDeviceType` was always set to `Desktop` when using the phone or tablet preview mode. (Ticket 52906)
