...
When selected, this shows the widget while a provided [expression](/refguide7/expressions/) evaluates to true. The object of the containing data view is available inside an expression as a `$currentObject` variable.
