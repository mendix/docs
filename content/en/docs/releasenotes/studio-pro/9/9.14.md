...
* When adding a new association from **System.User** or a specialization of **System.User** (meaning, the owner of the association is **System.User**) through a user-interface, the operation fails (for example, managing users through the **Administration** module does not work).
