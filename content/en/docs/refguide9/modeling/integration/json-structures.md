...
A JSON structure document stores a JSON snippet, and converts it into a schema structure that can be used in [Import Mappings](/refguide9/import-mappings/) and [Export Mappings](/refguide9/export-mappings/) to convert JSON content to Mendix objects and vice versa. 

{{< figure src="/attachments/refguide9/modeling/integration/json-structures/19398772.png" class="no-border" >}}
...
{{< figure src="/attachments/refguide9/modeling/integration/json-structures/19398781.png" class="no-border" >}}
...
{{< figure src="/attachments/refguide9/modeling/integration/json-structures/19399140.png" class="no-border" >}}
