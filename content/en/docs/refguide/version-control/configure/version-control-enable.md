...
4. In the **App Settings** dialog box, make sure that **Enable online services** is set to **Yes**. This option creates a remote (Team Server) repository and an app in [Projects](https://projects.home.mendix.com/) of the Mendix Portal.
