...
There are several ways to import an add-on module from the Marketplace. For more information, see the [Installing Marketplace Content](/appstore/overview/use-content/#install) section in *Use Marketplace Content in Studio Pro*.
...
* [Use Marketplace Content in Studio Pro](/appstore/overview/use-content/)
