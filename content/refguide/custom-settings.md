...
| <a name="CACertificates"></a>CACertificates | A comma-separated list of paths to Authority Certificates. |   |
...
| com.mendix.storage.s3.UseCACertificates | Sets this value to true to use the configured <a href="#CACertificates">CA Certificates</a> for the connection the S3 service. | false |
