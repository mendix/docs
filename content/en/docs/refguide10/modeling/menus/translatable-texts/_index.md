...
{{< figure src="/attachments/refguide10/modeling/menus/translatable-texts/language-status.png" alt="Language Status" width="300"  class="no-border" >}}
...
{{< figure src="/attachments/refguide10/modeling/menus/translatable-texts/language-menu.png" alt="Language Menu" class="no-border" >}}
...
{{< figure src="/attachments/refguide10/modeling/menus/translatable-texts/user-language-domain-model.png" alt="System Domain Model for User and Language" class="no-border" width="750" >}}
