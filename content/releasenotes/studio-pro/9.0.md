...
* You can now copy and paste multiple entities and annotations in the domain model. 
	...
	{{% /alert %}}
* In this release, you can finally use [Git for version control](/refguide/version-control) of your Mendix apps hosted on your own private Git server. This feature is currently in [Beta](/releasenotes/beta-features/).
