...
{% alert color="info" %}For an overview of the highlights in this release, see the [Mendix Release 8.15](https://www.mendix.com/blog/mendix-8-15-its-about-time/) blog post.{% /alert %}
...
* <a id="2562"></a>We fixed a known performance issue with the [Delete object(s)](/refguide8/deleting-objects/) activity. This action is no longer slowed down if there are microflow variables containing large lists of entities in scope.
