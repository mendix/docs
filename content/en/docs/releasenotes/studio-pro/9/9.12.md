...
* We fixed an issue where widgets added through the menu at the top of the page did not open a dialog box for configuring properties (e.g. to select a table size or to select a document for related buttons).
* We fixed the search for XPaths in **Edit** menu > **Find Advanced** > **XPaths**, which did not always find all of them. (Ticket 144720) 
