...
The properties or features of an entity are described using [attributes](/refguide5/attributes). An attribute represents a small piece of information about an entity, such as the name or birth date of a person.
...
*   [Validation Rules](/refguide5/validation-rules)

*   [Event Handlers](/refguide5/event-handlers)

*   [Indexes](/refguide5/indexes)

*   [Access Rules](/refguide5/access-rules)
...
Define whether instances of this entity can be stored in the database. See [persistability](/refguide5/persistability) for more information about this property. Non-persistable entities are painted orange instead of blue to indicate the difference.
