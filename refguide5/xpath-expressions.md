...
A comparison expression consists of two attributes or values, separated by a comparison [operator](/refguide5/xpath-operators), like '=', '<=' and '>'.
...
See [this page](/refguide5/xpath-constraint-functions) for information on the available functions.
