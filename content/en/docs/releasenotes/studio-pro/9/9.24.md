...
* [**VERIFY**] <a id="layout"></a>We fixed a [known issue](/releasenotes/studio-pro/9.23/#ki-layout) with opening or creating layout documents where an "Oops" pop-up window was produced.
