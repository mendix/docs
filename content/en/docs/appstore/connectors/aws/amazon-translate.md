...
6. In the **Select Constants** dialog, find and expand the **AWSAuthentication** > **ConnectionDetails** section.
    ...
    {{< figure src="/attachments/appstore/connectors/aws-translate/translate_edit_configuration.png" alt="The TemporaryCredentials and StaticCredentials items in the ConnectionDetails section">}}
