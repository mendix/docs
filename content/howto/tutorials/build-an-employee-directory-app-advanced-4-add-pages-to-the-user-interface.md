---
title: "Build an Employee Directory App (Advanced) Step 4: Add Pages to the User Interface"
...
* Complete the third how-to in this series: [How to Build an Employee Directory (Advanced) App Step 3: Publish and View Your App](build-an-employee-directory-app-advanced-3-publish-and-view-your-app)
...
1. Select the top-left **BUTTON** image:
    ...
    ![](attachments/build-an-employee-directory-app-advanced/select-card-item-button.png)

2. Click the **Icon** property and change it to **User**:

    ![](attachments/build-an-employee-directory-app-advanced/change-icon-signal.png)

3. Select the top-left **Open Page** button and enter *Employees* for the **Caption** property:

    ![](attachments/build-an-employee-directory-app-advanced/change-open-page-caption.png)

4. Select the image you just changed to a user image and set the **On Click Action** property to **Page**:

    ![](attachments/build-an-employee-directory-app-advanced/change-onclick-action.png)

5. Change the page property by clicking **Select page**:

    ![](attachments/build-an-employee-directory-app-advanced/select-page.png)
...
6. To create a new page in the **Select Page** dialog box, do the following:<br>
    ...
    ![](attachments/build-an-employee-directory-app-advanced/lists-default.png)
...
1. Open the **Employees** page by using the recent documents option:
    ...
    ![](attachments/build-an-employee-directory-app-advanced/recent-documents.png)

2. Select the **TEXT** widget with **Title**:

    ![](attachments/build-an-employee-directory-app-advanced/text-widget.png)
...
5. Select the **CONTAINER** where the **Add** button is located:
    ...
    ![](attachments/build-an-employee-directory-app-advanced/add-button.png)

6. Select the parent **Row** using the breadcrumb:

    ![](attachments/build-an-employee-directory-app-advanced/breadcrumb-container-add-button.PNG)

7. Change the **Row Layout** to *large left column & small right column* for all profiles:

    ![](attachments/build-an-employee-directory-app-advanced/change-row-layout2.png)
...
1. Select the **LIST VIEW** widget and delete it:
    ...
    ![](attachments/build-an-employee-directory-app-advanced/listview-delete.png)
...
1. Select the **LIST VIEW**, which groups all the user cards together:
    ...
    ![](attachments/build-an-employee-directory-app-advanced/listview-select.png)

2. You want to create a new entity, so click the **Entity** property:

    ![](attachments/build-an-employee-directory-app-advanced/select-entity.png)
...
4. Select the **TEXT** widget of the top user card and clear the **Content** property:
    ...
    ![](attachments/build-an-employee-directory-app-advanced/select-text-widget2.png)

5. Click **Add parameter** for the **Content** property:

    ![](attachments/build-an-employee-directory-app-advanced/add-parameter.png)
...
7. In the subtitle **TEXT** widget, repeat steps 4-6 to add an attribute for **Email [String]**:
    ...
    ![](attachments/build-an-employee-directory-app-advanced/list-view.png)
...
1. Select the **Add** button on the **Employees** page:
    ...
    ![](attachments/build-an-employee-directory-app-advanced/employees-add.png)

2. Select **Employee** for the **Entity** property of the button:

    ![](attachments/build-an-employee-directory-app-advanced/select-entity2.png)
...
4. Click **New page** and do the following:<br>
    ...
    ![](attachments/build-an-employee-directory-app-advanced/form-vertical.png)
...
2. Click the icon in the data source header to select the containing data view.
    ...
    ![](attachments/build-an-employee-directory-app-advanced/data-source-icon.png)

3. Set the **Entity** property of the related data view to **Employee**.

    ![](attachments/build-an-employee-directory-app-advanced/entity-employee.png)

4. Select the text box with the **Name** caption and connect it to the the **Name** attribute of the **Employee** entity.

    ![](attachments/build-an-employee-directory-app-advanced/name-attribute.png)
...
7. Go the **Design** properties category and toggle the **Full Width** property for the **Save** and **Cancel** buttons to improve the user experience:
    ...
    ![](attachments/build-an-employee-directory-app-advanced/save-full-width.png)
...
1. On the **Employee** page, open the **Toolbox**, make sure **Widgets** is selected, and search for the **Google Maps** widget:
    ...
    ![](attachments/build-an-employee-directory-app-advanced/googlemaps.png)
...
5. Connect the new text box to a new attribute named **Address**:
    ...
    ![](attachments/build-an-employee-directory-app-advanced/address.png)
...
Update and view your app, just like you did in [How to Build an Employee Directory App (Advanced) Step 3: Publish and View Your App](build-an-employee-directory-app-advanced-3-publish-and-view-your-app).

You can now use your app to add and edit employees!

Continue on to the next part of this tutorial: [How to Build an Employee Directory App (Advanced) Step 5: Promote an Employee](build-an-employee-directory-app-advanced-5-add-employee-promotion-logic).
