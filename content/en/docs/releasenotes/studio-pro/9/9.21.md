...
* In workflow settings, we changed the text of the following settings: "Parallel Workflow executions" to "Workflow instance threads" and "Parallel task executions" to "Microflow threads".
