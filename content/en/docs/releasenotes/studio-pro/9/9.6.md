...
{{% alert color="info" %}}For highlights of this release, see the [Mendix Release 9.6](https://www.mendix.com/blog/release-9-6-makes-your-mendix-world-spin/) blog post.{{% /alert %}}
...
* We fixed a crash that occurred when opening an uninitialized app from the [Most Recent](/developerportal/#my-projects) apps list.
