...
이 쿼리는 로컬 시간대에서 `DateAttribute`의 초 부분이 30인 모든 로그를 반환합니다(예: "2011-12-30 08:08:30"):
...
이 쿼리는 뉴욕 시간대에서 `DateAttribute`의 초 부분이 30인 모든 로그를 반환합니다(예: "2011-12-30 08:08:30"):
