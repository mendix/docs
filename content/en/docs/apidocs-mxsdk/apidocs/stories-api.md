...
{{% alert color="warning" %}}
We will delete all data from Mendix Stories starting October 1, 2023. We strongly urge you to [download your work](/developerportal/general/general-settings/#story-archive) before that date.
...
{{% alert color="info" %}}
You can create and manage your [API keys](/developerportal/general/general-settings/#general-settings-api-keys) in the **General Settings** of your project.
{{% /alert %}}
