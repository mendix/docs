...
Enumeration | One of the values of the given [enumeration](/refguide6/enumerations).
...
Hashed string | The hash value of a String or set of characters. It can among others contain letters, spaces and/or numbers. This type can for example be used to store a password. Hash values are generated using the hash algorithm that is chosen in the [Project Settings](/refguide6/project-settings).
