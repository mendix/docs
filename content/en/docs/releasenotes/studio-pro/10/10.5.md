...
* We fixed an issue in the entity dialog box where one-way navigable associations would not appear in the list of associations for the child entity, allowing the user to add them again.
