...
{{% alert color="warning" %}}
This widget is deprecated – specifically, the [Attribute Radio Button list](#attribute-radio-button-list) type is deprecated. Deprecated status means that Mendix Support will accept security-related tickets only. For more information, see the [Deprecated Support Category](/appstore/general/app-store-content-support/#deprecated) section of *Marketplace Content Support*. 
{{% /alert %}}
