...
* You can now add Agent Instructions. Agent Instructions are instructions that are automatically added to the conversation context. You can add them to the project or module level. For more information, see [Maia Agent Instructions (AGENTS.md)](/refguide/maia-agent-instructions/).
