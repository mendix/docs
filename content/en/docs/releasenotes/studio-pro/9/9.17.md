...
* In the [styling editor](/howto/front-end/customize-styling-new/#styling-editor), we added file and folder operations such as create, rename, and delete. Simply right-click a file or folder to see the available options.
