...
| CE1827     | Object should be of type {object type} or a specialization of it. | Call Workflow action                                         | This action requires you to pass an object of the same type that is configured for the [Workflow Context parameter](workflow-parameter). You have selected an object of a different entity for the microflow parameter or the **Create Object** activity. | Open the parameter or the **Create Object** activity properties and select the object of the same entity that is configured for the [Workflow Context parameter](workflow-parameter). |
