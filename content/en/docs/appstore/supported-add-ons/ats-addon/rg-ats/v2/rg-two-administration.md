...
url: /appstore/supported-add-ons/ats/rg-two-administration/
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-administration/tenant_admin_accounts.png" alt="Tenant administration page" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-administration/create_account.png" alt="Create new account dialog" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-administration/edit_account.png" alt="Edit account dialog" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-administration/app_new_edit.png" alt="App Create/Edit" >}}
