...
| [GenAI Commons](/appstore/modules/genai/v1/commons/) | Provides common capabilities that allow all GenAI connectors to integrate with other modules. You can also implement your own connector based on this. | TBD |
