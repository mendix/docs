...
| Registration fails on a PWA on iOS | To receive push notifications on iOS the app must be served over https and added to the home page | Deploy your app (or use a tool such as [ngrok](https://ngrok.com)), add your app to the home page via the Share button in Safari and try again |
