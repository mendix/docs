...
* The string to search in
    * Type: string
* The regular expression to match (if you want to search for a literal string, encapsulate this string with \G and \E. For example, `\GPaul S. Mueller\E` will search for the string `Paul S. Mueller`, without interpreting the dot as a wildcard)
    * Type: string
