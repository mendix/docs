...
Some modules you can download may come with its own [user roles](/studio/settings-security/), and you should keep them in mind to ensure the security of your application. If the Security level of your app is set to **Prototype/demo** or **Production**, you need to map the module roles to the applicable user roles in your app.
