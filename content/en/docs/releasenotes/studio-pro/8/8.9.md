...
description: "The release notes for Mendix Studio Pro 8.9 (including all patches) with details on new features, bug fixes, and known issues."
weight: 91
---

{% alert color="info" %}For an overview of the highlights in this release, see the [Mendix Release 8.9](https://www.mendix.com/blog/mendix-8-9-stay-connected/) blog post.{% /alert %}
