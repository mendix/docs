...
각 애플리케이션은 데이터를 보안하기 위해 적절한 보안 구성이 필요합니다. 이 사용 방법 가이드에서는 보안을 켜고 구성하는 방법을 설명합니다.

사용자 및 모듈 역할을 구성하여 페이지와 Microflow에 대한 접근을 설정하는 것부터 시작하여 프로토타입/데모 보안을 켤 것입니다. 다음으로 프로덕션 보안을 다룰 것입니다.
