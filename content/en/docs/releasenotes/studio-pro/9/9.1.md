...
{{% button color="info" href="https://marketplace.mendix.com/link/studiopro/9.1.1" text="Download in Marketplace" title="Download version 9.1.1 from the Marketplace" %}}
...
{{% button color="info" href="https://marketplace.mendix.com/link/studiopro/9.1.0" text="Download in Marketplace" title="Download version 9.1.0 from the Marketplace" %}}
...
* We added a new option for row insertion in the [layout grid](/refguide/layout-grid/). When you select **Duplicate**, the same setup of columns as the selected row will apply to the new row.
    ...
    {{% alert color="info" %}}This is based on an [upvoted idea from Rob de Leeuw](https://forum.mendixcloud.com/link/ideas/2233) submitted to the [Mendix Idea Forum](https://forum.mendixcloud.com/link/ideas). Thanks, Rob!{{% /alert %}}
