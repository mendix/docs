...
{{% alert type="warning" %}}
We are currently investigating an issue related to committing images with a one-to-one association For that reason, we advise you not to use versions 8.3.0 or 8.2.0 until further notice.
{{% /alert %}}
