...
* The Main Line is incorrectly detected when a branch other than the default branch is downloaded. This also causes an app to be re-downloaded from the version control server when switching branches in the **Branch Line Manager**, and this download may differ from your local copy.
