...
* **LogLineDateFormat** (default: MM/dd/yyyy) – This constant determines the format to be used to convert date attributes to strings. It uses the same pattern as used by the [Parse & Format Date Function Calls](parse-and-format-date-function-calls).
