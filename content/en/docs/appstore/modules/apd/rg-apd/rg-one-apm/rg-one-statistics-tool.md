...
url: /appstore/modules/apd/rg-one-statistics-tool/
---
...
{{< figure src="/attachments/appstore/modules/apd/rg-apd/rg-one-apm/rg-one-statistics-tool/Trend.png" >}}
...
{{< figure src="/attachments/appstore/modules/apd/rg-apd/rg-one-apm/rg-one-statistics-tool/Manual_statistics.png" >}}  
...
{{< figure src="/attachments/appstore/modules/apd/rg-apd/rg-one-apm/rg-one-statistics-tool/Now_Running.png" >}}
...
{{< figure src="/attachments/appstore/modules/apd/rg-apd/rg-one-apm/rg-one-statistics-tool/Snapshots.png" >}}
...
{{< figure src="/attachments/appstore/modules/apd/rg-apd/rg-one-apm/rg-one-statistics-tool/Snapshot_Details.png" >}}
...
{{< figure src="/attachments/appstore/modules/apd/rg-apd/rg-one-apm/rg-one-statistics-tool/Options.png" >}}
...
{{< figure src="/attachments/appstore/modules/apd/rg-apd/rg-one-apm/rg-one-statistics-tool/Protections.png" >}}
...
{{< figure src="/attachments/appstore/modules/apd/rg-apd/rg-one-apm/rg-one-statistics-tool/Triggers.png" >}}
