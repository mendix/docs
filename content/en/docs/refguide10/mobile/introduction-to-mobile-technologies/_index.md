...
If you are using Mendix version 10.24.0 or above and want to distribute a Mendix PWA through mobile app stores or package it in a native shell, see [PWA Wrapper](/refguide10/mobile/distributing-mobile-apps/pwa-wrapper/).
