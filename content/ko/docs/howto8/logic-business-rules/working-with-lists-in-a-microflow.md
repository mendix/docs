---
title: "Microflow에서 목록 작업하기"
url: /howto8/logic-business-rules/working-with-lists-in-a-microflow/
weight: 6
description: "Microflow에서 객체 목록을 다루는 방법과 데이터베이스에서 필터링된 객체 목록을 검색하는 방법을 학습합니다."
---
