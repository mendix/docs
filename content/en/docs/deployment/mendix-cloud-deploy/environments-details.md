...
{{% alert color="warning" %}}
If you are using Mendix version 10.13 or above, we recommend using the [`CSPHeaderTemplate` custom runtime setting](/refguide/runtime/custom-settings/#CSPHeaderTemplate) to configure this instead.
{{% /alert %}}
