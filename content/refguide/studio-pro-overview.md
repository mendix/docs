...
| **Full Screen** | Hides the title bar and makes the window fill the entire screen. This version of **Full Screen** was introduced in Studio Pro [8.3.0|(/releasenotes/studio-pro/8.3#830); in previous versions, the **Full Screen** option only hid all dockable window panes. | <kbd>F11</kbd> |
