...
To build a hybrid app and publish it, see [How to Build a Mendix Hybrid App Locally](/howto/mobile8/build-hybrid-locally) for information on local building.
