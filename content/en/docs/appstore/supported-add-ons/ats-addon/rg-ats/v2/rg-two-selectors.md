---
title: "Selectors"
url: /appstore/supported-add-ons/ats/rg-two-selectors/
---

## 1 Introduction

For the [Find Widget Child Node](/appstore/supported-add-ons/ats/rg-one-find-widget-child-node/) action or as part of a script for the [Execute JavaScript Integer](/appstore/supported-add-ons/ats/rg-one-execute-javascript-integer/), [Execute JavaScript String](/appstore/supported-add-ons/ats/rg-one-execute-javascript-string/), and [Execute JavaScript WebElement](/appstore/supported-add-ons/ats/rg-one-execute-javascript-webelement/) actions, you must use selectors to get a node or WebElement.
...
If you use JQuery selectors in the [Find Widget Child Node](/appstore/supported-add-ons/ats/rg-one-find-widget-child-node/) action, you must NOT use the `jQuery(...)` or `$(...)` function. Only use simple selectors, without quotations.

In the [Execute JavaScript](/appstore/supported-add-ons/ats/rg-one-execute-javascript-integer/) action, you must use the `jQuery(...)` or `$(...)` function to select a WebElement or node.
