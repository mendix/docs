...
This document explains how to integrate the prompt engineering capabilities of the [Agent Commons](/agents/agents-kit-2/genai-for-mx/agent-commons/) module into your app.
...
1. Install the [Agent Commons module](/agents/agents-kit-2/genai-for-mx/agent-commons/) module and its dependencies from the Mendix Marketplace.
...
For more technical details, refer to [Agent Commons](/agents/agents-kit-2/genai-for-mx/agent-commons/).
