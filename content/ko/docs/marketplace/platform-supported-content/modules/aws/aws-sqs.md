...
description: "Mendix Marketplace의 Amazon SQS 커넥터의 구성 및 사용법을 설명합니다. Amazon SQS를 사용하면 메시지 손실 없이 다른 서비스의 가용성에 의존하지 않고 소프트웨어 구성 요소 간에 모든 볼륨의 메시지를 보내고 저장하고 수신할 수 있습니다."
aliases:
