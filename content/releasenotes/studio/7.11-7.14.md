...
These are Mendix Studio release notes for app projects built with Desktop Modeler versions 7.11–7.14. The release notes include all minor versions, patches, and known issues.
...
* We added support for [Studio Pro 7.14.1](../studio7-pro/7.14). The minimum supported version remains Studio Pro 7.11.0.
...
* We added support for [Studio Pro 7.12.0](../studio7-pro/7.12). The minimum supported version remains Studio Pro 7.11.0.
...
* We added support for [Studio Pro 7.11.0](../studio7-pro/7.11). The minimum (and only) supported version is now Studio Pro 7.11.0.
...
* We added support for [Studio Pro 7.9.0](../studio7-pro/7.9). The minimum (and only) supported version is now [Studio Pro 7.9.0](../studio7-pro/7.9).
...
* We dropped support for [Studio Pro 7.7.1](../studio7-pro/7.7). The minimum (and only) supported version is now [Studio Pro 7.8.0](../studio7-pro/7.8).
...
* We added support for [Studio Pro 7.8.0](../studio7-pro/7.8).
...
* We added support for [Studio Pro 7.7.1](../studio7-pro/7.7)
...
* We added support for [Studio Pro 7.6.0](../studio7-pro/7.6).
