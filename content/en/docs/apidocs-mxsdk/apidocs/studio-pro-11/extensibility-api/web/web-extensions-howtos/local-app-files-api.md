...
description: "Describes how to interact with local application files from within an extension by adding buttons and event handlers for saving, loading, and deleting files."
---

## Introduction

This how-to describes how to interact with local app files from within an extension. In this example, you will:
...
The final part of the code adds three new buttons. When clicked, the buttons call the callbacks described above.
