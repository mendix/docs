...
{{% alert color="info" %}}
If you plan to build an offline-first progressive web app with Mendix, please use Mendix version 9.24.18, 10.6.6, 10.9.0 or newer. Offline-first PWAs built with older versions of Mendix are no longer supported in most web browsers.
{{% /alert %}}
