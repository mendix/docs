...
*   _Mode_ (String): Mode of the environment. Possible values: Test, Acceptance, Production or the name of a [flexible environment](/refguide/mendix-cloud-deploy#flexible-environments).
...
| 400 | INVALID_ENVIRONMENT | Could not parse environment mode 'mode'. Valid options are Test, Acceptance, Production or the name of a [flexible environment](/refguide/mendix-cloud-deploy#flexible-environments). |
