...
* We introduced user guidance for first-time users. A guided product tour is now shown when you choose the **Start Your First App** from the **Introduction Tour** category when creating an app in the [Mendix Developer Portal](https://sprintr.home.mendix.com/).
