...
For a details on custom actions, please see [Custom Actions](/addons/ats/refguide/rg-version-1/custom-actions) in the ATS Reference Guide 1.
 
These are the definitions of Mendix actions and Core actions:

* Mendix actions are a combination [Mendix actions](/addons/ats/refguide/rg-version-1/mendix-actions) and [Mendix App Store widget actions](/addons/ats/refguide/rg-version-1/mendix-appstore-widgets-actions)
* Core actions are a combination of [ATS Core actions](/addons/ats/refguide/rg-version-1/ats-core-actions) and [Selenium actions](/addons/ats/refguide/rg-version-1/selenium-actions)
...
| Waiting for background processes | A Mendix action waits untill the Mendix app is finished rendering. This aspect is also covered by the [Mendix Wait](/addons/ats/refguide/rg-version-1/mendix-wait) action.<br> |
...
![](attachments/ht1-guidelines-custom-action/mendix-action-input-parameters.png)
...
For more information, please see [Mendix wait](/addons/ats/refguide/rg-version-1/mendix-wait).
...
When defining action parameters, always use the ATS [naming conventions](/addons/ats/refguide/rg-version-1/best-practices).
...
![](attachments/ht1-guidelines-custom-action/standard-input-parameters.png)
...
![](attachments/ht1-guidelines-custom-action/datatype-web-element.png)

The JavaScript actions have three different versions, based on the data types:

* [Execute Javascript Integer](/addons/ats/refguide/rg-version-1/execute-javascript-integer)
* [Execute Javascript String](/addons/ats/refguide/rg-version-1/execute-javascript-string)
* [Execute Javascript WebElement](/addons/ats/refguide/rg-version-1/execute-javascript-webelement)
