...
<<<<<<< HEAD:content/en/docs/data-hub/data-hub-catalog/integrate-with-catalog/write-data/_index.md
...
>>>>>>> development:content/en/docs/catalog/integrate-with-catalog/write-data/_index.md
weight: 20
aliases:
    - /catalog/write-data/
---
