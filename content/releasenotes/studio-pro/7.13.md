...
* You can now trigger nanoflows from custom widgets as well. For more information, see [Build Widgets with XML](/howto7/extensibility/use-xml-widget) and [Namespace: data](https://apidocs.rnd.mendix.com/7/client/mx.data.html#.callNanoflow) in the Client API.
