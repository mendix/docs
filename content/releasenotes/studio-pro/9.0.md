...
{{% alert type="info" %}}
For details on converting your app project for Studio Pro 9, see [Moving from Studio Pro 8 to Studio Pro 9](/refguide/moving-from-8-to-9).
{{% /alert %}}
...
* The previously deprecated API for globally styling the status bar and header of native pages has been removed. Use the [Page and Layout classes](https://docs.mendix.com/refguide/native-styling-refguide#pages) instead.
