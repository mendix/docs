...
{{% alert type="info" %}}For more information on this release, see the [Release 9.10 – Kickstart the New Year](https://www.mendix.com/blog/release-9-10-kickstart-the-new-year/) blog post and video.{{% /alert %}}
