...
These are Mendix Studio release notes for app projects built with Desktop Modeler versions 7.15–7.22. The release notes include all minor versions, patches, and known issues.
...
For Studio release notes correlated with Studio Pro version 8 and above, see [8.0 & Above](8.0-and-above).

For Studio release notes correlated with Studio Pro version 7.23, see [7.23](7.23). 
