...
We have decided to retract version 7.17.0 due to an issue with the session manager in clustered environments and an issue that breaks the styling of your app once deployed to the cloud. This will be fixed in 7.17.1.
