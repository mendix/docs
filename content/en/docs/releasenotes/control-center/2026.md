...
* We have introduced the **Consumption** page in the **Maia** section of Control Center. This page allows company admins to monitor Maia Units usage and manage consumption limits for individual users. For more information, refer to [Maia Consumption](/control-center/maia-consumption/).

### September 7, 2026

#### New Features

* We have introduced the Maia Settings page in Control Center. This page allows company admins to manage Maia access and usage limits for their organization. These settings apply to both the Mendix Portal and Studio Pro, providing centralized control over Maia availability and company-wide usage. For more information, refer to [Maia-Settings](/control-center/maia-settings/).

#### Improvements

* We updated the Maia Resources [Usage](/control-center/maia-resources/#usage) list to return only active users of the company.
...
* We have introduced the **Usage** section in Maia Resources Control Center page. This section provides an overview of each user’s usage for the current month. It also enables company admins to manage budgets by setting usage caps for individual users. For more information refer to [Usage](/control-center/maia-resources/#usage).
...
* We have introduced the **Monthly Consumption** overview in Maia Resources Control Center page. This section displays the company’s Maia Unit usage for the current monthly cycle. For more information, refer to [Monthly Consumption](/control-center/maia-resources/#consumption).
...
* We have introduced **Maia Resources** page in Control Center. This page allows company admins to provision, upgrade, downgrade, and deprovision Maia Units and manage the resources for Maia Make for their company.
    For details, refer to [Maia-Resources](/control-center/maia-resources/).
