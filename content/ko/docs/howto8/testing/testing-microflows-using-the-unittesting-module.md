---
title: "Unit Testing 모듈을 사용하여 Microflow 테스트하기"
linktitle: "Unit Test 모듈로 Microflow 테스트하기"
...
비즈니스 로직으로 앱을 더 스마트하게 만들려면 Microflow를 사용할 수 있습니다. Microflow가 예상대로 작동하는지 확인하려면 Unit Testing 모듈을 사용하여 단위 테스트를 만들 수 있습니다. Unit Testing 모듈은 단위 테스트를 관리하고 실행하기 위한 사용하기 쉬운 인터페이스를 제공합니다. 이 모듈은 Microflow를 사용하여 생성된 단위 테스트와 JUnit을 사용하여 생성된 단위 테스트를 지원합니다.

이 사용 방법 가이드에서는 다음을 배우게 됩니다:

* Unit Testing 모듈 설정하기
* Microflow 단위 테스트 만들기
