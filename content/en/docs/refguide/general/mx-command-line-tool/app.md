...
| `--sprintr-app-id`     | Optional          | Associates the app [feedback features](/developerportal/app-insights/feedback/) with the provided [app](/developerportal/#my-projects) in **Projects**. The value is a GUID. You can find this ID in the browser URL when you access the app in [Projects](https://projects.home.mendix.com/) (for example, `1a428ea7-b00e-4166-9b23-20b7be88a40e`). |
