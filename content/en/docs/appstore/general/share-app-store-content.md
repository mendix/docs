...
These are the OSS licenses and requirements:
...
| **License Name** | **Commercial Use allowed?** | **Component Code Needs to Be in Public Repo?** | **License Text Required with Copyright Information in Code & Distribution Artifact?** | **Can Modify?** (Modifications to the code should be mentioned) | **Can Consuming Apps Use Without Publicly Putting Their Code?** | **Notice Files Should Be Distributed with Artifact?** | **Original Component Source Code to Be Distributed with Consuming App?** | **Can Sub-License?** |
| --- | --- | --- | --- | --- | --- |  --- | --- | --- |
| **Apache 2.0** | Y | Y | Y | Y | Y | Y | N | Y |
| **Mendix EULA (Commercial)** | Y (Should only be used by components developed by Mendix R&D) | N | Y (Or a link to Mendix Common Terms & Conditions) | N | Y | Y | N | (As per governing terms & conditions) |
| **MIT**| Y | Y | Y | Y | Y | Y | N | Y |
| **BSD 2.0,3.0** | Y | Y | Y | Y | Y | Y | N | Y |
| **Apache 1.0** | Y | Y | Y | Y | Y | Y | N | Y |
| **GPL v1/v2/v3** | Y | Y | Y | N (Modification has strong copyleft, so this is discouraged) | N | Y | Y | N |
...
| **Creative Commons CC0 1.0 Universal (CC-0)** (Public Domain) | Y | N | N | Y | Y | N | N | Y |

These are the Siemens license requirements:
...
| **License Name** | **Commercial Use allowed?** | **Component Code Needs to Be in Public Repo?** | **License Text Required with Copyright Information in Code & Distribution Artifact?** | **Can Modify?** (Modifications to the code should be mentioned) | **Can Consuming Apps Use Without Publicly Putting Their Code?** | **Notice Files Should Be Distributed with Artifact?** | **Original Component Source Code to Be Distributed with Consuming App?** | **Can Sub-License?** |
| --- | --- | --- | --- | --- | --- |  --- | --- | --- |
| **MindSphere Development License Agreement** | Y (Should only be used by components developed by Siemens) | N | Y | N | Y | Y | N | (As per governing terms & conditions) |
| **SDISW Development License Agreement for Mendix Sample Apps EXTERNAL** | Y (Should only be used by components developed by Siemens) | N | Y | N | Y | Y | N | (As per governing terms & conditions) |
| **SDISW End-User License Agreement for Mendix Connectors and Widgets** | Y (Should only be used by components developed by Siemens) | N | Y | N | Y | Y | N | (As per governing terms & conditions) |
| **SDISW End-User License Agreement for Mendix Connectors and Widgets EXTERNAL** | Y (Should only be used by components developed by Siemens) | N | Y | N | Y | Y | N | (As per governing terms & conditions) |
| **SDISW End-User License Agreement for Mendix Sample Apps** | Y (Should only be used by components developed by Siemens) | N | Y | N | Y | Y | N | (As per governing terms & conditions) |
