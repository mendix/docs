...
* Support for `dojo.require` has been dropped. It never worked in hybrid apps, and we have now made it official. Write your custom widgets in the AMD style, as described in [How to Basic Hello World Custom Widget](/howto7/custom-widget-development/create-a-basic-hello-world-custom-widget) and the [App Store Widget Boilerplate](https://github.com/mendix/AppStoreWidgetBoilerplate).
