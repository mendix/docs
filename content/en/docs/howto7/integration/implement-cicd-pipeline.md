...
{{< figure src="/attachments/howto7/integration/implement-cicd-pipeline/01APIRightsCloudPortal.png" class="no-border" >}}
...
{{< figure src="/attachments/howto7/integration/implement-cicd-pipeline/02GetLatestRevision.png" class="no-border" >}}
...
{{< figure src="/attachments/howto7/integration/implement-cicd-pipeline/03StartBuildingPackage.png" class="no-border" >}}
...
{{< figure src="/attachments/howto7/integration/implement-cicd-pipeline/04RetrievePackageStatus.png" class="no-border" >}}
...
{{< figure src="/attachments/howto7/integration/implement-cicd-pipeline/05GetEnvironment.png" class="no-border" >}}
...
{{< figure src="/attachments/howto7/integration/implement-cicd-pipeline/06TransportDeploymentPackageToEnvironment.png" class="no-border" >}}
...
{{< figure src="/attachments/howto7/integration/implement-cicd-pipeline/07StartEnvironment.png" class="no-border" >}}
...
{{< figure src="/attachments/howto7/integration/implement-cicd-pipeline/08StartEnvironmentStatusStarting.png" class="no-border" >}}
...
{{< figure src="/attachments/howto7/integration/implement-cicd-pipeline/10StartUnitTests.png" class="no-border" >}}
...
{{< figure src="/attachments/howto7/integration/implement-cicd-pipeline/11UnitTestsStatus.png" class="no-border" >}}
...
{{< figure src="/attachments/howto7/integration/implement-cicd-pipeline/13RestExampleVSTS_cut.png" class="no-border" >}}
