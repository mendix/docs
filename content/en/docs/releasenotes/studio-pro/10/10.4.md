...
* We fixed an issue in the microflow properties dialog box where it was not possible to toggle off the **Expose as microflow action** and **Expose as nanoflow action** options.
