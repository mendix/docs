...
* [Apply jump-to option](/refguide/apply-jump-to-option/) – applies the selected target workflow activity to continue the workflow execution from
...
* [Generate jump-to options](/refguide/generate-jump-to-options/) – generates a list of workflow activities as possible targets to jump to
