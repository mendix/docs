...
{{< figure src="/attachments/refguide8/modeling/pages/common-widgets/text/text.png" alt="Text Widget" class="no-border" >}}
...
{{< figure src="/attachments/refguide8/modeling/pages/common-widgets/text/text-properties.png" alt="Text Properties"   width="300"  class="no-border" >}}
...
* Double-click the text widget on the page and click **Edit** in the **General** section > **Caption**:
    ...
    {{< figure src="/attachments/refguide8/modeling/pages/common-widgets/text/caption-edit-button.png" alt="Opening Parameters" class="no-border" >}} 
...
3. In the **Edit Caption** dialog box > **Parameters** section click **New**:
    ...
    {{< figure src="/attachments/refguide8/modeling/pages/common-widgets/text/adding-parameter.png" alt="Adding New Parameter" class="no-border" >}}
