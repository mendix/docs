...
* We added support for [Studio Pro 7.22.1](../desktop-modeler/7.22).
...
* We added support for [Studio Pro 7.22](../desktop-modeler/7.22).
...
* We added support for [Studio Pro 7.21](../desktop-modeler/7.21).
...
* We added support for [Studio Pro 7.20.1](../desktop-modeler/7.20).
...
* We added support for [Studio Pro 7.20](../desktop-modeler/7.20).
...
* We added support for [Studio Pro 7.19](../desktop-modeler/7.19).
 ...
 * We re-added support for [Studio Pro 7.18](../desktop-modeler/7.18). The known issue with consistency error checking in Mendix version 7.18.0 has been resolved in version [7.18.1](../desktop-modeler/7.18#68234). Stduio users with apps in Mendix version 7.18.0 can now upgrade their apps when opening Studio in order to continue building and publishing.
...
* We added support for [Studio Pro 7.18](../desktop-modeler/7.18).
...
* We added support for [Studio Pro 7.17.2](../desktop-modeler/7.17).
...
* We added support for [Studio Pro 7.17](../desktop-modeler/7.17).
...
* We added support for [Studio Pro 7.16](../desktop-modeler/7.16). Studio supports ranges for Mendix Studio Pro. This gives you choice in whether to update Studio right away, or postpone the update. For more information on the topic, see [Studio Versions & Mendix Versions Correlation](/studio/general-versions).
