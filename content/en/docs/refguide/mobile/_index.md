...
As your native mobile app is getting more complex, monitoring your app's behavior and users' interactions becomes an essential part of your app development cycle, therefore mendix supports sending default and custom logs of different levels from the mendix native app to [MxRuntime](refguide/runtime/) so that app's adminstrators can monitor and have a better insgith about different app's states and an improved overview for troubleshooting. To learn more about logging in native mobile apps, checkout [Logging](/refguide/mobile/logging/) section.