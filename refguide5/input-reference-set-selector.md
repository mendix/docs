...
The input reference set selector is an [input widget](/refguide5/input-widgets) that can be used to display and edit [associations](/refguide5/associations) for which the multiplicity setting is configured to allow multiple parent objects to associate with multiple children. This type of association is also known as a reference set.

<div class="alert alert-info">{% markdown %}

![](attachments/4522250/4751429.jpg)
The multiplicity settings of an association can be found by double-clicking the association in the [domain model](/refguide5/domain-model).
