...
* To speed up the process of app creation and to give you more assistance in it, Mendix Studio checks your app for consistency in real-time now. This means you no longer have to first try to preview or publish your app to see if any check fails and you have to fix it. For example, Mendix Studio checks if any necessary properties of elements are missing and you will see it right away. 
