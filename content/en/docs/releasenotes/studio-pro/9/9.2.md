...
description: "The release notes for Mendix Studio Pro 9.2 (including all patches) with details on new features, bug fixes, and known issues."
weight: 98
---

{{% alert color="info" %}}For an overview of the highlights in this release, see the [Mendix Release 9.2](https://www.mendix.com/blog/mendix-9-2-0-a-modern-grid-for-a-multi-experience-world/) blog post.{{% /alert %}}
...
* We added quick navigation from a [menu widget](/refguide9/menu-widgets/) to a navigation document.
    ...
    {{% alert color="info" %}}This is based on an [upvoted idea from Fabian Recktenwald](https://community.mendix.com/link/ideas/678) submitted to the Mendix Community. Thanks, Fabian!{{% /alert %}}
...
* <a id="1866"></a>We fixed an issue where you could not drag an entity from the [Data Hub pane](/refguide9/data-hub-pane/) to the domain model editor when Studio Pro was displayed on a secondary screen. You can now do that again.
