...
description: "Mendix Marketplace에서 사용할 수 있는 AWS Lambda 커넥터의 구성 및 사용법을 설명합니다. AWS Lambda는 서버를 프로비저닝하거나 관리하지 않고도 거의 모든 유형의 애플리케이션 또는 백엔드 서비스에 대한 코드를 실행할 수 있는 서버리스 이벤트 기반 컴퓨팅 서비스입니다."
weight: 20
aliases:
