...
description: "Mendix on Kubernetes에서 스토리지 플랜을 구성하는 방법을 설명합니다."
weight: 10
...
### 스토리지 플랜 생성 및 테스트 {#typical-workflow}
...
## Blob File Storage 플랜 {#blob-storage}
