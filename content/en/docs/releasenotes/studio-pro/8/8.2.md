...
{{% alert color="info" %}}
This is based on an upvoted idea from [Andrej Gajduk](https://forum.mendixcloud.com/link/ideas/741) submitted to the Mendix Idea Forum. Cheers, Andrej!
{{% /alert %}}
...
* When using the expression editor's autocomplete function, the best matching records are now displayed first.
    ...
    {{% alert color="info" %}}This is based on an upvoted idea from [Luuk de Bakker](https://forum.mendixcloud.com/link/ideas/1496) submitted to the Mendix Idea Forum. Cheers, Luuk!{{% /alert %}}
