---
title: "플러그형 웹 위젯 빌드: 파트 2 (고급)"
linktitle: "2. 플러그형 웹 위젯 빌드"
url: /howto/extensibility/create-a-pluggable-widget-two/
weight: 20
description: "TextBox 입력 위젯에 고급 기능을 추가하는 방법을 알려주는 하우투입니다."
---
...
* onChange Action 생성
* 스크린 리더 접근성 개선 
* Mendix Studio Pro에서 미리보기 모드 활성화
