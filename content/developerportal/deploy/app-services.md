...
{{% alert type="info" %}}
App services are deprecated and from Studio Pro [8.18](/releasenotes/studio-pro/8.18) and [9.0](/releasenotes/studio-pro/9.0), they are no longer supported. They are replaced by [published web services](/refguide/published-web-services) and [published REST services](/refguide/published-rest-services).
{{% /alert %}}
