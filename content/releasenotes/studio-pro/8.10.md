...
* <a name="101587"></a>We fixed an issue where the output of an [Import with mapping](/refguide/import-mapping-action) activity was incorrectly set to **Nothing** (with error CE0366). (Tickets 101587, 101786, 102227, 102287, 102621, 102641)
