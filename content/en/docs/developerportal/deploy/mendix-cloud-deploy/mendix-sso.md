...
Give end-users access to your app through the [Manage App Users](/developerportal/general/general-settings/#managing-app-users) page of the Developer Portal. You can get to this page in the Developer Portal from the **General Settings** page of your app.
