...
url: /howto/general/translate-your-app-content/
...
3. Create a domain model in MyFirstModule with two entities:
	...
	* **Product** with the **String** attribute **ProductName**
		...
		{{< figure src="/attachments/howto/general/translate-your-app-content/domain-model.png" alt="Domain model for How To" >}}
...
5. In the **Generate pages** dialog box, ensure both entities are selected and click **OK**.
	...
	{{< figure src="/attachments/howto/general/translate-your-app-content/generate-pages.png" alt="Options selected for Generate Pages" >}}
...
7. Change the text on the new button to **Order**. You will use this button to allow the end-user to order the product they are viewing. Ignore the warnings about the setup of this button.
	...
	{{< figure src="/attachments/howto/general/translate-your-app-content/order-button.png" alt="Product New Edit page with an Order button" >}}

8. Open the page **Home_Web** and put some text into the title and subtitle.

	{{< figure src="/attachments/howto/general/translate-your-app-content/home-page-text.png" alt="Product New Edit page with an Order button" >}}
...
4. Click **OK** to save the changes. The **Add Language** dialog box closes.
   ...
   {{< figure src="/attachments/howto/general/translate-your-app-content/language-settings.png" alt="Language settings tab in the app settings dialog" >}}
...
2. Select **Russian, Russia** to make that your current language.
	...
	{{< figure src="/attachments/howto/general/translate-your-app-content/change-language.png" alt="Change the current language" >}}
...
1. Open the **Home_Web** page in Studio Pro.
	...
	{{< figure src="/attachments/howto/general/translate-your-app-content/untranslated-texts.png" alt="untranslated-texts" >}}
	
2. Enter your translation for the two text items on the page.

	{{< figure src="/attachments/howto/general/translate-your-app-content/home-page-russian.png" alt="Home page with translated text" >}}
...
5. Make sure only the module **MyFirstModule** is selected. This can restrict batch translation to this module.
    ...
    {{< figure src="/attachments/howto/general/translate-your-app-content/batch-translate-myfirstmodule.png" alt="Select only MyFirstModule" >}}
...
6. Click **OK**. You can now see all the translatable texts in your module. The **Translation (Russian, Russia)** column shows the individual translations you made in the previous section. The **#** column shows the number of times each text appears in the selected module(s).
    ...
    {{< figure src="/attachments/howto/general/translate-your-app-content/batch-translate-initial.png" alt="Translatable texts in MyFirstModule" >}}

7. Enter translations in the **Translation (Russian, Russia)** column for a few terms: **Cancel**, **Delete**, and **Edit**, for example.

    {{< figure src="/attachments/howto/general/translate-your-app-content/batch-translate-cancel-delete-edit.png" alt="Translate Cancel, Delete, and Edit into Russian" >}}
...
10. Open the **Product_NewEdit** page. The related terms now have Russian translations.
	...
	{{< figure src="/attachments/howto/general/translate-your-app-content/product-new-edit-partial-translation.png" alt="Product New Edit page showing the cancel button translated into Russian" >}}
...
3. In the grid, click the translatable text **Order**. The **#** column shows that there are three places where this text is used. The locations are listed in the **Show occurrence** section.
	...
	{{< figure src="/attachments/howto/general/translate-your-app-content/batch-translate-order.png" alt="All source texts containing the word 'order' with the locations of the text 'order' shown" >}}
...
4. In the **Show occurrence** section, the **Object** column shows that one of the locations of the text **Order** is the **Action button 'actionButton3'** on the **Product_NewEdit** page. This is the button we added to allow the end-user to order the product. To confirm this, double-click the row of **Action button 'actionButton3'**.
   ...
   {{< figure src="/attachments/howto/general/translate-your-app-content/product-new-edit-order.png" alt="Order button on Product New Edit page" >}}
...
8. Edit the text on the button to reflect the verb *to order*. In Russian this is *заказать*.
   ...
   {{< figure src="/attachments/howto/general/translate-your-app-content/product-new-edit-order-russian.png" alt="Order button on Product New Edit page translated into Russian" >}}
...
9. Go to the **Language** > **Batch Translate** to open the dialog box and search for *Order* in the module **MyFirstModule**. 
   ...
   {{< figure src="/attachments/howto/general/translate-your-app-content/batch-translate-order-split.png" alt="All source texts containing the word 'order' showing that ones with different translations are shown separately. " >}}

10. In the row where **Order** has no translation, enter *Заказ*. This is the Russian translation for *an order*.

    {{< figure src="/attachments/howto/general/translate-your-app-content/batch-translate-order-2-translations.png" alt="All source texts containing the word 'order' showing two different translations for Order. " >}}
...
2. Select the menu item **Language** > **Batch replace**.
	...
	{{< figure src="/attachments/howto/general/translate-your-app-content/batch-replace-russian-initial.png" alt="All texts which have been translated into Russian." >}}
...
3. Enter the new text in the **Replace with** column.
	...
	{{< figure src="/attachments/howto/general/translate-your-app-content/batch-replace-russian-capitals.png" alt="All texts which have been translated into Russian." >}}
...
2. Click **Add** to add **Belarusian, Belarus** as an app language.
   ...
   {{< figure src="/attachments/howto/general/translate-your-app-content/language-settings-belarusian.png" alt="Belarusian added to the app" >}}
