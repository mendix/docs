...
* For the app ID, select **Collaborate** > **General Settings** – you will find the ID at the bottom of the page:
    ...
    {{< figure src="/attachments/developerportal/general/general-settings/manage-deeplinks/app-id.png" width="500px" alt="App ID on General Settings page" >}}
...
* For the story ID, select **Collaborate** > **Stories** – then click the story title to show the details, the ID is below the story title:
    ...
    {{< figure src="/attachments/developerportal/general/general-settings/manage-deeplinks/story-id.png" width="500px" alt="Story ID on Stories page" >}}

* For the feedback item number, select **Collaborate** > **Feedback** – the number is next to the feedback item title:

    {{< figure src="/attachments/developerportal/general/general-settings/manage-deeplinks/feedback-nr.png" width="500px" alt="Feedback item number on Feedback page" >}}
