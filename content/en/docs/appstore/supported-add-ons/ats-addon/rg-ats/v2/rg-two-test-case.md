---
title: "Test Case"
url: /appstore/supported-add-ons/ats/rg-two-test-case/
---

## 1 Introduction

A test case is a set of [test steps](/appstore/supported-add-ons/ats/rg-two-test-step/) that exercise a particular program path or verify compliance with a specific need. The point of running the test is to check if your app is fully functional. For example, whether a user can perform a certain task in your app or not.
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-test-case/testcase-details.png" >}}

{{% alert color="info" %}}

Please note that there is an additional switch for **paralell**/**sequential**. This switch is only available for [data driven test cases](/appstore/supported-add-ons/ats/rg-two-data-driven-testing/).
...
| Name                   | Description                              |
| ---------------------- | ---------------------------------------- |
| Run                    | If the test case has been executed before, it runs with the configuration of the previous run. Otherwise, the [Run Configuration](/appstore/supported-add-ons/ats/rg-two-test-run/) page will open. |
| Edit Run Configuration | Opens the [Run Configuration](/appstore/supported-add-ons/ats/rg-two-test-run/) page. |
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-test-case/search-button.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-test-case/select-function-action.png" >}}.

After you have found the desired action, add it to your test case as a test step by selecting it and clicking **Select**.

Another way of adding test steps to a test case is to use the recorder by clicking **Record step**. For more information, see [Recorder](/appstore/supported-add-ons/ats/rg-two-recorder/).

The details of a test step open by clicking the test step. For more information, see [Test Step](/appstore/supported-add-ons/ats/rg-two-test-step/).
...
| Icon                                     | Meaning  |
| ---------------------------------------- | -------- |
| {{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-test-case/setting-gears-2.png" >}} | Setup    |
| {{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-test-case/hammer-2.png" >}}       | Teardown |

For more information about the call types of test steps, see [Test Step](/appstore/supported-add-ons/ats/rg-two-test-step/).

## 4 Test Data

Under the **Test Data** tab, you can set a primary dataset for your test case. You can now link the fields of the primary dataset to your test steps. Note that the test case runs a separate session for every record in the primary dataset. For more information on how to use datasets in your test cases, see [Data Driven Testing](/appstore/supported-add-ons/ats/rg-two-data-driven-testing/).
