...
description: "Mx11에서 pluggable widget의 동작에 영향을 미치는 Configuration Module API를 이해하기 위한 가이드입니다."
weight: 35
aliases:
...
## 오브젝트 그리드 사용자 정의하기 {#customize-object-grids}
