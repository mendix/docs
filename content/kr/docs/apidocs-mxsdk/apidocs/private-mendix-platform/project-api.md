...
Private Mendix Platform Project API를 사용하면 Private Mendix Platform에서 프로젝트를 관리할 수 있습니다. API를 사용하여 다음을 수행할 수 있습니다:

* ID로 프로젝트 가져오기
* 현재 사용자의 모든 프로젝트 목록 가져오기
* 프로젝트 생성 또는 삭제
* 프로젝트 생성 상태 검색
* 프로젝트 이름, 설명 또는 상태 변경
* 프로젝트의 소유 사용자 및 그룹 변경
* 모든 프로젝트 팀 구성원 가져오기
* 프로젝트에서 구성원 및 그룹 추가 또는 제거
