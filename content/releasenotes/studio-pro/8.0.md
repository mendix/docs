...
* Azure SQL Database currently identifies itself as a variant of SQL Server 2014 even though it supports newer features. As SQL Server 2014 is not supported, Mendix runtime will refuse to connect to this database.
