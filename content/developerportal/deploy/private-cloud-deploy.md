...
For this to work properly, you need to set the [ApplicationRootURL](/refguide/custom-settings#2-general-settings) **Custom Runtime Settings** in the **Runtime** tab to the app's URL.
