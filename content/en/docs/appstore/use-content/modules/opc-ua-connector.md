...
* An OPC-UA server 1.03 or above
...
{{% todo %}}Add the image to step 4?The style of a message security mode Sign or sign&encrypt?{{% /todo %}}
...
{{% todo %}}Where is the configuration menu item?{{% /todo %}}
