...
| Hide On Phone/Tablet/Desktop                             | Hides the selected widget on the phone, tablet, or desktop both on the preview and after publishing. | Enabled/Disabled                                             |
...
| Full Width | The button takes the whole width of a layout element it is placed in. For more information on layout elements, see [Layout Widgets in the Web Modeler](page-editor-widgets-layouts-wm). | Enabled/Disabled                                             |
