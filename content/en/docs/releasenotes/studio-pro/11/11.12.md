...
* We fixed an issue with the the External Database Connector where the editor crashes when an entity attribute type changes from String to Enumeration. (Ticket 283590)
