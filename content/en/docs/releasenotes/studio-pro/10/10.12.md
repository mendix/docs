...
- We moved the XPath Visual Builder is now GA (it was in public beta).
...
* We fixed an error which occured when a new line is a part of the parameter value in the **Query External Database** activity.
