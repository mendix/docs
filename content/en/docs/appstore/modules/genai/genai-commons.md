...
#### 3.1.1 Chat Completions without history {#chat-without-history}
...
#### 3.1.2 Chat Completions with history {#chat-with-history}
...
##### 3.2.1.2 Chat: Add Stop Sequence {#add-stopsequence}
...
##### 3.2.1.3 Chat: Add Message to Request {#add-message}
...
##### 3.2.1.5 Files: Add File To Collection {#add-file}

Use this microflow to add subsequent files to an existing file collection.

##### 3.2.1.6 Tools: Add Function To Request {#add-function}
...
##### 3.2.1.7 Tools: Set Tool Choice {#set-toolchoice}
...
| `StopReason` | The reason why the model stopped to generate further content. <br /> See connector documentation for possible values. | 
