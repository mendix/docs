...
| <a id="ConnectionPoolingTestOnBorrow" href="#ConnectionPoolingTestOnBorrow">ConnectionPoolingTestOnBorrow</a> | If `true`, a database connection will be validated by the connection pool before returning it to the application. This can be useful in situations where database connections can be closed by processes outside of the Mendix runtime, like firewalls. Supported since Mendix 10.6.4 and 10.8.0. | false |
| <a id="ConnectionPoolingTestOnCreate" href="#ConnectionPoolingTestOnCreate">ConnectionPoolingTestOnCreate</a> | If `true`, a database connection will be validated by the connection pool after being created. Supported since Mendix 10.6.4 and 10.8.0. | false |
| <a id="ConnectionPoolingTestOnReturn" href="#ConnectionPoolingTestOnReturn">ConnectionPoolingTestOnReturn</a> | If `true`, a database connection will be validated by the connection pool when it is returned to the pool by the application. Supported since Mendix 10.6.4 and 10.8.0. | false |
| <a id="ConnectionPoolingTestWhileIdle" href="#ConnectionPoolingTestWhileIdle">ConnectionPoolingTestWhileIdle</a> | If `true`, a database connection will be validated when the idle object evictor runs. Supported since Mendix 10.6.4 and 10.8.0. | false |
...
| <a id="commendixwebuiHybridAppLoginTimeOut" href="#commendixwebuiHybridAppLoginTimeOut">com.<wbr>mendix.<wbr>webui.<wbr>HybridAppLoginTimeOut</a> | Determines how many minutes your token will remain valid before re-authenticating using your full credentials. If no value is set the token will never expire. | |
