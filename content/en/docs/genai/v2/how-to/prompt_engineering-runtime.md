...
1. Install the [Agent Commons module](/agents/agents-kit-2/reference-guide/genai-for-mx/agent-commons/) module and its dependencies from the Mendix Marketplace.
