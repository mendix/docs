...
* We added a **Sign-in/sign-out** menu (just like that which appears in the Studio Pro main window) to the **App Selector** window. [**VERIFY UI TEXT FOR NOTE**]
...
* We have improved the **Select/Open App** dialog box. It takes less time to open, and when loading apps from the Team Server takes a long time, a list is shown with the apps present on the local machine.
