...
Private Mendix Platform can now use the Mendix Operator in [Global](/developerportal/deploy/global-operator/) mode. For more information about enabling this option, refer to the [Quickstart Guide](/private-mendix-platform/quickstart/).
