...
* We fixed an issue where newly-added Company Admins did not get access to edit [user groups](/appstore/overview/app-store-overview/#content-groups) in the Marketplace.
