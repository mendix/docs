...
Now you can use the [`isNew`](/refguide7/special-checks/#new) and [`isSynced`](/refguide7/special-checks/#synced) function associations of a context object to identify uncommitted objects as well as committed-but-not-synced objects (in offline apps). Have fun!
