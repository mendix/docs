---
title: "Agent Editor"
url: /agents/agents-kit-1/reference-guide/agent-editor/
linktitle: "Agent Editor"
description: "Agents Kit 1: Describes the purpose, configuration, and usage of the Agent Editor and Agent Editor Commons modules from Mendix Marketplace that allow developers to build, define, and refine agents, and integrate GenAI principles and agentic patterns into their Mendix app."
aliases:
    - /appstore/modules/genai/genai-for-mx/agent-editor/
---

{{% alert color="info" %}}
Looking for Mendix's newest agentic and generative AI features? [This page has been updated for Agents Kit 2](/agents/agents-kit-2/reference-guide/agent-editor/), which is available for Studio Pro 11.12 and above.
{{% /alert %}}
...
Configure [tool choice](/agents/agents-kit-1/reference-guide/commons/#enum-toolchoice) to control how the agent behaves with regard to tool calling.
...
If possible, confirm that the target endpoint is reachable from the running app runtime. You can do this, for example, by temporarily configuring it manually in the [MCP Client module](/agents/agents-kit-1/reference-guide/mcp-modules/mcp-client/) and checking the **Console** pane in Studio Pro for logs.
