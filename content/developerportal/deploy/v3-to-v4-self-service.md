---
title: "Self-service Migration to v4 of Mendix Cloud"
parent: "mxcloudv4"
menu_order: 5
description: "How to migrate your app from a Mendix Cloud v3 node to a Mendix Cloud v4 node using the self-service portal."
tags: ["App","Migrate","Developer Portal","v3","v4","Node"]
---

{{% todo %}}[New document or perhaps just update old document - migrating-to-v4. Needs editing]{{% /todo %}}
