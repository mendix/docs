...
description: "Mendix Marketplace의 Amazon SNS 커넥터의 구성 및 사용법을 설명합니다. Amazon Simple Notification Service(Amazon SNS)는 게시자에서 구독자(생산자 및 소비자라고도 함)로 메시지를 전달하는 관리형 서비스입니다."
weight: 20
aliases:
