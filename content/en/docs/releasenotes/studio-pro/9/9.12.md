...
* Scheduled events are not triggered on horizontally-scaled environments or single-node environments.
    * Fixed: Redeploy your app in the Mendix Portal or with the [buildpack](/refguide9/runtime-deployment/) release of [4.27.4](https://github.com/mendix/cf-mendix-buildpack/releases/tag/v4.27.4) or above.
