...
Deleting pages which previously were set as Default home page, Role-based home pages or were referenced from a Menu item in Offline navigation profile leads to unsolvable consistensy errors. Please keep these pages in your project until next Modeler release even if they are not in use anymore.
