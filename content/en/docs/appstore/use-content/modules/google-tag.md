...
{{< figure src="/attachments/appstore/use-contents/modules/google-tag/widget-basic-mode.png" class="no-border" >}}
...
{{< figure src="/attachments/appstore/use-contents/modules/google-tag/widget-advanced-event.png" class="no-border" >}}
...
{{< figure src="/attachments/appstore/use-contents/modules/google-tag/parameter-value-type.png" class="no-border" >}}
