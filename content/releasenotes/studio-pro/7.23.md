...
* We fixed an error in the **Call REST service** action where using a `DELETE` request with a body sent an empty body. (Ticket 92953, 103950)
* We fixed an issue which can cause 'session keep alive' to become defunct if a database connection becomes stale. (Tickets 102373, 103767, 103811) 
