...
We've extended ATS with a new simple API. Via this API, you can run your automated tests from any external tool. A good option for such a tool is Jenkins. We've documented how to set up Jenkins with ATS in a [How-to](/addons/ats/ht-two-ats-and-ci-cd).

### More Changes and Fixes

* There's a completely new [ATS Reference Guide](/addons/ats/rg-two-ats) for version 2.0.
