...
* We fixed an issue where the [ML Kit](/refguide/machine-learning-kit/) had an issue when the app was running.
...
* We fixed an issue with the search field with multiselect not working correctly with numeric attributes.
