...
* Now you can publish applications in Studio to different clouds: Mendix Cloud, SAP, IBM, or Mendix Private Cloud. For more information on how to publish your app, see [Previewing & Publishing Your App](/studio/publishing-app).
