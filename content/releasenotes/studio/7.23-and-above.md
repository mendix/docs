...
* You can secure your app from Studio now. Security allows you to restrict access to your app and prevent it from being publicly available. You can create different user roles and optimize user experience. For newly created apps, security is enabled automatically. For existing apps, you need to enable security before publishing you app. When you enable security, all the necessary checks and changes are performed automatically for your app. For more information, see [Security, Roles & Permissions]() in the *Studio Guide* and [Model Changes When Security Is Enabled in Studio]() in the *Studio Pro Guide*
