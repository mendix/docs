...
weight: 4
description: "XML Schema를 추가하고, Domain-to-XML 매핑을 만들고, 내보내기 로직을 설명합니다."
...
7. Drag a **Retrieve object(s)** activity from the **Toolbox** to the line between the start event and end event.
