...
description: "The release notes for Mendix Studio Pro 9.3 (including all patches) with details on new features, bug fixes, and known issues."
weight: 97
---

{{% alert color="info" %}}For an overview of the highlights in this release, see the [Mendix Release 9.3](https://www.mendix.com/videos/mendix-9-3-3-new-widgets-demo-atlas-3-improvements/) blog post.{{% /alert %}}
...
* The [Variables](/refguide9/view-menu/#variables) pane is now again opened automatically when a breakpoint in a microflow is hit.
...
* We fixed an issue where the List View Controls widget did not work in some cases when placed in a snippet.
...
* <a id="ki-315"></a>There is an issue with the exporting of user metrics that results in the [User Accounts and Login Sessions](/developerportal/operate/metrics/#Trends-appmxruntimesessions) graph being empty for apps deployed to the Mendix Cloud.
