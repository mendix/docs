...
On the upper-right corner, there is a **Copy Link** ({{% icon name="hyperlink" %}}) icon and a **More Options** ({{% icon name="three-dots-menu-horizontal" %}}) icon. Clicking **Copy Link** copies the link to the epic. Clicking **More Options** opens a pop-up menu that allows you to delete the epic.
