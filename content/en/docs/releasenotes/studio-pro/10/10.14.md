...
* <a id="fix-marketplace-modules"></a> We fixed a [known issue](/releasenotes/studio-pro/10.11/#ki-marketplace-modules) where version numbers of imported Marketplace modules did not present the module's version and mentioned the current Studio Pro version instead. 
