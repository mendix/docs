...
* You are now able to preview your app without publishing it. The **Preview** feature allows you to see how your app will look like for different end-users and to verify your own changes. As it has a different environment as the published app, you can use the **Preview** to experiment with changes and test them. For more information, see [Previewing & Publishing Your App](/studio/publishing-app) in the *Mendix Studio Guide*.
* To improve your user experience , we added an ability to filter your data for pages and microflows. In microflows, you can add a filter to the **Retrieve** activity, and in the page editor, it is possible to filter data in a list view and a data grid.  For more information, see [Data Filters](/studio/filters) in the *Mendix Studio Guide*.
* 

#### Improvements

* To avoid confusion, we cleared naming among variables, objects, and parameters in the microflow editor. 
