...
Atlas UI gives you a powerful tool to build a modern user experience. However, the flexibility of Mendix does not stop you from making your design system from scratch. This document will introduce you to the advanced options that module-level theme settings provide.
...
By excluding [layouts](/refguide/layout) or [page templates](/refguide/page-templates), developers can no longer use them to create a new page. Here is a small example of how to exclude Atlas Core layouts and page templates:
...
Filtering styling elements like [design properties](/apidocs-mxsdk/apidocs/design-properties) or [CSS classes](customize-styling-new) is useful when you do not want your developers to apply them. Here's a small example:
