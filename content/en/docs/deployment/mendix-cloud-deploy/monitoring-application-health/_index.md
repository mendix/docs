...
Warning Threshold | Not used.
Critical Threshold | Database has 5% freeable memory for XS21, XS20, S and Strato cloud resource packs. Database has 10% freeable memory for all other cloud resourc packs.
