...
When a widget expects an object from its data source and does not get it, or gets an object from another entity, this will cause errors in data consistency. 
