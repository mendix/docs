...
url: /appstore/supported-add-ons/ats/rg-one-clickdoubleclick/
---
...
Pass the WebElement you want to click as parameter for the action. To get the WebElement, use an action like [Find/Assert Widget](/appstore/supported-add-ons/ats/rg-one-findassert-widget/).
