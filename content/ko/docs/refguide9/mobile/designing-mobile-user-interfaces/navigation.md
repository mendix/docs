...
weight: 20
description: "Mendix의 Native 내비게이션에 대한 일반 정보를 제공합니다."
aliases:
...
{{< figure src="/attachments/refguide9/mobile/native-mobile/native-navigation/header.png" alt="An example of the default header on iOS."   width="250"  class="no-border" >}}
...
{{< figure src="/attachments/refguide9/mobile/native-mobile/native-navigation/bottombar.png" alt="An example of the default bottom bar on iOS."   width="250"  class="no-border" >}}
...
{{< figure src="/attachments/refguide9/mobile/native-mobile/native-navigation/singlestack.gif"   width="250"  class="no-border" >}}
...
{{< figure src="/attachments/refguide9/mobile/native-mobile/native-navigation/multiplestacks.gif"   width="250"  class="no-border" >}}
...
{{< figure src="/attachments/refguide9/mobile/native-mobile/native-navigation/popups.gif"   width="250"  class="no-border" >}}
