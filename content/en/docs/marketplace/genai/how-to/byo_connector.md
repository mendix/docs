...
{{< figure src="/attachments/genai/genai-howto-byo/connectors_diagram.png" alt="" >}}
...
{{< figure src="/attachments/genai/genai-howto-byo/GenAICommons_TextFiles_DomainModel.png" alt="" >}}
...
{{< figure src="/attachments/genai/genai-howto-byo/GenAICommons_DeployedModel_DM.png" alt="" >}}
...
{{< figure src="/attachments/genai/genai-howto-byo/EchoConnector_DomainModel.png" alt="" >}}
...
:-------------------------:|:-------------------------:
{{< figure src="/attachments/genai/genai-howto-byo/DeployedModel_Create.png" alt="" >}}  |  {{< figure src="/attachments/genai/genai-howto-byo/DeployedModel_SetMicroflow.png" alt="" >}}
...
{{< figure src="/attachments/genai/genai-howto-byo/EchoDeployedModel_CallLLM.png" alt="" >}}
