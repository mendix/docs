...
* The Core.execute(IContext context, String name, Object... params) method throws NullPointerException when it is used to execute a microflow that has List type parameters with a list containing one or more null elements.
