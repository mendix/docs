(function ($) {
    ...
    $(function () {
        ...
        template.innerHTML = `
            ...
            <span style="display: none; font-family: noto-sans; font-weight: 500; font-size: .75rem; padding: 2px 4px; border-radius: 4px; background-color: var(--bs-gray-900); color: #fff; vertical-align: middle; margin-left: .2rem; position: relative; text-wrap: nowrap;">
