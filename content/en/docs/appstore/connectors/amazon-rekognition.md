...
This service returns a list of `DetectModerationLabel` objects and associated objects.
...
This service returns a list of `DetectLabel` objects with associated objects.
...
This service returns a `DetectText` object with results.
...
This service returns a `DetectProtectiveEquipment` object with the results:
...
This service returns a `RecognizeCelebrity` object with results:
