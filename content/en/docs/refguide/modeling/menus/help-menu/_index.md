...
| **Open Log File Directory** | Opens the log files written by Studio Pro that can be used to see what might be the reason something went wrong in Studio Pro.These logs, organized into a 30-day archive, are useful for identifying errors or unusual behavior. Log files can also be used to share with Mendix Support when you submit a ticket. |
