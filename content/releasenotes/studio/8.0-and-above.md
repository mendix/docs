...
* In the page editor, we enhanced capabilities of the [layout grid](/studio/page-editor-widgets-structure#layout-grid), [rows](/studio/page-editor-widgets-structure#row), and [columns](/studio/page-editor-widgets-structure#column) by adding new settings to them. New layout grid gives you opportunity to build any kind of layout quicker. Changes can be outlined as following:

    *  Column width is easily influenced now, which gives you more flexibility to adjust the layout to your content or to a device type:

		<img src="../../studio/attachments/page-editor-widgets-structure/resizing-column.png" style="zoom:80%;" />
