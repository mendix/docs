...
* We fixed an issue with document export of a [dynamic label](/refguide/dynamic-label-document-template/) when the option **Render XHTML** is enabled. (Tickets 144111, 141843, 142237, 142342, 142378)
