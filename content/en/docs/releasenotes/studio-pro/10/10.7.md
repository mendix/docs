...
* We fixed an issue where the last row did not get imported from an Excel to the **Batch Translate** dialog box. (Tickets 199182, 202693)
...
* We fixed an issue where breakpoints were not updating.
