...
* We improved the way associated entities are selected. In the **Select Entity** dialog box, we added tooltips with explanations how entities are connected and why you may see one associated entity but not the other. 
