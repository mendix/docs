...
Main object has to have three objects called `container`, `cardLayout` and `fullWidthLayout`. `cardLayout` and `fullWidthLayout` will be applied automatically
depending on selected layout in widget properties.
