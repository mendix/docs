...
3. To prevent any errors, download the Excel file template from the **Import Initiatives** dialog box, and use it as the template to import your initiatives. When you prepare your Excel file, make sure it meets the following requirements:
   ...
   * The import file cannot contain any columns other than the ones that are allowed to be imported (with the exception of the ones from the export file that will not be imported).
   ...
   * The data and headers in your Excel file should meet the requirements as shown in the table below:
   ...
   | Column | Required                                                     | Format                       | Additional Constraints                                       | Example Value                          |
   | --------------------- | ------------------------------------------------------------ | ---------------------------- | ------------------------------------------------------------ | -------------------------------------- |
