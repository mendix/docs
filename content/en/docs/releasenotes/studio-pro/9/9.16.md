...
description: "The release notes for Mendix Studio Pro 9.16 (including all patches) with details on new features, bug fixes, and known issues."
weight: 84
---

{{% alert color="info" %}}For an overview of the highlights in this release, see the [Mendix Release 9.16](https://www.mendix.com/blog/mendix-release-9-16/) blog post.{{% /alert %}}
