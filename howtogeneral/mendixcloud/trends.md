...
### 1.1 Access to monitor trends 

To view the **Trends** you must have the permission to **Access the Monitoring**
...
### <a name="Trends-appmxruntimerequests"></a>2.1 Amount of handled external requests
...
### <a name="Trends-appmxruntimeconnectionbus"></a>2.2 Amount of database queries being executed
...
### <a name="Trends-appmxruntimesessions"></a>2.3 User accounts and login sessions
...
### <a name="Trends-appmxruntimejvmheap"></a>2.4 JVM Object Heap
...
### <a name="Trends-appmxruntimejvmprocessmemory"></a>2.5 JVM Process Memory Usage
...
### <a name="Trends-appm2eeserverthreadpool"></a>2.6 Threadpool for handling external requests
...
### <a name="Trends-appmxruntimethreads"></a>2.7 Total amount of threads in the JVM process
...
### <a name="Trends-appmxruntimecache"></a>2.8 Object Cache
...
### <a name="Trends-dbpgstatdatabaseVERSIONmain"></a>3.1 Mutations
...
### <a name="Trends-dbpgtableindexsizeVERSIONmain"></a>3.2 Index vs Table size
...
#### <a name="Trends-appcpu"></a>3.3.1 CPU
...
#### <a name="Trends-appmemory"></a>9.3.2 Memory
...
#### <a name="Trends-dbcpu"></a>3.4.1 CPU
...
#### <a name="Trends-dbmemory"></a>3.4.2 Memory
...
#### <a name="Trends-dbpgstatactivityVERSIONmain"></a>3.4.3 Database Connections
...
## <a name="Trends-dbdiskstatsiops"></a>4 Both Application and Database Node

{Introduction}

### <a name="Trends-appdiskstatsiops"></a>4.1 Disk IOPS
...
### <a name="Trends-appload"></a><a name="Trends-dbload"></a>4.2 Load
...
### <a name="Trends-appdiskstatslatency"></a><a name="Trends-dbdiskstatslatency"></a>4.3 Disk Latency
...
### <a name="Trends-appdiskstatsthroughput"></a><a name="Trends-dbdiskstatsthroughput"></a>4.4 Disk Throughput
...
### <a name="Trends-appdfabs"></a><a name="Trends-dbdfabs"><a name="Trends-dbdf"><a name="Trends-appdf"></a>4.5 Disk Usage
...
### <a name="Trends-appdiskstatsutilization"></a><a name="Trends-dbdiskstatsutilization"></a>4.6 Disk Utilization
