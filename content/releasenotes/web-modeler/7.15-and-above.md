...
* To give you a better preview of the pages, we now display pages with a pop-up dialog rendering, when you use the pop-up layout.
* To improve the user experience, we now display the real rendering of drop-down buttons in the Page editor.
* If you have added several tabs on a page in the Desktop Modeler, you now can switch between these tabs in the Web Modeler too and view the content of them. This improves the collaboration between developers in the Web Modeler and the Desktop Modeler. 

#### Fixes

* We fixed the issue where the Web Modeler crashed when you had list view templates. 
* We fixed the issue where a user could not select inherited attributes when initializing or setting values for microflow activities.
