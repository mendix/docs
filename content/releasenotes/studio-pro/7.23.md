...
{{% alert type="info" %}}
This the [LTS](lts-mts#lts) version 7 release for apps in production. 
{{% /alert %}}

{{% alert type="warning" %}}
There is an issue with installing Studio Pro for the first time due to inability to automatically download the Visual C++ 2010 SP1 Redistributable (x64). This does not occur if you already have the redistributable or Studio Pro already installed. Workaround: Download and install [Visual C++ 2010 SP1 Redistributable (x64)](https://download.microsoft.com/download/1/6/5/165255E7-1014-4D0A-B094-B6A430A6BFFC/vcredist_x64.exe), then install Studio Pro.
{{% /alert %}}
