...
{{% button color="info" href="https://marketplace.mendix.com/link/studiopro/7.20.1" text="Download in Marketplace" title="Download version 7.20.1 from the Marketplace" %}}
...
{{% button color="info" href="https://marketplace.mendix.com/link/studiopro/7.20.0" text="Download in Marketplace" title="Download version 7.20.0 from the Marketplace" %}}
...
* We fixed an issue in [XML schemas](/refguide7/xml-schemas/) where namespace prefixes could not be resolved inside WSDLs.
    ...
    {{% alert color="info" %}}This is based on a [question from Jan de Lange](https://forum.mendixcloud.com/link/questions/91462) asked on the [Mendix Forum](https://forum.mendixcloud.com). Thanks for bringing this to our attention, Jan!{{% /alert %}}
