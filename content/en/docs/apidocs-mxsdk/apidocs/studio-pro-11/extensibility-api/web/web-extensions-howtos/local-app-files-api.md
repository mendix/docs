...
* Add three new event handlers for savbing, loading, and deleting a file called `HelloWorld.txt`
...
The following sections explain the various parts of the code you will add in the example below.
...
Add all the code described in the sections above by following these steps:
