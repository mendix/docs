...
For more details, refer to [Mobile](/addons/ats/rg2-mobile) in the *ATS Reference Guide*.
...
For all the details please refer to [results section in the ATS reference guide](/addons/ats/rg2-results).
