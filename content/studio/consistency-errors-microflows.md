...
| CE1827     | The Context Object should be of type '{WORKFLOW_CONTEXT_TYPE}' or a specialization of it. | Call Workflow action                                         | This action requires you to pass an object of the same type as is configured in the workflow properties > Data > Workflow Entity. For more information, see the [Data](workflow-properties#data) section in *Workflow Properties*. |                                                              |
| CE1831     | All 'Complete task' actions should have an outcome selected from the same user task. | Complete task action                                         | Outcomes from different user tasks are selected in different Complete Task actions. |                                                              |
