...
* Documentation is now available. We added the *Web Modeler* category to the Mendix reference guide to improve your understanding of the Web Modeler. You can now read about the main features, concepts, and definitions, as well as learn how to perform different actions. For more information, see [Web Modeler](/refguide/web-modeler/). 

#### Fixes

* We fixed the issue where the **Carousel** custom widget could crash the Web Modeler when you configured the **Static Images** property. 
