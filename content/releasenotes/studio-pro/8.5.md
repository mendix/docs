...
* On MySQL 8.0.19 or higher, when violating a Unique Validation rule for an attribute, instead of the configured error message for the validation rule, the generic error message "An error occured, please contact your system administrator." may be shown. This will be fixed in Mendix Studio Pro 8.6.0.
