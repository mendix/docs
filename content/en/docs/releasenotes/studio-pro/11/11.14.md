...
- We upgraded the Java Migration Tool that is downloaded by the Studio Pro installer to version 1.0.2. This versions adds a recipe to fix the deprecated `ActionListener.addBeforeEvent`, `ActionListener.addAfterEvent`, and the various `ListenersRegistry.register*Listener` methods.
