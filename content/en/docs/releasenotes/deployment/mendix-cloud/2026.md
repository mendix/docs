...
* We introduced [OpenTelemetry integration](/developerportal/operate/opentelemetry/) which lets you send traces, metrics, and logs to any OpenTelemetry-compatible observability backend.
