...
Check the documentation on how to [create/maintain test data](/addons/ats/rg-one-data-management#test-data) and [use it within a test case](/addons/ats/rg-one-data-driven-tests).
