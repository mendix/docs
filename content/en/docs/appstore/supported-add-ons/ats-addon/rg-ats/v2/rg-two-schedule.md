---
title: "Schedule"
url: /appstore/supported-add-ons/ats/rg-two-schedule/
---
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-schedule/schedules_tab_with_alerting.png" >}}
...
With this option, you can specify the screen resolution for your test run. A list of all the supported screen resolutions can be found in [Supported Selenium Hub Providers](/appstore/supported-add-ons/ats/rg-two-supported-selenium-hub-provider/).
