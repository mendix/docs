...
weight: 10
description: "Provides decisions and usage guidelines for general (non-Mendix specific) terminology in Mendix documentation."
---

<!-- Source: Confluence page ID 2510356519, last imported: 2026-04-15 -->

## How to Use This Section

This section contains decisions and usage guidelines for general (non-Mendix specific) terminology. For guidelines on Mendix-specific terminology, see the Mendix Product Naming Guide. For further guidelines, see the Inclusive Language Guide.
