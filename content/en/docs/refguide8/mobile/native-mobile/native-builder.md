...
The Native Builder (CLI) takes your Mendix project containing a native profile and packages a native mobile app for iOS and Android. To learn more about using the Native Builder, see [How to Build a Mendix Native App in the Cloud](/howto8/mobile/deploying-native-app/).
...
#### Generating Custom Developer Apps {#generate}
...
### Creating an Over the Air Deployment Release {#ota}
...
### Updating an OTA Deployment Release's Metadata {#update-ota}
...
### Rolling Back to a Previous Deployment Release {#rollback}
...
## Expanded Parameter Explanations {#parameters}
...
## When to Regenerate Your Native Template {#sync-your-repository}
...
**Invalid Access Token** — Your access token is invalid. Consult the [GitHub Token](/howto8/mobile/deploying-native-app/#github-token) section in *How to Build a Mendix Native App in the Cloud* and provide the access token to Native Builder.

**Unable to Create the Repository: the Access Token Needs Access to the Repo Scope** — Your access token is valid, but has too few permissions for Native Builder to work. Native Builder clones a template GitHub repository, creates a branch, and commits files. Consult the [GitHub Token](/howto8/mobile/deploying-native-app/#github-token) section in *How to Build a Mendix Native App in the Cloud* and provide the new access token to Native Builder.
...
### App Center Errors {#app-center-errors}

**Invalid API Token** — Your API token is invalid. Follow the [App Center Token](/howto8/mobile/deploying-native-app/#appcenter-token) section in *How to Build a Mendix Native App in the Cloud* and provide the API token to Native Builder.
