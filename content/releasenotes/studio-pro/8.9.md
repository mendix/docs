...
* For Android, we have made a version of the Make It Native app available that you can use with Studio Pro version 8.8 – for details, see the [Archives](/refguide/getting-the-make-it-native-app#archives) section of *Getting the Make It Native App Reference Guide*.
