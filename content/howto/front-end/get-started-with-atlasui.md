...
parent: "atlas-ui"
menu_order: 10
tags: ["Atlas", "UI", "UX", "user experience", "Studio"]
---

## 1 Introduction

Mendix Studio is a powerful collaborative tool that lets you build your application in the cloud together with your team. When you log into Studio for the first time, you get the option to choose a starter app that is powered by Atlas UI. For more information on the Studio, see the [Studio Guide](/studio). 

**This how-to will teach you how to do the following:**

* Choose a starter app
* Edit your app in Studio
...
## 3 Editing Your App in Studio

You now have access to your app **Buzz** in the [Developer Portal](/developerportal). From **Buzz**, you can open Mendix Studio by clicking **Edit App** in the top-right corner of the screen:
...
You can choose a page template when you create a new page. For information on how to create a new page and perform other basic functions, see section [3 Performing Basic Functions](/studio/page-editor#page-editor-basic-functions) in Page Editor in the *Studio Guide*. 
...
The [Theme Customizer](/studio/theme-customizer) allows you to customize your app in Studio. For more information on how you can style your app with it, see [Theme Customizer](/studio/theme-customizer) in the *Studio Guide*. 
