...
* Changes in a [change object](/refguide/change-object) activity are being executed all at once and instead of being executed sequentially. In an example scenario, "Attribute1" has the value `$Variable` and "Attribute2" has the value `$Entity/Attribute1`. After the change activity, the value of "Attribute1" is updated to the value of the variable, but the value of "Attribute2" is updated to the old pre-change value of "Attribute1". This will be fixed in Mendix Studio Pro 8.6.0.
