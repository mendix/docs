...
* **WorkflowJumpToDetails** - This non-persistent entity is generated by the [Generate Jump-to Option microflow action](/refguide/generate-jump-to-options/) and contains information on the Workflow instance and the options to apply an ad-hoc jump to.
* **WorkflowCurrentActivity** - This non-persistent entity belongs to the data generated by the [Generate Jump-to Option microflow action](/refguide/generate-jump-to-options/) and contains information on the current activity of that workflow instance.
* **WorkflowActivityDetails** - This non-persistent entity belongs to the data generated by the [Generate Jump-to Option microflow action](/refguide/generate-jump-to-options/) and contains information on activities of the workflow instance.
...
* [Using Ad hoc Jump-to to change a running workflow instance](/refguide/ad-hoc-jump-to/)
