...
- We added the following additions to External Database Connector: 
    ...
    - Connection detail constants are now saved in active Aonfiguration of user, and Password and Private Key are now stored as private values
