...
* We improved parametrization of the **Delete object(s)** action in the Logic Bot recommendation with a smarter suggestions for error-handling and variable suggestions based on the usage..
