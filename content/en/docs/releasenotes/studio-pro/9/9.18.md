...
* <a name="ki-2661"></a>When you navigate between dockable panes using Ctrl + Tab and  you are in the microflow editor, the page editor, or the Properties pane, releasing the Ctrl key does not close the pane selection dialog.
The workaround is to use Enter or a mouse click. (Ticket 163193)
