...
- We added a capability to **Clear from device** nanoflow action that removes specific objects from the offline device storage. You can now select individual objects or object lists to clear, in addition to clearing all objects of an entity.
