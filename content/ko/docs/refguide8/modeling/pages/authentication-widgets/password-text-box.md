---
title: "Password 텍스트 박스"
url: /refguide8/password-text-box/
#If moving or renaming this doc file, implement a temporary redirect and let the respective team know they should update the URL in the product. See Mapping to Products for more details.
---

{{% alert color="warning" %}}**Password 텍스트 박스** 위젯은 네이티브 모바일 페이지에서 지원되지 않습니다.{{% /alert %}}

## 소개

**Password 텍스트 박스**는 인증을 위한 비밀번호를 제공하는 위젯입니다:
...
**Password 텍스트 박스**는 [Login ID 텍스트 박스](/refguide8/login-id-text-box/) 및 [Sign-in 버튼](/refguide8/sign-in-button/)과 함께 페이지에 배치해야 합니다.

## 속성

Password 텍스트 박스 속성의 예시는 아래 이미지에 나와 있습니다:
...
Password 텍스트 박스 속성은 다음 섹션으로 구성됩니다:
...
**Placeholder**는 최종 사용자가 아직 텍스트를 입력하지 않았을 때 표시되는 텍스트입니다. 필드에 어떤 정보를 입력해야 하는지 최종 사용자에게 힌트를 제공하는 데 사용할 수 있습니다.
