...
* We now support keyboard hotkeys for copy, cut, paste, undo, redo, and delete in MendixChat (Windows only).
...
* We fixed the positioning issue of the **Extract Flow** in logic editors.
