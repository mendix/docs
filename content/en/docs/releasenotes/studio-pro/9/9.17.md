...
* We added a new microflow activity [Apply Jump-to Option](/refguide/apply-jump-to-option/) which enables the workflow to jump to a selected activity. This activity should be used after the [Generate Jump-to Options](/refguide/generate-jump-to-options/) activity that generates the list of possible workflow activities the workflow can jump to.
