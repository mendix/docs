...
2. Select your entity from the [Integration Pane](/refguide/integration-pane/). By default, the pane only shows results published to the production environment. If you also want to see results from other environments, click the filter icon and select the **Show development environment** checkbox.
