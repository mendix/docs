...
{{< figure src="/attachments/refguide/modeling/security/app-security/user-roles/user-roles-example.png" >}}
...
{{< figure src="/attachments/refguide/modeling/security/app-security/user-roles/user-role-properties.png" >}}
