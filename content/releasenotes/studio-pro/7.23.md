...
* We fixed setting values of *owner* and *createdDate* system members when a new object is created. (Ticket 83424)
* We fixed an issue where CPU usage becomes too high. If critical error messages are logged, `EchoAction` returns only the first ten of them. (Ticket 82162)
