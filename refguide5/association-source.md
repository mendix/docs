...
The association source is a data source available to nested [data grids](/refguide5/data-grid), [template grids](/refguide5/template-grid), and [list views](/refguide5/list-view). This will fill the widget with the objects linked to an object already in the context by manner of an association. For this to function the data widget needs to be nested within another data widget to provide that context.

Data widgets that can function as a container for other data widgets are the [template grid](/refguide5/template-grid), [list view](/refguide5/list-view), and [data view](/refguide5/data-view).
