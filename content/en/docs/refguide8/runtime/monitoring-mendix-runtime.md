...
For deployments to Mendix Cloud, you will not have access to the m2ee admin handler. However, you can get the same information from various pages in the Developer Portal. For more information, see:
