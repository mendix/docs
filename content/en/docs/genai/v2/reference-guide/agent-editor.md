---
title: "Agent Editor"
url: /appstore/modules/genai/v2/genai-for-mx/agent-editor/
...
For a step by step tutorial, check out the [create your first agent](/appstore/modules/genai/v2/how-to/howto-single-agent/#define-agent-editor) documentation.
...
For more information about prompts and prompt engineering, see [Prompt Engineering](/appstore/modules/genai/v2/prompt-engineering/).
...
Configure [tool choice](/appstore/modules/genai/v2/genai-for-mx/commons/#enum-toolchoice) to control how the agent behaves with regard to tool calling.
...
If possible, also confirm that the target endpoint is reachable from the running app runtime: this can be done for example, by temporarily configuring it manually in the [MCP Client module](/appstore/modules/genai/v2/mcp-modules/mcp-client/) and checking the **Console** pane in Studio Pro for logs.
