---
title: "Mendix 데이터 스토리지 API를 사용한 재사용 가능한 Microflow Actions 빌드"
linktitle: "재사용 가능한 Microflow를 위한 데이터 스토리지 API"
url: /howto/extensibility/howto-datastorage-api/
weight: 90
description: "데이터 스토리지 API를 사용하여 사용자 정의 Microflow Actions를 만드는 방법을 설명합니다."
---
