...
{{% alert type="info" %}}
Styling in a Mendix app is easy to do once you get the hang of it. For the majority of styling needs, you can use Mendix's styling tool: Calypso. For more information, see [How to Use Calypso](/howto/front-end/calypso).
{{% /alert %}}
...
10.  Open your app in Studio Pro, then click the play button (**Run Locally**) and **View App**.
...
For example, when you set a color for your title and subtitle, click the play button (**Run Locally**) then **View App**. When browser automatically opens, you will see the following URL:
