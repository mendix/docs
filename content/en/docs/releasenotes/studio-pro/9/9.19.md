...
We are excited to bring new changes to the Mendix Marketplace and provide an improved experience to our community for accessing Marketplace content in Studio Pro. The new revamp of Marketplace presents a better UI with easier navigation, better search functionality, a faster content-discovery experience, and more control over category and filters. We have also included new filter that helps you select **Platform-supported content**. 

The new view also helps you to browse through Marketplace components and access component details more quickly, just as you can in the online Marketplace.

Finally, we introduced new UI changes for pagination and points of entry to he Marketplace for a better user experience.
