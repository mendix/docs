...
* We made Data Grid 2 configuration easier by adding the ability to automatically fill the contents, create columns with filters, and create buttons for the selected entity. [**VERIFY/ TW**]
