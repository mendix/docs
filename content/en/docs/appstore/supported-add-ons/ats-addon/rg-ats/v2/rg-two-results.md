---
title: "Results"
url: /appstore/supported-add-ons/ats/rg-two-results/
---
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-results/test-runs.png" >}}
...
* Queued – the test is waiting for a free running slot on the Selenium hub:
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-results/queued.png" >}}

* Running – the test is currently running:

    {{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-results/running.gif" >}}

* Warning – the test is passed but may require your attention.

    {{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-results/warning-flag.png" >}}

* Canceled – the test was canceled before it could be completed.

    {{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-results/canceled-flag.PNG" >}}

The second column shows the type of the test. The following list explains all the different icons:

* Test case:

    {{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-app/test-case-icon.png" alt="Test Case" >}}

* Test suite:

    {{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-app/test-suite-icon.png" alt="Test Suite" >}} 

* Data-driven instance:

    {{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-app/ddt-icon.png" alt="Datadriven Test Case" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-results/result-log.png" >}}

The following results can be assigned to a test step:

{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-results/passed-icon.png" >}}  Passed – the test has passed

{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-results/failed-icon.png" >}}  Failed – the test has failed

{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-results/not-executed-icon.png" >}}  Not Executed – the test was not executed; this happens if a test step has not met the set precondition

{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-results/mixed-icon.png" >}}  Different Results - some of the containing tests passed, some failed and some where not executed
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-results/result-log-run-config.png" >}}

### 2.5 Error Log

The **Error Log** shows detailed information about a failed test step.

{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-results/result-log-error-log.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-results/result-log-screenshots.png" >}}
