...
* We fixed the issue of modeler taking very very long startup time in 'Check Prerequisites' when moving to v7 (Ticket 51600)
...
For any known issues in this release, see [Known Issues](known-issues#KI740).
