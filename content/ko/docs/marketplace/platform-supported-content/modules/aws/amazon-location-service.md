...
description: "Mendix Marketplace의 Amazon Location Service 커넥터의 구성 및 사용법을 설명합니다. Amazon Location Service는 개발자가 애플리케이션에 지리 공간 데이터와 위치 기능을 추가할 수 있는 위치 기반 서비스입니다."
weight: 20
