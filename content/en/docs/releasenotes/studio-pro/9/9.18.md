...
* We fixed a known issue where Pane navigation dialog is not closed after releasing <kbd>Ctrl</kbd> key if Microflow editor, Page editor or Properties pane was focused. (Ticket 163193) [**UPDATE**]
