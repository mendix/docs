...
[Guidelines for Building a Custom Action](../bestpractices/guidelines-custom-action-1) is a best practice document that describes the guidelines  you must follow when building custom actions. These guidelines deliver the best results.
...
The how-to's use jQuery selectors to find elements in the browser. Next to the standard jQuery selectors, ATS also uses pseudo-selectors. You can find these pseudo-selectors in the [ATS Selector](/ats/ats/refguide-ats-1/selectors) documentation.
