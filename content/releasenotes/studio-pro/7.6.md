...
* The custom widgets listed below use a private API that has been improved and changed. This required us to update these widgets so that they keep working in Mendix 7.6. If you use any of these widgets, go to the [Mendix Marketplace](https://appstore.mendix.com/index3.html) to download the latest version.
