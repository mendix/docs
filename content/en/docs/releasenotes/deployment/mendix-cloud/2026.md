...
#### Deprecated
* Since migration of applications to kubenetes is almost complete, we have removed the banner which mentions this.

#### Improvements
* In the Control Center → Private Connectivity -> Resources tab, a warning message will be displayed to explain the limitation of internal subnets. 
