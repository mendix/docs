...
description: "The release notes for Mendix Studio Pro 8.2 (including all patches) with details on new features, bug fixes, and known issues."
weight: 98
---

{% alert color="info" %}For an overview of the highlights in this release, see the [Mendix Release 8.2](https://www.mendix.com/blog/mendix-8-2-go-with-the-microflow/) blog post.{% /alert %}

## 8.2.2 {#822}

**Release date: October 15, 2019**

{{% button color="info" href="https://marketplace.mendix.com/link/studiopro/8.2.2" text="Go to Marketplace" title="Download version 8.2.2 from the Marketplace" %}}
...
* <a id="284"></a>We fixed an issue where the creation of a deployment package failed when the project contained a native navigation profile.
...
{{% alert color="info" %}}
Kudos to [Tim van Steenbergen](https://community.mendix.com/link/ideas/681) and [Bart Tolen](https://community.mendix.com/link/ideas/517) for their ideas submitted to the Mendix Community. Thank you, Tim and Bart!
{{% /alert %}}
...
{{% alert color="info" %}}
This is based on an upvoted idea from [Andrej Gajduk](https://community.mendix.com/link/space/microflows/ideas/741) submitted to the Mendix Community. Cheers, Andrej!
{{% /alert %}}
...
{{% alert color="info" %}}
Kudos to [Sven Franke](https://community.mendix.com/link/ideas/1473) and [James Ramm](https://community.mendix.com/link/ideas/1479) for their ideas submitted to the Mendix Community. Nice job, Sven and James!
{{% /alert %}}
...
* When using the expression editor's autocomplete function, the best matching records are now displayed first.
    ...
    {{% alert color="info" %}}This is based on an upvoted idea from [Luuk de Bakker](https://community.mendix.com/link/space/usability/ideas/1496) submitted to the Mendix Community. Cheers, Luuk!{{% /alert %}}
