...
* Configure text generation and knowledge base keys (for details, see [Configuration](/agents/agents-kit-1/reference-guide/genai-for-mx/agent-commons/#configuration) in *Agent Commons*)
...
6. In the **System Prompt** field, add instructions for how the model generates a response and what process to follow. You can use this example prompt:
    ...
    2. Determine the type of request.
        ...
        * Case B: The user is trying to solve an IT-related issue. Use the `RetrieveSimilarTickets` tool to base your response on relevant historical tickets.
...
For more information, see [Human in the loop](/agents/agents-kit-1/reference-guide/genai-for-mx/conversational-ui/#human-in-the-loop).
