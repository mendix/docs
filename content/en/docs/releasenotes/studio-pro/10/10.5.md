...
#### Version Control Uses Rebase When Combining Changes
...
You can choose how to combine your work with the server state every time you interact with the server. Whether you are making a commit or performing a pull or a push, Studio Pro will detect if you are behind the server and let you choose how to proceed. We recommend you to use Rebase in most scenarios, but you can adjust the default with a user preference if needed.

For more information on the differences between using Rebase and Merge commit, and how they work, please see [Combining Changes and Conflict Resolution](/refguide/merge-algorithm/).
