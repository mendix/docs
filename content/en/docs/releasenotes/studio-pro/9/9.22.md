...
* To prevent a situation where you cannot disable collaboration after it was mistakenly enabled again, the **Disable collaboration** button is accessible in the Branch Line Manager for the collaboration-enabled branches. 
...
* You can now disable sending usage data to Mendix.
