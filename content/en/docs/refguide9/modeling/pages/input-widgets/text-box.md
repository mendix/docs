...
{{< figure src="/attachments/refguide9/modeling/pages/input-widgets/text-box/text-box.png" class="no-border" >}}

## Properties

An example of text box properties is represented in the image below:

{{< figure src="/attachments/refguide9/modeling/pages/input-widgets/text-box/text-box-properties.png"   width="250"  class="no-border" >}}
