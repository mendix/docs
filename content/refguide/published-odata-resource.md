...
For associations, the exposed name is the name given to the navigation property (the property referring to the associated object(s)). You can also specify the name of the association using the **exposed association name** column. By default, the name is the same as the name of the association in the domain model.
