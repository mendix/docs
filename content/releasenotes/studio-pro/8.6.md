...
It is no longer possible to upload microflows to and download microflows from Model Share using Studio Pro, because this service is now deprecated and will be discontinued on March 31st, 2020. Note that you can upload models to Model Share before March 31st using Studio Pro versions below 8.6. These models will still be available for download in the MPK format from [modelshare.mendix.com](http://modelshare.mendix.com/).
