...
| allowNonPersistableEntities | Allows the selection of an non persistent entity. (By default it is false) |
...
| multiline | Makes the string input mulitple lines, usefull for long texts. |
