...
1. To add more conditions and manage them, do the following: <br/>
...
1. To create a new group and manage it, do the following: <br/>
...
1. Click **Add** to save the filter.
