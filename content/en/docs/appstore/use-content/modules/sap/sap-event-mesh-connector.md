...
{{< figure src="/attachments/appstore/use-contents/modules/sap-event-mesh-connector/domain-model.png" class="no-border" >}}
...
{{< figure src="/attachments/appstore/use-contents/modules/sap-event-mesh-connector/publish-message.png" class="no-border" >}}
...
{{< figure src="/attachments/appstore/use-contents/modules/sap-event-mesh-connector/consume-message.png" class="no-border" >}}
...
{{< figure src="/attachments/appstore/use-contents/modules/sap-event-mesh-connector/publish-event.png" class="no-border" >}}
...
{{< figure src="/attachments/appstore/use-contents/modules/sap-event-mesh-connector/get-queue-list.png" class="no-border" >}}
...
{{< figure src="/attachments/appstore/use-contents/modules/sap-event-mesh-connector/get-queue-details.png" class="no-border" >}}
...
{{< figure src="/attachments/appstore/use-contents/modules/sap-event-mesh-connector/get-queue-subscriptions.png" class="no-border" >}}
...
{{< figure src="/attachments/appstore/use-contents/modules/sap-event-mesh-connector/create-queue.png" class="no-border" >}}
...
{{< figure src="/attachments/appstore/use-contents/modules/sap-event-mesh-connector/delete-queue.png" class="no-border" >}}
...
{{< figure src="/attachments/appstore/use-contents/modules/sap-event-mesh-connector/create-queue-subscription.png" class="no-border" >}}
...
{{< figure src="/attachments/appstore/use-contents/modules/sap-event-mesh-connector/delete-queue-subscription.png" class="no-border" >}}
