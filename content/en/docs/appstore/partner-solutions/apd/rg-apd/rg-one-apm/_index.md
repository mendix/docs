...
{{< figure src="/attachments/appstore/partner-solutions/apd/rg-apd/rg-one-apm/Performance_Tool_Tree_View.png" >}}
...
{{< figure src="/attachments/appstore/partner-solutions/apd/rg-apd/rg-one-apm/Performance_Tool_Browse_Microflow.png" >}}

This is the SQL statements during an action:

{{< figure src="/attachments/appstore/partner-solutions/apd/rg-apd/rg-one-apm/Performance_Tool_Browse_Actions.png" >}}
...
{{< figure src="/attachments/appstore/partner-solutions/apd/rg-apd/rg-one-apm/Measurements_Tool.png" >}}
