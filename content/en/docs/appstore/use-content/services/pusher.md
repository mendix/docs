...
{{< figure src="/attachments/appstore/use-contents/services/pusher/SequenceDiagramUpdateObject.png" alt="update object via notify listen" class="no-border" >}}
...
{{< figure src="/attachments/appstore/use-contents/services/pusher/RefreshMicroflowSample.png" alt="refresh microflow" class="no-border" >}}
