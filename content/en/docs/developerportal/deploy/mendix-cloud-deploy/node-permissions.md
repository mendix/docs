...
To find a list of all Mendix Cloud licensed nodes that you have access to, open the [Global Navigation Menu](/developerportal/#navigation) and select **Deployment**.
