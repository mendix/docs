...
* It is now possible to set the render mode of a container widget as one of the HTMLS5 section tags (`main`, `section`, `header`, `footer`, etcetera)
...
* A source file is now included for an exported and imported JavaScript action.
...
* We fixed an issue where it was not possible to commit after merging in a branch. (Tickets 78468, 76785)
