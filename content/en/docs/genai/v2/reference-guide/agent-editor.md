---
title: "Agent Editor"
url: /agents/agents-kit-2/reference-guide/agent-editor/
...
aliases:
    - /agents/reference-guide/agent-editor/
...
{{% alert color="warning" %}}
Please note, that listing Azure AI Foundry models in Studio Pro 11.12.2 does not work. If you want to use those models, Mendix recommends to stay on 11.12.1 and the corresponding Agent Editor version 2.1.0.
{{% /alert %}}
...
Configure [tool choice](/agents/agents-kit-2/reference-guide/commons/#enum-toolchoice) to control how the agent behaves with regard to tool calling.
...
* Model documents with Azure AI Foundry as provider do not work in Studio Pro 11.12.2. Mendix recommends to stay on 11.12.1 and the corresponding Agent Editor version 2.1.0.
...
Listing Azure AI Foundry models in Studio Pro 11.12.2 does not work. If you want to use those models, Mendix recommends to stay on 11.12.1 and the corresponding Agent Editor version 2.1.0.
