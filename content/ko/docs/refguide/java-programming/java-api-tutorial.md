---
title: "Mendix Runtime Java API 사용하기"
...
This tutorial contains some examples of how to use the [Mendix Runtime Java API](/apidocs-mxsdk/apidocs/runtime-api-11/). The tutorial assumes that you have some basic Java and Mendix modeling knowledge.
