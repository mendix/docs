...
| **xasid** | Runtime | Used for mult-instance fail-over | <ul><li>Path: `/`</li><li>Duration: until user closes their browser (session cookie)</li></ul><ul><li>HttpOnly: `true`</li></ul> |
