...
Check the documentation on how to [create/maintain test data](/addons/ats/refguide/rg-version-1/data-management#test-data) and [use it within a test case](/addons/ats/refguide/rg-version-1/data-driven-tests).
