...
---
This chapter describes the installation of the APM tool. In case of upgrading to a new version, please also have a look at the mandatory [upgrade steps](https://docs.mendix.com/APM/upgrade-steps).
