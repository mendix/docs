...
{{< figure src="/attachments/refguide10/modeling/integration/ml-kit/design-patterns/pre-postprocessor-design-patterns/ResNet-pre-processor-Model-Inference-single-activity.png" class="no-border" >}}

Create Variable Activity

{{< figure src="/attachments/refguide10/modeling/integration/ml-kit/design-patterns/pre-postprocessor-design-patterns/categorical-numerical-create-variable.png" alt="." class="no-border" >}}
...
{{< figure src="/attachments/refguide10/modeling/integration/ml-kit/design-patterns/pre-postprocessor-design-patterns/numerical-categorical-postprocessor-activity.png" class="no-border" >}}

Create Variable Activity

{{< figure src="/attachments/refguide10/modeling/integration/ml-kit/design-patterns/pre-postprocessor-design-patterns/numerical-categorical-create-variable.png" class="no-border" >}}
...
{{< figure src="/attachments/refguide10/modeling/integration/ml-kit/design-patterns/pre-postprocessor-design-patterns/aggregation-activity.png" class="no-border" >}}

Aggregate List Activity

{{< figure src="/attachments/refguide10/modeling/integration/ml-kit/design-patterns/pre-postprocessor-design-patterns/aggregate-list-activity.png" class="no-border" >}}
...
{{< figure src="/attachments/refguide10/modeling/integration/ml-kit/design-patterns/pre-postprocessor-design-patterns/java-actions-encoding-features-microflow.png" alt="." class="no-border" >}}
...
{{< figure src="/attachments/refguide10/modeling/integration/ml-kit/design-patterns/pre-postprocessor-design-patterns/ResNet-pre-processor-Model-Inference-sep-activities.png" alt="." class="no-border" >}}
...
{{< figure src="/attachments/refguide10/modeling/integration/ml-kit/design-patterns/pre-postprocessor-design-patterns/ResNet-pre-processor-Model-Inference-single-activity.png" alt="." class="no-border" >}}
...
{{< figure src="/attachments/refguide10/modeling/integration/ml-kit/design-patterns/pre-postprocessor-design-patterns/hybrid-activity-microflow.png" class="no-border" >}}
