---
title: "Mendix 데이터 스토리지 API를 사용한 재사용 가능 Microflow 액션 빌드"
linktitle: "재사용 가능 Microflow를 위한 데이터 스토리지 API"
url: /howto9/extensibility/howto-datastorage-api/
weight: 90
description: "데이터 스토리지 API를 사용하여 커스텀 Microflow 액션을 만드는 방법을 설명합니다."
---
