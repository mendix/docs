...
![](attachments/ht2-connect-stories-to-testcases/set-api-key.png)

Clicking **Set API Key** opens the **Mendix API Key** Dialog:

![](attachments/ht2-connect-stories-to-testcases/mendix-api-key-dialog.png)
...
![](attachments/ht2-connect-stories-to-testcases/mendix-api-key-filled-e.png)

You have set the Mendix API Key. ATS can now retrieve the User Stories from the Mendix Developer Portal project.

![](attachments/ht2-connect-stories-to-testcases/set-mendix-api-key.png)
...
![](attachments/ht2-connect-stories-to-testcases/go-to-stories-tab-e.png)

If you filled in a correct Mendix API Key you can now see the User Stories in ATS:

![](attachments/ht2-connect-stories-to-testcases/user-stories-in-ats.png)
...
![](attachments/ht2-connect-stories-to-testcases/add-test-to-story.png)

Clicking **Add test** opens the **Select item** Dialog box:

![](attachments/ht2-connect-stories-to-testcases/add-test-case-to-story-dialog.png)
...
1. In the **Select item** Dialog box click **Create new test case**.
    ...
    ![](attachments/ht2-connect-stories-to-testcases/create-new-test-case.png)
...
5. Use the **Template** referenceSelector in case you have a test case that you want to use as a template. ATS copies all the test steps of the template to the new test case.
    ...
    * In the Dialog search and select the test case you want to add as template and click **Select**.
    ...
    ![](attachments/ht2-connect-stories-to-testcases/select-template.png)
...
![](attachments/ht2-connect-stories-to-testcases/new-test-case-e.png)

Clicking **Create & Open** or **Create** links the test case to the user story:

![](attachments/ht2-connect-stories-to-testcases/test-case-added.png)
...
![](attachments/ht2-connect-stories-to-testcases/edit-story-page.png)
...
![](attachments/ht2-connect-stories-to-testcases/edit-story-page-options-e.png)
...
![](attachments/ht2-connect-stories-to-testcases/add-existing-test-case-e.png)

Clicking **Add selected** links the test case to the user story. As this test case ran successfully, the **Succes** is 100%:

![](attachments/ht2-connect-stories-to-testcases/existing-test-case-added-e.png)
...
![](attachments/ht2-connect-stories-to-testcases/test-case-stories-tab-e.png)

Clicking **Link new story** opens the **Link Story** Dialog:

![](attachments/ht2-connect-stories-to-testcases/link-story-dialog.png)

4. Search and select the user story you want to add to the test case.
5. Click **Add selected**:

![](attachments/ht2-connect-stories-to-testcases/link-story-selected-e.png)

Clicking **Add selected** links the story to the test case:

![](attachments/ht2-connect-stories-to-testcases/story-linked-to-test-case.png)
...
You now learned how to link user stories to your test cases. The next how-to is [Use ATS in Combination with CI/CD](ht2-ats-and-ci-cd). You find an overview of all the how-tos and the structure on the [ATS 2 How-to's](ht2) page. We advise you to follow the predefined structure.
