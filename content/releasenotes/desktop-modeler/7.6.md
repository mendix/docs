...
{{% modelerdownloadlink "7.6.1" %}}

### Features

* We upgraded the PostgreSQL JDBC driver from version 42.0.0 to 42.1.4.

### Fixes 

* We fixed the following data retrieval issues concerning virtual attributes:
  * Template grids containing an entity with a virtual attribute did not show any data over an association (for example, nested data views). (Ticket 56016)
  * <a name="RN761"></a>Custom widgets requesting Mendix objects with a virtual attribute through XPath received objects without their associations.
...
For known issues in this version, see [Known Issues](known-issues#KI760).
