...
System variables are tokens whose values can be used in XPath expressions. For a complete overview of these tokens, see [XPath Keywords and System Variables](/refguide8/xpath-keywords-and-system-variables/).
