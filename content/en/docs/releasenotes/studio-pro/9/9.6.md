...
* We reorganized the toolbars of the [App Explorer](/refguide9/app-explorer/), [Integration pane](/refguide9/integration-pane/), [Connector](/refguide9/view-menu/#connector), **Toolbox**, and selector dialog boxes to save more vertical screen space for the content.
...
The [Integration pane](/refguide9/integration-pane/) now shows for every entity which CRUD (creatable, readable, updatable, deletable) capabilities the entity supports. It will mark a capability as highlighted when the combination of the data source and Studio Pro supports it. As of this version, that means readable and updatable, but we will add more in upcoming releases.
...
* We now show which services are validated in the [Integration pane](/refguide9/integration-pane/). This corresponds to the services that are marked as validated in the [Data Hub Catalog](/data-hub/data-hub-catalog/).
