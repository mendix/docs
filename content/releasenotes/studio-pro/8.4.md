...
{{% alert type="warning" %}}
We are currently investigating an issue related to committing multiple object that have an autocommited object. For that reason, we advise you not to use version 8.4.1 and 8.4.0 until further notice.
{{% /alert %}}
