...
* When opening *.mpr* or *.mpk* files from File Explorer, you may see the message "Please wait while Windows configures Mendix Version Selector."
	* Workaround: In **Control Panel** > **Programs** > **Uninstall a program**, select **Mendix Version Selector** and click **Repair**. If that does not work, you can uninstall the Version selector completely and install a Mx7 version you don't have installed yet. Else please contact [Mendix Support](https://support.mendix.com/hc/en-us).
