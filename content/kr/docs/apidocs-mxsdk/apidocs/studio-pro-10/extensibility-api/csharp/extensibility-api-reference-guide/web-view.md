...
다음 표에는 사용자 지정 UI를 추가할 수 있는 API와 해당 뷰 모델 기본 클래스가 나열되어 있습니다:
...
웹 뷰에 콘텐츠를 제공하고 양방향으로 통신하는 방법은 [Todo 예제 확장 프로그램 빌드](/apidocs-mxsdk/apidocs/csharp-extensibility-api-10/build-todo-example-extension/)를 참조하십시오.
