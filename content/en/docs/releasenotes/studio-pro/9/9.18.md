...
* We fixed a couple of small issues where the user's avatar image (or a default image when the user doesn't have an avatar)
would not show correctly after signing in.
...
* We fixed the issue where Studio Pro freezes in certain cases when microflow activities were dragged from toolbar. (Tickets 168530, 168328, 165904, 165769, 165516, 165491, 164808)
