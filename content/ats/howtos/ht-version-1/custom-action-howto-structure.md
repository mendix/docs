...
The introduction also tells you what type of action the how-to explains. The how-to's are written based on the [guidelines for building a custom action](../bestpractices/guidelines-custom-action-1).
