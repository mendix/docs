...
{{% alert color="info" %}}
The [Catalog](/data-hub/mendix-connect-catalog/) is a hub for shared registered assets made available in your organization. At the moment, it only supports OData.
{{% /alert %}}
