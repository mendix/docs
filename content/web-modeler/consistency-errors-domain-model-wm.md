...
In this document, we will explain how to solve the most common consistency errors that can occur when configuring the domain model in the Desktop Modeler. For more information on domain models, see [Domain Model Overview in the Web Modeler](domain-models-wm).
