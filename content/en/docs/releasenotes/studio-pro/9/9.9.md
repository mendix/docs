...
* We changed how the names of external attributes and associations are displayed in the [Integration pane](/refguide9/integration-pane/) so they are now consistent with the dataset attributes and associations names in the [Data Hub Catalog](/data-hub/data-hub-catalog/).
...
* We fixed an issue where apps with hundreds of branches took a very long time to load from the app selector and [Branch Line Manager](/refguide9/branch-line-manager-dialog/). (Ticket 136374)
