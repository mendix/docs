---
title: "Amazon RDS와 Mendix Database Connector를 사용하여 데이터베이스 생성하기"
linktitle: "Amazon RDS"
url: /appstore/modules/aws/amazon-rds-database-connector/
description: "Mendix Database Connector와 함께 Amazon Relational Database Service(RDS)를 사용하기 위해 필요한 단계를 설명합니다."
weight: 20
aliases:
