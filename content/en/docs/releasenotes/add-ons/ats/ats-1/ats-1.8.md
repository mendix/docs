...
The [Action Reference Guide](/addons/ats-addon/rg1-std-acts/) lists the new actions.
...
We've also documented all our actions in a [Reference Guide](/addons/ats-addon/rg1-std-acts/). It describes all the actions that you can use in your test cases. In addition to that, it also references the internal actions that are very helpful if you want to create your own actions.
