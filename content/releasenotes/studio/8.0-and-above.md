...
* For better search results, the **Toolbox** supports additional search terms now. For example, if you type in *table* in the **Toolbox** search bar, the search result will give you **Data grid** and **Structure** widgets, because they have the form of a table.  
* In the breadcrumb, we renamed **Navigation Layout** to **Layout** to be consistent in terms throughout Studio and to avoid confusion. 
