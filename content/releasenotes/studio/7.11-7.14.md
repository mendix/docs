...
title: "7.11–7.14"
category: "Studio"
description: "New features, bug fixes, and known issues in Mendix Studio correlated to Mendix Studio Pro version 7.11–7.14."
---

These are Mendix Studio release notes for app projects built with Studio Pro versions 7.11–7.14. The release notes include all minor versions, patches, and known issues.
...
For Studio release notes correlated with Studio Pro versions 7.23 and above, see [7.23 & Above](7.23-and-above). 
...
* We added support for [Studio Pro 7.14.1](../desktop-modeler/7.14). The minimum supported version remains Studio Pro 7.11.0.
...
* The page editor no longer crashes when encountering a list view with a nanoflow data source (for example, if this was incorporated using Studio Pro).
...
* In the page editor, the following widgets are now rendered in their full glory (meaning, when you add them to your model using Studio Pro):
  * Data grids
  * Template grids
...
* At this stage *all* the Mendix widgets supported by Studio Pro are now rendered in Studio. This will further streamline collaboration between users of Mendix Studio and Mendix Studio Pro. It also enables you to use Studio live in meetings (for example, in frequent iterations during the app development cycle).
...
* We added support for the release of Studio Pro version 7.13.1. The minimum supported version remains Studio Pro 7.11.0.
...
* Java actions and connectors may be part of your microflows (for example, when added to your model using Studio Pro). If so, they are now fully rendered in Studio's microflow editor. Also, the return type of a Java action is now available for use in microflows.
* We added support for [Studio Pro 7.12.0](../desktop-modeler/7.12). The minimum supported version remains Studio Pro 7.11.0.
...
* We added support for [Studio Pro 7.11.0](../desktop-modeler/7.11). The minimum (and only) supported version is now Studio Pro 7.11.0.
...
* We introduced a help menu and improved the dialog box for syncing with Studio Pro.
* We added support for [Studio Pro 7.9.0](../desktop-modeler/7.9). The minimum (and only) supported version is now [Studio Pro 7.9.0](../desktop-modeler/7.9).
* You are now able to configure **Close Page** and **Show Home Page** activities in the microflow editor.
* Your SCSS is no longer compiled to CSS when opening Studio, so you won't have styling changes when you sync with Studio Pro without having changed any styling in Studio.
...
* We dropped support for [Studio Pro 7.7.1](../desktop-modeler/7.7). The minimum (and only) supported version is now [Studio Pro 7.8.0](../desktop-modeler/7.8).
...
* We fixed an issue that redirected the user to the `project/null` URL while syncing with Studio Pro or during model conversion.
...
* We added support for [Studio Pro 7.8.0](../desktop-modeler/7.8).
...
* False positive changes in *entry-prefix.css* no longer occur when syncing with Studio Pro.
...
* Entity access will no longer be out of date when adding or removing attributes, associations, and entities, so you won't need to go to Studio Pro anymore to fix this problem. Deployment in Studio will succeed after the aforementioned actions.
...
* We fixed an issue in the microflow editor elements that was causing synchronization with Studio Pro to fail.
...
* We added support for [Studio Pro 7.6.0](../desktop-modeler/7.6).
...
* We fixed Studio Pro links not opening the correct projects.
...
* Hello world! Mendix Studio is now available in public beta. Start building beautiful apps at speed and collaborate with non-technical domain experts using the Studio Pro's WYS/WYG page editor and visual modeling capabilities.
