...
4. Conditions specified in the XPath constraint of the **System.WorkflowUserTask** entity are met. 자세한 내용은 the [Configuring User Assignment](#user-assignment) section above.
