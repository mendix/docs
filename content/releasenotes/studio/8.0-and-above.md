...
* We added the **Page View** feature to the **Theme Customizer**. With **Page View**, you can select any page from your app and preview new style on it. This feature will help you customize apps faster and will visualize your changes right away. For more information, see [Theme Customizer](/studio/theme-customizer). 
...
* We fixed an issue where a pop-up window for selecting an icon (for example, when you select an icon for a button) did not show icon previews. 
* We fixed an issue where association auto-renaming when you rename an entity did not work for self-associations correctly. 
