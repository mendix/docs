...
* Application migration from Cloud Foundry to Kubernetes is nearly complete. We have now removed the migration banner from the [Environments](/developerportal/deploy/environments/) page.
