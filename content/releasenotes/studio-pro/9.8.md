...
* We fixed two issues in the generated metadata of published OData services in Studio Pro. Due to these changes, previous Studio Pro versions are not able to read metadata produced by this Studio Pro version. The runtime is unaffected. When updating the contract of a consumed OData service we advise is to upgrate to Studio Pro 9.6.4, 9.8.1 or 9.9.0 or later. The two fixes are:
