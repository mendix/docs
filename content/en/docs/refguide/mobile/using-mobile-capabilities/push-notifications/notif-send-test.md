...
| Messages are not sent (Status remains Pending) | The Push notifications connector relies on scheduled events to function, which are not supported in a free app running | Run your app on a licensed node |
