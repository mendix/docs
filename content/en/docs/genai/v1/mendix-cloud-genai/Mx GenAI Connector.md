...
Typical use cases for generative AI are described in more detail in the [Typical LLM Use Cases](/appstore/modules/genai/v1/get-started/#llm-use-cases) section of the *GenAI Concepts*.
