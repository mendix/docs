...
* We fixed an issue where a pop-up window was blinking while your app was being     prepared to be published.  
* We fixed an issue where the upgrade message in the top-bar was not visible when you open **App from a spreadsheet** or **Approval Template** app templates.
