...
* We now allows rounding off model constants value with decimal type to 10 decimal digits.
* We fixed an issue where customer failed to retrieve the build status (Ticket [224896](https://mendixsupport.zendesk.com/agent/tickets/224896))
