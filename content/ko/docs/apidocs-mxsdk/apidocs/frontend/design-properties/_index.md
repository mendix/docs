...
description: "이 API 가이드는 Atlas UI에서 디자인 속성이 작동하는 방식을 설명하고 사용자 정의 디자인 속성을 생성하는 데 도움을 줍니다."
weight: 50
---

## 소개

Mendix Design Properties API를 사용하면 Mendix 앱의 디자인 속성을 생성하거나 확장할 수 있습니다.
...
Mendix 앱의 스타일을 지정하는 동안, users must often apply the same set of CSS or native styling classes to widgets on different pages again and again. This work is time consuming and vulnerable to human error as you edit text fields in order to apply classes to a widget.
...
### Dropdown 옵션을 Toggle 속성으로 이름 변경
...
### 여러 Toggle 속성을 다중 선택 ToggleButtonGroup 속성으로 이름 변경
...
### Dropdown 옵션을 Spacing 옵션으로 이름 변경
