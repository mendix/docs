...
Connecting to Git is done via a personal access token (PAT). For information on how to create a PAT, see [Mendix Profile: Personal Access Tokens](/portal/user-settings/#pat).
