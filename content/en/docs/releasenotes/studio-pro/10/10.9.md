...
- We improved the order of the drop-down list items in the XPath constraint Builder to better match the autocomplete list in the XPath expression editor.
