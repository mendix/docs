...
To start the wizard, log in to your Private Mendix Platform app with the *Admin* user ID. The wizard starts automatically and walks you through the required configuration steps. For more information about the available options, refer to the sections below.
