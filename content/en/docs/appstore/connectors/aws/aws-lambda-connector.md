...
By default, this function invokes Lambda functions synchronously. To invoke an asynchronous Lambda function, make sure to update the `InvokeAsynchronous` attribute to true of the `InvokeFunctionRequest` entity.
