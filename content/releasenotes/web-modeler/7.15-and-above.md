 ...
 * We re-added support for [Desktop Modeler 7.18](../desktop-modeler/7.18). The known issue with consistency error checking in Mendix version 7.18.0 has been resolved in version 7.18.1 (see known issue mentioned on September 4th). Web Modeler users with apps of Mendix version 7.18.0 can now upgrade their apps when opening the Web Modeler, to continue building and publishing the app.
