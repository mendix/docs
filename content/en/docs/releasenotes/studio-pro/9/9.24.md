...
* We expanded entity attribute options. Now, attribute-based expressions, reference selectors, and input reference set selectors can select entity attributes from a snippet parameter or a grandparent data view.
