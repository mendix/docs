...
#KI: "Not all one-to-one association values" = RUN-2156/UICORE-461
...
{{% alert type="warning" %}}
We are currently investigating an issue related to committing multiple entities associated to the same autocommited object. For that reason, we advise you not to use version 8.3.0 until further notice.
{{% /alert %}}
