...
* In [published OData services](/refguide/published-odata-services), you can now choose to publish associations as links. When you choose to publish associations as links (in the settings tab of the OData service), you can publish many-to-many associations.
