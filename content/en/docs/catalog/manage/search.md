...
You can also filter by CRUD (Creatable, Readable, Updatable, or Deletable) capabilities. See the [Viewing OData Capabilities in Catalog](/howto/integration/write-data/#view-capabilities) section of *Write Data to Another App* for more information.
