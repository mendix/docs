...
description: "The release notes for Mendix Studio Pro 8.7 (including all patches) with details on new features, bug fixes, and known issues."
weight: 93
---

{% alert color="info" %}For an overview of the highlights in this release, see the [Mendix Release 8.7](https://www.mendix.com/blog/mendix-8-7-more-time-to-make/) blog post.{% /alert %}
...
Even though model warnings are useful, you now have the option to suppress them in Studio Pro. You can decide which warnings will not be shown. This could be a specific warning, all the warnings in a module, or even all the warnings from [Marketplace content](/appstore/use-content/).

{{% alert color="info" %}}
This is based on upvoted ideas from several Mendix community members: thank you to [Jord ten Bulte and Jitze de Groote](https://community.mendix.com/link/space/usability/ideas/1282), [Mart Busger op Vollenbroek](https://community.mendix.com/link/ideas/1466), [Jan de Lange](https://community.mendix.com/link/space/other/ideas/1374), [Gerard Veurink and Stefan Boeser](https://community.mendix.com/link/ideas/213), [Diederik Wentink](https://community.mendix.com/link/ideas/399), and [Michal Mesaros](https://community.mendix.com/link/ideas/1643)!
{{% /alert %}}
...
* We improved the performance of export mappings that export persistable associated objects. [Mendix Runtime](/refguide8/runtime/) now retrieves batches of associated objects instead of individual associated objects, which reduces the number of calls to the database. (Ticket 89189)
...
* We introduced highlighting for template parameters in the [show message](/refguide8/show-message/), [validation feedback](/refguide8/validation-feedback/), and [Java action call](/refguide8/java-action-call/) actions.
...
* We fixed an issue where problems with missing or outdated custom widgets were not reported on [page templates](/refguide8/page-templates/) and [building blocks](/refguide8/building-block/). In rare cases, this can trigger consistency errors for existing projects. If this happens, please follow these steps to update Atlas:<br />
    1. Reinstall [Atlas UI Resources](https://marketplace.mendix.com/link/component/104730) from the Marketplace.<br />
...
* If a [date picker](/refguide8/date-picker/) widget has a custom date pattern without year tokens, it will now use the year of its current value when parsing a new value. This ensures that, for example, February 29 is recognized as a valid date if the current value falls within a leap year. The [Pluggable Widgets API](/apidocs-mxsdk/apidocs/pluggable-widgets/) has been enhanced to cover this use case as well. (Ticket 92181)
