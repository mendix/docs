...
**To configure Scout, Windows 10 users need to use the workaround described in [How to Perform the Scout with the Windows 10 Workaround](scout-and-windows-10-workaround).**
