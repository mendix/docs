...
{{% alert type="info" %}}
To use push notifications with apps created with the Native Builder, make sure you have completed [How To Deploy Your First Mendix Native App](deploying-native-app) and [Setting up Native Push Notifications](setting-up-native-push-notifications-4-setting-up-native-app-customizations)
{{% /alert %}}
