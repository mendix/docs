...
Check the documentation on how to [create/maintain test data](/addons/ats/rg1-data-management#test-data) and [use it within a test case](/addons/ats/rg1-data-driven-tests).
