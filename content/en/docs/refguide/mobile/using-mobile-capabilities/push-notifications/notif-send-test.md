...
| Messages are not sent (Status remains Pending) | The Push notifications connector uses scheduled events to retry failed message deliveries, which are not supported in a free app running | Run your app on a licensed node |
