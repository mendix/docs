...
{{% alert type="info" %}}
This the preferred Studio Pro version 8 release for apps in production. High-priority issues fixed in [7.23](7.23) patch releases will also be fixed in 8.18 patch releases if applicable.
{{% /alert %}}
