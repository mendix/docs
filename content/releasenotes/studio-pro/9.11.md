...
* We prioritized the **Check if object exists** decision recommendation after the retrieve-object operation in the [MxAssist Logic Bot](/refguide/mx-assist-logic-bot) menu.
