...
- It was not possible to import an item into a project, when the parent folder of the item still exists in another project. This has been fixed.
- It could happen, that an imported item has a test step which refers to an item of another app. That is not possible anymore.
