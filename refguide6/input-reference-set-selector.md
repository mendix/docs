...
The input reference set selector is an [input widget](/refguide6/input-widgets) that can be used to display and edit [associations](/refguide6/associations) for which the multiplicity setting is configured to allow multiple parent objects to associate with multiple children. This type of association is also known as a reference set.

<div class="alert alert-info">{% markdown %}

![](attachments/16713883/16844008.jpg)
The multiplicity settings of an association can be found by double-clicking the association in the [domain model](/refguide6/domain-model).
