...
* We fixed a bug where synchronizing more than 999 objects with the [Synchronize to device](/refguide/synchronize-to-device) activity caused an error in an offline-first application.
