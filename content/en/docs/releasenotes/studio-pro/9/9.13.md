...
* <a id="ki-639"></a>When you horizontally scale an app based on Private Cloud hosting, scheduled events are not correctly run.
...
* We improved parametrization of the **Delete object (or objects)** action in the MxAssist Logic Bot recommendation with smarter suggestions for error-handling and variable suggestions based on usage.
