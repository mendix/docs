...
#KI: "Export mappings" = IN-3267 (to be fixed in 8.7.0)
#KI: "When you use a JSON structure" = IN-3414 (to be fixed in 8.6.1 & 8.7.0)
#KI: "MySQL 8.0 cannot" = DAT-1530 (to be fixed in 8.7.0)
