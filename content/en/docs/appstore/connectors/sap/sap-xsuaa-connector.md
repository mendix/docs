...
url: /appstore/connectors/sap/sap-xsuaa-connector/
category: "SAP"
weight: 40
...
{{< figure src="/attachments/appstore/connectors/sap-xsuaa-connector/xsuaa-diagram.png" >}}
...
{{< figure src="/attachments/appstore/connectors/sap-xsuaa-connector/trusted-idp.png" >}}
...
* Set up the app with the following two **User roles** in **App** > **Security**: Supervisor and Inspector
    ...
    {{< figure src="/attachments/appstore/connectors/sap-xsuaa-connector/add-roles-to-app.png" >}}
...
If the connector is not already in your app, download it from the [XSUAA Connector for SAP Business Technology Platform](https://marketplace.mendix.com/link/component/78091/) page in the Mendix Marketplace, and then follow the instructions in [How to Use Marketplace Content in Studio Pro](/appstore/overview/app-store-content/) to import the connector into your app.
...
2. Set up the configuration in the sections shown on the screen.
    ...
    {{< figure src="/attachments/appstore/connectors/sap-xsuaa-connector/configurator.png"   width="50%"  >}}
...
{{< figure src="/attachments/appstore/connectors/sap-xsuaa-connector/runtime-settings.png" >}}
...
7. Deploy and run your app. The XSUAA login button will look like this:
    ...
    {{< figure src="/attachments/appstore/connectors/sap-xsuaa-connector/sso-login-screen.png" >}}
...
{{< figure src="/attachments/appstore/connectors/sap-xsuaa-connector/xsuaa-diagram-labeled.png" >}}
...
{{< figure src="/attachments/appstore/connectors/sap-xsuaa-connector/app-scopes.png" >}}
...
{{< figure src="/attachments/appstore/connectors/sap-xsuaa-connector/app-role-templates.png" >}}
...
{{< figure src="/attachments/appstore/connectors/sap-xsuaa-connector/app-roles.png" >}}
...
1. Give the new Role Collection a name and, optionally, a description.
    ...
    {{< figure src="/attachments/appstore/connectors/sap-xsuaa-connector/new-role-collection.png" >}}
...
{{< figure src="/attachments/appstore/connectors/sap-xsuaa-connector/trust-configurations.png" >}}
...
{{< figure src="/attachments/appstore/connectors/sap-xsuaa-connector/role-collection-assignment-direct.png" >}}

You can picture the authentication as shown below:

{{< figure src="/attachments/appstore/connectors/sap-xsuaa-connector/xsuaa-diagram-config-direct.png" >}}
...
{{< figure src="/attachments/appstore/connectors/sap-xsuaa-connector/role-collection-mapping.png" >}}
...
{{< figure src="/attachments/appstore/connectors/sap-xsuaa-connector/xsuaa-diagram-config-via-group.png" >}}
