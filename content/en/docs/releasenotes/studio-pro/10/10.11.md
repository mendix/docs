...
{{% alert color="info" %}}For highlights of this release, see the [Mendix Release 10.11](https://www.mendix.com/blog/mendix-release-10-11-power-up-your-development/) blog post.{{% /alert %}}
