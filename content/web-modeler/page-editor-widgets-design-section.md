...
| Full Width | The button takes the whole width of a layout element it is placed in. For more information on layout elements, see [Layout Widgets in the Web Modeler](page-editor-widgets-layouts). | Enabled/Disabled                                             |
