...
| --------------------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| *Non-resolvable:*                                   |                                                              |                                                              |                                                              |                                                              |
| Context Entity Replaced                             | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} | N/A                                                          | N/A                                                          | N/A                                                          |
| Context Object Not Found                            | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} | N/A                                                          | N/A                                                          | N/A                                                          |
| Workflow Definition Deleted                         | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} | N/A                                                          | N/A                                                          | N/A                                                          |
| *Partially resolvable*:                             |                                                              |                                                              |                                                              |                                                              |
| Current Activity Removed                            | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} | N/A                                                          | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} |
| Current Activity Moved out of Path                | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} | N/A                                                          | N/A                                                          |
| Parallel Split Introduced in Executed Path          | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} | N/A                                                          | N/A                                                          |
| *Resolvable*:                                       |                                                              |                                                              |                                                              |                                                              |
| Parallel Path Introduced                          | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} | N/A                                                          |
| Selected Outcome Replaced                           | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} |
| Multi-User Task Outcome Changed                           | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} |
| Activities Introduced in Executed Path              | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} |
| Executed Activities Moved to Re-executable Position | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} |
| Parallel Split Path Removed                       | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} | {{< figure src="/attachments/refguide/mobile/progressive-web-app/check-mark.svg" class="no-border" >}} |
