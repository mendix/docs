---
title: "App"
url: /appstore/supported-add-ons/ats/rg-two-app/
---
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-app/dashboard.png" >}}
...
| Icon                                     | Meaning    |
| ---------------------------------------- | ---------- |
|{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-app/test-case-icon.png" >}} | Test case  |
|{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-app/test-suite-icon.png" >}} | Test suite |
|{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-app/ddt-icon.png" >}}| Data-driven test case |
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-app/settings.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-app/deployments.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-app/selenium-hub.png" >}}
...
For more information about the CI/CD API, see [CI/CD API](/appstore/supported-add-ons/ats/rg-two-cicd-api/).
