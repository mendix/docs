...
* We improved performance by dynamically importing the Navigation Document, only when it is actually needed.
...
* We updated the tooltip texts that were outdated after changing [naming improvements](#naming-improvements). 
...
* <a name="naming-improvements"></a>To avoid confusion, we changed naming of variables and objects in the microflow editor. Previously, the term "variable" could be used in different ways: as a name for a list of objects or as an object itself. This has now been cleared. 
