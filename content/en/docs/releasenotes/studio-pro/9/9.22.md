...
* We added a deprecation warning to the old merge algorithm, which will be removed in Studio Pro version 10. Unless you disabled the new algorithm, it was the default merge algorithm for you since Studio Pro version 9.0.5. If you had at some point disabled it because of an issue, please reach out to Mendix Support if you have not done so yet and if the issue is still relevant for you.
