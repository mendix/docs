...
* We added integration with the new [Mendix Business Events](/appstore/modules/business-events/) module. After downloading and installing it from the Marketplace, you can create published or consumed business event services by right-clicking on your app module, then going to **Add other** > **Published Business Event Service** or **Consumed Business Event Service**. 
