...
* We fixed an issue in published OData services where the service feed did not have a title for the workspace, even though that is required. (Thanks to [Ronald van Puijenbroek](https://community.mendix.com/link/ideas/1357) for pointing this out on the Mendix Community!)
