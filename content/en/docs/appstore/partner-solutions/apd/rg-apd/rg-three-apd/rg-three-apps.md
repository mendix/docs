---
title: "Apps"
url: /appstore/modules/apd/rg-three-apps/
---
...
{{< figure src="/attachments/appstore/modules/apd/rg-apd/rg-three-apd/rg-three-apps/ProjectsDashboard.png" >}}

It is possible to search on an app's name or select one from the overview directly.

Selecting an app in the overview displays the overview of the [Environments](/appstore/modules/apd/rg-three-environments/) for that app.
...
{{< figure src="/attachments/appstore/modules/apd/rg-apd/rg-three-apd/rg-three-apps/Documentation.png" >}}

{{% alert color="info" %}}
By default, APD displays the tour guides and videos upon login for new users.
{{% /alert %}}

{{< figure src="/attachments/appstore/modules/apd/rg-apd/rg-three-apd/rg-three-apps/Tour.png" >}}

When starting a tour, a tooltip will appear throughout the APD application with instructions to follow.

{{< figure src="/attachments/appstore/modules/apd/rg-apd/rg-three-apd/rg-three-apps/TourStep.png" >}}
...
{{< figure src="/attachments/appstore/modules/apd/rg-apd/rg-three-apd/rg-three-apps/profile_menu.png" >}}
...
* A specific app on the [Environments](/appstore/modules/apd/rg-three-environments/) overview if an app is selected and the **Environment** drop-down menu is empty
* A specific environment of a specific app

{{< figure src="/attachments/appstore/modules/apd/rg-apd/rg-three-apd/rg-three-apps/user_settings.png" >}}
...
Clicking **Delete account** deletes your account, including the [Mendix Studio Pro environments](/appstore/modules/apd/rg-three-environments/) belonging to your account. After the deletion, you will navigate to the Mendix Developer Portal. Apps are not deleted at this time.
