...
* We improved the special service that makes it possible to manage your app users. As of April 1st, 2020 we are replacing the current service with an improved one. You might be notified that an auto-upgrade of this service is required before you can publish your app:

	<img src="../../studio/attachments/settings-security/upgrade.png" style="zoom:50%;" />
	
	If you do not auto-upgrade this service, your app will still be secured and running, but you will not be able to publish a newer version of your app. For more information, see the [Auto-Upgrade to a New Service](/studio/settings-security#upgrade) section in *Security, Roles & Permissions*.
	
* To help you spot and solve consistency errors faster, we now highlight the element that causes the consistency error:

	<img src="attachments/8.7/error-highlight.png" style="zoom:67%;" />
...
* To speed up the process of creating pages, we added an opportunity to clear the selected attribute. Simply click the **Clear** button:
    ...
    <img src="attachments/8.7/clear-attribute.png" style="zoom:60%;" />
...
* We fixed an issue where you could not manage users if your app had the AppCloudServices module instead of the MendixSSO module.
