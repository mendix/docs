...
* We have added a CanApplyJumpTo attribute to the System.Workflow entity that indicates whether it is allowed to apply a jump-to option to the workflow in its current state.
...
* We added a Support Tools sub-menu to the **Help** menu that has the following tools: Performance logging, Profiling, and Optimize MPR.
