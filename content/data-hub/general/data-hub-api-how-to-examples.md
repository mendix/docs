...
description: "Examples of the how to use the Dat Hub API ."
...
## 3 Searching for Registered Assets in the Catalog that have the string:  `sample` {#get-data-ex}
...
## 6 Consuming data through Data Hub {#consume-data}


### 6.1 Example: All Available Services for  `SAMPLE_EmployeeDirectory`
...
##### 6.1.4.2 Successful 200 OK Response
...
### 6.2 Retrieve Contract of a Specific Service

### 6.2.4 Example: Retrieve the SAMPLE_EmployeeDirectory in the Production Environment
