...
#### 3.3.4 Show Empty Rows {#show-empty-rows}
...
#### 3.3.5 Selection Mode {#selection-mode}
...
#### 3.3.6 Select First {#select-first}

This property indicates whether the first item will be selected initially. This is especially useful if there is a data view listening to this grid.

Default: *False*

#### 3.3.7 Default Button Trigger {#default-button-trigger}
...
#### 3.3.8 Refresh Time (in Seconds) {#refresh-time}
