...
You can use the [MQTT](https://marketplace.mendix.com/link/component/118282) connector with your Mendix app to communicate with an MQTT broker. [MQTT](https://mqtt.org/) is a lightweight Internet of things (IoT) messaging protocol. 
