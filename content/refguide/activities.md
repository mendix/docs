...
| Graphic | Name | Description |
| --- | --- | --- |
| [![java action call](attachments/microflows-and-nanoflows/918018.png)](java-action-call) | [Java action call](java-action-call) *(only in microflows)* | Can be used to call a Java action. Arguments can be passed to the action and the result can be stored in a variable. |
| [![javascript action call](attachments/microflows-and-nanoflows/918008.png)](javascript-action-call) | [JavaScript action call](javascript-action-call) *(only in nanoflows)* | Can be used to call a JavaScript action. Arguments can be passed to the action and the result can be stored in a variable. |
...
| Graphic | Name | Description |
| --- | --- | --- |
| [![nanoflow call](attachments/microflows-and-nanoflows/918005.png)](nanoflow-call) | [Call nanoflow](nanoflow-call) *(only in nanoflows)* | Can be used to call another nanoflow. Arguments can be passed to the nanoflow and the result can be stored in a variable. |
...
| [![show home page](attachments/microflows-and-nanoflows/17661963.png)](show-home-page) | [Show home page](show-home-page) *(only in microflows)* | Can be used to navigate to the home page for the current user. |
...
| [![synchronize](attachments/microflows-and-nanoflows/synchronize.png)](synchronize) | [Synchronize](synchronize)  *(only in nanoflows)* | Can be used to synchronize data. |
| [![sync to device](attachments/microflows-and-nanoflows/sync-to-device.png)](sync-to-device) | [Sync to device](sync-to-device) *(only in microflows)* | Can be used to selectively sync one or more objects or lists to a device and store them in the offline database |
