...
The new value for the variable. The value is entered using a [microflow expression](/refguide6/microflow-expressions). The type of the microflow expression should be the same as the type of the selected variable.
