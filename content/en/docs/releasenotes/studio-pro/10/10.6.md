...
For more information, see [Microflows and Nanoflows](/refguide/microflows-and-nanoflows/).
    ...
    {{% alert color="info" %}}Adding a search to the smart suggestions is based on an [upvoted idea from Anthony Dickinson](https://forum.mendix.com/link/space/microflows/ideas/3472). Thanks, Anthony!{{% /alert %}}
