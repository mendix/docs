...
{{% alert color="info" %}}For an overview of the highlights in this release, see the [Mendix Release 10.9](https://www.mendix.com/blog/mendix-release-10-9-see-whats-inside/) blog post.{{% /alert %}}
