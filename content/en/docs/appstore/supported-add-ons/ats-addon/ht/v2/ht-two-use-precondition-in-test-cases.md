...
url: /appstore/supported-add-ons/ats/ht-two-use-precondition-in-test-cases/
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-use-precondition-in-test-cases/expense-to-click-on.png" >}}
...
3. Create a new test case and record the following steps:
    ...
    * Log out
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-use-precondition-in-test-cases/beginning-of-test-case.png" >}}
...
7. Click **Setup precondition**.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-use-precondition-in-test-cases/find-datagrid-row.png" >}}

    Clicking **Setup precondition** opens the **Select funtion or action** dialog:

    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-use-precondition-in-test-cases/select-function-or-action.png" >}}
...
9. Enter the same values in the input parameter fields:
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-use-precondition-in-test-cases/find-datagrid-row-precondition.png" >}}
...
13. Use the output of the previous step in the **Object 1** input parameter of the precondition and Leave **Object 2** empty:
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-use-precondition-in-test-cases/click-doubleclick-action.png" >}}
...
14. Record your click the **Next page** button and add the step:
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-use-precondition-in-test-cases/next-chunk.png" >}}
...
16. Use the output of step 3 in the **Object 1** input parameter of the precondition and leave **Object 2** empty: 
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-use-precondition-in-test-cases/click-widget-action.png" >}}
...
18. Add the **Assert equalTo** action as a precondition and use the outcome of step 3 in the **Object 1** input parameter:
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-use-precondition-in-test-cases/find-expense-on-new-page.png" >}}
...
20. Add the **Assert equalTo** action as a precondition and use the outcome of step 6 in the **Object 1** input parameter:
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-use-precondition-in-test-cases/click-on-found-expense.png" >}}
...
21. The last step that you must add is the **Close Dialog** step, as double-clicking on an expense opens the **New Expense** dialog:
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-use-precondition-in-test-cases/new-expense-dialog.png" >}}
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-use-precondition-in-test-cases/setup-and-teardown.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-use-precondition-in-test-cases/expense-on-first-page.png" >}}

If the expense is present on the second page the test run results look like:

{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-use-precondition-in-test-cases/expense-on-second-page.png" >}}
...
The next how-to is [How to Create a Negative Test Case](/appstore/supported-add-ons/ats/ht-two-create-a-negative-test-case/). You can find an overview of all the how-tos and the structure on the [ATS 2 How-tos](/appstore/supported-add-ons/ats/ht-two/) page. We advise you to follow the predefined structure.
