...
- We fixed the situation in workflows in which the failure reason of an activity is overwritten by a subsequent abort. A failed activity is no longer aborted, but stays failed.
