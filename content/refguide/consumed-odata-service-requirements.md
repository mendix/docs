...
1. Those properties cannot be nullable (so they must have `isNullable="false"` specified)
2. Only the following types are allowed: `Byte`, `SByte`, `Int16`, `Int32`, `Int64`, `Boolean`, `Decimal`, `Single`, `Double`, and `String`

3. If the type is `String`, a `MaxLength` must be specified
