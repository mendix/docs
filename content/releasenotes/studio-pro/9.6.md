...
* A pluggable widget configured with an association, microflow or nanoflow datasource could not be filtered correctly when some attribute values were empty. This has been fixed. (Tickets 136438, 139549)
