...
Comments from Studio Buzz are automatically posted in [App Buzz](/developerportal/general/buzz/#app-buzz) in the Developer Portal giving your team members an opportunity to respond to comments both in Studio and the Developer Portal. 
...
{{% alert color="info" %}}
You cannot delete comments in Studio, this is only possible in the [App Buzz](/developerportal/general/buzz/#app-buzz) in the Developer Portal.  
{{% /alert %}}
...
You will be automatically taken to the Developer Portal. For more information on the App Buzz, see the [App Buzz](/developerportal/general/buzz/#app-buzz) section in *Buzz*.  
