...
{{% alert color="info" %}}For highlights of this release, see the [Mendix Release 11.2](https://www.mendix.com/blog/release-11-2-group-smarter-select-better-build-faster/) blog post.{{% /alert %}}
