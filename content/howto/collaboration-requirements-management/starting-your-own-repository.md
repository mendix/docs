...
In this how-to, you will learn how to set up a GitHub repository. The repository will contain your development content and can be shared for others to contribute to an application or [App Store item](/developerportal/app-store/share-app-store-content).
