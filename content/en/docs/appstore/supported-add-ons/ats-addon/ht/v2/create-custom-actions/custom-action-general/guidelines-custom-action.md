...
url: /appstore/supported-add-ons/ats/ht-two-guidelines-custom-action/
---

## 1 Introduction

For details on custom actions, please see [Custom Actions](/appstore/supported-add-ons/ats/rg-one-custom-actions/) in the ATS 1 Reference Guide.
 
These are the definitions of Mendix actions and core actions:

* Mendix actions include [Mendix actions](/appstore/supported-add-ons/ats/rg-one-mendix-actions/) and [Mendix Marketplace widget actions](/appstore/supported-add-ons/ats/rg-one-appstore-widg-acts/)
* Core actions include [ATS Core actions](/appstore/supported-add-ons/ats/rg-one-ats-core-actions/) and [Selenium actions](/appstore/supported-add-ons/ats/rg-one-selenium-actions/)
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/create-custom-actions/custom-action-general/guidelines-custom-action/mendix-action-input-parameters.png" >}}

But when you use a core action, you have four input parameters: 

{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/create-custom-actions/custom-action-general/guidelines-custom-action/core-action-input-parameters.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/create-custom-actions/custom-action-general/guidelines-custom-action/visual-component-widget.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/create-custom-actions/custom-action-general/guidelines-custom-action/mx-name-in-debugger.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/create-custom-actions/custom-action-general/guidelines-custom-action/mendix-wait-action.png" >}}
...
When defining action parameter names, always use the ATS [naming conventions](/appstore/supported-add-ons/ats/rg-one-best-practices/).
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/create-custom-actions/custom-action-general/guidelines-custom-action/standard-input-parameters.png" >}}

{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/create-custom-actions/custom-action-general/guidelines-custom-action/standard-input-parameters-2.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/create-custom-actions/custom-action-general/guidelines-custom-action/describe-teststeps-define-output.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/create-custom-actions/custom-action-general/guidelines-custom-action/datatype-web-element.png" >}}
