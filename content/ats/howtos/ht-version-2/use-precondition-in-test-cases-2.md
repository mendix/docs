...
![](attachments/ht2-use-precondition-in-test-cases/expense-to-click-on.png)
...
3. Create a new test case and record the following steps:
   ...
   ![](attachments/ht2-use-precondition-in-test-cases/beginning-of-test-case.png)
...
9. Enter the same values in the input parameter fields:
   ...
   ![](attachments/ht2-use-precondition-in-test-cases/find-datagrid-row-precondition.png)
...
12. Use the output of the previous step in the **Object 1** input parameter of the precondition and Leave **Object 2** empty:
   ...
   ![](attachments/ht2-use-precondition-in-test-cases/click-doubleclick-action.png)
...
13. Record your click on the **Next page** button and add the step:
   ...
   ![](attachments/ht2-use-precondition-in-test-cases/next-chunk.png)
...
15. Use the output of step 3 in the **Object 1** input parameter of the precondition and leave **Object 2** empty: 
   ...
   ![](attachments/ht2-use-precondition-in-test-cases/click-widget-action.png)
...
17. Add the **Assert equalTo** action as a precondition and use the outcome of step 3 in the **Object 1** input parameter:
   ...
   ![](attachments/ht2-use-precondition-in-test-cases/find-expense-on-new-page.png)
...
19. Add the **Assert equalTo** action as a precondition and use the outcome of step 6 in the **Object 1** input parameter:
   ...
   ![](attachments/ht2-use-precondition-in-test-cases/click-on-found-expense.png)
...
20. The last step that you must add is the **Close Dialog** step, as double-clicking on an expense opens the **New Expense** dialog:
   ...
   ![](attachments/ht2-use-precondition-in-test-cases/new-expense-dialog.png)
...
The final test case looks like this:
   ...
   ![](attachments/ht2-use-precondition-in-test-cases/setup-and-teardown.png)
...
![](attachments/ht2-use-precondition-in-test-cases/expense-on-first-page.png)

If the expense is present on the second page the test run results look like:

![](attachments/ht2-use-precondition-in-test-cases/expense-on-second-page.png)
...
The next how-to is [How to Create a Negative Test Case](ht2-create-a-negative-test-case). You can find an overview of all the how-tos and the structure on the [ATS 2 How-to's](ht2) page. We advise you to follow the predefined structure.
