---
title: "Web API를 사용하여 모달 대화 상자 열기"
linktitle: "모달 대화 상자 열기"
url: /apidocs-mxsdk/apidocs/web-extensibility-api-11/dialog-api/
---

## 소개

이 How-to에서는 open a modal dialog in Studio Pro from an extension, allowing you to display web content.
