...
| [![](attachments/overview/bluewave.png)](build-a-simple-hrm-app) | **[Build a Simple HRM App](build-a-simple-hrm-app)<br> Learn the basics of app development with Mendix by building a simple HRM app.** |
