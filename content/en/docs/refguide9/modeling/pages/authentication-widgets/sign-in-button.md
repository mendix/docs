...
{{< figure src="/attachments/refguide9/modeling/pages/authentication-widgets/sign-in-button/sign-in-button.png" alt="Sign-In Button" >}}
...
{{< figure src="/attachments/refguide9/modeling/pages/authentication-widgets/sign-in-button/sign-in-button-properties.png" alt="Sign-In Button Properties"   width="250"  >}}
...
{{< figure src="/attachments/refguide9/modeling/pages/authentication-widgets/sign-in-button/validation-failure.png" alt="Validation Failure" >}}
