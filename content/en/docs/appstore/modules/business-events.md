...
* `TruststoreLocation` and `TruststorePassword` - [OPTIONAL] The module suports adding a Truststore and password in order to allow for SSL verification of the server.
