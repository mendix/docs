...
[![](attachments/16713812/page-template.png)](page-template) Page templates | [Page templates](page-templates) Newly created pages are based on page templates. By mapping out common design patterns, a lot of the initial work involved in creating a new page can be simplified by setting up a proper set of page templates. 
