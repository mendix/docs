---
title: "C#를 사용하여 Studio Pro에 메뉴 및 하위 메뉴 추가하기"
linktitle: "구조화된 메뉴"
...
이 How-to에서는 add a menu that contains sub-menus, some of which also contain sub-menus of their own. 

이 How-to의 예제는 [이 GitHub 저장소](https://github.com/mendix/ExtensionAPI-Samples)에서 다운로드할 수 있습니다.

## 전제 조건

이 How-to는 다음의 결과를 사용합니다: [Create a Menu Extension Using C#](/apidocs-mxsdk/apidocs/csharp-extensibility-api-11/create-menu-extension/). 이 How-to를 시작하기 전에 해당 How-to를 먼저 완료하세요.
...
위 코드는 다음을 생성합니다 a single menu, `Beverages`. This menu contains the following:
