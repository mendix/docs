...
<sup>4</sup> The *enumerations* feature was introduced in Studio Pro [9.22.0](/releasenotes/studio-pro/9.22.0/). In earlier versions, all enumeration attributes were published as strings.
