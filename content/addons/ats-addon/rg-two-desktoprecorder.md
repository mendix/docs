...
In most cases, administrative privileges are not needed to install the desktop recorder. However, the administrator may have restricted access to the windows registry which is necessary for the installation. If this is the case, the following error will be displayed during installation: `ERROR: Registry editing has been disabled by your administrator.` If you see this message, I am afraid you will need help from the administrator to complete the installation.
