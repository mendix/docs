...
| TemplateUUID (can be `empty`) | String | The [UUID](/appstore/overview/app-store-overview/#usage) that identifies the template with which the project will be created. If left empty, a default blank template will be used. |
