...
Mendix는 [Siemens ProductCERT](https://www.siemens.com/global/en/products/services/cert.html)를 활용하여 보안 권고를 게시합니다. Siemens ProductCERT는 Siemens 제품, 솔루션 및 서비스와 관련된 보안 문제의 접수, 조사, 내부 조정, 공개 보고를 관리하는 숙련된 보안 전문가로 구성된 전담 팀입니다.

Mendix는 Studio Pro 릴리스 노트에 설명된 보안 취약점에 대한 CVSS 점수 및 CVSS 벡터를 추가합니다. 또한 Mendix 고유의 CVE ID가 사용 가능해지면 추가합니다.

{{% alert color="warning" %}}
Siemens는 매월 두 번째 화요일에 공통 취약점 및 노출(CVE)을 게시합니다.
{{% /alert %}}
...
* [Siemens ProductCERT and Siemens CERT](https://new.siemens.com/global/en/products/services/cert.html)
    * "Mendix" 키워드로 관련 보안 권고를 [검색](https://new.siemens.com/global/en/products/services/cert.html#SecurityPublications)할 수 있습니다.
* Mendix 관련 보안 권고는 [Atom 피드](https://cert-portal.siemens.com/productcert/rss/advisories_mendix_products.atom) 및 [RSS 피드](https://cert-portal.siemens.com/productcert/rss/advisories_mendix_products.rss)를 통해 확인할 수 있습니다.
