...
## Using an Unprivileged Dedicated User Account for Every Application
...
## Using a HTTP Reverse Proxy with SSL Support
...
## Letting the HTTP Reverse Proxy Serve Static Content
...
## Securing Access to the Admin Port (for m2ee-tools and Windows Service Console Access)
...
## Do Not Connect to a Production Database Using Studio Pro
