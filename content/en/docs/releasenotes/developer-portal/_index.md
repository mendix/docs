...
- We are fixing an issue that was sending duplicate email notifications after a migration to Git was finished.
- We are fixing an issue that prevented teams from modifying their roles after migrating to Centralized Company Roles.
