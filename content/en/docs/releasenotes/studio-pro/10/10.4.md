...
In this case, a dialog box is shown where you can choose from which of the surrounding data views, snippets, or page parameters


and available selections a parameter must be created in the new microflow or nanoflow.
