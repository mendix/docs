...
{{% alert type="info" %}}
[Mendix Admins](/developerportal/control-center/index#company) can manage [groups](/developerportal/control-center/index#company#groups) that grant app permissions to groups of users.
{{% /alert %}}
