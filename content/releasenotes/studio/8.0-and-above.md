...
* We made the **Message** column in the **Checks** panel wider to improve readability. 

* For **App from a spreadsheet**, if importing your file fails, you can retry importing the same file or import another file without having to create a new app. 
