...
*  To speed up the process of creating pages, **Pre-fill page contents based on the X entity** is now checked by default when creating a new page with an entity.

	{{% image_container width="350" %}}![](attachments/pre-fill-page-contents.png)
	{{% /image_container %}}
