...
#KI: "Cannot add microflows from the Project Explorer" = LC-310
...
{{% alert type="warning" %}}
To test your Mendix Native apps, Make It Native v1.2.0 is required.
{{% /alert %}}
...
* Dragging and dropping a microflow from the Project Explorer into a microflow to create a **Microflow call** activity is not possible. The workaround is to create an **Activity** in a microflow, set the type to **Microflow call**, and select the required microflow.
