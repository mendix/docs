...
{{< figure src="/attachments/refguide/mendix-ai-assistance/workflow-recommender/blue-plus.png" max-width=20% >}}
...
{{< figure src="/attachments/refguide/mendix-ai-assistance/workflow-recommender/initial-recommendations.png" max-width=50% >}}
...
{{< figure src="/attachments/refguide/mendix-ai-assistance/workflow-recommender/search-toolbox.png" max-width=80% >}}
