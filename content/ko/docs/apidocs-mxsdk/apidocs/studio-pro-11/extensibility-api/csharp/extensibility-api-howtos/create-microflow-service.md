---
title: "C#를 사용하여 Microflow 만들고 Activity 추가하기"
linktitle: "Microflow와 Activity"
...
## 소개
 ...
 이 How-to에서는 create a new microflow and add activities to it. The `IMicroflowService` is used to perform actions related to microflows.

## `Initialize`를 사용하여 Microflow 만들고 초기화하기
...
## `CreateMicroflow`를 사용하여 Microflow 만들기
