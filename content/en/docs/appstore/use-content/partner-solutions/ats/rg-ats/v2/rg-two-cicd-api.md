...
{{< figure src="/attachments/appstore/use-contents/partner-solutions/ats/rg-ats/v2/rg-two-cicd-api/CICD_JobTemplateOverview.png" class="no-border" >}}
...
{{< figure src="/attachments/appstore/use-contents/partner-solutions/ats/rg-ats/v2/rg-two-cicd-api/CICD_JobTemplateNewEdit.png" class="no-border" >}}
