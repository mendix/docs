...
{{% alert color="info" %}}For an overview of the highlights in this release, see the [Mendix Release 10.16](https://www.mendix.com/blog/mendix-release-10-16-a-leader-keeps-on-giving/) blog post.{{% /alert %}}
