...
* We added a commandline option to the `mx` commandline tool called `dump-mpr`. This exports the app model of a Mendix App as JSON data. See [the documentation](/refguide/mx-command-line-tool/dump-mpr)  for more context.
