...
Condition value describes which direction should be followed based on the outcome of an [exclusive split](/refguide6/exclusive-split) or an [inheritance split](/refguide6/inheritance-split).
