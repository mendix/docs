...
For example, you are developing a feature together with another developer on the same branch. You both have the same starting point (3). When your colleague pushes their changes (4 and 5) to the branch, you can retrieve and integrate them. To do this safely, you first need to commit your own local changes (6), this prepares them for merging but does not yet share them with others. Once your changes are committed locally, you can pull your colleague's work, which automatically merges with your committed changes. After reviewing the merged result, you push it (7) back to the branch, making it available to your colleague. This approach ensures a clear history: your work is always committed before merging, so you can see exactly what changed and prevent accidental overwrites during conflict resolution.
