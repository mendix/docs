...
[기록된 세션 개요](/appstore/partner-solutions/apd/rg-three-recorder/)에서 런타임 기록을 열면 이 런타임 기록의 세부 정보가 표시됩니다. 결과는 소요 시간별로 정렬됩니다. 기록된 모든 액션은 클릭 가능하며 상세 정보를 보여줍니다. 정확한 위치까지 드릴다운하여 애플리케이션에서 시간이 소요되는 곳을 정확히 파악할 수 있습니다.
...
트리 뷰는 Microflow와 액션의 소요 시간 개요를 제공합니다:
...
액션의 세부 정보를 볼 때 해당 액션이 SQL을 사용하는 경우 SQL 문을 볼 수 있습니다:
