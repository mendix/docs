...
* There is an issue when user adds a **new** enumeration as return type of a Java action. This can result in an Oops exception in modeler. The user can continue working in the modeler by closing the Oops dialog.
