...
* We removed support for PostgreSQL 9.6, because it is no longer supported by the vendor.
...
* Starting with version 8.18.8, we will drop support for Microsoft SQL Server 2016, because it is no longer supported by the vendor.
