...
<<<<<<< HEAD:content/en/docs/data-hub/data-hub-catalog/register-data-sources/register-data.md
url: /data-hub/mendix-connect-catalog/register-data/
=======
url: /catalog/register/register-data/
>>>>>>> development:content/en/docs/catalog/register-data-sources/register-data.md
