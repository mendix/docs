...
This error occurs when you work with SAP environments from within the Mendix Mendix Portal. As described on the error page, it occurs when you use different email addresses for signing in to Mendix platform and SAP region which you are working on.
