...
Internally, user manangement properties are translated into entity access rules for `System.User`. This means that they are not applied in microflows that don't check entity access.
