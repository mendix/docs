...
{{< figure src="/attachments/appstore/use-contents/modules/native-mobile-ar/scale-one.jpg" alt="Cube"   width="300"  class="no-border" >}}
...
{{< figure src="/attachments/appstore/use-contents/modules/native-mobile-ar/Cube.gif" alt="Cube" class="no-border" >}}

### 4.2 Sphere (AR) {#sphere}

{{< figure src="/attachments/appstore/use-contents/modules/native-mobile-ar/Sphere.gif" alt="Sphere" class="no-border" >}}

### 4.3 Square (AR) {#square}

{{< figure src="/attachments/appstore/use-contents/modules/native-mobile-ar/Square.gif" alt="Square" class="no-border" >}}

### 4.4 3D Object (AR) {#3d-object}

{{< figure src="/attachments/appstore/use-contents/modules/native-mobile-ar/3DObject.gif" alt="3DObject" class="no-border" >}}
