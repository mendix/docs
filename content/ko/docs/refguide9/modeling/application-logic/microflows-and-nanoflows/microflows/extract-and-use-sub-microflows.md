...
3. In the **Add microflow** dialog box, enter a name for the sub-microflow.
    ...
    {{% alert color="info" %}}As a best practice, use a consistent naming scheme that clearly identifies the microflow, for example, *Sub_{MicroflowDescription}*. 자세한 내용은 [Microflow Naming Conventions](/refguide9/dev-best-practices/#microflow-naming-conventions).{{% /alert %}}
