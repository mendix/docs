...
url: /appstore/modules/apd/ig-one-java-security-settings/
---
...
1. Turn off the emulate cloud security option in project settings, active configuration, server tab
    ...
    {{< figure src="/attachments/appstore/modules/apd/ig/ig-one/ig-one-prerequisites/ig-one-java-security-settings/Java_Command_Line_Options.png" >}}
