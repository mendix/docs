...
* We fixed an application startup error when a direct association from an entity to a specialization of itself was removed and when the parent of the association was either removed or was no longer a generalization of the child of the association. (Ticket 285998)
