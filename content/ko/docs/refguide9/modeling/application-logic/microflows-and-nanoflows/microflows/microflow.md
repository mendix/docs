...
자세한 내용은 [Module Security](/refguide9/module-security/).
...
The **Caption** and **Category** of the workflow action are required, but the **Icon** and **Image** are optional. The image in the **Icon** property is used for the list view of the **Toolbox**, and the image in the **Image** property – for the toolbox tile view. 자세한 내용은 the [Toolbox](/refguide9/view-menu/#toolbox) section in the **View Menu**.
