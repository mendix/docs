...
{{% alert type="info" %}}
Quick guide to making a doc change: fork the [**mendix/docs**](https://github.com/mendix/docs repository and create a pull request with our **development** branch as the base.
{{% /alert %}}
