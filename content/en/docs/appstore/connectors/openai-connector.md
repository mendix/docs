...
| --- | --- | --- |
| `assistant` | **Assistant** | An assistant message that was generated by the model as a response to a user message. |
...
| Name | Type | Description |
| --- | --- | --- |
| `IsSuccess` | Boolean | `true` if the image generations request was successful, `false` if an error occurred or a validation failed. |
...
| Name | Type | Description |
| --- | --- | --- |
| `EmbeddingVector` | String | String representation of a vector embedding for the input. |
