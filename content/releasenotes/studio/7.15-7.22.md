...
* We added support for [Studio Pro 7.16](../studio-pro/7.16). Studio supports ranges for Mendix Studio Pro. This gives you choice in whether to update Studio right away, or postpone the update. For more information on the topic, see [Studio Ranges & Mendix Versions](/studio7/general-versions).
