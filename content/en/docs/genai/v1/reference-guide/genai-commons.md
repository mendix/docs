---
title: "GenAI Commons"
url: /agents/agents-kit-1/genai-for-mx/commons/
...
The [Conversational UI module](/agents/agents-kit-1/genai-for-mx/conversational-ui/) provides pages, snippets, and logic to display and export token usage information. For this to work, assign the module roles `UsageMonitoring` from both Conversational UI and GenAI Commons to the applicable project roles.
...
The `ConsumedKnowledgeBase` entity was introduced in module version 6.0.0. To migrate data from earlier versions, refer to the [GenAI migration guide](/agents/agents-kit-1/genai-for-mx/migration-guide/#march-2026).
