...
description: "Runtime Server와 그 기능을 설명합니다."
weight: 10
---
...
{{< figure src="/attachments/refguide9/runtime/runtime-server/runtime-server.png" alt="The makeup of the Runtime Server" class="no-border" >}}
