...
* We added a **Portfolio** button in the **Open App** dialog box menu. [**TW**]
...
* We are deprecating the **Import Web Service or XML Schema** wizard that is accessible in the domain model editor when you click **Import web service/XML file**. This functionality will be removed in Mendix 10.6. [**TW - ADD NOTE TO DOC?**]

### Breaking Changes

* When committing multiple objects, the order that **Before Commit** and **After Commit** events are executed may have changed. This order was already documented to be unspecified, and it should not be relied on. [**TW - WHERE DOCUMENTED?**]
