...
{{% alert color="info" %}}This is based on an [upvoted idea from Bart Rikers](https://forum.mendix.com/link/space/studio%20pro/ideas/1938) submitted to the [Mendix Idea Forum](https://forum.mendixcloud.com/link/ideas). Thanks, Bart!{{% /alert %}}
...
* We added the option to copy the styling of a widget. This enables copying the inline styles, (dynamic) classes, and (applicable) design properties to other widgets. For information on copy-pasting widget styling with shortcuts, see the  [Studio Pro Overview](/refguide/studio-pro-overview/#editors-only).
