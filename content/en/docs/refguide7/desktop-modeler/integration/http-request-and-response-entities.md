...
{{< figure src="/attachments/refguide7/desktop-modeler/integration/http-request-and-response-entities/http-request-and-response-domain-model.png" class="no-border" >}}
