...
* We upgraded the internal browser to fix an issue where single sign-on for Studio Pro was giving an error. (Ticket 108368)
...
* We improved the speed of the [Project Explorer](/refguide/project-explorer) when you expand or collapse a folder or module, and when scrolling and filtering documents.
* We resolved several minor issues in the [Project Explorer](/refguide/project-explorer) and Connector that would cause items in the tree to expand or collapse without good reason.
