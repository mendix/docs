...
* We updated the [Make It Native](/releasenotes/mobile/make-it-native-9/) app to make it compatible with this Studio Pro version. This means it is no longer compatible with older Studio Pro versions. We recommend upgrading your app to 9.24 or building a custom developer app as described in our documentation.
