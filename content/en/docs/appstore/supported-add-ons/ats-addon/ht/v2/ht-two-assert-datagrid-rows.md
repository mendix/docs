...
url: /appstore/supported-add-ons/ats/ht-two-assert-datagrid-rows/
...
In ATS you can assert rows in a data grid With the [Find/Assert DataGrid Row](/appstore/supported-add-ons/ats/rg-one-findassert-datagrid-row/) action. As the action has many input parameters this how to explains how-to use the action. 
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-assert-datagrid-rows/datagrid.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-assert-datagrid-rows/find-assert-datagrid-row.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-assert-datagrid-rows/widget-name-grid.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-assert-datagrid-rows/column-mx-name.png" >}}

#### 3.1.3 Column 1 Value

In **Column 1 Value** you have to add the value of the column you want to assert:

{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-assert-datagrid-rows/value-of-column-1.png" >}}

Filling the data in the **Find/Assert DataGrid Row** action, results in the following action:

{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-assert-datagrid-rows/datagrid-action-partly-filled.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-assert-datagrid-rows/add-optional-parameters.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-assert-datagrid-rows/column-value-2.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-assert-datagrid-rows/column-value-3.png" >}}

Filling the data in the **Find/Assert DataGrid Row** action, results in the following action:

{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-assert-datagrid-rows/datagrid-action-filled.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-assert-datagrid-rows/assert-in-precondition.png" >}}

## 4 Next Up

You now learned how to assert datagrid rows with ATS. The next how-to is [How to Increase Recorder and Helper Coverage](/appstore/supported-add-ons/ats/ht-two-increase-recorder-helper-coverage/). You find an overview of all the how-tos and the structure on the [ATS 2 How-tos](/appstore/supported-add-ons/ats/ht-two/) page. We advise you to follow the predefined structure.
