---
title: "Mendix Data Storage API를 사용하여 재사용 가능한 Microflow Action 빌드"
linktitle: "재사용 가능한 Microflow를 위한 Data Storage API"
url: /howto8/extensibility/howto-datastorage-api/
weight: 90
description: "Data Storage API를 사용하여 커스텀 Microflow Action을 생성하는 방법을 설명합니다."
---
