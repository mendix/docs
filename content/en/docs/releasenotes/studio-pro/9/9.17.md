...
* We re-added the **For Each** and **While** [loop type](/refguide/loop/#loop-type) property names for microflow actions in the logging. These are `ListLoop` and `WhileLoop`, respectively.
