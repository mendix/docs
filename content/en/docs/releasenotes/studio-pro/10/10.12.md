...
- We rebuilt the **Toolbox** to give it the same look and feel for both Windows and macOS. You can switch to the new version of the **Toolbox** via **Edit > Preferences > New Features**. {TW}
