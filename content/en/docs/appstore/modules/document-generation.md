...
Use this module to generate PDF documents based on regular pages in your project.
...
This module uses the Document generation service in the Mendix cloud to convert any regular web page in your app into a PDF document. The result is similar to what you would get when using 'Save as PDF' in the print dialog of your browser. 
...
### Running the generation for the current user
...
### Running the generation as system task
