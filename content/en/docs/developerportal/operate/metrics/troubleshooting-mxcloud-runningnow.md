...
The **Running now** window can be opened using the **Show Running Now** button on the details page of your Cloud node environment. It can be used to monitor all actions that are currently running in your environment.
