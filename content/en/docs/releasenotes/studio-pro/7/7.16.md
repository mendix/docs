...
{{% alert color="info" %}}
This is based on an [upvoted idea from Fabian Recktenwald](https://community.mendix.com/link/ideas/685) submitted to the Mendix Community. Thanks, Fabian!
{{% /alert %}}
...
{{% alert color="info" %}}
This is based on an [upvoted idea from Chris de Gelder](https://community.mendix.com/link/ideas/163) submitted to the Mendix Community. Nice one, Chris!
{{% /alert %}}
...
* We fixed an issue where a Java action with the type parameter (or parameters) did not get uncommitted changes from the client during microflow execution. (Ticket 60911)
