...
* We fixed an issue where date tokens like `[%BeginOfCurrentWeek%]` were evaluated in client-side expressions but did not respect the [first day of the week](/refguide/project-settings#first-day-of-the-week) project setting.
