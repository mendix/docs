...
The Mendix Platform offers online services such as [version control](/refguide10/version-control/) and [cloud deployment](/deployment/). When enabled, this will create an app in [Projects](https://projects.home.mendix.com/) in the Mendix Portal and a corresponding version control repository.
