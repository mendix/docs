...
* A Mendix account with **Deploy App** rights to an existing namespace – see [Creating a Private Cloud Cluster](private-cloud-cluster) for more information on setting up clusters and namespaces and adding members
