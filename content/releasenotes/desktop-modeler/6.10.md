...
* We fixed the memory problem that caused a constantly growing tenured generation, resulting in an `OutOfMemoryError`. This problem was introduced in Mendix 6.9.1. (Ticket 52238, 53357, 54560, 55296, 55309)
...
Performing a migration to Mendix 7.X from this version is going to be possible only when the Mendix version is greater than 7.6.
