...
When doing a commit or update to the Team Server after more than 1 hour after the last Team Server connection, you will get an error dialog with the details panel showing SvnOperationCanceledException info.
