...
---
{{% alert color="info" %}}
OTA updates via App Center's CodePush are now deprecated. Please consider switching to the newly introduced [Mendix OTA update solution](/refguide/mobile/distributing-mobile-apps/overtheair-updates/). 
{{% /alert %}}
