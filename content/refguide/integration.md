...
Integration between Mendix applications is done best with REST Services (for details, see [Published REST Services](published-rest-services) and [Call REST Service Action](call-rest-action)). Some of the terms used the most often are explained below.
