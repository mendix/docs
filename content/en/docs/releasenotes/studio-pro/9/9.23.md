...
* We have released a new feature named **Machine Learning (ML) Kit**. The ML Toolkit enables deploying an ML model (built using a common ML framework and language) into Studio Pro runtime in a low-code way. For more information, see [](). [**CROSS-REFERENCE?**]
...
* We fixed the sizes of the **Caption** and **Validation Message** fields in the new/edit **Validation Rule** dialog box for [Validation Assist](/refguide/validation-assist/). [**VERIFY**]
