...
2. Open the project in which you want to install content from the Marketplace.
...
4.  On the Marketplace overview page, find the content to use in your app. The **Categories** gives you an overview of which types of content you can download. You can use the **Search** bar to find the specific project or component.
...
6. Click **Download** to download the content to your app. 
    ...
    Make sure that you download the correct version. The version must be compatible with the Studio Pro version that you use. Do check the **Mendix Version** on the **Overview** tab. Do not download the content that requires a higher **Mendix version** than the Studio Pro that you use. You can download older versions of the content on the **All Versions** tab.
...
{{% alert type="info" %}}
For more information on what the content works, check the **Documentation** tab on the page of the content in the Marketplace.
{{% /alert %}}
...
You can download a widget from the Marketplace and use it in your project. We will use the [Rating](/appstore/widgets/rating) widget as an example. You can follow the steps to use any widget from the Marketplace.
...
5. In the page of your project, click where you want to drop the widget. After you release the mouse button, the widget is placed in the page.
   ...
   {{% alert type="info" %}}
   If you want to delete a widget from the project, go to **App** > **Show App Directory in Explorer** to open the app folder, and then remove the *.mpk* file from the **widgets** folder.
   {{% /alert %}}
...
To use the Email with templates module in Studio Pro, see [Email with templates](/appstore/modules/email-with-templates).

### 4.3  Using a Project or Layout {#project-layout}

Downloading a project or layout will create a new project structure in the location that you enter. After you click **Download**, a window will appear where you can specify how the project should be created.
