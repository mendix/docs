...
* We added `createXPathQuery` in the Core Java API. This offers a fluent way of creating and executing an XPath-based query, with a syntax for adding variables comparable to microflow expressions. This new API supercedes the `retrieveXPathQueryEscaped` methods, which will be deprecated pending removal in Mendix 8.
