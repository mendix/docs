...
If you have [TortoiseSVN](/refguide/using-version-control-in-the-dm#tortoisesvn-and-subclipse) installed, right-click the **node_modules** folder and select **TortoiseSVN** > **Add to ignore list**.
