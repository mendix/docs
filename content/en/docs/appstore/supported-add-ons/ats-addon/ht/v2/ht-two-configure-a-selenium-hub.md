...
url: /appstore/supported-add-ons/ats/ht-two-configure-a-selenium-hub/
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-configure-a-selenium-hub/new-selenium-hub.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-configure-a-selenium-hub/select-provider-dialog.png" >}}
...
1. Go to the **Select Provider** dialog box and select **Browserstack**.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-configure-a-selenium-hub/select-provider-dialog-browserstack.png" >}}
...
5. In the **Access Key** field you enter the access key of your Browserstack account.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-configure-a-selenium-hub/new-selenium-hub-dialog-browserstack.png" >}}
...
3. There is a collapsible menu on the left side of the screen. When you unfold it, it displays the **Username** and the **Access Key** when you unfold it. It also has a **Copy** button.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-configure-a-selenium-hub/username-access-key-browserstack.png" >}}
...
2. Click **New** in the **Custom Capabilities** section.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-configure-a-selenium-hub/new-selenium-hub-dialog-browserstack-custom-capability.png" >}}
...
4. To enter a custom capability you must know which capabilities you can use. Go to the [capabilities](https://www.browserstack.com/automate/capabilities) section on the Browserstack website. Choose a capability, for example, **name**.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-configure-a-selenium-hub/name-capability-browserstack.png" >}}
...
5. Now enter the capability in the **Key** field and the value you want in the **Value** field.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-configure-a-selenium-hub/name-capability-browserstack-ats.png" >}}

6. Click **Save**.

7. Add another custom capability or click **Save** when on the **New Selenium Hub** dialog to store your selenium hub set-up.

    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-configure-a-selenium-hub/new-selenium-hub-dialog-browserstack-with-name-capability.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-configure-a-selenium-hub/finished-browserstack-selenium-hub.png" >}}
...
1. Go to the **Select Provider** dialog box and select **SauceLabs**.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-configure-a-selenium-hub/select-provider-dialog-saucelabs.png" >}}
...
5. In the **Access Key** field you enter the access key of your SauceLabs account.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-configure-a-selenium-hub/new-selenium-hub-dialog-saucelabs.png" >}}
...
2. Open the profile menu in the upper right corner of your screen and click **My Account** in the drop-down menu.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-configure-a-selenium-hub/my-account-saucelabs.png" >}}

3. You find your SauceLabs username and access key on this page.

    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-configure-a-selenium-hub/username-access-key-saucelabs.png" >}}
...
2. Click **New** in the **Custom Capabilities** section.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-configure-a-selenium-hub/new-selenium-hub-dialog-saucelabs-custom-capability.png" >}}
...
4. To enter a custom capability you must know which capabilities you can use. Go to the [Test Configuration](https://wiki.saucelabs.com/display/DOCS/Test+Configuration+Options#TestConfigurationOptions-TestAnnotation) section on the SauceLabs documentation website. Choose a capability, for example, **name**.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-configure-a-selenium-hub/name-capability-saucelabs.png" >}}
...
5. Now enter the key in the **Key** field and the value you want in the **Value** field.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-configure-a-selenium-hub/name-capability-saucelabs-ats.png" >}}

6. Click **Save**.

7. Add another custom capability or click **Save** when on the **New Selenium Hub** dialog to store your selenium hub set-up.

    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-configure-a-selenium-hub/new-selenium-hub-dialog-saucelabs-with-name-capability.png" >}}
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-configure-a-selenium-hub/finished-saucelabs-selenium-hub.png" >}}
...
1. Go to the **Select Provider** dialog box and select **Testingbot**.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-configure-a-selenium-hub/select-provider-dialog-testingbot.png" >}}
...
5. In the **Client Secret** field you enter the Client secret of your testingbot account.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-configure-a-selenium-hub/new-selenium-hub-dialog-testingbot.png" >}}
...
2. Click **My Account** in the upper right corner of the screen.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-configure-a-selenium-hub/my-account-testingbot.png" >}}

3. You find your Testingbot key and secret on this page.

    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-configure-a-selenium-hub/client-key-client-secret-testingbot.png" >}}
...
2. Click **New** in the **Custom Capabilities** section.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-configure-a-selenium-hub/new-selenium-hub-dialog-testingbot-custom-capability.png" >}}
...
4. To enter a custom capability you must know which capabilities you can use. Go to the [Test Configuration](https://testingbot.com/support/other/test-options#name) section on the Testingbot website. Choose a capability, for example, **name**.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-configure-a-selenium-hub/name-capability-testingbot.png" >}}
...
5. Now enter the *name* value in the **Key** field and the value you want in the **Value** field.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-configure-a-selenium-hub/name-capability-testingbot-ats.png" >}}

6. Click **Save**.

7. Add another custom capability or click **Save** when on the **New Selenium Hub** dialog to store your selenium hub set-up.

    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-configure-a-selenium-hub/new-selenium-hub-dialog-testingbot-with-name-capability.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-configure-a-selenium-hub/finished-testingbot-selenium-hub.png" >}}
...
1. Go to the **Select Provider** dialog box and select **Custom**.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-configure-a-selenium-hub/select-provider-dialog-custom.png" >}}
...
4. In the **Custom URL** field you enter the access URL of your server.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-configure-a-selenium-hub/new-selenium-hub-dialog-custom.png" >}}

    {{% alert color="info" %}}For more information on local selenium set-up go to [Customer Hosted Selenium](/appstore/supported-add-ons/ats/ov-deployment/#customer-hosted-selenium).
    {{% /alert %}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-configure-a-selenium-hub/finished-custom-selenium-hub.png" >}}

## 9 Next Up

You now learned how to configure the different selenium hubs. The next how-to is [How to Create a Test Case](/appstore/supported-add-ons/ats/ht-two-create-a-test-case/). You find an overview of all the how-tos and the structure on the [ATS 2 How-tos](/appstore/supported-add-ons/ats/ht-two/) page. We advise you to follow the predefined structure.
