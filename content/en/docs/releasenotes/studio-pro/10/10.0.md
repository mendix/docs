...
* MxAssist Performance Bot best practice [MXP003](/refguide/performance-best-practices/#mxp003) for a non-indexed attribute used in sorting is now extended to the same attribute types as for a non-indexed attribute used in XPath.
...
* We fixed an issue with the search field where multiselection was not working correctly with numeric attributes.
