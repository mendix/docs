...
2. Click **Schedule test case** to schedule a test case:
    ...
    {{< figure src="/attachments/addons/ats-addon/ht/v2/ht-two-schedule-testcase-testsuite/Schedules-tab-TC.png" >}}

    Clicking **Schedule test case** opens the **Select Test Case** dialog box:

    {{< figure src="/attachments/addons/ats-addon/ht/v2/ht-two-schedule-testcase-testsuite/select-testcase-dialog.png" >}}
...
4. Click **Select**. Selecting a test case opens the **New Schedule** dialog box:
    ...
    {{< figure src="/attachments/addons/ats-addon/ht/v2/ht-two-schedule-testcase-testsuite/new-schedule-dialog.png" >}}
...
8. Click **Save**:
    ...
    {{< figure src="/attachments/addons/ats-addon/ht/v2/ht-two-schedule-testcase-testsuite/new-schedule-filled.png" >}}
...
{{< figure src="/attachments/addons/ats-addon/ht/v2/ht-two-schedule-testcase-testsuite/scheduled-testcase.png" >}}
...
2. Click **Schedule test suite** to schedule a test suite:
    ...
    {{< figure src="/attachments/addons/ats-addon/ht/v2/ht-two-schedule-testcase-testsuite/Schedules-tab-TS.png" >}}

    Clicking **Schedule test suite** opens the **Select Test Suite** dialog box:

    {{< figure src="/attachments/addons/ats-addon/ht/v2/ht-two-schedule-testcase-testsuite/select-testsuite-dialog.png" >}}
...
{{< figure src="/attachments/addons/ats-addon/ht/v2/ht-two-schedule-testcase-testsuite/scheduled-testsuite-g.png" >}}
