...
Apps running without a license (such as running from the Studios) do not have this limitation. This also means that you can run your app from the Studios without Data Hub license limitations.
