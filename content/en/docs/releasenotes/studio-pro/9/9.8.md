...
* It is now possible to select your [WorkflowContext](/refguide/workflows-elements/#parameters) entity without an association already existing. When done, the necessary association is created for you.
