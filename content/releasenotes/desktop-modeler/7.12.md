...
A software error in Mendix 7.12 has resulted in a possible security vulnerability, where, for a small subset of queries, the write permission was not correctly determined.

Because of this, version 7.12 is no longer available for download.
