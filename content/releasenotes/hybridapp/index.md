...
* We added backwards compatibility w.r.t. the quality vs density properties (android only).

### March 23rd, 2018 (2.0.3 / 2.0.1)

This patch release fixes an issue with an upstream dependency (`com.google.android.gms:play-services-gcm`) that was updated by Google. The issue prevents building *.apk* files, both locally and on Phonegap Build.
