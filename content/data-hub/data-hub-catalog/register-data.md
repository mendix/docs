...
The discoverable status of the OData service defaults to the value set by the Mendix Admin. For more details, see the [Settings](data-hub-admin#settings) section of *Data Hub Administration*.
