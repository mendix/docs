...
* <a id="1866"></a>We fixed an issue where you could not drag an entity from the [Data Hub pane](/refguide/data-hub-pane/) to the domain model editor when Studio Pro was displayed on a secondary screen. You can now do that again.
* <a id="1655"></a>We fixed the issue with [Full Screen mode](/refguide/view-menu/#full-screen) not being available.
