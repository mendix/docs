...
* If a domain model is drawn which contains an **association of length 0px**, you cannot open the domain model when it is migrated to versions 7.23.6 and 7.23.7. For more information see this [Mendix Forum question](https://mxforum.mendix.com/link/questions/94784). (Ticket 85976)
