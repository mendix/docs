...
### Sprintr Fixes
* We have fixed an found issue where a user is not able to change his/her password on the "Password Has Expired" page. (Tickets 80828, 80882, 80884, 80888, 80997, 81005)
* Fixed an issue with retrieving stories in the desktop modeler. (Tickets 80618, 80623, 80636, 80665, 80685, 80705, 80726, 80738, 80780, 80833, 80834, 80854, 80866, 80935, 81008)
* We fixed an error occurring importing stories from excel in certain situations.
* We have fixed an issue where a user was unable to invite referrals to the platform.
