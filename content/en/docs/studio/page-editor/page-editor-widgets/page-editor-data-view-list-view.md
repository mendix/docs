...
| -------------------- | ------------------------------------------------------------ |
| Context              | A data source determining that wherever you are opening the page from, you are passing the selected object. Data views with this data source get the object from the context. You select an entity for this data source, data from this entity will be shown in the data view. The page will expect the object or objects of the selected entity to be passed to it when opened. <br />If your data view is placed inside another data container, for example, inside a list view, you can also select an entity that has associations with the entity of this list view. <br />For more technical information on the context source, see [Context Source](/refguide/context-source/) in the *Studio Pro Guide*. |
