...
Selecting a tile (for instance: 'SalesForce.com' in the above illustration) and then selecting the OK button will import the app service for you in the modeler. See [Consumed App Services](/refguide6/consumed-app-services) for information about the use of imported app services.
