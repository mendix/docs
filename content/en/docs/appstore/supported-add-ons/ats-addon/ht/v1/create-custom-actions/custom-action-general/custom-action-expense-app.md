...
url: /appstore/supported-add-ons/ats/ht-one-custom-action-expense-app/
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v1/create-custom-actions/custom-action-general/custom-action-expense-app/company-expenses-login-screen.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v1/create-custom-actions/custom-action-general/custom-action-expense-app/company-expenses-my-expenses.png" >}}
...
{{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v1/create-custom-actions/custom-action-general/custom-action-expense-app/company-expenses-custom-action-page.png" >}}
