...
* We improved parametrization of the **Delete (\1 \1s)** action in the MxAssist Logic Bot recommendation with smarter suggestions for error-handling and variable suggestions based on usage.
