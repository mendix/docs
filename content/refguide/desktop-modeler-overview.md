...
| More Versioning > Sync with Web Modeler | Syncs your app project with the Web Modeler. For more information, see [How to Sync the Web Modeler & Desktop Modeler](sync-webmodeler-desktopmodeler). |   |
