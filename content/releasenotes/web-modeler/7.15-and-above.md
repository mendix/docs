...
#### Improvements
* We removed the feedback option from the side bar in the user interface, because users got confused with the feedback widget that is part of the app. Of course, you are still welcome to provide feedback about your experience while using the Web Modeler. You can do so in three ways: 1) use the chat icon in the bottom right, or 2) contact Mendix Support for specific issues or questions, or 3) raise your questions/comments on the Community forum 
* We added links to Mendix Support (**Contact Mendix Support**)) and Mendix Community (**Ask the Community**) in the information menu at the top right of the screen, 

#### Fixes
* We fixed a broken url for the how-to that describes syncing the Web Modeler with the Desktop Modeler (in the popup that appears after choosing **Open in Desktop Modeler**)
* We fixed an issue in the microflow editor where the Web Modeler would crash while opening the **Condition** dialog for an Exclusive Split activity that is based on an enumeration
