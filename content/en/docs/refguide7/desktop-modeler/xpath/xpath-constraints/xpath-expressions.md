...
A comparison expression consists of two attributes or values separated by a comparison [operator](/refguide7/xpath-operators/) like `=`, `<=,` and `>`.
...
For information on the available functions, see [XPath Constraint Functions](/refguide7/xpath-constraint-functions/).
