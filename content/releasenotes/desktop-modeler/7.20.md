...
* There is an issue when a new enumeration is added or an existing enumeration is selected as the return type of a Java action. This can result in an Oops exception in the Desktop Modeler. (Ticket 76617)
	* Workaround: You can continue working in the Modeler by closing the pop-up window.
