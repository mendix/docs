...
Major service updates are, for example, when entities or attributes are removed, or input parameters are required. This would be incompatible for the consuming apps and result in the consuming app "breaking".
