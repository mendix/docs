...
* We fixed a bug which allowed creation of multiple sessions for a single user when multiple sessions are not allowed in modeler. (Tickets 78405, 79370, 79520)
