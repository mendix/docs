...
* We fixed the sizes of the **Caption** and **Validation Message** fields in the new/edit **Validation Rule** dialog box for [Validation Assist](/refguide/validation-assist/). [**TW**]
