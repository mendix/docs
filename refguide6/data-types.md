...
Throughout the Modeler the same set of data types are used. The exception is the type of [attributes](/refguide6/attributes), which is more specific with regard to storage in the database. In general, an attribute type maps to the data type with the same name. The exceptions are mentioned in the table below.
...
| Enumeration | One of the values of the given [enumeration](/refguide6/enumerations). | Red, Green, Blue; Todo, Running, Done |
...
| List | A list of objects of a specific [entity](/refguide6/entities). |   |
| Nothing | No value. Can only be used as the return type of a [microflow](/refguide6/microflows). |   |
| Object | A single object of a specific [entity](/refguide6/entities). |   |
