...
* **ki: "When opening" = SPC-868 & SPVC-200 - DONE - add fix note to KI in 8.0 RN**
* **ki: "Incorrect results" = DAT-1587 - DONE - identify fix note below & add anchor - add fix note to KI in 8.0 RN**
* **ki: "In native mobile apps, bottom bar captions" = UICORE-171 - DONE - add fix note to KI in 8.0 RN**
* **ki: "Azure SQL Database currently identifies itself as a variant of SQL Server 2014" = DAT-1610 - will be DONE - add fix note to KI in 8.0 RN**
