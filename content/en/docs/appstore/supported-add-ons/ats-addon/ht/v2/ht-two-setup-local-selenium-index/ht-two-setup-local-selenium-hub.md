...
url: /appstore/supported-add-ons/ats/ht-two-setup-local-selenium-hub/
...
3. Check with the following link if the hub works: `http://localhost:4444/grid/console`.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-setup-local-selenium-index/ht-two-setup-local-selenium-hub/grid_hub.png" >}}
...
3. Check in the console whether your Selenium hub node is active `http://localhost:4444/grid/console`:
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/ht/v2/ht-two-setup-local-selenium-index/ht-two-setup-local-selenium-hub/grid_nodes.png" >}}
...
Congratulations you have finished setting up a local selenium hub. The next how-to is [How to Set Up a Local Docker Selenium Hub](/appstore/supported-add-ons/ats/ht-two-setup-local-docker-selenium-hub/). You find an overview of all the how-tos and the structure on the [ATS 2 How-tos](/appstore/supported-add-ons/ats/ht-two/) page. We advise you to follow the predefined structure.
