...
## SAVEPOINT Exception Does Not Exist
...
Mendix supports functionality to extract a part of a date and time in a query. In XPath, you can use functions like [`hours-from-dateTime`](/refguide9/xpath-hours-from-datetime/) and [`week-from-dateTime`](/refguide9/xpath-week-from-datetime/). In OQL, you can use functions like [`DATEPART(..)`](/refguide9/oql-datepart/) and [`DATEDIFF(..)`](/refguide9/oql-datediff/). 
