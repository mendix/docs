...
| **Edit Cloud Foundry Settings** | Opens the **Edit Cloud Foundry Settings** dialog box so you can edit your Cloud Foundry settings. For more information on this dialog window, see [Edit Cloud Foundry Settings](edit-cloud-foundry-settings). | |
