---
title: "Local Profile"
url: /appstore/supported-add-ons/ats/rg-two-profile/
...
For more details on tenant administration, see [Administration](/appstore/supported-add-ons/ats/rg-two-administration/).
...
2. Click **Show Profile**.
    ...
    {{< figure src="/attachments/appstore/supported-add-ons/ats/rg-ats/v2/rg-two-profile/profile.png" alt="Edit profile page" >}}
...
{{% alert color="info" %}}
To change your password, you need to log in first. If you have problems with logging in, contact your tenant administrator. For more details on tenant administration, see [Administration](/appstore/supported-add-ons/ats/rg-two-administration/).
{{% /alert %}} 
