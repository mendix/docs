...
* Configure text generation and knowledge base keys (for details, see [Configuration](/agents/agents-kit-1/reference-guide/genai-for-mx/agent-commons/#configuration) in the *Agent Commons* documentation).
