...
With these changes in _config.xml_, your app will run on the superior `WKWebView` engine. Make sure you update your custom widgets with the latest version in the Mendix Marketplace, publish your app, and enjoy the ride! (Tickets 39806, 43665)
