...
| **com.mendix.core.UseMimeDecoderForBase64** | Introduced in Studio Pro 9.12.0. The setting defines whether to use Basic decoder ([RFC 4648](https://datatracker.ietf.org/doc/html/rfc4648)) or MIME decoder ([RFC 2045](https://datatracker.ietf.org/doc/html/rfc2045)) when decoding base64 binary data. The Basic decoder is recommended due to its strictness with not accepting any character outside of Base64 specification, see [Security Considerations](https://datatracker.ietf.org/doc/html/rfc4648#section-12). This setting exists for  for reasons of backwards compatibility. Using the MIME decoder is deprecated and the option will be removed in future versions. | false |
