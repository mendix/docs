...
| **com.mendix.core.ScheduledEventsCleanupAge** | This settings specifies (in milliseconds) how old completed Scheduled Events can be before they are removed from the database. By default this setting is off. | |
...
| **com.mendix.core.ProcessedTasksCleanupAge** | This settings specifies (in milliseconds) how old completed Processed Tasks can be before they are removed from the database. By default this setting is off. | |
