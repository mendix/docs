...
{{% alert type="warning" %}}
We are investigating an issue related to styling that was introduced in 8.14.0. This might cause breaking changes in style in your native apps. We advise not going into production with this Studio Pro version before we have done a thorough investigation and shared our outcome. Please note that web apps are not affected.
{{% /alert %}}
