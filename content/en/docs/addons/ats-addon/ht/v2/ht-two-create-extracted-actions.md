...
6. Click **Extract action**.
    ...
    {{< figure src="/attachments/addons/ats-addon/ht/v2/ht-two-create-extracted-actions/extract-actions.png" >}}

    Clicking **extract action** opens the **Action - Set Details** dialog box:

    {{< figure src="/attachments/addons/ats-addon/ht/v2/ht-two-create-extracted-actions/action-set-details.png" >}}
...
9. Click **Close**.
    ...
    {{< figure src="/attachments/addons/ats-addon/ht/v2/ht-two-create-extracted-actions/close-extracted-action.png" >}}
...
2. Click **Open**.
    ...
    {{< figure src="/attachments/addons/ats-addon/ht/v2/ht-two-create-extracted-actions/click-open.png" >}}
    ...
    {{< figure src="/attachments/addons/ats-addon/ht/v2/ht-two-create-extracted-actions/open-app-and-login-action.png" >}}
...
4. Click **Select**
    ...
    {{< figure src="/attachments/addons/ats-addon/ht/v2/ht-two-create-extracted-actions/add-extracted-action.png" >}}
...
{{< figure src="/attachments/addons/ats-addon/ht/v2/ht-two-create-extracted-actions/Deleting_an_expense.png" >}}

The actions needed to delete an expense are **Click DataGrid row**, **Click Widget** and **Confirm Dialog**. 

{{< figure src="/attachments/addons/ats-addon/ht/v2/ht-two-create-extracted-actions/test-steps-delete-expense.png" >}}
...
3. Click **New Action**.
    ...
    {{< figure src="/attachments/addons/ats-addon/ht/v2/ht-two-create-extracted-actions/create-new-action.png" >}}

    Clicking **New Action** opens the **Create new** dialog box:

    {{< figure src="/attachments/addons/ats-addon/ht/v2/ht-two-create-extracted-actions/create-new.png" >}}
...
6. Click **Create**.
    ...
    {{< figure src="/attachments/addons/ats-addon/ht/v2/ht-two-create-extracted-actions/click-create-of-action.png" >}}

7. Click create to open the **Actions Details** Page.

    {{< figure src="/attachments/addons/ats-addon/ht/v2/ht-two-create-extracted-actions/action-details-page.png" >}}
...
8. Record the test steps needed to delete an expense, these are the **Click DataGrid row**, **Click Widget** and **Confirm Dialog** actions. You can also add the actions manually and enter the needed input parameters yourself.
    ...
    {{< figure src="/attachments/addons/ats-addon/ht/v2/ht-two-create-extracted-actions/added-steps.png" >}}

9. Click the **Settings** tab.
10. Click **New**.

    {{< figure src="/attachments/addons/ats-addon/ht/v2/ht-two-create-extracted-actions/create-new-input-parameter.png" >}}

    Clicking **New** opens the **Edit Input Parameter** dialog box:

    {{< figure src="/attachments/addons/ats-addon/ht/v2/ht-two-create-extracted-actions/edit-input-parameter-dialog.png" >}}
...
13. Click **Save**.
    ...
    {{< figure src="/attachments/addons/ats-addon/ht/v2/ht-two-create-extracted-actions/save-input-parameter.png" >}}

    Clicking **Save** adds the input parameter:

    {{< figure src="/attachments/addons/ats-addon/ht/v2/ht-two-create-extracted-actions/added-input-parameter.png" >}}
...
16. Change the input parameter to **Column Value** below **Input values**.
    ...
    {{< figure src="/attachments/addons/ats-addon/ht/v2/ht-two-create-extracted-actions/change-input-parameter.png" >}}
...
{{< figure src="/attachments/addons/ats-addon/ht/v2/ht-two-create-extracted-actions/enter-input-and-run.png" >}}
