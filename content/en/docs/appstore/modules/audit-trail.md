...
* **LogUseDecimalScientificNotation** (default: true) - This determines if the module should log large decimal values using scientific notation (`BigDecimal.toString`) or not (`BigDecimal.toPlainString`).
