...
| Full Width | The button takes the whole width of a container it is placed in. | Enabled/Disabled                                             |
...
| Color        | Changes the color of the text        | Possible values for **Color** are the following:<ul><li>Header color</li><li>Detail color</li><li>Default – note that this is the default text color, not the default button color</li><li>Primary</li><li>Inverse</li><li>Success</li><li>Warning</li><li>Danger</li></ul><br />{{%alert type="info" %}}The color for each value depends on your settings in the **Theme Customizer**. For details, see [Theme Customizer in the Web Modeler](theme-customizer-wm).<br />{{%/alert %}} |
