...
[{{< figure src="/attachments/refguide10/modeling/pages/page-icon.png" class="no-border" >}}Page](/refguide/page/) | A [page](/refguide/page/) is the end-user interface of a Mendix application. Pages are the things that are actually shown to the end-user. 
[{{< figure src="/attachments/refguide10/modeling/pages/menu-icon.png" class="no-border" >}}Menu](/refguide/menu/) | A [menu](/refguide/menu/) defines a menu structure that can be used by a menu widget. 
