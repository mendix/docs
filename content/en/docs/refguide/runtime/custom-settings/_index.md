...
If you are running your app on the Mendix Cloud or SAP Business Technology Platform, you can access these settings in Apps via **Environments** > **Environment Details** > **Runtime** > **Custom Runtime Settings**. For more information see:
