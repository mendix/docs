...
3. Go to the Marketplace and download the *SendEmailModule.mpk* file for the [Automated Task & Resource Planner](https://marketplace.mendix.com/link/component/118393).
4.  To add the Automated Task & Resource Planner to your app in Mendix Studio Pro, follow these steps:
   ...
   5.  Open the **App Explorer** to view the **SendEmailModule** module.
