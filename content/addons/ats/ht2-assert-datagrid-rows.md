...
In ATS you can assert rows in a data grid With the [Find/Assert DataGrid Row](../../refguide/rg1/findassert-datagrid-row) action. As the action has many input parameters this how to explains how-to use the action. 
